...
namespace WindowsApplication1
{
  ...
  pub class SFTypeClass : ISerializable
  {
    ...
    pub int[] ExtraPicSpriteID;
    pub string[] ExtraSidewaysFileName;
    pub int[] ExtraSidewaysSpriteID;
    pub string[] ExtraSymbolFileName;
    pub int[] ExtraSymbolSpriteID;
    pub string[] ExtraSymbolFileName2;
    pub int[] ExtraSymbolSprite2ID;
    pub string[] ExtraSymbolColBigFileName;
    pub int[] ExtraSymbolColBigSpriteID;
    pub string[] ExtraSymbolColBigFileName2;
    pub int[] ExtraSymbolColBigSprite2ID;
    pub int[] ExtraCode;
    ...
    pub ArtRange: i32;
    pub int[] FavTarget;
    pub int[] FavArtTarget;
    pub FavTargetTries: i32;
    pub int[] AttackPower;
    pub int[] AttackPowerDef;
    ...
    pub int[] ModelVariantCheck;
    pub int[] ModelVariantExec;
    pub int[] artCode;
    pub int[] SFTypeVar;
    pub ArtSFType: i32;
