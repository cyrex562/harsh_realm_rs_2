...
namespace WindowsApplication1
{
  ...
  {
    public const int CONSTVERSION = 424;
    public const string CONSTSUBVERSION = ".04b";
    public const string CONSTFILEEXTENSIONSLOAD = "SE1 Scenario file (*.se1)|*.se1";
    public const string CONSTFILEEXTENSIONSSAVE = "SE1 Scenario file (*.se1)|*.se1";
    public const string CONSTFILEEXTENSIONAUTOSAVE = ".se1";
    public const int CONSTVERSIONDISPLAYMINUS = 314;
    public const string CONSTFILEEXTENSTIONLOADMAP = "SE1 Map file(*.se1map)|*.se1map";
    public const string CONSTFILEEXTENSIONEVENTLIB = "SE1 Event library(*.se1evlib)|*.se1evlib";
    public const string CONSTFILEEXTENSIONTROOPSLIB = "SE1 Troops&Equipment library(*.se1troops)|*.se1troops";
    public const string CONSTFILEEXTENSIONHISTORICALLIB = "SE1 Historical library(*.se1his)|*.se1his";
    public const string CONSTFILEEXTENSIONOFFICERLIB = "SE1 Officer library(*.se1off)|*.se1off";
    public const string CONSTFILEEXTENSIONOFFICERCARDLIB = "SE1 Officer Card Library(*.se1offcard)|*.se1offcard";
    public const string CONSTFILEEXTENSIONLOADANYLIB = "SE1 Scenario file (*.se1)|*.se1|SE1 Map file(*.se1map)|*.se1map|SE1 Master file(*.se1master)|*.se1master|SE1 Event library(*.se1evlib)|*.se1evlib|SE1 Troops&Equipment library(*.se1troops)|*.se1troops|SE1 Historical library(*.se1his)|*.se1his|SE1 Officer Card Library(*.se1offcard)|*.se1offcard|SE1 Officer library(*.se1off)|*.se1off";
    public const string CONSTFILEEXTENSIONLOADLIB = "SE1 Event library(*.se1evlib)|*.se1evlib|SE1 Troops&Equipment library(*.se1troops)|*.se1troops|SE1 Historical library(*.se1his)|*.se1his|SE1 Officer Card Library(*.se1offcard)|*.se1offcard|SE1 Officer library(*.se1off)|*.se1off";
    public const string CONSTFILEEXTENSIONLOADMASTER = "SE1 Master file(*.se1master)|*.se1master";
    public const string CONSTSHORTLOADMAP = ".se1map";
    public const string CONSTSHORTEVENTLIB = ".se1evlib";
    public const string CONSTSHORTTROOPSLIB = ".se1troops";
    public const string CONSTSHORTHISTORICALLIB = ".se1his";
    public const string CONSTSHORTOFFICERLIB = ".se1off";
    public const string CONSTSHORTOFFICERCARDLIB = ".se1offcard";
    public const string CONSTSHORTMASTER = ".se1master";
    public const string CONSTPREINSTALLEDGFXDIR = "shadow";
    public string Name;
    public int Product;
    ...
    public bool[] GameSlotShow;
    public bool[] GameSlotShow2;
    public string[] RegimeSlotName;
    public bool[] RegimeSlotShow;
    public int[] RegimeSlotShow2;
    public int[] RegimeSlotNato;
    public int[] RegimeSlotSmallGfx;
    public string[] RealTempString;
    public int[] GameSlotNato;
    public int[] GameSlotSmallGfx;
    public const int Slotcounter = 499;
    public bool ShrowdOn;
    public bool FOWOn;
    public bool UncertaintyOn;
    public bool ASOn;
    public int ResMod;
    ...
    public int VPWin;
    public bool PasswordsOn;
    public bool PBEM;
    public bool ScreenShotOn;
    public bool CreatedWithShrowd;
    public bool ShrowdPeek;
    public bool AutoSave;
    public bool Verify1;
    public bool Verify2;
    public int MapCounter;
    public MapClass[] MapObj;
    public int LibraryCounter;
    public LibraryClass[] LibraryObj;
    public int LibVarCounter;
    public LibVarClass[] LibVarObj;
    public int MapWidth;
    public int MapHeight;
    public HexClass[,] HexObj;
    public int LandscapeTypeCounter;
    public LandscapeTypeClass[] LandscapeTypeObj;
    public int RoadTypeCounter;
    public RoadTypeClass[] RoadTypeObj;
    public int RegimeCounter;
    public RegimeClass[] RegimeObj;
    public int RegimeIdCounter;
    public int UnitCounter;
    public UnitClass[] UnitObj;
    public int SFCounter;
    public SFClass[] SFObj;
    public int SFTypeCounter;
    public SFTypeClass[] SFTypeObj;
    public int SFTypeIdCounter;
    public int LocTypeCounter;
    public LocationTypeClass[] LocTypeObj;
    public int LocCounter;
    public LocationClass[] LocObj;
    public object LocIdCounter;
    public int ItemTypeCounter;
    public ItemTypeClass[] ItemTypeObj;
    public int PeopleCounter;
    public PeopleClass[] PeopleObj;
    public int PeopleIdCounter;
    public int StringCounter;
    public string[] TempString;
    public float[] RuleVar;
    public string[] RuleString;
    public int[] RuleGroup;
    public int[] RuleGroup2;
    public int RuleCounter;
    public int RiverTypeCounter;
    public RiverTypeClass[] RiverTypeObj;
    public int AreaCounter;
    public AreaClass[] AreaObj;
    public int AreaIDCounter;
    public int HistoricalUnitCounter;
    public HistoricalUnitClass[] HistoricalUnitObj;
    public int HistoricalIDCounter;
    public BridgeClass[] BridgeObj;
    public int ActionCardCounter;
    public ActionCardClass[] ActionCardObj;
    public int ResearchCounter;
    public ResearchClass[] ResearchObj;
    public int EventCounter;
    public EventClass[] EventObj;
    public int EventIdCounter;
    public int EventPicCounter;
    public string[] EventPicName;
    public int[] EventPicNr;
    public LibIdClass[] eventPicLibId;
    public int SmallPicCounter;
    public string[] SmallPicName;
    public int[] SmallPicNr;
    public LibIdClass[] SmallLibId;
    public int reinfIdCounter;
    public int ReinfCounter;
    public string[] ReinfName;
    public LibIdClass[] ReinfLibId;
    public int[] ReinfId;
    public int StringListCounter;
    public StringListClass[] StringListObj;
    public int StringIDCounter;
    public string[] CheckTypeNames;
    public string[] ExecTypeNames;
    public string[,] CheckTypeVarName;
    public int[] CheckTypeVarCount;
    public int CheckTypeCount;
    public string[] CheckDesc;
    public int[] CheckCategory;
    public int[] CheckCategory2;
    public int[] ExecCategory;
    public int[] ExecCategory2;
    public string[,] ExecTypeVarName;
    public int[] ExecTypeVarCount;
    public string[] ExecDesc;
    public int ExecTypeCount;
    public int[] ExecTypeString;
    public int[] TempVar;
    public string[] ExecCategoryName;
    public string[] CheckCategoryName;
    public int AlternateRound;
    public int AlternateRound2;
    public DateTime StartData;
    public float PPMultiplier;
    public float SupplyMultiplier;
    public float ResCostMod;
    public bool NoPlayChoice;
    public bool NoAIAdvice;
    public int[] Variants;
    public int[] VariantEvent;
    public const int MoveGroup1 = 0;
    public const int MoveGroup2 = 99;
    public const int LandscapeGroup1 = 100;
    public const int LandscapeGroup2 = 199;
    public const int PeopleGroup1 = 200;
    public const int PeopleGroup2 = 299;
    public const int ItemGroup1 = 300;
    public const int ItemGroup2 = 399;
    public const int SFTypeGroup1 = 400;
    public const int SFTypeGroup2 = 499;
    public const int LocTypeGroup1 = 500;
    public const int LocTypeGroup2 = 599;
    public int[] MoveTypePenalty;
    public int[] UnitTypePenalty;
    public int[] WheaterColor;
    public bool MasterfileReadPeople;
    public bool MapLoop;
    public int[] ReinfRatio;
    public int GameID;
    public bool TerrorMode;
    public bool DontShowAIMove;
    public string LoadGame;
    public int UseAI;
    public int CampaignRoom;
    public string SystemGfx;
    public string ScenarioDir;
    public string SoundDir;
    public int SFModelIDCounter;
    public string TurnString;
    public bool Loadable;
    public int specialSaveMode;
    public string RuleSetName;
    public bool DoAllied;
    public bool PermanentOverlayUse;
    public string PermanentOverlayName;
    public int PermanentOverlaySpriteID;
    public int PbemGameID;
    public string PbemPlayer1;
    public string PbemPlayer2;
    public int PbemGameOver;
    public int PbemDrawGame;
    public int AIUnitCounter;
    public bool SimpleEditor;
    public string ExtraTabName;
    public int ExtraTabEvent;
    public string ExtraTabName2;
    public int ExtraTabEvent2;
    public string ExtraTabName3;
    public int ExtraTabEvent3;
    public string ExtraTabName4;
    public int ExtraTabEvent4;
    public string MapName;
    public int MapVersion;
    public string MapDesigner;
    public int CombatLogId;
    public string scenarioVersion;
    public string scenarioVersionMaster;
    public int[] transportMovementType;
    public int se1_earlyCinematicsLogin;

    public int GetLibVarUseId(int libVarId, int slotId)
    {
      int index = slotId;
      ...
      if (index > -1)
      {
        ...
        for (int libVarUseId = 0; libVarUseId <= libVarCounter; ++libVarUseId)
        {
    ...
    public DataClass(int twidth = 25, int theight = 25, bool DontLoadGraphics = false)
    {
    ...
    public void SetEventNames()
    {
      ...
      this.CheckTypeNames[(int) sbyte.MaxValue] = "CheckHisVar";
      this.CheckTypeVarCount[(int) sbyte.MaxValue] = 2;
      this.CheckTypeVarName[(int) sbyte.MaxValue, 1] = "His Unit ID#";
      this.CheckTypeVarName[(int) sbyte.MaxValue, 2] = "Type#";
      this.CheckCategory[(int) sbyte.MaxValue] = 5;
      this.CheckDesc[(int) sbyte.MaxValue] = "Returns value if type is present. If type is not present it returns 0.";
      ...
      this.CheckTypeNames[(int) byte.MaxValue] = "CheckTextWidth";
      this.CheckTypeVarCount[(int) byte.MaxValue] = 1;
      this.CheckTypeVarName[(int) byte.MaxValue, 1] = "Full Element Text";
      this.CheckDesc[(int) byte.MaxValue] = "Returns the number of pixels ";
      this.CheckCategory[(int) byte.MaxValue] = 11;
      ...
      this.ExecTypeNames[(int) sbyte.MaxValue] = "ExecRemoveStringListRow";
      this.ExecTypeVarCount[(int) sbyte.MaxValue] = 2;
      this.ExecTypeVarName[(int) sbyte.MaxValue, 1] = "StringList ID";
      this.ExecTypeVarName[(int) sbyte.MaxValue, 2] = "Row Number";
      this.ExecCategory[(int) sbyte.MaxValue] = 16;
      ...
      this.ExecTypeNames[(int) byte.MaxValue] = "ExecSetActionCardEventPicture";
      this.ExecTypeVarCount[(int) byte.MaxValue] = 2;
      this.ExecTypeVarName[(int) byte.MaxValue, 1] = "Card Nr";
      this.ExecTypeVarName[(int) byte.MaxValue, 2] = "Event Picture Nr";
      this.ExecCategory[(int) byte.MaxValue] = 5;
      this.ExecDesc[(int) byte.MaxValue] = "A simple replace picture of the card. ";
    ...
    public void SetDefaultRules(bool namesonly = false)
    {
      ...
      this.RuleString[(int) sbyte.MaxValue] = "Score Pinned Entrench loss %";
      if (!namesonly)
        this.RuleVar[(int) sbyte.MaxValue] = 50f;
      this.RuleGroup[(int) sbyte.MaxValue] = 9;
    ...
    public void SetDefaultTempStrings()
    {
    ...
    public int FindUnit(ref UnitClass uni, string libName)
    {
      int unitCounter = this.UnitCounter;
      for (int unit = 0; unit <= unitCounter; ++unit)
      {
    ...
    public int FindPredef(int id)
    {
      int unitCounter = this.UnitCounter;
      for (int predef = 0; predef <= unitCounter; ++predef)
      {
    ...
    public int AddUnit(int x, int y, int map)
    {
      ++this.UnitCounter;
      ++this.AIUnitCounter;
    ...
    public void RemoveUnit(int nr, ref GameClass tgame = null, bool deleteRegimeMod = false)
    {
      ...
      if (nr < this.UnitCounter)
      {
        ...
        for (int Newnr = num1; Newnr <= num2; ++Newnr)
        {
      ...
      bool DeleteRegimeMode = false)
    {
      ...
      for (int index7 = 0; index7 <= unitCounter1; ++index7)
      {
        ...
        if (this.UnitObj[index7].PassengerCounter > -1)
        {
          ...
          for (int index8 = 0; index8 <= passengerCounter; ++index8)
          {
        ...
        if (this.UnitObj[index7].TransportCounter > -1)
        {
          ...
          for (int index9 = 0; index9 <= transportCounter; ++index9)
          {
      ...
      if (!DeleteRegimeMode && !Information.IsNothing((object) tgame))
      {
        if (!Information.IsNothing((object) tgame.AIObj))
        {
          ...
          for (int index = 0; index <= tplanCount; ++index)
          {
    ...
    public void MassChangeSFNr(int FromNr)
    {
      if (this.UnitCounter <= -1)
        return;
      int unitCounter = this.UnitCounter;
    ...
    public void ChangeSFNr(int Oldnr, int Newnr)
    {
      if (this.UnitCounter <= -1)
        return;
      int unitCounter = this.UnitCounter;
    ...
    public int FindSFType(ref SFTypeClass sft, string libName, bool thisIsHistoricalImport = false)
    {
      int sfTypeCounter = this.SFTypeCounter;
      for (int sfType = 0; sfType <= sfTypeCounter; ++sfType)
      {
    ...
    public int FindSFType(string libName, int libId)
    {
      int sfTypeCounter = this.SFTypeCounter;
      for (int sfType = 0; sfType <= sfTypeCounter; ++sfType)
      {
    ...
    public int FindSFTypeAlien(string libName, int libId, int buildGround)
    {
      int num = -1;
      SimpleList simpleList = new SimpleList();
      int sfTypeCounter = this.SFTypeCounter;
      for (int tid = 0; tid <= sfTypeCounter; ++tid)
      {
    ...
    public void AddSFType(bool temporary = false)
    {
      ++this.SFTypeCounter;
    ...
    public void ChangeSFTypeNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int nr;
      for (int index1 = 0; index1 <= stringListCounter; ++index1)
      {
        ...
        for (int index2 = 0; index2 <= width; ++index2)
        {
          ...
          for (int index3 = 0; index3 <= length; ++index3)
          {
            ...
            {
              nr = (int) Math.Round(Conversion.Val(this.StringListObj[index1].Data[index3, index2]));
              if (nr == Oldnr)
                nr = Newnr;
    ...
    public void RemoveLandscapeType(int nr)
    {
    ...
    public void ChangeLandscapeNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
      {
        ...
        for (int index3 = 0; index3 <= width; ++index3)
        {
          ...
          for (int index4 = 0; index4 <= length; ++index4)
          {
            ...
            {
              index1 = (int) Math.Round(Conversion.Val(this.StringListObj[index2].Data[index4, index3]));
              if (index1 == Oldnr)
                index1 = Newnr;
      ...
      int mapCounter = this.MapCounter;
      for (int index5 = 0; index5 <= mapCounter; ++index5)
      {
      ...
      for (index1 = 0; index1 <= locTypeCounter; ++index1)
      {
      ...
      for (index1 = 0; index1 <= landscapeTypeCounter1; ++index1)
      {
      ...
      for (index1 = 0; index1 <= landscapeTypeCounter2; ++index1)
      {
    ...
    public void RemoveLandscapeBasicSprite(int ltnr, int nr)
    {
    ...
    public void ChangeLandscapeSpriteNr(int LTnr, int OldNr, int NewNr)
    {
      int mapCounter = this.MapCounter;
    ...
    public int FindLibrary(string libName)
    {
      int libraryCounter = this.LibraryCounter;
      for (int library = 0; library <= libraryCounter; ++library)
      {
    ...
    public int FindLibraryLowCase(string libName)
    {
      libName = Strings.LCase(libName);
      int libraryCounter = this.LibraryCounter;
      for (int libraryLowCase = 0; libraryLowCase <= libraryCounter; ++libraryLowCase)
      {
    ...
    public void AddLibrary()
    {
      ...
      this.LibraryObj[this.LibraryCounter] = new LibraryClass();
    }

    public void RemoveLibrary(int nr)
    {
    ...
    public void ChangeLibraryNr(int Oldnr, int Newnr)
    {
    ...
    public int FindLibVar(ref LibVarClass tlv, string libName)
    {
      libName = Strings.LCase(libName);
      int libVarCounter = this.LibVarCounter;
      for (int libVar = 0; libVar <= libVarCounter; ++libVar)
      {
    ...
    public int FindLibVar(ref string libvarname, string libName)
    {
    ...
    public void AddLibVar(int libSlot)
    {
      ++this.LibVarCounter;
    ...
    public void RemoveLibVar(int nr)
    {
    ...
    public void ChangeLibVarNr(int Oldnr, int Newnr)
    {
      int mapWidth = this.MapObj[0].MapWidth;
      for (int index1 = 0; index1 <= mapWidth; ++index1)
      {
    ...
    public void RemoveRoadType(int nr)
    {
    ...
    public void ChangeRoadNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
    ...
    public void RemoveRiverType(int nr)
    {
    ...
    public void ChangeRiverNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
    ...
    public void AddArea()
    {
      ...
      this.AreaObj[this.AreaCounter] = new AreaClass();
      ++this.AreaIDCounter;
      this.AreaObj[this.AreaCounter].ID = this.AreaIDCounter;
    }

    public void RemoveArea(int nr)
    {
    ...
    public int FindHistorical(ref HistoricalUnitClass his, string libName)
    {
      int historicalUnitCounter = this.HistoricalUnitCounter;
      for (int historical = 0; historical <= historicalUnitCounter; ++historical)
      {
    ...
    public int FindHistoricalFromSameLib(ref HistoricalUnitClass his, string libName)
    {
      int historicalUnitCounter = this.HistoricalUnitCounter;
      for (int historicalFromSameLib = 0; historicalFromSameLib <= historicalUnitCounter; ++historicalFromSameLib)
      {
    ...
    public int FindOffHistorical(ref HistoricalUnitClass his, string libName)
    {
      int historicalUnitCounter = this.HistoricalUnitCounter;
      for (int offHistorical = 0; offHistorical <= historicalUnitCounter; ++offHistorical)
      {
    ...
    public int FindOffHistoricalBySameLib(ref HistoricalUnitClass his, string libName)
    {
      int historicalUnitCounter = this.HistoricalUnitCounter;
      for (int historicalBySameLib = 0; historicalBySameLib <= historicalUnitCounter; ++historicalBySameLib)
      {
    ...
    public void AddHistoricalUnit()
    {
      ...
      this.HistoricalUnitObj[this.HistoricalUnitCounter] = new HistoricalUnitClass();
      int historicalUnitCounter = this.HistoricalUnitCounter;
    ...
    public void ChangeHistoricalUnitNr(int Oldnr, int Newnr, bool QuickMode = false)
    {
      QuickMode = true;
      int index1;
      if (!QuickMode)
    ...
    public int FindRegime(ref RegimeClass reg, string libName)
    {
      int regimeCounter = this.RegimeCounter;
      for (int regime = 0; regime <= regimeCounter; ++regime)
      {
    ...
    public int FindRegimeFromSameLib(ref RegimeClass reg, string libName)
    {
      int regimeCounter = this.RegimeCounter;
      for (int regimeFromSameLib = 0; regimeFromSameLib <= regimeCounter; ++regimeFromSameLib)
      {
    ...
    public void AddRegime(bool noRedimNecc = false, bool tMinimumDataUsage = false)
    {
      this.ThreadBlock();
      ++this.RegimeCounter;
      ...
      if (noRedimNecc)
      {
        ...
        for (int index4 = 0; index4 <= mapCounter2; ++index4)
        {
    ...
    public void MoveRegimeHigher(int regnr)
    {
      this.AddRegime();
    ...
    public void MoveRegimeLower(int regnr)
    {
      this.AddRegime();
      if (regnr > 0)
      {
    ...
    public void ChangeRegimeNr(int Oldnr, int Newnr, bool QuickMode = false)
    {
      QuickMode = true;
      int index1;
      if (!QuickMode)
        ...
        for (int index2 = 0; index2 <= stringListCounter; ++index2)
        {
          ...
          for (index1 = 0; index1 <= width; ++index1)
          {
            ...
            for (int index3 = 0; index3 <= length; ++index3)
            {
              ...
              {
                int num = (int) Math.Round(Conversion.Val(this.StringListObj[index2].Data[index3, index1]));
                if (num == Oldnr)
                  num = Newnr;
      ...
      int mapCounter1 = this.MapCounter;
      for (int index4 = 0; index4 <= mapCounter1; ++index4)
      {
        int mapWidth = this.MapObj[index4].MapWidth;
      ...
      if (this.Product >= 6 & this.Round > 0)
      {
        ...
        int regimeCounter = this.RegimeCounter;
        for (int index7 = 0; index7 <= regimeCounter; ++index7)
        {
          if (!this.RegimeObj[index7].minimumDataUsage)
            tRegimeFullCount = index7;
        }
        int mapCounter2 = this.MapCounter;
        for (int index8 = 0; index8 <= mapCounter2; ++index8)
        {
      ...
      for (int index11 = this.RegimeCounter; index11 >= 0; index11 += -1)
      {
        if (this.Round > 0)
        {
          ...
          try
          {
            ...
            for (int index14 = 0; index14 <= historyStepCounter; ++index14)
            {
      ...
      for (int index15 = 0; index15 <= itemTypeCounter; ++index15)
      {
    ...
    public int FindStringList(ref StringListClass e, string libname)
    {
      int stringListCounter = this.StringListCounter;
      for (int stringList = 0; stringList <= stringListCounter; ++stringList)
      {
    ...
    public void RemoveStringList(int nr)
    {
      int regimeCounter = this.RegimeCounter;
      for (int index = 0; index <= regimeCounter; ++index)
      {
    ...
    public void RemoveResearch(int nr)
    {
    ...
    public void ChangeResearchNr(int Oldnr, int Newnr)
    {
      int itemTypeCounter = this.ItemTypeCounter;
      ...
      int locTypeCounter = this.LocTypeCounter;
      for (int index3 = 0; index3 <= locTypeCounter; ++index3)
      {
        int index4 = 0;
        do
        {
    ...
    public void RemoveLocType(int nr)
    {
    ...
    public void ChangeLocTypeNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int nr;
      for (int index1 = 0; index1 <= stringListCounter; ++index1)
    ...
    public void AddLoc(int x, int y, int map)
    {
      this.ThreadBlock();
      ...
      this.LocObj[this.LocCounter].items = new ItemList();
      this.ThreadRelease();
    }

    public void AddLoc2(int x, int y, int map)
    {
      this.ThreadBlock();
      this.LocIdCounter = Operators.AddObject(this.LocIdCounter, (object) 1);
      ++this.LocCounter;
    ...
    public void ChangeLocNr(int Oldnr, int Newnr)
    {
      int mapCounter = this.MapCounter;
      for (int index1 = 0; index1 <= mapCounter; ++index1)
      {
    ...
    public int FindEvent(ref EventClass e, string libname)
    {
    ...
    public int FindEvent2(string libname, int id)
    {
      int eventCounter = this.EventCounter;
      for (int event2 = 0; event2 <= eventCounter; ++event2)
      {
    ...
    public void AddEvent(int insert = -1)
    {
    ...
    public void ChangeEventNr2(int fromnr, int toonr)
    {
      ...
      for (int index2 = 0; index2 <= historicalUnitCounter; ++index2)
      {
        ...
        for (int index3 = 0; index3 <= autoEventCounter; ++index3)
        {
      ...
      for (int index4 = 0; index4 <= sfTypeCounter; ++index4)
      {
        ...
        for (int index5 = 0; index5 <= upperBound; ++index5)
        {
        ...
        for (int index6 = 0; index6 <= modelVariantCounter; ++index6)
        {
      ...
      int locTypeCounter = this.LocTypeCounter;
      for (int index7 = 0; index7 <= locTypeCounter; ++index7)
      {
    ...
    public void ChangeEventSwitchNr(int fromnr, int toonr)
    {
      int actionCardCounter = this.ActionCardCounter;
      for (int index = 0; index <= actionCardCounter; ++index)
      {
      ...
      for (int index4 = 0; index4 <= sfTypeCounter; ++index4)
      {
        ...
        int researchCounter = this.ResearchCounter;
        for (int index5 = 0; index5 <= researchCounter; ++index5)
        {
          if (this.SFTypeObj[index4].ModelImproveEvent[index5] == fromnr)
            this.SFTypeObj[index4].ModelImproveEvent[index5] = toonr;
    ...
    public void RemoveEvent(int nr)
    {
      if (nr < this.EventCounter)
      {
        ...
        for (int toonr = num1; toonr <= num2; ++toonr)
        {
          this.EventObj[toonr] = this.EventObj[toonr + 1];
          this.ChangeEventNr2(toonr + 1, toonr);
        }
    ...
    public int FindPeople(ref PeopleClass ppl, string libName)
    {
      int peopleCounter = this.PeopleCounter;
      for (int people = 0; people <= peopleCounter; ++people)
      {
    ...
    public void ChangePeopleNr(int Oldnr, int Newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
      ...
      int itemTypeCounter = this.ItemTypeCounter;
      for (index1 = 0; index1 <= itemTypeCounter; ++index1)
      {
        if (this.ItemTypeObj[index1].PeopleMod == Oldnr)
          this.ItemTypeObj[index1].PeopleMod = Newnr;
      }
      int historicalUnitCounter = this.HistoricalUnitCounter;
      for (index1 = 0; index1 <= historicalUnitCounter; ++index1)
      {
    ...
    public void MovePeopleHigher(int peopleNr)
    {
      this.AddPeople();
    ...
    public void MovePeopleLower(int PeopleNr)
    {
      this.AddPeople();
      if (PeopleNr > 0)
      {
    ...
    public void ChangeMapNr(int Oldnr, int Newnr)
    {
      for (int unitCounter = this.UnitCounter; unitCounter >= 0; unitCounter += -1)
      {
    ...
    public void AddItemType()
    {
      ...
      for (int index1 = 0; index1 <= regimeCounter2; ++index1)
      {
        int upperBound = this.RegimeObj[index1].SProd.GetUpperBound(0);
        for (int index2 = 0; index2 <= upperBound; ++index2)
        {
          int round = this.Round;
          for (int index3 = 0; index3 <= round; ++index3)
      ...
      for (int index4 = 0; index4 <= regimeCounter4; ++index4)
      {
        int itemTypeCounter = this.ItemTypeCounter;
        for (int index5 = 0; index5 <= itemTypeCounter; ++index5)
        {
          int num = this.Round + 1;
    ...
    public void RemoveItemType(int nr)
    {
    ...
    public void ChangeItemTypeNr(int Oldnr, int Newnr)
    {
      int itemTypeCounter = this.ItemTypeCounter;
    ...
    public int FindActionCard(ref ActionCardClass e, int origCardSlot, string libname)
    {
      if (Information.IsNothing((object) e))
      {
        int actionCardCounter = this.ActionCardCounter;
        for (int actionCard = 0; actionCard <= actionCardCounter; ++actionCard)
        {
    ...
    public void AddActionCard()
    {
      ...
      this.ActionCardObj[this.ActionCardCounter] = new ActionCardClass();
    }

    public void RemoveActionCard(int nr, bool QuickMode = false)
    {
    ...
    public void ChangeActionCardNr(int Oldnr, int Newnr, bool QuickMode = false)
    {
      int index1;
      if (!QuickMode)
      {
          ...
          if (this.HistoricalUnitObj[index1].DeckCard[deckCardCounter] == Oldnr)
          {
            if (Newnr == -1)
            {
              ...
              if (num1 < this.HistoricalUnitObj[index5].DeckCardCounter)
              {
                ...
                for (int index6 = num2; index6 <= num3; ++index6)
                {
    ...
    protected DataClass(SerializationInfo info, StreamingContext context)
    {
      ...
      if (!DrawMod.TGame.SuperAdminRights)
      {
        ...
        {
          int num2 = (int) Interaction.MsgBox((object) "This file could not be loaded. We have to Quit the application due to this. ", Title: ((object) "Shadow Empire : Planetary Conquest"));
          ProjectData.EndApp();
        }
        if (num1 == 2 && this.Product == 1 | this.Product == 0)
        {
          if (this.Version >= 185)
          {
            int num3 = (int) Interaction.MsgBox((object) "This file could not be loaded. We have to Quit the application due to this. ", Title: ((object) "Shadow Empire : Planetary Conquest"));
            ProjectData.EndApp();
          }
          else
            this.Product = 2;
        ...
        {
          int num4 = (int) Interaction.MsgBox((object) "This file might have the propper file extension but is not a real DC3 file. This file could not be loaded. We have to Quit the application due to this. ", Title: ((object) "Shadow Empire : Planetary Conquest"));
          ProjectData.EndApp();
        }
        if (num1 == 5 && this.Product != 5)
        {
          int num5 = (int) Interaction.MsgBox((object) "This file have the propper file extension but is not a real DCX file. This file could not be loaded. We have to Quit the application due to this.", Title: ((object) "Shadow Empire : Planetary Conquest"));
          ProjectData.EndApp();
        }
        if (num1 == 6 && this.Product != 6)
        {
          int num6 = (int) Interaction.MsgBox((object) "This file have the propper file extension but is not a real DC4 file. This file could not be loaded. We have to Quit the application due to this.", Title: ((object) "Shadow Empire : Planetary Conquest"));
          ProjectData.EndApp();
        }
        if (num1 == 7 && this.Product != 7)
        {
          int num7 = (int) Interaction.MsgBox((object) "This file have the propper file extension but is not a real SE1 file. This file could not be loaded. We have to Quit the application due to this.", Title: ((object) "Shadow Empire : Planetary Conquest"));
          ProjectData.EndApp();
        }
      }
      if (this.Version > 424)
      {
        int num8 = (int) Interaction.MsgBox((object) ("You are loading a scenario or saved game made with version " + Conversion.Str((object) (this.Version - 314)) + ". Your version is " + Conversion.Str((object) 110) + ". This could cause errors. You are advised to upgrade to the latest version of this Shadow Empire : Planetary Conquest."), Title: ((object) "You should upgrade to the latest version!"));
      }
      if (this.Version < 424)
      {
        int num9 = (int) Interaction.MsgBox((object) ("You are loading a scenario or saved game made with a previous version " + Conversion.Str((object) (this.Version - 314)) + ". This is probably incompatible with the current game version " + Conversion.Str((object) 110) + "."));
      }
      ...
      catch (Exception ex)
      {
        ...
        for (int index = 0; index <= eventPicCounter; ++index)
          this.eventPicLibId[index] = new LibIdClass();
        ProjectData.ClearProjectError();
      }
      try
      {
    ...
    public static DataClass deserialize(string fileloc)
    {
      FileStream serializationStream = new FileStream(fileloc, FileMode.Open, FileAccess.Read, FileShare.None);
      BinaryFormatter binaryFormatter = new BinaryFormatter();
      GC.Collect();
      Application.DoEvents();
      DataClass dataClass1 = (DataClass) binaryFormatter.Deserialize((Stream) serializationStream);
      ...
      for (int index = 0; index <= locCounter1; ++index)
      {
        ...
        {
          DataClass dataClass2 = dataClass1;
      ...
      for (int index = 0; index <= reinfCounter1; ++index)
      {
      ...
      if (dataClass1.ReinfCounter == -1)
      {
        ...
        for (int index3 = 0; index3 <= sfTypeCounter4; ++index3)
        {
          if (dataClass1.SFTypeObj[index3].ReinforcementType > -1)
          {
            string str = dataClass1.TempString[750 + dataClass1.SFTypeObj[index3].ReinforcementType];
            bool flag = false;
            int reinfCounter2 = dataClass1.ReinfCounter;
            for (int index4 = 0; index4 <= reinfCounter2; ++index4)
            {
          ...
          {
            string str = dataClass1.TempString[750 + dataClass1.SFTypeObj[index3].ReinforcementType2];
            bool flag = false;
            int reinfCounter3 = dataClass1.ReinfCounter;
            for (int index5 = 0; index5 <= reinfCounter3; ++index5)
            {
          ...
          {
            string str = dataClass1.TempString[750 + dataClass1.SFTypeObj[index3].ReinforcementType3];
            bool flag = false;
            int reinfCounter4 = dataClass1.ReinfCounter;
            for (int index6 = 0; index6 <= reinfCounter4; ++index6)
            {
    ...
    public void LoadGraphics(Form1 tformref)
    {
      ...
      if (this.LandscapeTypeCounter > -1)
      {
        ...
        for (int Number = 0; Number <= landscapeTypeCounter; ++Number)
        {
          this.LandscapeTypeObj[Number].LoadSprites();
          string str = Strings.Trim(Conversion.Str((object) Number)) + " of " + Strings.Trim(Conversion.Str((object) this.LandscapeTypeCounter));
          if (!Information.IsNothing((object) tformref))
      ...
      {
        int sfTypeCounter = this.SFTypeCounter;
        for (int Number = 0; Number <= sfTypeCounter; ++Number)
        {
          string str = Strings.Trim(Conversion.Str((object) Number)) + " of " + Strings.Trim(Conversion.Str((object) this.SFTypeCounter));
          if (!Information.IsNothing((object) tformref))
    ...
    public void RemoveEventPic(int nr)
    {
    ...
    public int FindEventPic(string teventpicName, int eventPicOrigSlot, string libname)
    {
      int eventPicCounter = this.EventPicCounter;
      for (int eventPic = 0; eventPic <= eventPicCounter; ++eventPic)
      {
    ...
    public int FindEventPic(int eventPicOrigSlot, string libname)
    {
      int eventPicCounter = this.EventPicCounter;
      for (int eventPic = 0; eventPic <= eventPicCounter; ++eventPic)
      {
    ...
    public void AddEventPic(string filename)
    {
      ++this.EventPicCounter;
      this.EventPicName = (string[]) Utils.CopyArray((Array) this.EventPicName, (Array) new string[this.EventPicCounter + 1]);
      this.EventPicNr = (int[]) Utils.CopyArray((Array) this.EventPicNr, (Array) new int[this.EventPicCounter + 1]);
      ...
      this.eventPicLibId[this.EventPicCounter] = new LibIdClass();
      this.EventPicNr[this.EventPicCounter] = BitmapStore.AddFile(filename, false);
    }

    public void EventChangeEventNr(int oldnr, int newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
      ...
      int actionCardCounter = this.ActionCardCounter;
      for (index1 = 0; index1 <= actionCardCounter; ++index1)
      {
    ...
    public void RemoveSmallPic(int nr)
    {
    ...
    public void RemoveReinf(int nr)
    {
      ...
      else
      {
        this.ReinfName[nr] = "";
        this.ReinfId[nr] = -1;
        this.ReinfLibId[nr] = new LibIdClass();
        --this.ReinfCounter;
        this.ReinfRatio[nr] = 1;
      }
    }

    public int FindSmallPic(string tsmallpicName, int smallId, string libname)
    {
      int smallPicCounter = this.SmallPicCounter;
      for (int smallPic = 0; smallPic <= smallPicCounter; ++smallPic)
      {
    ...
    public int FindSmallPic(int smallId, string libname)
    {
      int smallPicCounter = this.SmallPicCounter;
      for (int smallPic = 0; smallPic <= smallPicCounter; ++smallPic)
      {
    ...
    public int FindReinf(string treinfName, int reinfId, string libname)
    {
      int reinfCounter = this.ReinfCounter;
      for (int reinf = 0; reinf <= reinfCounter; ++reinf)
      {
    ...
    public void AddSmallPic(string filename)
    {
      int num;
      ++num;
      ++this.SmallPicCounter;
      ...
      this.SmallPicNr = (int[]) Utils.CopyArray((Array) this.SmallPicNr, (Array) new int[this.SmallPicCounter + 1]);
      this.SmallLibId = (LibIdClass[]) Utils.CopyArray((Array) this.SmallLibId, (Array) new LibIdClass[this.SmallPicCounter + 1]);
      this.SmallLibId[this.SmallPicCounter] = new LibIdClass();
    ...
    public void AddReinf(string name)
    {
      int num;
      ++num;
      ++this.ReinfCounter;
      ...
      this.ReinfLibId = (LibIdClass[]) Utils.CopyArray((Array) this.ReinfLibId, (Array) new LibIdClass[this.ReinfCounter + 1]);
      this.ReinfRatio = (int[]) Utils.CopyArray((Array) this.ReinfRatio, (Array) new int[this.ReinfCounter + 1]);
      this.ReinfLibId[this.ReinfCounter] = new LibIdClass();
      ++this.reinfIdCounter;
    ...
    public void SmallChangeEventNr(int oldnr, int newnr)
    {
      int stringListCounter = this.StringListCounter;
      int index1;
      for (int index2 = 0; index2 <= stringListCounter; ++index2)
      ...
      for (index1 = 0; index1 <= historicalUnitCounter; ++index1)
      {
        ...
        for (int index6 = 0; index6 <= hisVarCount; ++index6)
        {
    ...
    public void ReinfChangeEventNr(int oldnr, int newnr)
    {
      int sfTypeCounter = this.SFTypeCounter;
      for (int index = 0; index <= sfTypeCounter; ++index)
      {
