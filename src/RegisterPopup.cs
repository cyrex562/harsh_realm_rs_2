...
{
  public class RegisterPopup : WindowClass
  {
    private int okid;
    ...
    public RegisterPopup(ref GameClass tGame)
    ...
    public void View()
    {
      ...
      DrawMod.DrawTextColouredMarc(ref graphics, "REGISTER WITH PBEM++ SERVER", this.game.MarcFont1, 98, 27, Color.White);
      ...
      DrawMod.DrawTextColouredMarc(ref graphics, "Email:", this.game.MarcFont4, 80, 315, Color.White);
      SubPartClass tsubpart4 = (SubPartClass) new InputTextClass("", this.game.MarcFont4, 440, 36, false, 40, true);
      this.emailid = this.AddSubPart(ref tsubpart4, 80, 340, 440, 36, 0);
      ...
      SubPartClass tsubpart5 = (SubPartClass) new TextButtonPartClass("Already Registered user", 200, "Click to go directly to PBEM++ screen for login with an existing account.", ref this.OwnBitmap, 80, 410, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
      this.cancelid = this.AddSubPart(ref tsubpart5, 80, 410, 200, 36, 1);
      SubPartClass tsubpart6 = (SubPartClass) new TextButtonPartClass("Register User", 200, "Register with the PBEM++ server if you do not have an existing user account yet.", ref this.OwnBitmap, 320, 410, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
      this.okid = this.AddSubPart(ref tsubpart6, 320, 410, 200, 36, 1);
    }
