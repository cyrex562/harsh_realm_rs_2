...
namespace WindowsApplication1
{
  pub class GameClass
  {
    ...
    pub Color seColWhite;
    pub Color seColYellow;
    pub Color seColRed;
    pub Color seColGreen;
    pub Color seColGray;
    pub Color seColDelegated;
    pub Color seColBrown;
    pub Color seColBlue;
    pub Color seColTW;
    pub BUTTONSMALL: i32;
    ...
    pub DataClass Data;
    pub CustomBitmapClass CustomBitmapObj;
    pub HandyFunctionsclass HandyFunctionsObj;
    pub CombatClass TempCombat;
    pub ProcessingClass ProcessingObj;
    pub AIClass AIObj;
    pub NewAIClass NewAIObj;
    pub DC2AIClass DC2AIObj;
    pub EventRelatedClass EventRelatedObj;
    pub EditClass EditObj;
    ...
    pub string[] ModGfxReplaceS1;
    pub string[] ModGfxReplaceS2;
    pub CornerX: i32;
    pub CornerY: i32;
    pub SelectX: i32;
    pub SelectY: i32;
    pub Bitmap MapFrame1;
    pub Bitmap MapFrame2;
    pub Bitmap MapFrame3;
    pub Bitmap MapFrame4;
    pub Bitmap LeftFrame1;
    pub Bitmap LeftFrame2;
    pub Bitmap LeftFrame3;
    pub Bitmap LeftFrame4;
    pub Color GameCol1;
    pub Color GameCol2;
    pub Color GameCol3;
    pub Color GameCol4;
    ...
    pub Font MarcFont10;
    pub Font MarcFont11;
    pub Font MarcFont11b;
    pub Font MarcFont12;
    pub Font MarcFont13;
    pub Font MarcFont14;
    pub Font MarcFont14b;
    pub Font MarcFont15;
    pub Color MarcCol1;
    pub Color MarcCol2;
    pub Color MarcCol3;
    ...
    pub Color VicColor8;
    pub Color viccolor7;
    pub Color VicColor5Shade;
    pub Color VicColor1Shade;
    pub Color VicColor2Shade;
    pub Color VicColor3Shade;
    pub Color VicColor4Shade;
    pub Font introFont1;
    pub Font introFont2;
    pub Font introfont2b;
    pub Font introfont1b;
    pub Font introfont3;
    pub Font shadowFontConsole;
    pub Font shadowFontConsole2;
    pub Font shadowFontConsole3;
    pub Font shadowFontConsole4;
    pub Font seFont2;
    pub Font se1TypeWriterBig;
    pub Font se1TypeWriterBig2;
    pub Font se1TypeWriterBig3;
    pub Font se1TypeWriterMedium;
    pub Font se1TypeWriterSmall;
    pub PrivateFontCollection FontCol;
    ...
    pub AIRunning: bool;
    pub Thread se1Thread;
    pub se1ThreadRunning: bool;
    pub se1Running: bool;
    pub GameLoopClass2 se1GameLoop;
