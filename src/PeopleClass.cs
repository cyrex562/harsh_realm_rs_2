...
{
  [Serializable]
  public class PeopleClass : ISerializable
  {
    public string Name;
    public int PeopleGroup;
    public int[] BaseMorale;
    public float[] ProdMod;
    public float[] ProdMod2;
    public float[] ProdMod3;
    public float[] ProdMod4;
    public float[] BattleForMod;
    public float[] BattleVSMod;
    public int PolPts;
    public int RegCol;
    public int Red;
    public int Blue;
    ...
    public string SidewaysFileName2;
    public int SidewaysSpriteID2;
    public string SidewaysFileName3;
    public int SidewaysSpriteID3;
    public string SidewaysFileName4;
    public int SidewaysSpriteID4;
    public string NationalFileName;
    public int NationalSpriteID;
    public int SFIll;
    public int SFExtra;
    ...
    public PeopleClass(int hardcoded)
    {
      this.BaseMorale = new int[100];
      this.ProdMod = new float[100];
      this.ProdMod2 = new float[100];
    ...
    public void ReplaceSidewaysSprite3(string filename)
    {
    ...
    public void ReplaceSidewaysSprite4(string filename)
    {
