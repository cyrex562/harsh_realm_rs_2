...
{
  public class CombatResultWindowClass2 : WindowClass
  {
    private int okid;
    private int tbacknr;
    private int typeid;
    ...
    private bool crmSet;
    private int attPage;
    private int maxAttPage;
    private int defPage;
    private int maxDefPage;
    private int slotCulture;
    private int slotChar;
    private int slotCharSkill;
    private int slotSkillType;
    private int slotUnitFeats;
    private int[,] tabid;
    private int[] tabup;
    private int[] tabdown;
    private int zoom1id;
    ...
    private int roundId;
    private int playId;
    private int crmSetOnRound;
    private SimpleList animList;
    private Bitmap bufferBitmap;

    public CombatResultWindowClass2(ref GameClass tGame, int thn)
    ...
    public CombatResultWindowClass2(ref GameClass tGame, int tUseWidth, int tUseHeight)
    ...
    public string GetUnitDescription(int unr)
    {
    ...
    public Color GetUnitColor(int unr)
    {
      int uslot = this.game.TempCombat.FindUSlot(unr);
    ...
    public void dostuff(bool crmAlreadySet = false)
    {
      ...
      if (!this.crmSet | this.crmSetOnRound < this.game.TempCombat.CombatRound)
      {
        ...
        for (int index2 = 0; index2 <= ucounter1; ++index2)
        {
          int num13 = 3;
        ...
        for (int index8 = 0; index8 <= ucounter2; ++index8)
        {
          int index9 = 0;
          ...
          if (flagArray[index8])
          {
            ...
            for (int index10 = 0; index10 <= icounter1; ++index10)
            {
            ...
            for (int index11 = 0; index11 <= icounter2; ++index11)
            {
        ...
        int num21 = index5;
        for (int index12 = 0; index12 <= num21; ++index12)
        {
      ...
      int num31;
      for (int index30 = 0; index30 <= counter1; ++index30)
      {
        ...
        if (simpleList2.FindNr(tid, tdata3: tdata3) == -1 & tdata3 >= 1)
        {
          ...
          for (int index31 = 0; index31 <= counter2; ++index31)
          {
          ...
          for (int index32 = 0; index32 <= counter3; ++index32)
          {
      ...
      for (int index33 = 0; index33 <= counter4; ++index33)
      {
        ...
        if (simpleList2.FindNr(tid, tdata3: tdata3) == -1 & tdata3 > 0)
        {
          ...
          for (int index34 = 0; index34 <= counter5; ++index34)
          {
      ...
      for (int index36 = 0; index36 <= counter7; ++index36)
      {
        ...
        if (simpleList1.FindNr(tid) == -1)
        {
          ...
          for (int index37 = 0; index37 <= counter8; ++index37)
          {
      ...
      for (int index38 = 0; index38 <= counter9; ++index38)
      {
      ...
      Rectangle trect1;
      Rectangle trect2;
      for (int index39 = 0; index39 <= counter10; ++index39)
      {
        ...
        if (regimeById == this.game.TempCombat.AttackerRegime)
        {
          if (num49 <= 2)
          {
            ...
            string str = ((int) Math.Round((double) simpleList1.Data1[index39] + (double) simpleList1.Data2[index39] / 2.0)).ToString() + "%";
      ...
      for (int index41 = num48; index41 <= 2; ++index41)
      {
      ...
      for (int index42 = num49; index42 <= 2; ++index42)
      {
      ...
      do
      {
        ...
        do
        {
          ...
          if (num55 >= 3)
          {
            ...
            for (int index46 = 0; index46 <= repCounter; ++index46)
            {
          ...
          if (num55 == 2)
          {
            ...
            if (this.game.TempCombat.customCombatObj.otherBonus.FindNr(tid, tdata2: 4) > -1 | this.game.TempCombat.customCombatObj.otherBonus.FindNr(tid, tdata2: 5) > -1 && num57 == 0 & index43 == 0 & num62 == 0 & num64 == 0 & tid == 0)
              str = "?";
            string ttext = "Weapon Matrix Modifier for Attack Values : " + index44.ToString() + "%\r\n" + "Callibre Modifier to Attack Values : " + num68.ToString() + "%\r\n";
            if (tid == 1)
            {
        ...
        if (((this.game.TempCombat.BattleEnded <= 0 ? 1 : 0) | 1) != 0)
        {
          ...
          if (numArray1[index49] > 0)
          {
            ...
            if (numArray6[index49] > 0)
              str += " ?";
            string tstring = str + " Troops Operational";
      ...
      if (this.showdetail <= 0)
      {
        ...
        {
          int num93 = num3 - 1;
          for (int index50 = 0; index50 <= num93; ++index50)
          {
            int num94 = num4 - 1;
            for (int index51 = 0; index51 <= num94; ++index51)
            {
              int num95;
              int index52;
              if (num92 == 1)
              ...
              if (num95 == 1)
              {
                ...
                string name = this.game.Data.UnitObj[index52].Name;
                string ttext = "[ " + this.GetUnitDescription(index52) + " ]";
              ...
              if (num95 == 2)
              {
                if (this.useZoom == 1)
                {
                  string str3 = this.game.Data.UnitObj[index52].Name;
                  ...
                  string unitDescription = this.GetUnitDescription(index52);
                ...
                if (this.useZoom == 0)
                {
                  string lower = this.GetUnitDescription(index52).ToLower();
              ...
              if (num95 == 3)
              {
                ...
                if (!Information.IsNothing((object) this.game.TempCombat.IList[index43].IunitFeat))
                {
                  ...
                  for (int index53 = 0; index53 <= counter12; ++index53)
                  {
                    if (index53 <= 1)
                    {
                      ...
                      if (idValue > 0)
                      {
                        ...
                        if (this.game.TempCombat.IList[islot].IunitFeatDeadRound < 1 & (this.game.TempCombat.IList[islot].IKilled < 1 | islot == index43))
                        {
                          ...
                          string str5 = this.game.Data.StringListObj[this.slotUnitFeats].GetData(0, idValue, 2);
                ...
                if (this.useZoom == 1)
                {
                  ...
                  {
                    string str6 = this.game.TempCombat.IList[index43].ItotalKills.ToString();
                    string str7 = "/";
                    string str8 = this.game.TempCombat.IList[index43].ItotalHits.ToString();
                  ...
                  {
                    string str9 = this.game.TempCombat.IList[index43].ItotalKills.ToString();
                  ...
                  {
                    string str10 = this.game.TempCombat.IList[index43].ItotalHits.ToString();
                ...
                string ttitle = this.game.Data.SFTypeObj[this.game.TempCombat.IList[index43].ISFType].Ratio.ToString() + "x " + this.game.Data.SFTypeObj[this.game.TempCombat.IList[index43].ISFType].Name;
                string str11 = "";
                if (str2.Length > 0)
              ...
              if (num95 == 4)
              {
                ...
                string data = this.game.Data.StringListObj[this.slotUnitFeats].GetData(0, iunitFeatStart, 2);
                string ttext = this.game.Data.StringListObj[this.slotUnitFeats].GetData(0, iunitFeatStart, 12);
      ...
      string combatDescription = this.GetCombatDescription();
      ...
      string str26 = "Rec: " + num113.ToString();
      index45 = (int) Math.Round((double) this.game.Data.RuleVar[56]);
      string str27 = index45.ToString();
      string tstring3 = str26 + " / " + str27;
      DrawMod.DrawTextColouredConsoleCenter(ref graphics, tstring3, this.game.MarcFont4, x26 + 70, y24 + 11, Color.LightGray);
      string ttitle1 = "Recon on target Hex";
      index45 = (int) Math.Round((double) this.game.Data.RuleVar[56]);
      string ttext1 = "As long as you have less than " + index45.ToString() + " Recon Points on the Hex you are attacking you'll not be sure to spot all enemy sub formations.";
      ...
      if (this.showdetail < 1)
      {
        ...
        if (this.game.TempCombat.BattleEnded > 0)
        {
          string str29 = this.game.EditObj.CombatOneSentence;
      ...
      if (this.useZoom == 1)
      {
        SubPartClass tsubpart1 = (SubPartClass) new TextButtonPartClass("ZOOM IN", 90, "Click to use big icons.", ref this.OwnBitmap, 50, this.Hn - 51, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.zoom1id = this.AddSubPart(ref tsubpart1, 50, this.Hn - 51, 90, 36, 0);
        SubPartClass tsubpart2 = (SubPartClass) new TextButtonPartClass("ZOOM OUT", 90, "Click to use small icons.", ref this.OwnBitmap, 150, this.Hn - 51, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.zoom0id = this.AddSubPart(ref tsubpart2, 150, this.Hn - 51, 90, 36, 1);
      }
      else
      {
        SubPartClass tsubpart3 = (SubPartClass) new TextButtonPartClass("ZOOM IN", 90, "Click to use big icons.", ref this.OwnBitmap, 50, this.Hn - 51, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.zoom1id = this.AddSubPart(ref tsubpart3, 50, this.Hn - 51, 90, 36, 1);
        SubPartClass tsubpart4 = (SubPartClass) new TextButtonPartClass("ZOOM OUT", 90, "Click to use small icons.", ref this.OwnBitmap, 150, this.Hn - 51, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      tsubpart5 = (SubPartClass) new TextButtonPartClass("DETAIL", 90, "Click to get deepest detail level.\r\nOr press any key instead.", ref this.OwnBitmap, this.useWidth - 146, this.Hn - 51, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      this.detailid = this.AddSubPart(ref tsubpart5, this.useWidth - 146, this.Hn - 51, 90, 36, 1);
      if (this.showdetail <= 0)
      {
        tsubpart5 = (SubPartClass) new TextButtonPartClass("TEXTUAL", 90, "Click to switch to a numerical combat overview.", ref this.OwnBitmap, this.useWidth - 256, this.Hn - 51, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.typeid = this.AddSubPart(ref tsubpart5, this.useWidth - 256, this.Hn - 51, 90, 36, 1);
      }
      else
      {
        tsubpart5 = (SubPartClass) new TextButtonPartClass("GRAPHIC", 90, "Click to switch to a graphical combat overview.", ref this.OwnBitmap, this.useWidth - 256, this.Hn - 51, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.typeid = this.AddSubPart(ref tsubpart5, this.useWidth - 256, this.Hn - 51, 90, 36, 1);
      }
      int index56;
      if (this.maxAttPage > 3)
      {
        ...
        if (this.attPage > 0)
        {
          ...
          tsubpart5 = (SubPartClass) new TextButtonPartClass("< ", 50, "Click to go back a page.", ref this.OwnBitmap, num117, num118, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        ...
        {
          int[] tabdown = this.tabdown;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("< ", 50, "You are at the first page.", ref this.OwnBitmap, num117, num118, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
          int num120 = this.AddSubPart(ref tsubpart5, num117, num118, 50, 36, 0);
          tabdown[1] = num120;
        }
        int num121 = num117 + 50;
        index56 = this.attPage + 1;
        string str31 = index56.ToString();
        index45 = this.maxAttPage + 1;
        string str32 = index45.ToString();
        string tstring5 = "Page " + str31 + " of " + str32;
        ...
        if (this.attPage < this.maxAttPage)
        {
          ...
          tsubpart5 = (SubPartClass) new TextButtonPartClass("> ", 50, "Click to go forward a page.", ref this.OwnBitmap, num122, num118, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        ...
        {
          int[] tabup = this.tabup;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("> ", 50, "You are at the last page.", ref this.OwnBitmap, num122, num118, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      else if (this.maxAttPage > 0)
      {
        ...
        for (int index57 = 0; index57 <= maxAttPage; ++index57)
        {
          if (index57 < 9)
          {
            if (index57 != this.attPage)
            {
              ...
              int index58 = index57;
              index56 = index57 + 1;
              tsubpart5 = (SubPartClass) new TextButtonPartClass("Pg " + index56.ToString(), 50, "Click to see this page.", ref this.OwnBitmap, num125, num126, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
            ...
            else
            {
              ...
              int index59 = index57;
              index56 = index57 + 1;
              tsubpart5 = (SubPartClass) new TextButtonPartClass("Pg " + index56.ToString(), 50, "This page is currently selected.", ref this.OwnBitmap, num125, num126, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      if (this.maxDefPage > 3)
      {
        ...
        {
          int[] tabdown = this.tabdown;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("< ", 50, "Click to go back a page.", ref this.OwnBitmap, num129, num130, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        ...
        {
          int[] tabdown = this.tabdown;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("< ", 50, "You are at the first page.", ref this.OwnBitmap, num129, num130, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
          int num132 = this.AddSubPart(ref tsubpart5, num129, num130, 50, 36, 0);
          tabdown[0] = num132;
        }
        int num133 = num129 + 50;
        index45 = this.defPage + 1;
        string str33 = index45.ToString();
        index56 = this.maxDefPage + 1;
        string str34 = index56.ToString();
        string tstring6 = "Page " + str33 + " of " + str34;
        ...
        {
          int[] tabup = this.tabup;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("> ", 50, "Click to go forward a page.", ref this.OwnBitmap, num134, num130, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        ...
        {
          int[] tabup = this.tabup;
          tsubpart5 = (SubPartClass) new TextButtonPartClass("> ", 50, "You are at the last page.", ref this.OwnBitmap, num134, num130, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      else if (this.maxDefPage > 0)
      {
        ...
        for (int index60 = 0; index60 <= maxDefPage; ++index60)
        {
          if (index60 < 9)
          {
            if (index60 != this.defPage)
            {
              ...
              int index61 = index60;
              index56 = index60 + 1;
              tsubpart5 = (SubPartClass) new TextButtonPartClass("Pg " + index56.ToString(), 50, "Click to see this page.", ref this.OwnBitmap, num137, num138, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
            ...
            else
            {
              ...
              int index62 = index60;
              index56 = index60 + 1;
              tsubpart5 = (SubPartClass) new TextButtonPartClass("Pg " + index56.ToString(), 50, "This page is currently selected.", ref this.OwnBitmap, num137, num138, true, theight: 36, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      int index64 = -1;
      int ucounter = this.game.TempCombat.UCounter;
      for (int index65 = 0; index65 <= ucounter; ++index65)
      {
        if (this.game.TempCombat.UList[index65].Uattacker == 1)
        {
          ...
          for (int index67 = 0; index67 <= num141; ++index67)
          {
        ...
        else
        {
          ...
          for (int index69 = 0; index69 <= num142; ++index69)
          {
      ...
      for (int index70 = 0; index70 <= icounter3; ++index70)
      {
        ...
        if (iattacker == 1)
          index43 = index63;
        int num144 = index43;
        for (int index71 = 0; index71 <= num144; ++index71)
        {
      ...
      for (int index79 = 0; index79 <= icounter4; ++index79)
      {
      ...
      if (this.showdetail == 1)
      {
        string str35 = "ATTACKER TOTALS\r\n";
        string Expression1 = "SUBFORMATIONTYPE";
        int Number1 = 35 - Strings.Len(Expression1);
        if (0 > Number1)
          Number1 = 0;
        string str36 = str35 + Expression1 + Strings.Space(Number1);
        string Expression2 = "INITIAL";
        int Number2 = 10 - Strings.Len(Expression2);
        if (0 > Number2)
          Number2 = 0;
        string str37 = str36 + Expression2 + Strings.Space(Number2);
        string Expression3 = "@FRONT";
        int Number3 = 9 - Strings.Len(Expression3);
        if (0 > Number3)
          Number3 = 0;
        string str38 = str37 + Expression3 + Strings.Space(Number3);
        string Expression4 = "DEAD";
        int Number4 = 7 - Strings.Len(Expression4);
        if (0 > Number4)
          Number4 = 0;
        string str39 = str38 + Expression4 + Strings.Space(Number4);
        string Expression5 = "RETREAT";
        int Number5 = 9 - Strings.Len(Expression5);
        if (0 > Number5)
          Number5 = 0;
        string str40 = str39 + Expression5 + Strings.Space(Number5);
        string Expression6 = "ALIVE";
        int Number6 = 6 - Strings.Len(Expression6);
        if (0 > Number6)
          Number6 = 0;
        string str41 = str40 + Expression6 + Strings.Space(Number6) + "\r\n";
        int sfTypeCounter1 = this.game.Data.SFTypeCounter;
        for (int index120 = 0; index120 <= sfTypeCounter1; ++index120)
        {
          int num164 = 1;
          ...
          {
            string Expression7 = this.game.Data.SFTypeObj[index120].Name;
            if (Strings.Len(Expression7) > 29)
              Expression7 = Strings.Left(str41, 29);
            int Number7 = 35 - Strings.Len(Expression7);
            if (0 > Number7)
              Number7 = 0;
            string str42 = str41 + Expression7 + Strings.Space(Number7);
            string Expression8 = Strings.Trim(Conversion.Str((object) (num164 * (numArray22[index120, 1] + numArray20[index120, 1] + numArray21[index120, 1]))));
            int Number8 = 10 - Strings.Len(Expression8);
            if (0 > Number8)
              Number8 = 0;
            string str43 = str42 + Expression8 + Strings.Space(Number8);
            string Expression9 = Strings.Trim(Conversion.Str((object) (num164 * numArray22[index120, 1])));
            int Number9 = 9 - Strings.Len(Expression9);
            if (0 > Number9)
              Number9 = 0;
            string str44 = str43 + Expression9 + Strings.Space(Number9);
            string Expression10 = Strings.Trim(Conversion.Str((object) (num164 * numArray20[index120, 1])));
            int Number10 = 7 - Strings.Len(Expression10);
            if (0 > Number10)
              Number10 = 0;
            string str45 = str44 + Expression10 + Strings.Space(Number10);
            string Expression11 = Strings.Trim(Conversion.Str((object) (num164 * numArray21[index120, 1])));
            int Number11 = 9 - Strings.Len(Expression11);
            if (0 > Number11)
              Number11 = 0;
            string str46 = str45 + Expression11 + Strings.Space(Number11);
            string Expression12 = Strings.Trim(Conversion.Str((object) (num164 * (numArray21[index120, 1] + numArray22[index120, 1]))));
        ...
        {
          string str47 = str41 + "\r\n" + "DEFENDERS TOTALS\r\n";
          string Expression13 = "SUBFORMATIONTYPE";
          int Number13 = 35 - Strings.Len(Expression13);
          if (0 > Number13)
            Number13 = 0;
          string str48 = str47 + Expression13 + Strings.Space(Number13);
          string Expression14 = "INITIAL";
          int Number14 = 10 - Strings.Len(Expression14);
          if (0 > Number14)
            Number14 = 0;
          string str49 = str48 + Expression14 + Strings.Space(Number14);
          string Expression15 = "@FRONT";
          int Number15 = 9 - Strings.Len(Expression15);
          if (0 > Number15)
            Number15 = 0;
          string str50 = str49 + Expression15 + Strings.Space(Number15);
          string Expression16 = "DEAD";
          int Number16 = 7 - Strings.Len(Expression16);
          if (0 > Number16)
            Number16 = 0;
          string str51 = str50 + Expression16 + Strings.Space(Number16);
          string Expression17 = "RETREAT";
          int Number17 = 9 - Strings.Len(Expression17);
          if (0 > Number17)
            Number17 = 0;
          string str52 = str51 + Expression17 + Strings.Space(Number17);
          string Expression18 = "ALIVE";
        ...
        for (int index121 = 0; index121 <= sfTypeCounter2; ++index121)
        {
          int num165 = 1;
          ...
          {
            string Expression19 = this.game.Data.SFTypeObj[index121].Name;
            if (Strings.Len(Expression19) > 29)
              Expression19 = Strings.Left(str41, 29);
            int Number19 = 35 - Strings.Len(Expression19);
            if (0 > Number19)
              Number19 = 0;
            string str53 = str41 + Expression19 + Strings.Space(Number19);
            string Expression20 = Strings.Trim(Conversion.Str((object) (num165 * (numArray22[index121, 0] + numArray20[index121, 0] + numArray21[index121, 0]))));
            int Number20 = 10 - Strings.Len(Expression20);
            if (0 > Number20)
              Number20 = 0;
            string str54 = str53 + Expression20 + Strings.Space(Number20);
            string Expression21 = Strings.Trim(Conversion.Str((object) (num165 * numArray22[index121, 0])));
            int Number21 = 9 - Strings.Len(Expression21);
            if (0 > Number21)
              Number21 = 0;
            string str55 = str54 + Expression21 + Strings.Space(Number21);
            string Expression22 = Strings.Trim(Conversion.Str((object) (num165 * numArray20[index121, 0])));
            int Number22 = 7 - Strings.Len(Expression22);
            if (0 > Number22)
              Number22 = 0;
            string str56 = str55 + Expression22 + Strings.Space(Number22);
            string Expression23 = Strings.Trim(Conversion.Str((object) (num165 * numArray21[index121, 0])));
            int Number23 = 9 - Strings.Len(Expression23);
            if (0 > Number23)
              Number23 = 0;
            string str57 = str56 + Expression23 + Strings.Space(Number23);
            string Expression24 = Strings.Trim(Conversion.Str((object) (num165 * (numArray21[index121, 0] + numArray22[index121, 0]))));
        ...
        string str58 = str41 + "\r\n";
        string Expression25 = "ATTACKER";
        int Number25 = 10 - Strings.Len(Expression25);
        if (0 > Number25)
          Number25 = 0;
        string str59 = str58 + Strings.Space(20) + Expression25 + Strings.Space(Number25);
        string Expression26 = "DEFENDER";
        int num166 = 10 - Strings.Len(Expression26);
        if (0 > num166)
          num166 = 0;
        string str60 = str59 + Strings.Space(20) + Expression26 + Strings.Space(num166 + 50) + "\r\n";
        string Expression27 = "STAT";
        int Number26 = 20 - Strings.Len(Expression27);
        if (0 > Number26)
          Number26 = 0;
        string str61 = str60 + Expression27 + Strings.Space(Number26);
        string Expression28 = "INITIAL";
        int Number27 = 10 - Strings.Len(Expression28);
        if (0 > Number27)
          Number27 = 0;
        string str62 = str61 + Expression28 + Strings.Space(Number27);
        string Expression29 = "CURRENT";
        int Number28 = 20 - Strings.Len(Expression29);
        if (0 > Number28)
          Number28 = 0;
        string str63 = str62 + Expression29 + Strings.Space(Number28);
        string Expression30 = "INITIAL";
        int Number29 = 10 - Strings.Len(Expression30);
        if (0 > Number29)
          Number29 = 0;
        string str64 = str63 + Expression30 + Strings.Space(Number29);
        string Expression31 = "CURRENT";
        int Number30 = 10 - Strings.Len(Expression31);
        if (0 > Number30)
          Number30 = 0;
        string str65 = str64 + Expression31 + Strings.Space(Number30) + "\r\n";
        string Expression32 = "Readiness";
        if (Strings.Len(Expression32) > 29)
          Expression32 = Strings.Left(str65, 29);
        int Number31 = 20 - Strings.Len(Expression32);
        if (0 > Number31)
          Number31 = 0;
        string str66 = str65 + Expression32 + Strings.Space(Number31);
        string Expression33 = Strings.Trim(Conversion.Str((object) this.StartRdn[1]));
        int Number32 = 10 - Strings.Len(Expression33);
        if (0 > Number32)
          Number32 = 0;
        string str67 = str66 + Expression33 + Strings.Space(Number32);
        string Expression34 = Strings.Trim(Conversion.Str((object) numArray23[1]));
        int Number33 = 20 - Strings.Len(Expression34);
        if (0 > Number33)
          Number33 = 0;
        string str68 = str67 + Expression34 + Strings.Space(Number33);
        string str69 = Strings.Trim(Conversion.Str((object) this.StartRdn[0]));
        if (numArray31[0] < 1)
          str69 = "?";
        ...
        if (0 > Number34)
          Number34 = 0;
        string str70 = str68 + str69 + Strings.Space(Number34);
        string str71 = Strings.Trim(Conversion.Str((object) numArray23[0]));
        if (numArray31[0] < 1)
          str71 = "?";
        ...
        if (0 > Number35)
          Number35 = 0;
        string str72 = str70 + str71 + Strings.Space(Number35) + "\r\n";
        string Expression35 = "Experience";
        if (Strings.Len(Expression35) > 29)
          Expression35 = Strings.Left(str72, 29);
        int Number36 = 20 - Strings.Len(Expression35);
        if (0 > Number36)
          Number36 = 0;
        string str73 = str72 + Expression35 + Strings.Space(Number36);
        string Expression36 = Strings.Trim(Conversion.Str((object) this.StartXp[1]));
        int Number37 = 10 - Strings.Len(Expression36);
        if (0 > Number37)
          Number37 = 0;
        string str74 = str73 + Expression36 + Strings.Space(Number37);
        string Expression37 = Strings.Trim(Conversion.Str((object) numArray24[1]));
        int Number38 = 20 - Strings.Len(Expression37);
        if (0 > Number38)
          Number38 = 0;
        string str75 = str74 + Expression37 + Strings.Space(Number38);
        string str76 = Strings.Trim(Conversion.Str((object) this.StartXp[0]));
        if (numArray31[0] < 1)
          str76 = "?";
        ...
        if (0 > Number39)
          Number39 = 0;
        string str77 = str75 + str76 + Strings.Space(Number39);
        string str78 = Strings.Trim(Conversion.Str((object) numArray24[0]));
        if (numArray31[0] < 1)
          str78 = "?";
        ...
        if (0 > Number40)
          Number40 = 0;
        string str79 = str77 + str78 + Strings.Space(Number40) + "\r\n";
        string Expression38 = "Morale";
        if (Strings.Len(Expression38) > 29)
          Expression38 = Strings.Left(str79, 29);
        int Number41 = 20 - Strings.Len(Expression38);
        if (0 > Number41)
          Number41 = 0;
        string str80 = str79 + Expression38 + Strings.Space(Number41);
        string Expression39 = Strings.Trim(Conversion.Str((object) this.StartMor[1]));
        int Number42 = 10 - Strings.Len(Expression39);
        if (0 > Number42)
          Number42 = 0;
        string str81 = str80 + Expression39 + Strings.Space(Number42);
        string Expression40 = Strings.Trim(Conversion.Str((object) numArray25[1]));
        int Number43 = 20 - Strings.Len(Expression40);
        if (0 > Number43)
          Number43 = 0;
        string str82 = str81 + Expression40 + Strings.Space(Number43);
        string str83 = Strings.Trim(Conversion.Str((object) this.StartMor[0]));
        if (numArray31[0] < 1)
          str83 = "?";
        ...
        if (0 > Number44)
          Number44 = 0;
        string str84 = str82 + str83 + Strings.Space(Number44);
        string str85 = Strings.Trim(Conversion.Str((object) numArray25[0]));
        if (numArray31[0] < 1)
          str85 = "?";
        ...
        if (0 > Number45)
          Number45 = 0;
        string str86 = str84 + str85 + Strings.Space(Number45) + "\r\n";
        string Expression41 = "Entrenchment";
        if (Strings.Len(Expression41) > 29)
          Expression41 = Strings.Left(str86, 29);
        int Number46 = 20 - Strings.Len(Expression41);
        if (0 > Number46)
          Number46 = 0;
        string str87 = str86 + Expression41 + Strings.Space(Number46);
        string Expression42 = Strings.Trim(Conversion.Str((object) this.StartEntr[1]));
        int Number47 = 10 - Strings.Len(Expression42);
        if (0 > Number47)
          Number47 = 0;
        string str88 = str87 + Expression42 + Strings.Space(Number47);
        string Expression43 = Strings.Trim(Conversion.Str((object) numArray26[1]));
        int Number48 = 20 - Strings.Len(Expression43);
        if (0 > Number48)
          Number48 = 0;
        string str89 = str88 + Expression43 + Strings.Space(Number48);
        string str90 = Strings.Trim(Conversion.Str((object) this.StartEntr[0]));
        if (numArray31[0] < 1)
          str90 = "?";
        ...
        if (0 > Number49)
          Number49 = 0;
        string str91 = str89 + str90 + Strings.Space(Number49);
        string str92 = Strings.Trim(Conversion.Str((object) numArray26[0]));
        if (numArray31[0] < 1)
          str92 = "?";
        ...
        if (0 > Number50)
          Number50 = 0;
        string str93 = str91 + str92 + Strings.Space(Number50) + "\r\n" + "\r\n";
        if (this.game.TempCombat.BattleEnded > 0)
        {
          string str94 = this.game.EditObj.CombatOneSentence;
        ...
        tsubpart5 = (SubPartClass) new UDSPartClass(this.game, num170, num171, tTexty, ref this.OwnBitmap, num168, num169, tAllGray: true);
      ...
      int y)
    {
      if (this.game.EditObj.CombatNumbers)
      {
        ...
        if (qty1 > 0)
        {
          string text = Strings.Trim(Conversion.Str((object) qty1));
        ...
        if (qty2 > 0)
        {
          string text = Strings.Trim(Conversion.Str((object) qty2));
        ...
        if (qty1 > 0)
        {
          string str = Strings.Trim(Conversion.Str((object) qty1));
        ...
        if (qty2 <= 0)
          return;
        string str1 = Strings.Trim(Conversion.Str((object) qty2));
    ...
    public override WindowReturnClass HandleMouseClick(int x, int y, int b)
    {
      ...
      if (this.SubPartCounter > -1)
      {
        ...
        for (int index1 = 0; index1 <= subPartCounter1; ++index1)
        {
          ...
          {
            int maxAttPage = this.maxAttPage;
            for (int index2 = 0; index2 <= maxAttPage; ++index2)
            {
            ...
            int maxDefPage = this.maxDefPage;
            for (int index3 = 0; index3 <= maxDefPage; ++index3)
            {
        ...
        for (int index = 0; index <= subPartCounter2; ++index)
        {
          if (x > this.SubPartX[index] & x < this.SubPartX[index] + this.SubPartW[index] && y > this.SubPartY[index] & y < this.SubPartY[index] + this.SubPartH[index])
          {
            ...
            if (num == this.okid)
            {
              WindowReturnClass Expression = this.EndTheBattle();
              this.game.EditObj.TempCoordList.DeActivate();
              this.game.EditObj.CombatOneSentence = "";
              this.game.EditObj.OrderType = 0;
              this.game.EditObj.TargetX = -1;
    ...
    public WindowReturnClass EndTheBattle()
    {
      ...
      WindowReturnClass windowReturnClass1;
      return windowReturnClass1;
    }
