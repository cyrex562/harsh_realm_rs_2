...
{
  public class BattlegroupWindowClass : WindowClass
  {
    private int okid;
    ...
    private int sourceUnr;
    private int targetUnr;
    private SimpleList TL;
    private int Pic1Id;
    private int[] SlidersId;
    private int[] SlidersSfnr;
    private int SourceNextId;
    private int SourcePrevId;
    private int TargetNextId;
    private int TargetPrevId;
    private int SourcePage;
    private int TargetPage;
    private int SourcePageMax;
    private int TargetPageMax;

    public BattlegroupWindowClass(ref GameClass tGame)
      : base(ref tGame, 1000, 760, 8)
    {
      this.SlidersId = new int[20];
      this.SlidersSfnr = new int[20];
      this.TL = new SimpleList();
    ...
    public void View()
    {
      ...
      for (int index3 = 0; index3 <= counter1; ++index3)
      {
        ...
        string str = this.game.Data.UnitObj[index4].Name;
        if (str.Length > 25)
        ...
        string tstring3 = hq <= -1 ? "no HQ" : "HQ: " + this.game.Data.UnitObj[hq].Name;
      ...
      if (this.game.HandyFunctionsObj.GetBattlegroupTemplate(this.game.Data.Turn) > -1)
      {
        if (-2 == this.targetUnr)
        {
          ...
          DrawMod.DrawBlock(ref toG, num7, num8, num9, num10, 0, 0, 0, 128);
        string tstring6 = "New Battlegroup";
        ...
        string tstring7 = "Newly created Battlegroup";
      ...
      for (int index6 = 0; index6 <= counter2; ++index6)
      {
        ...
        string str = this.game.Data.UnitObj[index7].Name;
        if (str.Length > 25)
          str = Strings.Left(str, 25) + ".";
        ...
        string tstring8 = hq <= -1 ? "no HQ" : "HQ: " + this.game.Data.UnitObj[hq].Name;
      ...
      if (this.targetUnr > -1)
      {
        ...
        for (int index15 = 0; index15 <= sfCount; ++index15)
        {
          ...
          if (index15 >= (this.TargetPage - 1) * num11 & index15 <= (this.TargetPage - 1) * num11 + (num11 - 1))
          {
            ...
            string tstring9 = (num19 + num20).ToString() + "x " + this.game.Data.SFTypeObj[type3].Name + "(" + Strings.Left(this.game.Data.PeopleObj[people5].Name, 3) + ")";
            DrawMod.DrawTextColouredMarc(ref toG, tstring9, this.game.MarcFont4, x1_2 + 65, y1_2 + 2, Color.White);
            if (this.targetUnr == -3)
            {
              string tstring10 = this.game.Data.SFTypeObj[type3].scrapable.ToString() + "%";
              DrawMod.DrawTextColouredMarc(ref toG, tstring10, this.game.MarcFont4, x1_2 + maxValue - 40, y1_2 + 15, Color.White);
            }
            else if (num20 > 0)
            {
              string tstring11 = "+" + num20.ToString();
            ...
            if (reinforcementType > -1 & index8 > -1 & this.targetUnr > -1)
            {
              ...
              {
                string tstring12 = "Reinf. max: " + num21.ToString() + "/" + num22.ToString();
                if (num21 > num22)
        ...
        for (int index17 = 0; index17 <= counter6; ++index17)
        {
          ...
          if (index17 + num24 + 1 >= (this.TargetPage - 1) * num11 & index17 + num24 + 1 <= (this.TargetPage - 1) * num11 + (num11 - 1))
          {
            ...
            else if (reinforcementType > -1 & index8 > -1 & this.targetUnr > -1)
            {
              ...
              {
                string tstring19 = "Reinf. max: " + num29.ToString() + "/" + num30.ToString();
                if (num29 > num30)
      ...
      if (this.TargetPage > 1)
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" < ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_2 + 10), bby: (y1_3 + 4), usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.TargetPrevId = this.AddSubPart(ref tsubpart, x1_2 + 10, y1_3 + 4, 50, 35, 1);
      }
      else
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" < ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_2 + 10), bby: (y1_3 + 4), tinactive: true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.TargetPrevId = this.AddSubPart(ref tsubpart, x1_2 + 10, y1_3 + 4, 50, 35, 0);
      }
      if (this.TargetPage < this.TargetPageMax)
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" > ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_2 + 200), bby: (y1_3 + 4), usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.TargetNextId = this.AddSubPart(ref tsubpart, x1_2 + 200, y1_3 + 4, 50, 35, 1);
      }
      else
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" > ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_2 + 200), bby: (y1_3 + 4), tinactive: true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.TargetNextId = this.AddSubPart(ref tsubpart, x1_2 + 200, y1_3 + 4, 50, 35, 0);
      }
      string tstring22 = this.TargetPage.ToString() + "/" + this.TargetPageMax.ToString();
      ...
      if (this.sourceUnr > -1)
      {
        ...
        for (int index20 = 0; index20 <= sfCount; ++index20)
        {
          ...
          if (index20 >= (this.SourcePage - 1) * num11 & index20 <= (this.SourcePage - 1) * num11 + (num11 - 1))
          {
            ...
            string tstring23 = num39.ToString() + "x " + this.game.Data.SFTypeObj[type].Name + "(" + Strings.Left(this.game.Data.PeopleObj[people7].Name, 3) + ")";
            bool flag2 = false;
            bool flag3 = false;
      ...
      if (this.SourcePage > 1)
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" < ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_3 + 10), bby: (y1_5 + 4), usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.SourcePrevId = this.AddSubPart(ref tsubpart, x1_3 + 10, y1_5 + 4, 50, 35, 1);
      }
      else
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" < ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_3 + 10), bby: (y1_5 + 4), tinactive: true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.SourcePrevId = this.AddSubPart(ref tsubpart, x1_3 + 10, y1_5 + 4, 50, 35, 0);
      }
      if (this.SourcePage < this.SourcePageMax)
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" > ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_3 + 180), bby: (y1_5 + 4), usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.SourceNextId = this.AddSubPart(ref tsubpart, x1_3 + 180, y1_5 + 4, 50, 35, 1);
      }
      else
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(" > ", 50, tBackbitmap: (ref this.OwnBitmap), bbx: (x1_3 + 180), bby: (y1_5 + 4), tinactive: true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.SourceNextId = this.AddSubPart(ref tsubpart, x1_3 + 180, y1_5 + 4, 50, 35, 0);
      }
      string tstring24 = this.SourcePage.ToString() + "/" + this.SourcePageMax.ToString();
      ...
      if (num41 == 0)
      {
        ...
        for (int index22 = 0; index22 <= counter7; ++index22)
        {
      ...
      if (this.targetUnr != -3 & this.sourceUnr > -1 && num36 < (int) Math.Round((double) this.game.Data.RuleVar[476]) & !(num36 == 0 & this.game.HandyFunctionsObj.GetPowerPtsAbsolute(this.sourceUnr) > 0 & !this.game.Data.UnitObj[this.sourceUnr].IsHQ))
      {
        ...
        string tid = "You cannot reduce Source Unit below " + num25.ToString() + " power points.";
      ...
      if (this.targetUnr == -2 & num17 < (int) Math.Round((double) this.game.Data.RuleVar[476]))
      {
        ...
        num25 = (int) Math.Round((double) this.game.Data.RuleVar[476]);
        string tid = "You cannot create a new Battlegroup with less than " + num25.ToString() + " power points.";
      ...
      if (this.targetUnr == -2 & num17 > (int) Math.Round((double) this.game.Data.RuleVar[477]))
      {
        ...
        string tid = "You cannot create a Battlegroup with more than " + num25.ToString() + " power points.";
      ...
      for (int index23 = 0; index23 <= counter8; ++index23)
      {
        string tstring25 = simpleStringList1.Id[index23];
      ...
      if (simpleStringList1.Counter == -1)
      {
        if (this.targetUnr == -3)
        {
          ...
          {
            string tstring26 = "Please select troops for Scrapping.";
            DrawMod.DrawTextColouredMarcCenter(ref toG, tstring26, this.game.MarcFont4, num44 + 130, y, Color.White);
          }
          else
          {
            string tstring27 = "Transfer selection for Scrapping.";
      ...
      int num45 = y1_7 + 4;
      int num46 = x1_5 + 45;
      SubPartClass tsubpart1 = (SubPartClass) new TextButtonPartClass("Cancel", 150, "Click to return to main screen.", ref this.OwnBitmap, num46, num45, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      if (this.targetUnr == -3)
      {
        ...
        {
          SubPartClass tsubpart2 = (SubPartClass) new TextButtonPartClass("Scrap" + str1, 150, "Go ahead and Scrap the selected equipment.", ref this.OwnBitmap, num47, num45, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
          this.transferid = this.AddSubPart(ref tsubpart2, num47, num45, 150, 35, 1);
        }
        else
        {
          SubPartClass tsubpart3 = (SubPartClass) new TextButtonPartClass("Scrap" + str1, 150, "Not possible to Scrap.", ref this.OwnBitmap, num47, num45, true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
          this.transfer2id = this.AddSubPart(ref tsubpart3, num47, num45, 150, 35, 0);
        }
      }
      else if (this.TL.Counter > -1 & !flag)
      {
        SubPartClass tsubpart4 = (SubPartClass) new TextButtonPartClass("Transfer" + str1, 150, "Go ahead and make the selected transfer.", ref this.OwnBitmap, num47, num45, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.transferid = this.AddSubPart(ref tsubpart4, num47, num45, 150, 35, 1);
      }
      else
      {
        SubPartClass tsubpart5 = (SubPartClass) new TextButtonPartClass("Transfer" + str1, 150, "Not possible to transfer.", ref this.OwnBitmap, num47, num45, true, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      ...
      num2 = 110;
      int num49 = 10;
      string str2 = "No source unit selected";
      string tstring30 = "";
      string tstring31 = "";
      if (this.sourceUnr > -1)
      ...
      string tstring36 = "Wgt: " + num13.ToString() + " Car: " + num15.ToString() + " Pow: " + num17.ToString();
      DrawMod.DrawTextColouredMarcCenter(ref toG, tstring36, this.game.MarcFont4, num48 + 600, num49 + 60, Color.White);
      if (!(num14 > 0 | num16 > 0))
        return;
      string tstring37 = "ManpWgt: " + num14.ToString() + " ManpCar: " + num16.ToString();
                ...
                if (num1 == this.transferid)
                {
                  ...
                  if (this.targetUnr == -3)
                  {
                    ...
                    if ((double) this.game.Data.RuleVar[486] > 0.0)
                    {
                      ...
                      for (int index9 = 0; index9 <= sfCount2; ++index9)
                      {
                  ...
                  else
                  {
                    if (this.targetUnr == -2)
                    {
                      ...
                      if ((double) this.game.Data.RuleVar[479] > 0.0)
                      {
                        ...
                        string str;
                        int num7;
                        for (int index10 = 0; index10 < 99; ++index10)
                        {
                    ...
                    if ((double) this.game.Data.RuleVar[403] == 1.0)
                    {
                      ...
                      for (int index13 = 0; index13 <= sfCount3; ++index13)
                      {
                    ...
                    int num8;
                    int num9;
                    for (int index14 = 0; index14 <= counter; ++index14)
                    {
