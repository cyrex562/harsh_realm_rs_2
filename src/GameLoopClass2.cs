...
namespace WindowsApplication1
{
  public class GameLoopClass2
  {
    ...
    public GameLoopClass2(ref GameClass GameRef) => this.game = GameRef;
            ...
            do
            {
              ...
              if (this.game.EditObj.Test == 1)
              {
                ...
                if (this.game.Data.Round == 0)
                {
                  ...
                  for (int regnr = 0; regnr <= regimeCounter1; ++regnr)
                  {
                    ...
                    for (int index5 = 0; index5 <= sfCounter; ++index5)
                  ...
                  for (index1 = 0; index1 <= regimeCounter2; ++index1)
                  {
              ...
              if (this.game.EditObj.Test == 4)
              {
                if (!this.game.Data.RegimeObj[this.game.Data.Turn].AI && this.game.Data.Product == 7 & this.game.EditObj.TestEarlyCinematics == 0 & (double) this.game.Data.RuleVar[971] > 0.0)
                {
                  ...
                  if (this.game.Data.StringListObj[this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[971]))].Length > -1)
                  {
                ...
                {
                  int stringListById1 = this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[955]));
                  if (stringListById1 > -1)
                  {
                    for (int length1 = this.game.Data.StringListObj[stringListById1].Length; length1 >= 0; length1 += -1)
                    {
                      int num = (int) Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].Data[length1, 0]));
                      if ((int) Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].Data[length1, 9])) < this.game.Data.Round & (int) Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].Data[length1, 1])) == this.game.Data.Turn)
                      {
                        int stringListById2 = this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[956]));
                        if (stringListById2 > -1)
                        {
                          for (int length2 = this.game.Data.StringListObj[stringListById2].Length; length2 >= 0; length2 += -1)
                          {
                            if ((int) Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById2].Data[length2, 0])) == num)
              ...
              if (this.game.EditObj.Test == 6)
              {
                ...
                {
                  this.game.EventRelatedObj.DoCheckSpecificEvent((int) Math.Round((double) this.game.Data.RuleVar[402]));
                  if (this.game.Data.RegimeObj[this.game.Data.Turn].UberRegime == -1)
    ...
    public void ExitTheLoopSub(string s)
    {
