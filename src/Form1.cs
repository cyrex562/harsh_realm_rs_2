...
{
  public class Form1 : ImmoveableForm
  {
    ...
    private int TempKeyTest;
    private GameClass Game;
    public ScreenClass Screeny;
    public ScreenClass StoredScreeny;
    ...
    public int LastMouseOverX;
    public int LastMouseOverY;
    public int LastTipX;
    public int LastTipY;
    public string LastTipText;
    public int LastTipTextX;
    public int LastTipTextY;
    private int StartupPhase;
    public bool Buisy;
    private int CollectCount;
    private int CheckMouseMove;
    public bool doubleSize;
    public float doubleModX;
    public float doubleModY;
    private bool tempOnlyToolTip;
    [AccessedThroughProperty("Label1")]
    private Label _Label1;
    public bool startedWithDPIaware;
    public bool windowsTxtFormPlease;
    public int windowsFormWidth;
    public int windowsFormHeight;
    private bool hasFocus;
    private bool currentlyInMouseLock;
    public bool clickInProgress;
    private Bitmap sbmp;
    public SimpleStringList DebugL;
    public DateTime lastTimerTime;
    public DateTime lastTimerTime_DebugPoint1;
    public bool onlyTimerRun;
    public int debugPoint2;
    public int debugPoint3;
    public int debugPoint4;
    ...
    public Form1()
    {
      ...
      this.DebugL = new SimpleStringList();
      ...
      else
      {
        ...
        {
          ProjectData.SetProjectError(ex);
          int num = (int) Interaction.MsgBox((object) "Error trying to read windows.txt file.");
          ProjectData.ClearProjectError();
        }
      }
    ...
    private void Form1_Load(object sender, EventArgs e) => this.Cursor = Cursors.WaitCursor;
    ...
    public void Startup()
    {
      ...
      if (!flag)
      {
        if (files.Length > 0)
        {
          ...
          int num = (int) Math.Round(Conversion.Val(Interaction.InputBox(Prompt, "Shadow Empire : Planetary Conquest : Select Mod")));
    ...
    public void FinishUp()
    {
      ...
      DrawMod.DPIx = (int) Math.Round((double) Expression.DpiX);
      DrawMod.DPIy = (int) Math.Round((double) Expression.DpiY);
      ...
      {
        int num = (int) Interaction.MsgBox((object) "The game is not launched from Steam. The game will close down. Please start the game up from Steam. ", Title: ((object) "Copy protection check"));
        ProjectData.EndApp();
      }
      ...
      if (this.windowsTxtFormPlease)
      {
        ...
        {
          if ((int) Math.Round((double) (this.Width * 100) / (double) this.Game.EditObj.DoubleSizePercentage) < 1280)
          {
          ...
          if ((int) Math.Round((double) (this.Height * 100) / (double) this.Game.EditObj.DoubleSizePercentage) < 768)
          {
            this.Game.EditObj.DoubleSizePercentage = 100;
            this.Game.EditObj.DoubleSize = false;
            this.Game.EditObj.Save(this.Game.AppPath + "editobj.txt");
      ...
      else
      {
        ...
        {
          DEVMODE1 lpDevMode = new DEVMODE1();
          lpDevMode.dmSize = (short) Marshal.SizeOf((object) lpDevMode);
          if (Form1.EnumDisplaySettings(0, 0, ref lpDevMode))
          {
            ...
            if (Form1.ChangeDisplaySettings(ref lpDevMode, 4) == 0)
              flag = true;
            if (flag)
            {
      ...
      {
        int num1 = (int) Interaction.MsgBox((object) "The minimum screen resolution your desktop needs to have is 1280x768.", Title: ((object) "Shadow Empire : Planetary Conquest"));
      }
      if (this.doubleSize)
      {
        HandyFunctionsclass handyFunctionsObj = this.Game.HandyFunctionsObj;
        Form1 form1 = this;
        ref Form1 local = ref form1;
        handyFunctionsObj.SwitchResolution(ref local);
      }
      SoundMod.InitSound((Form) this);
      this.Screeny = DrawMod.TGame.ModIntroType != 0 ? (DrawMod.TGame.ModIntroType != 2 ? (ScreenClass) new FirstScreenClass2(ref this.Game, this, true) : (ScreenClass) new CinematicsScreenClass(ref this.Game, this)) : (ScreenClass) new FirstScreenClass(ref this.Game, this);
      this.PaintScreeny();
    ...
    public int GetMemorySize() => (int) Math.Round((double) (32 * this.Width * this.Height) / 8000.0) + this.Screeny.GetMemorySize();

    public void SuperImposeMessage(string texty, string texty2)
    {
      int num1 = (int) Math.Round((double) this.Game.RealScreenWidth / 2.0 - 185.0);
      int num2 = (int) Math.Round((double) this.Game.RealScreenHeight / 2.0 - 106.0);
      ...
      if (texty.Length > 1)
      {
        DrawMod.DrawTextColouredConsoleCenter(ref objgraphics, texty, this.Game.MarcFont3, num1 + 185 + 1, num2 + 66 + 1, this.Game.seColBrown);
        DrawMod.DrawTextColouredConsoleCenter(ref objgraphics, texty, this.Game.MarcFont3, num1 + 185, num2 + 66, this.Game.seColWhite);
      }
      if (texty2.Length > 1)
      {
        DrawMod.DrawTextColouredConsoleCenter(ref objgraphics, texty2, this.Game.MarcFont4, num1 + 185 + 1, num2 + 116 + 1, this.Game.seColBrown);
        DrawMod.DrawTextColouredConsoleCenter(ref objgraphics, texty2, this.Game.MarcFont4, num1 + 185, num2 + 116, this.Game.seColWhite);
      }
      objgraphics.Dispose();
      this.Refresh();
    }
        ...
        if (this.Screeny != null)
        {
          ...
          if ((num1 & num2) != 0)
          {
            if (this.doubleSize)
            {
              ...
              int x = (int) Math.Round((double) ((float) clipRectangle.X * this.doubleModX));
              int y = (int) Math.Round((double) ((float) e.ClipRectangle.Y * this.doubleModY));
              int width = (int) Math.Round((double) ((float) e.ClipRectangle.Width * this.doubleModX));
              int height = (int) Math.Round((double) ((float) e.ClipRectangle.Height * this.doubleModY));
    ...
    private void Form1_Mousedown(object sender, MouseEventArgs e)
    {
      ...
      if (this.doubleSize)
      {
        x1 = (int) Math.Round((double) ((float) x1 * this.doubleModX));
        y1 = (int) Math.Round((double) ((float) y1 * this.doubleModY));
      }
      this.LastMouseX = x1;
      this.LastMouseY = y1;
      ...
      if (screenReturnClass.NewScreen > 0)
      {
        ...
        if (screenReturnClass.NewScreen == 24)
          this.Screeny = (ScreenClass) new ManagementScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 12)
          this.Screeny = (ScreenClass) new FirstScreenClass2(ref this.Game, this, true);
        if (screenReturnClass.NewScreen == 13)
          this.Screeny = (ScreenClass) new GameLoopScreenClass2(ref this.Game, this, true);
        if (screenReturnClass.NewScreen == 14)
          this.Screeny = (ScreenClass) new MessagePopUpScreenClass2(ref this.Game, this);
        if (screenReturnClass.NewScreen == 16)
          this.Screeny = (ScreenClass) new HistoryScreenClass2(ref this.Game, this);
        if (screenReturnClass.NewScreen == 15)
          this.Screeny = (ScreenClass) new SFScreenClass2(ref this.Game, this, true);
        if (screenReturnClass.NewScreen == 11)
          this.Screeny = (ScreenClass) new PlayScreenClass2(ref this.Game, this);
        if (screenReturnClass.NewScreen == 22)
          this.Screeny = (ScreenClass) new DynamicCinematicsScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 17)
          this.Screeny = (ScreenClass) new SimpleEditScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 25)
          this.Screeny = (ScreenClass) new SS_ScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 18)
          this.Screeny = (ScreenClass) new SimpleTroopTypeScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 19)
          this.Screeny = (ScreenClass) new SimpleHisScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 20)
          this.Screeny = (ScreenClass) new SimpleOfficerScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 21)
          this.Screeny = (ScreenClass) new SimpleMapScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 23)
          this.Screeny = (ScreenClass) new RandomScreenClass2(ref this.Game, this);
        if (screenReturnClass.NewScreen == 3)
          this.Screeny = (ScreenClass) new PlayScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 2)
          this.Screeny = (ScreenClass) new MainEditScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 1)
          this.Screeny = (ScreenClass) new FirstScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 4)
          this.Screeny = (ScreenClass) new GameLoopScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 5)
          this.Screeny = (ScreenClass) new CombatScreenClass(ref this.Game);
        if (screenReturnClass.NewScreen == 6)
          this.Screeny = (ScreenClass) new HistoryScreenClass(ref this.Game);
        if (screenReturnClass.NewScreen == 7)
          this.Screeny = (ScreenClass) new EventScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 8)
          this.Screeny = (ScreenClass) new SFScreenClass(ref this.Game, this);
        if (screenReturnClass.NewScreen == 9)
          this.Screeny = (ScreenClass) new StatsScreenClass(ref this.Game);
        if (screenReturnClass.NewScreen == 10)
          this.Screeny = (ScreenClass) new MessagePopUpScreenClass(ref this.Game, this);
        this.PaintScreeny();
    ...
    private void Form1_Mouseup(object sender, MouseEventArgs e)
    {
      ...
      if (this.Buisy)
      {
        ...
        if (this.doubleSize)
        {
          x = (int) Math.Round((double) ((float) x * this.doubleModX));
          y = (int) Math.Round((double) ((float) y * this.doubleModY));
        }
        if (!Information.IsNothing((object) this.Screeny))
          return;
        try
        {
          this.Screeny.HandleBLOCKEDMouseUp(x, y, (int) e.Button);
        }
        catch (Exception ex)
        {
          ProjectData.SetProjectError(ex);
      ...
      else
      {
        ...
        this.LastMouseX = x;
        this.LastMouseY = y;
        ScreenReturnClass screenReturnClass = this.Screeny.HandleMouseUp(x, y, (int) e.Button);
        if (screenReturnClass.NewScreen > 0)
        {
          if (screenReturnClass.OpenPopUp)
          {
    ...
    private void Form1_Keydown(object sender, KeyEventArgs e)
    {
      ...
      ScreenReturnClass screenReturnClass = this.Screeny.HandleKeyPress((int) Math.Round(Conversion.Val((object) e.KeyValue)));
      if (screenReturnClass.NewScreen > 0)
      {
        if (screenReturnClass.OpenPopUp)
        {
    ...
    private void Form1_Keyup(object sender, KeyEventArgs e)
    {
      if (this.StartupPhase < 2 || this.Buisy || Conversions.ToBoolean(this.OnlyTimerCall()))
        return;
      this.Buisy = true;
      ScreenReturnClass screenReturnClass = this.Screeny.HandleKeyup((int) Math.Round(Conversion.Val((object) e.KeyValue)));
      if (screenReturnClass.NewScreen > 0)
      {
        if (screenReturnClass.OpenPopUp)
        {
    ...
    public object OnlyTimerCall() => (object) false;
    ...
    private void Timer1_Tick(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        this.debugPoint2 = 5;
        this.debugPoint3 = 5;
        string tipText = this.Game.EditObj.TipText;
        ...
        if (this.Game.EditObj.CounterAlpha2 < 1)
        {
          if (this.Game.EditObj.CounterAlpha < 128)
            this.Game.EditObj.CounterAlpha = (int) sbyte.MaxValue;
          this.Game.EditObj.CounterAlpha += 32;
          if (this.Game.EditObj.CounterAlpha > (int) byte.MaxValue)
          {
            this.Game.EditObj.CounterAlpha = (int) byte.MaxValue;
        ...
        if (this.FullScreen & this.hasFocus)
        {
          ...
          if (this.doubleSize)
          {
            num1 = (int) Math.Round((double) ((float) num1 * this.doubleModX));
            num2 = (int) Math.Round((double) ((float) num2 * this.doubleModY));
            if ((double) this.doubleModX >= 2.0)
              num3 = (int) Math.Round((double) this.doubleModX);
          }
          if (this.FullScreen)
          {
    ...
    public void PaintScreeny()
    {
      if (!this.hasFocus & this.Game.noDrawNoFocus)
        return;
      if (this.doubleSize)
        this.PaintScreeny(new Rectangle(0, 0, (int) Math.Round((double) ((float) this.Width * this.doubleModX)), (int) Math.Round((double) ((float) this.Height * this.doubleModY))));
      else
    ...
    public void PaintScreeny(Rectangle rect)
    {
      ...
      if (DrawMod.TGame.EditObj.highGfxSpeedOn)
      {
        if (this.doubleSize)
        {
          ...
          {
            DrawMod.CopyPerLine_DOUBLE(ref bitmap, ref this.sbmp, 0, 0, bitmap.Width, bitmap.Height, 0, 0);
          }
          else
          {
            ...
            DrawMod.DrawSimplePart2(ref objGraphics, ref bitmap, new Rectangle(0, 0, bitmap.Width, bitmap.Height), new Rectangle(0, 0, this.Width, this.Height));
            objGraphics.Dispose();
          }
          ref Bitmap local1 = ref this.sbmp;
          Form form = (Form) this;
          ref Form local2 = ref form;
          DrawMod.CopyToForm2(ref local1, ref local2);
        }
        else if (!(rect.X == 0 & rect.Y == 0 & rect.Width == this.Width & rect.Height == this.Height))
        {
          ...
          Form form = (Form) this;
          ref Form local4 = ref form;
          Rectangle rect1 = rect;
          DrawMod.CopyToForm2rect(ref local3, ref local4, rect1);
        }
        else
        {
          Bitmap bitmap = this.Screeny.Paint(this.tempOnlyToolTip);
          ...
          Form form = (Form) this;
          ref Form local6 = ref form;
          DrawMod.CopyToForm2(ref local5, ref local6);
        }
      }
      else
      {
        ...
        if (this.doubleSize)
        {
          ...
          Rectangle destrect = new Rectangle((int) Math.Round((double) ((float) rect.X / this.doubleModX)), (int) Math.Round((double) ((float) rect.Y / this.doubleModY)), (int) Math.Round((double) ((float) rect.Width / this.doubleModX)), (int) Math.Round((double) ((float) rect.Height / this.doubleModY)));
        ...
        else
        {
          ...
          if (!(rect.X == 0 & rect.Y == 0 & rect.Width == this.Width & rect.Height == this.Height))
          {
            ...
            DrawMod.DrawSimplePart(ref local9, ref local10, rect2);
          }
          else if (DrawMod.TGame.EditObj.highGfxSpeedOn)
          {
            ...
            Form form = (Form) this;
            ref Form local12 = ref form;
            DrawMod.CopyToForm2(ref local11, ref local12);
          }
          else
          {
