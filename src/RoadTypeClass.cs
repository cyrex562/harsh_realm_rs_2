...
{
  [Serializable]
  public class RoadTypeClass : ISerializable
  {
    public string Name;
    public string[] BasicSpriteFileName;
    public int[] BasicSpriteID;
    public int[] MoveCostOverrule;
    public int EPCost;
    public int Thickness;
    public int[] LayerSpriteID;
    public string[] LayerSpriteFileName;
    public bool SpecialLayer;
    public int FirstDrawOther;
    public string SheetFileName;
    public int SheetSpriteID;
    public bool UseSheet;
    public bool Transparent;
    public int Category;
    public string[] BridgeOverruleSpriteFileName;
    public int[] BridgeOverruleSpriteID;
    public bool BridgeOverrule;
    public bool useCenter6;
    public int center6spriteId;
    public string center6spriteFileName;
    public int trafficPoints;
    ...
    public RoadTypeClass(int hardcoded)
    {
      this.BasicSpriteFileName = new string[6];
      this.BasicSpriteID = new int[6];
      this.MoveCostOverrule = new int[100];
    ...
    public void ReplaceCenter6(string filename)
    {
    ...
    public void ReplaceBridgeOverruleSprite(int nr, string filename)
    {
