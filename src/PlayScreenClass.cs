...
{
  public class PlayScreenClass : ScreenClass
  {
    private int WLeft;
    private int Wleft2;
    private int WRight;
    ...
    public PlayScreenClass(ref GameClass tgame, Form1 tformref)
      : base(ref tgame, tgame.BACKGROUND1MARC, tformref)
    {
      ...
      this.OffSetY = (int) Math.Round((double) (this.Game.ScreenHeight - 768) / 2.0);
      if (this.Game.EditObj.CameFrom == 25)
      {
        ...
        this.WDown = this.AddWindow((WindowClass) new ProdWindowClass(ref tgame, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200, tgame.EditObj.TempProdList1, tgame.EditObj.TempProdList2, tgame.EditObj.TempProdList3), this.OffSetX, this.Game.ScreenHeight - 200, 1000, 200);
        if (this.Game.EditObj.ProdFlap)
        {
          this.WRight = this.AddWindow((WindowClass) new ProdFlapWindowClass(ref tgame, 305, this.OwnBackground, 0, 0), 0, 35, this.Game.ScreenWidth, this.Game.ScreenHeight - 305);
        }
        else
        {
          this.WLeft = this.AddWindow((WindowClass) new PlayMainWindowClass(ref tgame), this.Game.ScreenWidth - 220, 0, 220, this.Game.ScreenHeight - 270);
          if (this.Game.EditObj.Layout == 1)
            this.Wleft2 = this.AddWindow((WindowClass) new PlaySecondMainWindowClass(ref tgame), 0, 35, 220, this.Game.ScreenHeight - 305);
          this.WRight = this.Game.EditObj.Layout != 1 ? this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 220), 0, 35, this.Game.ScreenWidth - 220, this.Game.ScreenHeight - 305) : this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 440), 220, 35, this.Game.ScreenWidth - 440, this.Game.ScreenHeight - 305);
        }
        this.WUp = this.AddWindow((WindowClass) new InfoWindowClass(ref tgame), 0, this.Game.ScreenHeight - 270, this.Game.ScreenWidth, 20);
        this.WRes = !(this.Game.EditObj.OrderType == 24 | this.Game.EditObj.ProdFlap) ? this.AddWindow((WindowClass) new ResourceWindowClass(ref tgame, 0), 0, 0, this.Game.ScreenWidth - 220, 35) : this.AddWindow((WindowClass) new ResourceWindowClass(ref tgame, 220), 0, 0, this.Game.ScreenWidth, 35);
      ...
      {
        this.WDown = this.AddWindow((WindowClass) new SFDesignWindowClass(ref tgame, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200, tgame.EditObj.TempProdList1, tgame.EditObj.TempProdList2), this.OffSetX, this.Game.ScreenHeight - 200, 1000, 200);
        this.WLeft = this.AddWindow((WindowClass) new PlayMainWindowClass(ref tgame), this.Game.ScreenWidth - 220, 0, 220, this.Game.ScreenHeight - 270);
        if (this.Game.EditObj.Layout == 1)
          this.Wleft2 = this.AddWindow((WindowClass) new PlaySecondMainWindowClass(ref tgame), 0, 35, 220, this.Game.ScreenHeight - 305);
        this.WRight = this.Game.EditObj.Layout != 1 ? this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 220), 0, 35, this.Game.ScreenWidth - 220, this.Game.ScreenHeight - 305) : this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 440), 220, 35, this.Game.ScreenWidth - 440, this.Game.ScreenHeight - 305);
      ...
      {
        this.WDown = this.Game.EditObj.CameFrom != 45 ? this.AddWindow((WindowClass) new PlayExtraWindowClass(ref tgame, this.OwnBackground, 0, this.Game.ScreenHeight - 210), 0, this.Game.ScreenHeight - 210, this.Game.ScreenWidth, 210) : this.AddWindow((WindowClass) new PrefsWindowClass(ref this.Game, this.OwnBackground, 0, this.Game.ScreenHeight - 200), (int) Math.Round((double) (this.Game.ScreenWidth - 1024) / 2.0), this.Game.ScreenHeight - 200, 1024, 200);
        this.WLeft = this.AddWindow((WindowClass) new PlayMainWindowClass(ref tgame), this.Game.ScreenWidth - 220, 0, 220, this.Game.ScreenHeight - 270);
        if (this.Game.EditObj.Layout == 1)
          this.Wleft2 = this.AddWindow((WindowClass) new PlaySecondMainWindowClass(ref tgame), 0, 35, 220, this.Game.ScreenHeight - 305);
        this.WRight = this.Game.EditObj.Layout != 1 ? this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 220), 0, 35, this.Game.ScreenWidth - 220, this.Game.ScreenHeight - 305) : this.AddWindow((WindowClass) new MapWindowClass(ref tgame, 305, 440), 220, 35, this.Game.ScreenWidth - 440, this.Game.ScreenHeight - 305);
          ...
          if (windowReturnClass.Counter > -1)
          {
            ...
            for (int index2 = 0; index2 <= counter; ++index2)
            {
              ...
              if (windowReturnClass.CommandType[index2] == 2)
              {
                if (windowReturnClass.CommandData[index2] == 18)
                {
                  this.WLeft = this.AddWindow((WindowClass) new PlayMainWindowClass(ref this.Game), this.Game.ScreenWidth - 220, 0, 220, this.Game.ScreenHeight - 270);
                  if (this.Game.EditObj.Layout == 1)
                    this.Wleft2 = this.AddWindow((WindowClass) new PlaySecondMainWindowClass(ref DrawMod.TGame), 0, 35, 220, this.Game.ScreenHeight - 305);
                }
                if (windowReturnClass.CommandData[index2] == 12)
                  this.WRight = this.Game.EditObj.Layout != 1 ? this.AddWindow((WindowClass) new MapWindowClass(ref DrawMod.TGame, 305, 220), 0, 35, this.Game.ScreenWidth - 220, this.Game.ScreenHeight - 305) : this.AddWindow((WindowClass) new MapWindowClass(ref DrawMod.TGame, 305, 440), 220, 35, this.Game.ScreenWidth - 440, this.Game.ScreenHeight - 305);
                if (windowReturnClass.CommandData[index2] == 53)
                  this.WRight = this.AddWindow((WindowClass) new BigMiniMapWindowClass(ref this.Game, 305, 0), 0, 35, this.Game.ScreenWidth, this.Game.ScreenHeight - 305);
                if (windowReturnClass.CommandData[index2] == 52)
                  this.WRight = this.AddWindow((WindowClass) new ProdFlapWindowClass(ref DrawMod.TGame, 305, this.OwnBackground, 0, 0), 0, 35, this.Game.ScreenWidth, this.Game.ScreenHeight - 305);
                if (windowReturnClass.CommandData[index2] == 66)
                  this.WRes = !(this.Game.EditObj.OrderType == 24 | this.Game.EditObj.ProdFlap) ? this.AddWindow((WindowClass) new ResourceWindowClass(ref DrawMod.TGame, 0), 0, 0, this.Game.ScreenWidth - 220, 35) : this.AddWindow((WindowClass) new ResourceWindowClass(ref DrawMod.TGame, 220), 0, 0, this.Game.ScreenWidth, 35);
                if (windowReturnClass.CommandData[index2] == 25)
                  this.WDown = this.AddWindow((WindowClass) new ProdWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 48)
                  this.WDown = this.AddWindow((WindowClass) new BuildWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 28)
                  this.WDown = this.AddWindow((WindowClass) new NewUnitWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 59)
                  this.WDown = this.AddWindow((WindowClass) new NewUnit2WindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 30)
                  this.WDown = this.AddWindow((WindowClass) new TransferWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 61)
                ...
                if (windowReturnClass.CommandData[index2] == 63)
                  this.WDown = this.AddWindow((WindowClass) new ChangeModelWindowClass2(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 51)
                  this.WDown = this.AddWindow((WindowClass) new AirSupplyWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 35)
                  this.WDown = this.AddWindow((WindowClass) new StrategicWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 20)
                  this.WDown = this.AddWindow((WindowClass) new PlayExtraWindowClass(ref this.Game, this.OwnBackground, 0, this.Game.ScreenHeight - 210), 0, this.Game.ScreenHeight - 210, this.Game.ScreenWidth, 210);
                if (windowReturnClass.CommandData[index2] == 45)
                  this.WDown = this.AddWindow((WindowClass) new PrefsWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 37)
                  this.WDown = this.AddWindow((WindowClass) new OldResearchWindowClass(ref this.Game), this.OffSetX, this.OffSetY, 1024, 768);
                if (windowReturnClass.CommandData[index2] == 65)
                  this.WDown = this.AddWindow((WindowClass) new SFDesignWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
                if (windowReturnClass.CommandData[index2] == 39)
                  this.WDown = this.AddWindow((WindowClass) new DipWindowClass(ref this.Game, this.OwnBackground, this.OffSetX, this.Game.ScreenHeight - 200), this.OffSetX, this.Game.ScreenHeight - 200, 1024, 200);
              }
            }
          }
