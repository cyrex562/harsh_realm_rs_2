  ...
  pub class ResourceWindowClass : WindowClass
  {
    ...
    pub void dostuff()
    {
      ...
      if (this.game.Data.Round > 0)
      {
        ...
        text2: String = Strings.Trim(Conversion.Str( this.game.Data.RegimeObj[this.game.Data.Turn].ResPts));
        ...
        {
          text4 = Strings.Trim(Conversion.Str( this.game.Data.Round));
          text5 = "ROUND";
        }
        else
        {
          ...
          text4 = Strings.Left(this.game.HandyFunctionsObj.GetMonth(dateTime2.Month), 3) + " " + Strings.Trim(Conversion.Str( dateTime2.Day)) + ", " + Strings.Trim(Conversion.Str( dateTime2.Year));
          text5 = "ROUND";
        }
      ...
      do
      {
        if (this.game.Data.RegimeSlotShow[index1])
        {
          ...
          text6: String = Strings.Trim(Conversion.Str( this.game.Data.RegimeObj[this.game.Data.Turn].RegimeSlot[index1]));
      ...
      let mut num21: i32 =  Math.Round( this.game.ScreenWidth / 2.0 -  num20 / 2.0);
      ...
      if (this.game.Data.Round > 0)
      {
        ...
        {
          text13 = Strings.Trim(Conversion.Str( this.game.Data.Round));
          text14 = "ROUND";
        }
        else
        {
          DateTime dateTime3 = DateTime::new().AddYears(this.game.Data.StartData.Year - 1).AddMonths(this.game.Data.StartData.Month - 1).AddDays( (this.game.Data.StartData.Day - 1));
          DateTime dateTime4;
          if (this.game.Data.AlternateRound == 31)
          {
          ...
          text13 = Strings.Left(this.game.HandyFunctionsObj.GetMonth(dateTime4.Month), 3) + " " + Strings.Trim(Conversion.Str( dateTime4.Day)) + ", " + Strings.Trim(Conversion.Str( dateTime4.Year));
          text14 = "ROUND";
        }
        ...
        ttext: String = "The date or the round number. Round number is " + Strings.Trim(Conversion.Str( this.game.Data.Round)) + ". ";
        if (this.game.Data.AlternateRound > -1)
        {
          ...
          ttext = str2 + this.game.HandyFunctionsObj.GetMonth(dateTime.Month) + " " + Strings.Trim(Conversion.Str( dateTime.Day)) + " " + Strings.Trim(Conversion.Str( dateTime.Year));
        }
        rectangle1 = Rectangle::new(x3, 0, width3, 25);
        trect = rectangle1;
        this.AddMouse( trect, "", ttext);
        let mut x4: i32 = x3 + width3 + 20;
        text15: String = Strings.Trim(Conversion.Str( this.game.Data.RegimeObj[this.game.Data.Turn].ResPts));
        ...
        let mut num25: i32 =  Math.Round( Expression.MeasureString(str1, this.game.VicFont2).Width);
      ...
      do
      {
        if (this.game.Data.RegimeSlotShow[index10])
        {
          ...
          str3: String = Strings.Trim(Conversion.Str( this.game.Data.RegimeObj[this.game.Data.Turn].RegimeSlot[index10]));
