...
namespace WindowsApplication1
{
  pub class CombatClass
  {
            ...
            if (this.game.Data.UnitObj[index9].Regime != this.AttackerRegime)
            {
              ...
              if (this.game.HandyFunctionsObj.CanUnitIntercept(index9, Target, this.AttackerRegime))
              {
                if (num7 > 0 & (double) this.game.Data.RuleVar[837] > 0.0)
                {
                  ...
                  let mut num9: i32 =  (int) Math.Round((double) ((float) this.game.HandyFunctionsObj.GetLowestAirAp(index9) * this.game.Data.RuleVar[147]));
                  let mut num10: i32 =  num8 <= num9 ? (int) Math.Round((double) ((float) (int) Math.Round((double) (int) Math.Round((double) (this.game.Data.RuleVar[837] - this.game.Data.RuleVar[838])) * ((double) num8 / (double) num9)) + this.game.Data.RuleVar[838])) : (int) Math.Round((double) this.game.Data.RuleVar[837]);
    ...
    pub void PayForLis()
    {
      let mut index1: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 2;
      let mut index2: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 3;
      let mut index3: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 4;
      let mut index4: i32 =  17;
      let mut index5: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 0;
      let mut index6: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 1;
      let mut ucounter: i32 =  this.UCounter;
      for (let mut index7: i32 =  0; index7 <= ucounter; index7 += 1)
      {
        ...
        for (let mut index8: i32 =  0; index8 <= icounter; index8 += 1)
        {
          if (this.IList[index8].IUlistNr == index7)
          {
            ...
            if (num2 > 0)
            {
              let mut num4: i32 =  (int) Math.Round(Math.Ceiling((double) (num2 * this.game.Data.SFTypeObj[isfType].AirAPRule) / 10.0));
              if (num4 > num3)
                num3 = num4;
            }
        ...
        for (let mut index9: i32 =  0; index9 <= counter; index9 += 1)
        {
          ...
          let mut num6: i32 =  (int) Math.Round(Math.Ceiling((double) SL.Weight[index9] / 10.0));
    ...
    pub void InitLis()
    {
      ...
      let mut index2: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 3;
      let mut index3: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 4;
      let mut index4: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 0;
      let mut index5: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 1;
      let mut ucounter: i32 =  this.UCounter;
      for (let mut index6: i32 =  0; index6 <= ucounter; index6 += 1)
      {
        ...
        for (let mut index7: i32 =  0; index7 <= icounter1; index7 += 1)
        {
          if (this.IList[index7].IUlistNr == index6)
          {
            ...
            {
              let mut val1: i32 =  (int) Math.Round(Math.Ceiling((double) (num1 * this.game.Data.SFTypeObj[isfType].AirAPRule) / 10.0));
    ...
    pub CheckEnoughFuelAmmo: bool(int unr, bool forAA)
    {
      ...
      if (this.CombatType == 13)
        val2 = 3;
      let mut index1: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 2;
      let mut num2: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 3;
      let mut index2: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 4;
      let mut index3: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 0;
      let mut index4: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 1;
      ...
      for (let mut index5: i32 =  0; index5 <= sfCount; index5 += 1)
      {
        ...
        if (num1 > 0)
        {
          let mut num5: i32 =  Math.Max((int) Math.Round(Math.Ceiling((double) (num1 * this.game.Data.SFTypeObj[type].AirAPRule) / 10.0)), val2);
          num4 = (float) ((double) num4 * (double) num5 / 10.0);
        }
    ...
    pub void PlayRelevantSound()
    {
      ...
      let mut num2: i32 =  0;
      let mut num3: i32 =  (int) Math.Round((double) VBMath.Rnd() * (double) this.ICounter + 1.0);
      ...
      if (index1 < 0)
      {
        ...
        index1 = -1;
        let mut num5: i32 =  0;
        let mut num6: i32 =  (int) Math.Round((double) VBMath.Rnd() * (double) this.ICounter + 1.0);
        while (index1 == -1)
        {
          num5 += 1;
    ...
    pub int GetIndividualHide(int inr)
    {
      ...
      if ((double) this.game.Data.RuleVar[419] > 0.0)
      {
        ...
        let mut num3: i32 =  (double) averageXp <= (double) this.game.Data.RuleVar[423] ? (int) Math.Round(Math.Ceiling(0.6 * (double) num2)) + (int) Math.Round(Math.Floor(0.4 * (double) num2 * (double) averageXp / (double) this.game.Data.RuleVar[423])) : num2 + (int) Math.Round(Math.Floor(0.4 * (double) num2 * (double) Math.Min(1f, (float) (((double) averageXp - (double) this.game.Data.RuleVar[423]) / (80.0 - (double) this.game.Data.RuleVar[423])))));
    ...
    pub void DoActualAttack(int attnr, int defnr, bool counterattack = false)
    {
      ...
      else
      {
        ...
        s1: String = "BEFORE MOD: Attval=" + Conversion.Str((object) num1) + ", DefVal= " + Conversion.Str((object) Number1);
        str2: String = "attack=" + Strings.Trim(Conversion.Str((object) num1)) + " VS defense = " + Strings.Trim(Conversion.Str((object) Number1));
        int num2;
        ...
        if (counterattack)
        {
          ...
          {
            let mut num17: i32 =  (int) Math.Round((double) (this.IList[attnr].ICounterAttacks - this.game.Data.SFTypeObj[this.IList[attnr].ISFType].Attacks * 2));
        ...
        if (this.customCombatObj.HasCustumCalls())
        {
          if (this.game.Data.SFTypeObj[this.IList[defnr].ISFType].Theater != 2)
          {
            ...
            if (this.IList[attnr].IAttacker == 0)
            {
              let mut num19: i32 =  (int) Math.Round((double) (this.game.Data.SFTypeObj[this.IList[attnr].ISFType].CombatModDef[landscapeType1] * 100f));
              CustomCombatCalls customCombatObj = this.customCombatObj;
              combatClass = this;
            ...
            {
              let mut num22: i32 =  (int) Math.Round((double) (this.game.Data.SFTypeObj[this.game.Data.SFTypeObj[this.IList[attnr].ISFType].ArtSFType].CombatModAtt[landscapeType1] * 100f));
              CustomCombatCalls customCombatObj = this.customCombatObj;
              combatClass = this;
            ...
            {
              let mut num25: i32 =  (int) Math.Round((double) (this.game.Data.SFTypeObj[this.IList[attnr].ISFType].CombatModAtt[landscapeType1] * 100f));
              CustomCombatCalls customCombatObj = this.customCombatObj;
              combatClass = this;
        ...
        if (this.game.Data.Product >= 6)
        {
          if (!(this.CombatType == 11 | this.InterceptFire) & !this.UList[this.IList[attnr].IUlistNr].USupportInterceptFire)
          {
            ...
            if (this.IList[defnr].IAttacker == 0 & this.CombatType != 12)
            {
              ...
              {
                let mut oldval36: i32 =  (int) Math.Round((double) num34);
                CustomCombatCalls customCombatObj = this.customCombatObj;
                combatClass = this;
                ref CombatClass local = ref combatClass;
        ...
        if (this.IList[defnr].IAttacker != 0 && !this.game.Data.SFTypeObj[this.IList[defnr].ISFType].BackBench & !(this.CombatType == 3 | this.CombatType == 4) && this.game.Data.SFTypeObj[this.IList[defnr].ISFType].Theater == 0 & this.game.Data.SFTypeObj[this.IList[defnr].ISFType].Theater == 0 && this.IList[defnr].IBreakTrough == 0 & this.game.Data.UnitObj[this.IList[defnr].IUnr].Map == this.CombatTarget.map && this.game.HandyFunctionsObj.Distance(this.game.Data.UnitObj[this.IList[defnr].IUnr].X, this.game.Data.UnitObj[this.IList[defnr].IUnr].Y, this.game.Data.UnitObj[this.IList[defnr].IUnr].Map, this.CombatTarget.x, this.CombatTarget.y, this.CombatTarget.map) == 1)
        {
          ...
          if (index32 > -1)
          {
            if (this.customCombatObj.HasCustumCalls())
            {
              ...
              let mut num45: i32 =  (int) Math.Round((1.0 - (double) num44) * 100.0);
              str5: String = "";
              CustomCombatCalls customCombatObj = this.customCombatObj;
              combatClass = this;
        ...
        if ((double) num31 == 0.0)
          num31 = num31;
        s2: String = "AFTER ALL MODS: Attval=" + Conversion.Str((object) num31) + ", DefVal= " + Conversion.Str((object) num39);
        this.AddDetail(s2);
        string txt;
        if ((double) this.game.Data.RuleVar[431] < 1.0)
        ...
        if (num59 == 1)
        {
          let mut num61: i32 =  (int) Math.Round((double) (Conversion.Int(VBMath.Rnd() * 100f) + 1f));
          ...
          if ((double) this.game.Data.RuleVar[431] > 0.0)
          {
            ...
            if (num66 < 50)
              num66 = 50;
            let mut num67: i32 =  (int) Math.Round(800.0 / (double) (int) Math.Round((double) (this.game.Data.RuleVar[56] - this.game.Data.RuleVar[55])));
            if (this.CombatType == 3)
            {
              if (this.IList[attnr].IAttacker == 1)
              {
        ...
        if (this.IList[attnr].IAttacker == 1 && this.game.Data.SFTypeObj[this.IList[attnr].ISFType].AntiStrucPts > 0 & this.IList[attnr].ILastAttackDone < this.CombatRound && !this.game.HandyFunctionsObj.IsAlliedOrSelf(this.game.Data.MapObj[0].HexObj[this.TargetX, this.TargetY].Regime, this.AttackerRegime))
        {
          if (this.IList[attnr].Istockpile)
          {
            ...
            let mut num76: i32 =  (int) Math.Round(Conversion.Int((double) (int) Math.Round(0.33 * (double) antiStrucPts + 0.66 * (double) antiStrucPts * (double) this.game.HandyFunctionsObj.GetAirFieldStackModifier(this.game.Data.UnitObj[this.IList[attnr].IUnr].X, this.game.Data.UnitObj[this.IList[attnr].IUnr].Y)) * ((double) this.IList[attnr].IRdn / 100.0)));
            if (num76 == 0 && (double) VBMath.Rnd() < (double) this.IList[attnr].IRdn / 100.0)
              num76 = 1;
            let mut Number7: i32 =  (int) Math.Round((double) (int) Math.Round((double) VBMath.Rnd() * ((double) num76 + 0.5)) / (double) (this.IList[attnr].AttackedCount + 1));
        ...
        {
          str16: String = this.game.Data.SFTypeObj[this.IList[attnr].ISFType].Name + "(" + Strings.Trim(Conversion.Str((object) this.IList[attnr].IID)) + ")";
          str17: String = this.game.Data.SFTypeObj[this.IList[defnr].ISFType].Name + "(" + Strings.Trim(Conversion.Str((object) this.IList[defnr].IID)) + ")";
          if (this.IList[attnr].IvisibleFromRound > this.CombatRound && this.game.Data.UnitObj[this.IList[attnr].IUnr].Regime != this.game.Data.Turn)
          {
    ...
    pub int FindPreventer(int defnr, int attnr)
    {
      ...
      if (this.game.Data.Product != 7 && this.game.Data.SFTypeObj[isfType2].ArtRange > 0 || (double) this.game.Data.RuleVar[493] > 0.0 && this.IList[defnr].IleftOutOfPartialAttack)
        return defnr;
      let mut num2: i32 =  (int) Math.Round((double) Conversion.Int(VBMath.Rnd() * (float) this.ICounter)) + 1;
        ...
        if (this.IList[index2].IAttacker == iattacker & (this.IList[index2].IRetreatMode == 0 | this.IList[defnr].IRetreatMode > 0 & this.IList[index2].IRetreated == 0) & this.IList[index2].IKilled == 0)
        {
          ...
          if (this.game.Data.UnitObj[this.IList[index2].IUnr].X == this.game.Data.UnitObj[this.IList[defnr].IUnr].X & this.game.Data.UnitObj[this.IList[index2].IUnr].Y == this.game.Data.UnitObj[this.IList[defnr].IUnr].Y | this.game.Data.SFTypeObj[this.IList[index2].ISFType].Theater >= 2 && this.IList[index2].AttackedCount < this.game.Data.SFTypeObj[isfType4].MaxAttacked | this.game.Data.SFTypeObj[isfType4].MaxPreventPointsUsed >= 9999)
          {
            ...
            for (let mut index3: i32 =  0; index3 <= preventCounter; index3 += 1)
            {
              ...
              {
                let mut num4: i32 =  (int) Math.Round((double) (100f * VBMath.Rnd()));
      ...
      if (preventer > -1)
      {
        if (preventer > -1 & this.game.Data.SFTypeObj[this.IList[preventer].ISFType].PreventChance[index1] > 0)
        {
          ...
          let mut Number1: i32 =  (int) Math.Round((double) (VBMath.Rnd() * 100f));
          let mut Number2: i32 =  this.game.Data.SFTypeObj[this.IList[preventer].ISFType].PreventChance[index1];
          str1: String = this.game.Data.SFTypeObj[this.IList[defnr].ISFType].Name + "(" + Strings.Trim(Conversion.Str((object) this.IList[defnr].IID)) + ")";
          str2: String = this.game.Data.SFTypeObj[this.IList[attnr].ISFType].Name + "(" + Strings.Trim(Conversion.Str((object) this.IList[attnr].IID)) + ")";
          str3: String = this.game.Data.SFTypeObj[this.IList[preventer].ISFType].Name + "(" + Strings.Trim(Conversion.Str((object) this.IList[preventer].IID)) + ")";
          str4: String = "Roll required to be lower or equal then " + Conversion.Str((object) Number2) + ". roll was " + Conversion.Str((object) Number1) + ". PreventPointsGiven to " + str1 + ": " + Conversion.Str((object) this.IList[defnr].IPreventPointsGiven) + ". PreventPointsUsed for " + str3 + ": " + Conversion.Str((object) this.IList[preventer].IPreventPointsUsed) + ". ";
          if (Number1 < Number2)
          {
        ...
        if (num2 > 0 & !this.previewMode)
        {
          ...
          for (let mut index1: i32 =  0; index1 <= regimeCounter; index1 += 1)
          {
            if (this.game.HandyFunctionsObj.IsAlliedOrSelf(this.AttackerRegime, index1))
            {
              ...
              let mut num3: i32 =  (int) Math.Round((double) hexObj[targetX, targetY].get_BattlePenalty(Index1) + Math.Max(1.0, (double) this.game.Data.RuleVar[325] * Math.Min((double) num2 / 100.0, 1.0)));
        ...
        for (let mut index4: i32 =  0; index4 <= icounter6; index4 += 1)
        {
          ...
          while (num11 == 1)
          {
            ...
            if (flag1 && this.game.Data.SFTypeObj[this.IList[index4].ISFType].AntiStrucPts > 0 && this.IList[index4].IAttacker == 1 && this.IList[index4].ILastAttackDone < this.CombatRound && !this.game.HandyFunctionsObj.IsAlliedOrSelf(this.game.Data.MapObj[0].HexObj[this.TargetX, this.TargetY].Regime, this.AttackerRegime))
            {
              ...
              let mut num13: i32 =  (int) Math.Round(Conversion.Int((double) this.game.Data.SFTypeObj[this.IList[index4].ISFType].AntiStrucPts * ((double) this.IList[index4].IRdn / 100.0)));
              let mut num14: i32 =  (int) Math.Round(0.33 * (double) num13 + 0.66 * (double) num13 * (double) this.game.HandyFunctionsObj.GetAirFieldStackModifier(this.game.Data.UnitObj[this.IList[index4].IUnr].X, this.game.Data.UnitObj[this.IList[index4].IUnr].Y));
              if (num14 == 0 && (double) VBMath.Rnd() < (double) this.IList[index4].IRdn / 100.0)
                num14 = 1;
              let mut Number2: i32 =  (int) Math.Round((double) (int) Math.Round((double) VBMath.Rnd() * ((double) num14 + 0.5)) / (double) (this.IList[index4].AttackedCount + 1));
              ...
              if ((double) this.game.Data.RuleVar[435] > 0.0)
              {
                if (((!this.game.EditObj.CombatSim ? 1 : 0) & 0) != 0)
                {
                  ...
                  let mut index11: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[435]);
                  let mut attackerRegime: i32 =  this.AttackerRegime;
                  if (Number1 > 0)
                  {
              ...
              for (let mut index7: i32 =  1; index7 <= num11; index7 += 1)
              {
                ...
                if ((double) this.game.Data.RuleVar[431] > 0.0)
                {
                  if ((double) this.game.Data.RuleVar[419] > 0.0)
                  {
                    ...
                    if (this.CombatType == 3 | this.CombatType == 4)
                    {
                      let mut maxValue: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[55]) + (int) Math.Round((double) ((int) Math.Round((double) this.game.Data.RuleVar[56]) - (int) Math.Round((double) this.game.Data.RuleVar[55])) / 2.0);
                    ...
                    let mut num14: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[56]);
                    ...
                    let mut num15: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[55]) + (int) Math.Round((double) ((int) Math.Round((double) this.game.Data.RuleVar[56]) - (int) Math.Round((double) this.game.Data.RuleVar[55])) / 2.0) + this.GetIndividualHide(this.ICounter);
                ...
                if (this.game.Data.SFTypeObj[this.game.Data.SFObj[sf].Type].DepletingHitpointRule > 0)
                {
                  ...
                  if ((double) this.game.Data.RuleVar[407] > 0.0)
                  {
                    let mut index14: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 2;
                    let mut index15: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 3;
                    let mut index16: i32 =  (int) Math.Round((double) this.game.Data.RuleVar[407]) + 4;
          ...
          if (this.IList[index3].IAttacker == 1 && !(this.CombatType == 12 | this.CombatType == 10) & !this.IList[index3].IParadropper)
          {
            ...
            if (this.game.Data.SFTypeObj[isfType].FuelForMove > 0 & this.game.Data.SFTypeObj[isfType].FuelRegimeVar > -1)
            {
              ...
              if ((double) this.game.Data.RuleVar[435] <= 0.0)
              {
                ...
                let mut num5: i32 =  (int) Math.Round((double) this.game.Data.SFTypeObj[isfType].FuelForMove * ((double) num4 / 10.0));
    ...
    pub void CheckPanicUnitRetreat()
    {
      ...
      for (let mut fromy: i32 =  0; fromy <= ucounter; fromy += 1)
      {
        ...
        if (num1 > 0 | num2 > 0 && this.UList[fromy].URetreat == 0)
        {
          ...
          str1: String = "If % of troops left gets below " + Strings.Trim(Conversion.Str((object) Math.Round(new Decimal(num1), 1))) + "% then panic test must be made." + "\r\n";
          if ((double) this.game.Data.RuleVar[996] == 1.0)
          ...
          str2: String = str1 + "Current % of troops left is " + Strings.Trim(Conversion.Str((object) Math.Round((double) (num4 * 100) / (double) num3))) + "%.";
          string str3;
        ...
        if (this.UList[fromy].URetreat == this.CombatRound & this.UList[fromy].Uattacker == 0 & !this.game.Data.UnitObj[this.UList[fromy].UNr].IsHQ)
        {
          ...
          if (this.game.Data.Product >= 6 && this.UList[fromy].URetreatMode != 5)
          {
            ...
            if (this.game.Data.Product == 6 && this.UList[fromy].URetreatMode > 0)
            {
              ...
              {
                let mut num2: i32 =  (int) Math.Round((double) ((float) (100 * num1) / this.game.Data.RuleVar[476]));
          ...
          if (flag)
          {
            ...
            if (num3 > 0)
            {
              ...
              let mut Number1: i32 =  (int) Math.Round(Conversion.Int((double) num4 / (double) num3));
    ...
    pub void CheckVictory()
    {
      ...
      if (num3 == 0 | num1 == 0)
      {
        ...
        if (this.CombatType == 6)
        {
          ...
          for (let mut inr: i32 =  0; inr <= icounter3; inr += 1)
          {
            ...
            {
              let mut num4: i32 =  (int) Math.Round(Conversion.Int(160.0 * ((double) this.UList[this.IList[inr].IUlistNr].UApMoveCost / 100.0)));
              if (num4 > 160)
                num4 = 160;
              let mut pointstot: i32 =  (int) Math.Round(Conversion.Int((double) (int) Math.Round((double) (VBMath.Rnd() * (float) num4)) / 10.0));
        ...
        if (this.CombatType == 13)
        {
          ...
          for (let mut inr: i32 =  0; inr <= icounter4; inr += 1)
          {
            ...
            {
              let mut num5: i32 =  (int) Math.Round(Conversion.Int(80.0 * ((double) this.UList[this.IList[inr].IUlistNr].UApMoveCost / 100.0)));
              if (num5 > 80)
                num5 = 80;
              let mut pointstot: i32 =  (int) Math.Round(Conversion.Int((double) (int) Math.Round((double) (VBMath.Rnd() * (float) num5)) / 10.0));
              this.AddXp(inr, pointstot);
            }
          }
        }
        if (this.CombatType == 9 | this.CombatType == 14 | this.CombatType == 15)
        {
          ...
          for (let mut inr: i32 =  0; inr <= icounter5; inr += 1)
          {
            ...
            {
              let mut num6: i32 =  (int) Math.Round(Conversion.Int(120.0 * ((double) this.UList[this.IList[inr].IUlistNr].UApMoveCost / 100.0)));
              if (num6 > 120)
                num6 = 120;
              let mut pointstot: i32 =  (int) Math.Round(Conversion.Int((double) (int) Math.Round((double) (VBMath.Rnd() * (float) num6)) / 10.0));
              this.AddXp(inr, pointstot);
            }
          }
        }
      ...
      if ((num3 == 0 | num1 == 0) & this.CombatType == 14)
      {
        ...
        let mut num11: i32 =  (int) Math.Round((double) Conversion.Int((float) num10 / (float) this.game.EditObj.AirSupplyCarry * (float) this.game.EditObj.AirSupplyPts));
        int num12;
    ...
    pub void CombatLogBattles(int tBattleEnded)
    {
      ...
      if (tBattleEnded == 3)
        num = -1;
      let mut stringListById: i32 =  this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[955]));
      if (stringListById == -1)
        return;
    ...
    pub void EndBattle()
    {
      ...
      if (this.BattleEnded > 0)
      {
        ...
        {
          let mut stringListById: i32 =  this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[485]));
          if (stringListById > -1)
          {
    ...
    pub void ReformUnit(int tunr)
    {
      ...
      for (let mut index5: i32 =  0; index5 <= sfCount1; index5 += 1)
      {
        ...
        if (num14 > 0)
        {
          let mut num28: i32 =  (int) Math.Round(Conversion.Int((double) num13 / (double) num14));
          let mut num29: i32 =  (int) Math.Round(Conversion.Int((double) num12 / (double) num14));
          let mut num30: i32 =  (int) Math.Round(Conversion.Int((double) num17 / (double) num14));
          let mut num31: i32 =  (int) Math.Round(Conversion.Int((double) num19 / (double) num14));
          int num32;
          if (this.UList[tunr].Uattacker == 1)
          {
            ...
            let mut num33: i32 =  (int) Math.Round((double) Conversion.Int(Number));
      ...
      if (this.game.Data.Product != 7 & (double) this.game.Data.RuleVar[497] > 0.0 & num3 > 0)
      {
        ...
        let mut num37: i32 =  (double) num36 > 0.25 ? ((double) num36 > 0.33 ? ((double) num36 > 0.5 ? ((double) num36 > 0.66 ? ((double) num36 >= 1.5 ? ((double) num36 >= 2.0 ? ((double) num36 >= 3.0 ? ((double) num36 >= 4.0 ? 4 : 3) : 2) : 1) : 0) : 1) : 2) : 3) : 4;
        let mut num38: i32 =  0;
        ...
        if (num38 != 0)
        {
          ...
          str2: String = (double) num36 >= 1.0 ? str1 + num38.ToString() + "%" : str1 + "+" + num38.ToString() + "%";
          this.AddBiggy(str2);
      ...
      if ((double) this.game.Data.RuleVar[472] > 0.0 & this.game.Data.Product >= 6)
      {
        ...
        {
          let mut num43: i32 =  (int) Math.Round((double) ((uinitialRdn - averageRdn3) * 100) / (double) uinitialRdn) * 2;
          if (num43 > 100)
            num43 = 100;
          if (num43 > 0)
          {
      ...
      if (!((double) this.game.Data.RuleVar[399] > 0.0 & num1 > 0))
        return;
      let mut num47: i32 =  (int) Math.Round((double) (100f * this.game.Data.RuleVar[397] * (float) num1 / (float) num11));
      let mut num48: i32 =  (int) Math.Round(Math.Floor((double) num47 / 1000.0));
          ...
          for (let mut index1: i32 =  0; index1 <= sfCount1; index1 += 1)
          {
            ...
            if (tweight >= 1)
            {
              ...
              do
              {
                ...
                {
                  let mut index3: i32 =  (int) Math.Round(Conversion.Val(this.game.Data.StringListObj[this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[486]))].GetData(0, people, 1)));
                  if (index3 > -1)
                  {
              ...
              if (simpleList2.Weight[index42] > 0)
              {
                ...
                if (flag4)
                {
                  ...
                  for (let mut index44: i32 =  0; index44 <= icounter; index44 += 1)
                  {
                    ...
                    {
                      let mut SfType: i32 =  (int) Math.Round(Conversion.Val(this.game.Data.StringListObj[this.game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.game.Data.RuleVar[486]))].GetData(0, people2, 1)));
    ...
    {
      let mut num: i32 =  (int) Math.Round(Conversion.Int((double) this.IList[inr].IRdn * ((double) percent / 100.0)));
      if (num == 0)
        num = 1;
      Individual[] ilist = this.IList;
      Individual[] individualArray = ilist;
    ...
    {
      let mut num: i32 =  (int) Math.Round(Conversion.Int((double) this.IList[inr].IEntrench * ((double) percent / 100.0)));
      if (num == 0)
        num = 1;
      Individual[] ilist = this.IList;
      Individual[] individualArray = ilist;
    ...
    {
      let mut num: i32 =  (int) Math.Round(Conversion.Int((double) this.IList[inr].IMor * ((double) percent / 100.0)));
      if (num == 0)
        num = 1;
    ...
    pub void AddXp(int inr, int pointstot)
    {
      ...
      if (pointstot > 0)
      {
        ...
        for (let mut index1: i32 =  1; index1 <= num2; index1 += 1)
        {
          ...
          if ((double) a > 0.0 & this.customCombatObj.HasCustumCalls())
          {
            ...
            ref CombatClass local = ref combatClass;
            let mut inr1: i32 =  inr;
            let mut xpToBeGiven: i32 =  (int) Math.Round((double) a);
      ...
      if (num4 == -1)
      {
        let mut pointstot1: i32 =  (int) Math.Round((double) Conversion.Int((float) num1 * this.UList[this.IList[inr].IUlistNr].UStaffXpMod));
      ...
      {
        let mut inr2: i32 =  (int) Math.Round((double) (VBMath.Rnd() * (float) this.ICounter));
        let mut num5: i32 =  0;
        while (num5 < 2)
        {
          inr2 += 1;
          ...
          {
            let mut pointstot2: i32 =  (int) Math.Round((double) Conversion.Int((float) num1 * this.UList[this.IList[inr].IUlistNr].UStaffXpMod));
    ...
    pub void AddXp2(int inr, int pointstot)
    {
      ...
      for (let mut index1: i32 =  1; index1 <= num1; index1 += 1)
      {
        ...
        let mut index3: i32 =  index2;
        individualArray[index3].IXp = (int) Math.Round((double) ((float) ilist[index2].IXp + a));
        let mut num2: i32 =  (int) Math.Round((double) ((float) num2 + a));
        if ((double) this.IList[inr].IXp > (double) this.game.Data.RuleVar[81])
          this.IList[inr].IXp = (int) Math.Round((double) this.game.Data.RuleVar[81]);
      }
    }
    ...
    pub int FindOpponent(int inr)
    {
      ...
      do
      {
        ...
        if (num2 == 1 & flag1 | num2 == 2)
        {
          ...
          do
          {
            let mut index: i32 =  (int) Math.Round((double) Conversion.Int(VBMath.Rnd() * (float) (this.ICounter + 1)));
      ...
      if ((double) this.game.Data.RuleVar[431] > 0.0 & opponent > -1 && this.game.Data.Product != 7)
      {
        ...
        {
          let mut num7: i32 =  (int) Math.Round((double) num5 / 3.0);
    ...
    pub void ThrowInitiative()
    {
      ...
      for (let mut inr: i32 =  0; inr <= icounter; inr += 1)
      {
        if (this.TestAttack(inr))
        {
          ...
          let mut num2: i32 =  (int) Math.Round((double) Conversion.Int(VBMath.Rnd() * (float) num1));
