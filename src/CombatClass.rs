...
namespace WindowsApplication1
{
  pub class CombatClass
  {
    ...
    pub CombatType2: i32;
    pub IDcounter: i32;
    pub const int LANDATTACK = 1;
    pub const int LANDSURPRISE = 11;
    pub const int AIRRECON = 13;
    pub const int SEAATTACK = 2;
    pub const int ARTATTACK = 3;
    pub const int AIRSTRIKE = 5;
    pub const int SEAARTATTACK = 4;
    pub const int BOMB = 6;
    pub const int PARADROP = 9;
    pub const int AMPH = 10;
    pub const int REBEL = 12;
    pub const int AIRSUPPLY = 14;
    pub const int AIRLIFT = 15;
    pub const int AIRBRIDGE = 16;
      ...
      bool tallowHistoryOwnRegime = false)
    {
      ...
      for (int index = 0; index <= mapCounter1; index += 1)
      ...
      for (int index1 = 0; index1 <= mapCounter2; index1 += 1)
      {
      ...
      if (orderResult.OK)
      {
        ...
        if (!this.previewMode && this.CombatType == 5 | this.CombatType == 6 | this.CombatType == 9 | this.CombatType == 13 | this.CombatType == 14 | this.CombatType == 15)
        {
          ...
          for (int index9 = 0; index9 <= unitCounter4; index9 += 1)
          {
          ...
          for (int index16 = 0; index16 <= unitCounter5; index16 += 1)
          {
    ...
    pub void PayForSimplifiedSupplyRules()
    {
      if (this.CombatRound < 1)
        this.CombatRound = 1;
      int ucounter = this.UCounter;
      for (int index1 = 0; index1 <= ucounter; index1 += 1)
      {
        float a1 = 0.0f;
        float a2 = 0.0f;
        int icounter = this.ICounter;
    ...
    pub void PayForLis()
    {
      ...
      int ucounter = this.UCounter;
      for (int index7 = 0; index7 <= ucounter; index7 += 1)
      {
    ...
    pub void InitLis()
    {
      ...
      int ucounter = this.UCounter;
      for (int index6 = 0; index6 <= ucounter; index6 += 1)
      {
        int num1 = 0;
        if (this.CombatType == 5 | this.CombatType == 13)
        ...
        for (int index7 = 0; index7 <= icounter1; index7 += 1)
        {
        ...
        for (int index8 = 0; index8 <= icounter2; index8 += 1)
        {
    ...
    pub void InitSimplifiedSupply()
    {
      ...
      for (int index1 = 0; index1 <= ucounter; index1 += 1)
      {
        ...
        float num4 = 0.0f;
        int icounter1 = this.ICounter;
        for (int index2 = 0; index2 <= icounter1; index2 += 1)
        {
          if (this.IList[index2].IUlistNr == index1)
          {
            bool flag = false;
        ...
        if ((double) this.game.Data.RuleVar[435] < 1.0)
          num7 = 0.0f;
        int icounter2 = this.ICounter;
        for (int index3 = 0; index3 <= icounter2; index3 += 1)
        {
    ...
    pub void DoRound()
    {
      ...
      string txt;
      string str1;
      for (int fromy = 0; fromy <= ucounter1; fromy += 1)
      {
      ...
      int icounter1 = this.ICounter;
      for (int index3 = 0; index3 <= icounter1; index3 += 1)
      {
      ...
      this.FinishStats();
      int icounter2 = this.ICounter;
      for (int index4 = 0; index4 <= icounter2; index4 += 1)
      {
      ...
      for (int index13 = 0; index13 <= icounter3; index13 += 1)
      {
      ...
      for (int fromy = 0; fromy <= ucounter2; fromy += 1)
      {
        if (!this.game.Data.FOWOn | this.game.HandyFunctionsObj.IsAlliedOrSelf(this.game.Data.UnitObj[this.UList[fromy].UNr].Regime, this.game.Data.Turn))
        {
    ...
    pub void PlayRelevantSound()
    {
      ...
      while (index1 == -1 & num1 > 0)
      {
        ...
        int num4 = num3;
        int icounter2 = this.ICounter;
        for (int index2 = num4; index2 <= icounter2; index2 += 1)
        {
      ...
      {
        int icounter3 = this.ICounter;
        for (int index3 = 0; index3 <= icounter3; index3 += 1)
        {
        ...
        while (index1 == -1)
        {
          ...
          for (int index4 = num7; index4 <= icounter4; index4 += 1)
          {
    ...
    pub void CombatReconEndOfRound()
    {
      ...
      int icounter = this.ICounter;
      for (int inr = 0; inr <= icounter; inr += 1)
      {
    ...
    pub void FinishStats()
    {
      ...
      int icounter1 = this.ICounter;
      for (int Number = 0; Number <= icounter1; Number += 1)
      {
      ...
      int icounter2 = this.ICounter;
      for (int Number = 0; Number <= icounter2; Number += 1)
      {
      ...
      else
      {
        ...
        if (counterattack)
        {
          ...
          if (this.game.Data.Product >= 6 && this.game.Data.SFTypeObj[this.IList[attnr].ISFType].Attacks * 2 < this.IList[attnr].ICounterAttacks)
          {
            ...
            for (int index18 = 1; index18 <= num17; index18 += 1)
              num13 *= 0.66f;
          }
        ...
        if (num59 == 1)
        {
          ...
          if ((double) this.game.Data.RuleVar[431] > 0.0)
          {
            ...
            for (int index38 = 0; index38 <= landscapeTypeCounter; index38 += 1)
            {
    ...
    {
      int icounter = this.ICounter;
      for (int islot = 0; islot <= icounter; islot += 1)
      {
    ...
    {
      int ucounter = this.UCounter;
      for (int uslot = 0; uslot <= ucounter; uslot += 1)
      {
      ...
      while (num3 != 1)
      {
        ...
        if (this.IList[index2].IAttacker == iattacker & (this.IList[index2].IRetreatMode == 0 | this.IList[defnr].IRetreatMode > 0 & this.IList[index2].IRetreated == 0) & this.IList[index2].IKilled == 0)
        {
          ...
          if (this.game.Data.UnitObj[this.IList[index2].IUnr].X == this.game.Data.UnitObj[this.IList[defnr].IUnr].X & this.game.Data.UnitObj[this.IList[index2].IUnr].Y == this.game.Data.UnitObj[this.IList[defnr].IUnr].Y | this.game.Data.SFTypeObj[this.IList[index2].ISFType].Theater >= 2 && this.IList[index2].AttackedCount < this.game.Data.SFTypeObj[isfType4].MaxAttacked | this.game.Data.SFTypeObj[isfType4].MaxPreventPointsUsed >= 9999)
          {
            ...
            for (int index3 = 0; index3 <= preventCounter; index3 += 1)
            {
    ...
    pub void DoSteps()
    {
      ...
      {
        int icounter2 = this.ICounter;
        for (int inr = 0; inr <= icounter2; inr += 1)
        {
      ...
      {
        int icounter3 = this.ICounter;
        for (int inr = 0; inr <= icounter3; inr += 1)
        {
      ...
      {
        int icounter4 = this.ICounter;
        for (int inr = 0; inr <= icounter4; inr += 1)
        {
          if (this.TestAttack(inr) && this.game.Data.SFTypeObj[this.IList[inr].ISFType].Theater == 2 && this.IList[inr].IAttacker == 1)
          {
      ...
      if (this.CombatType == 12 | this.CombatType == 1 | this.CombatType == 10 | this.CombatType == 9 | this.CombatType == 3 | this.CombatType == 4 | this.CombatType == 5 | this.CombatType == 6)
      {
        ...
        for (int inr = 0; inr <= icounter5; inr += 1)
        {
      ...
      while (num10 > 0)
      {
        ...
        for (int index4 = 0; index4 <= icounter6; index4 += 1)
        {
          int num11 = 1;
          int Number1 = 0;
      ...
      int ucounter2 = this.UCounter;
      for (int index = 0; index <= ucounter2; index += 1)
      ...
      for (int index1 = 0; index1 <= ucounter2; index1 += 1)
      {
        ...
        if ((double) this.game.Data.RuleVar[419] > 0.0)
        {
          if ((this.CombatType == 3 | flag1) & this.UList[index1].Uattacker == 1)
          {
            ...
            for (int index2 = 0; index2 <= ucounter3; index2 += 1)
          ...
          if ((this.CombatType == 3 | flag1) & this.UList[index1].Uattacker == 0)
          {
            ...
            for (int index3 = 0; index3 <= ucounter4; index3 += 1)
            {
          ...
          if (this.CombatType == 1 & this.UList[index1].Uattacker == 0 & this.UList[index1].USupportInterceptFire)
          {
            ...
            for (int index4 = 0; index4 <= ucounter5; index4 += 1)
            {
          ...
          for (int i1 = 0; i1 <= sfCount1; i1 += 1)
          {
            ...
            if (num1 == 0)
            {
              ...
              if (this.previewMode)
              {
                ...
                reconMinusHide = this.game.HandyFunctionsObj.GetReconMinusHide(unr, this.game.Data.Turn);
              int num11 = num4;
              for (int index7 = 1; index7 <= num11; index7 += 1)
              {
                this += 1.IDcounter;
                this += 1.ICounter;
                ...
                if ((double) this.game.Data.RuleVar[419] > 0.0)
                {
                  if (this.CombatType == 3 & this.UList[index1].Uattacker == 1 | flag2)
                  {
                    if (this.game.Data.SFTypeObj[this.IList[this.ICounter].ISFType].directRange >= maxDist)
                    {
                      ...
                      int num16 = maxDist;
                      for (int index9 = 2; index9 <= num16; index9 += 1)
                  ...
                  else if ((this.CombatType == 3 | flag1) & this.UList[index1].Uattacker == 0 & !this.InterceptFire)
                  {
                    ...
                    for (int index10 = 0; index10 <= ucounter6; index10 += 1)
                    {
                      if (this.UList[index10].Uattacker == 1)
                      {
                        ...
                        if (this.game.Data.SFTypeObj[this.IList[this.ICounter].ISFType].directRange >= num17)
                        {
                          ...
                          int num18 = num17;
                          for (int index11 = 2; index11 <= num18; index11 += 1)
                  ...
                  else if (this.CombatType == 1 & this.UList[index1].Uattacker == 0 & this.UList[index1].USupportInterceptFire)
                  {
                    ...
                    for (int index12 = 0; index12 <= ucounter7; index12 += 1)
                    {
                      if (this.UList[index12].Uattacker == 1)
                      {
                        ...
                        if (this.game.Data.SFTypeObj[this.IList[this.ICounter].ISFType].directRange >= num19)
                        {
                          ...
                          int num20 = num19;
                          for (int index13 = 2; index13 <= num20; index13 += 1)
    ...
    pub void CheckOutOfAP()
    {
      ...
      if (num1 == 0)
        return;
      int ucounter = this.UCounter;
      for (int fromy = 0; fromy <= ucounter; fromy += 1)
      {
        ...
        if (this.UList[fromy].URetreat == 0 & this.UList[fromy].Uattacker == 0)
        {
          if (this.CombatType == 9 & this.CombatRound == 5)
          {
            if (this.UList[fromy].UDefIntercept)
            {
              ...
              int icounter2 = this.ICounter;
              for (int index = 0; index <= icounter2; index += 1)
              {
            ...
            int icounter3 = this.ICounter;
            for (int index = 0; index <= icounter3; index += 1)
            {
          ...
          if (this.UList[fromy].UApSpend + 10 > this.UList[fromy].UMaxApToSpend)
          {
            ...
            int icounter4 = this.ICounter;
            for (int index = 0; index <= icounter4; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
        ...
        if (this.UList[fromy].URetreat == 0 & this.UList[fromy].Uattacker == 1)
        {
          if (this.UList[fromy].UApSpend + 10 > this.UList[fromy].UMaxApToSpend)
          {
            this.AddReport(0, "Unit out of AP", "Unit retreats due to being out of AP.", fromy, this.CombatRound);
            int icounter5 = this.ICounter;
            for (int index = 0; index <= icounter5; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
          ...
          if ((this.CombatType == 13 | this.CombatType == 14 | this.CombatType == 15) & this.CombatRound == num3)
          {
            this.AddReport(0, "Unit out of AP", "Unit retreats due to max combatrounds for this engagement type reached.", fromy, this.CombatRound);
            int icounter6 = this.ICounter;
            for (int index = 0; index <= icounter6; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
          ...
          if (this.CombatType == 11 & this.CombatRound == 2)
          {
            ...
            for (int index = 0; index <= icounter7; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
          ...
          if (this.InterceptFire & this.CombatRound >= (int) Math.Round((double) (this.game.Data.RuleVar[428] / 2f)))
          {
            ...
            for (int index = 0; index <= icounter8; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
          ...
          if (this.CombatType == 9 & this.CombatRound == 5)
          {
            ...
            if (!this.UList[fromy].UParadropper)
            {
              ...
              for (int index = 0; index <= icounter9; index += 1)
              {
                if (this.IList[index].IUnr == this.UList[fromy].UNr)
                {
                  this.IList[index].IRetreat = this.CombatRound;
        ...
        else
        {
          if (this.UList[fromy].USupportInterceptFire & this.CombatRound >= (int) Math.Round((double) (this.game.Data.RuleVar[428] / 2f)))
          {
            ...
            for (int index = 0; index <= icounter10; index += 1)
            {
              if (this.IList[index].IUnr == this.UList[fromy].UNr)
              {
                this.IList[index].IRetreat = this.CombatRound;
    ...
    pub void CheckSafeRetreat()
    {
      ...
      int icounter2 = this.ICounter;
      for (int index1 = 0; index1 <= icounter2; index1 += 1)
      {
    ...
    pub void FillEditObjHisLoss(int forReg = -1)
    {
        ...
        for (int index1 = 0; index1 <= icounter; index1 += 1)
        {
          ...
          try
          {
            if (this.game.EditObj.HisLossCounter > -1)
            {
              ...
              for (int index2 = 0; index2 <= hisLossCounter; index2 += 1)
              {
      ...
      {
        int icounter = this.ICounter;
        for (int index7 = 0; index7 <= icounter; index7 += 1)
        {
          ...
          try
          {
            ...
            {
              int hisLossCounter = this.game.EditObj.HisLossCounter;
              for (int index8 = 0; index8 <= hisLossCounter; index8 += 1)
              {
      ...
      if (num3 == 0 | num1 == 0)
      {
        ...
        if (!this.game.EditObj.CombatSim && dam > 0)
        {
          ...
          if (this.game.Data.MapObj[this.game.EditObj.MapSelected].HexObj[this.TargetX, this.TargetY].Location == -1 & location1 != -1)
          {
            ...
            int ucounter = this.UCounter;
            for (int tunr = 0; tunr <= ucounter; tunr += 1)
            {
    ...
    pub void EndBattle()
    {
      ...
      if (this.BattleEnded > 0)
      {
        ...
        if ((double) this.game.Data.RuleVar[485] > 0.0 & (this.CombatType == 3 | this.CombatType == 4))
        {
          ...
          if (stringListById > -1)
          {
            ...
            int ucounter1 = this.UCounter;
            for (int index1 = 0; index1 <= ucounter1; index1 += 1)
            {
              if (this.UList[index1].Uattacker == 1 & !flagArray[index1] & this.UList[index1].UNr > -1)
              {
                ...
                bool flag2 = false;
                int ucounter2 = this.UCounter;
                for (int index2 = 0; index2 <= ucounter2; index2 += 1)
                {
        ...
        int ucounter3 = this.UCounter;
        for (int index4 = 0; index4 <= ucounter3; index4 += 1)
        {
        ...
        int ucounter4 = this.UCounter;
        for (int index = 0; index <= ucounter4; index += 1)
        {
        ...
        int ucounter5 = this.UCounter;
        for (int index = 0; index <= ucounter5; index += 1)
        {
        ...
        int ucounter6 = this.UCounter;
        for (int index = 0; index <= ucounter6; index += 1)
        {
        ...
        int ucounter7 = this.UCounter;
        for (int index = 0; index <= ucounter7; index += 1)
        {
          if (this.UList[index].UDead == 0)
          {
        ...
        if (this.game.Data.Turn == this.AttackerRegime)
        {
          ...
          for (int index10 = 0; index10 <= ucounter8; index10 += 1)
          {
          ...
          for (int index11 = 0; index11 <= ucounter9; index11 += 1)
          {
        ...
        if (this.game.Data.Product == 6)
        {
          ...
          for (int index = 0; index <= ucounter10; index += 1)
          {
            int unr = this.UList[index].UNr;
        ...
        if (this.CombatType == 11)
        {
          ...
          for (int index = 0; index <= ucounter11; index += 1)
          {
        ...
        for (int index = 0; index <= ucounter12; index += 1)
        {
        ...
        for (int unitCounter = this.game.Data.UnitCounter; unitCounter >= 0; unitCounter += -1)
        {
          ...
          else
          {
            ...
            for (int index = 0; index <= ucounter13; index += 1)
            {
        ...
        if (!(this.CombatType == 3 | this.CombatType == 4 | this.CombatType == 13) && (double) this.game.Data.RuleVar[431] < 1.0)
        {
          ...
          int regimeCounter = this.game.Data.RegimeCounter;
          for (int index14 = 0; index14 <= regimeCounter; index14 += 1)
          {
      ...
      int mapCounter = this.game.Data.MapCounter;
      for (int map = 0; map <= mapCounter; map += 1)
      {
      ...
      for (int reg2 = 0; reg2 <= regimeCounter1; reg2 += 1)
      {
    ...
    pub void ReformUnit(int tunr)
    {
      ...
      int num11 = 0;
      int sfCount1 = this.game.Data.UnitObj[unr].SFCount;
      for (int index5 = 0; index5 <= sfCount1; index5 += 1)
      {
        int sf = this.game.Data.UnitObj[unr].SFList[index5];
        int num12 = 0;
        int num13 = 0;
      ...
      if (this.game.Data.Product >= 6 && 3 == this.CombatType && this.UList[tunr].Uattacker == 0)
      {
        ...
        for (int index26 = 0; index26 <= sfCount2; index26 += 1)
        {
      ...
      if (this.game.Data.Product != 7 & (double) this.game.Data.RuleVar[497] > 0.0 & num3 > 0)
      {
        ...
        int num38 = 0;
        int num39 = num37;
        for (int index27 = 1; index27 <= num39; index27 += 1)
        ...
        if (num38 != 0)
        {
          ...
          for (int index28 = 0; index28 <= sfCount3; index28 += 1)
          {
      ...
      if (this.game.Data.Product == 6)
      {
        ...
        for (int index36 = 0; index36 <= sfCount5; index36 += 1)
        {
        ...
        if (num44 < 999)
        {
          ...
          for (int index37 = 0; index37 <= sfCount6; index37 += 1)
      ...
      for (int index38 = 0; index38 <= sfCount7; index38 += 1)
      {
      ...
      for (int index1 = 0; index1 <= sfCount1; index1 += 1)
      {
        ...
        if (this.game.Data.SFTypeObj[this.game.Data.SFObj[sf].Type].Theater > 0)
        {
          if (!this.issfthere(sf))
          {
            ...
            for (int index2 = 1; index2 <= qty; index2 += 1)
            {
              this += 1.ICounter;
              this.IList = (Individual[]) Utils.CopyArray((Array) this.IList, (Array) new Individual[this.ICounter + 1]);
          ...
          {
            int icounter = this.ICounter;
            for (int index27 = 0; index27 <= icounter; index27 += 1)
            {
      ...
      else
      {
        ...
        if (this.game.Data.Product >= 6 & (double) this.game.Data.RuleVar[455] > 0.0)
        {
          ...
          for (int index1 = 0; index1 <= sfCount1; index1 += 1)
          {
            ...
            int icounter = this.ICounter;
            for (int index2 = 1; index2 <= icounter; index2 += 1)
            {
          ...
          for (int index4 = 0; index4 <= counter2; index4 += 1)
          {
            ...
            for (int index5 = 0; index5 <= counter3; index5 += 1)
            {
              ...
              if (num4 == 0)
              {
                ...
                for (int index9 = 0; index9 <= counter5; index9 += 1)
                {
          ...
          for (int index13 = 0; index13 <= counter6; index13 += 1)
          {
          ...
          if (index12 > -1)
          {
            ...
            for (int index14 = 0; index14 <= counter7; index14 += 1)
            {
              if (simpleList2.Weight[index14] > 0)
              {
                bool flag2 = true;
                int counter8 = simpleList1.Counter;
                for (int index15 = 0; index15 <= counter8; index15 += 1)
                {
                ...
                if (flag2)
                {
                  ...
                  if (flag3)
                  {
                    ...
                    for (int index16 = 1; index16 <= qty; index16 += 1)
                    {
                      this += 1.ICounter;
                      this.IList = (Individual[]) Utils.CopyArray((Array) this.IList, (Array) new Individual[this.ICounter + 1]);
                      this.IList[this.ICounter].IAttacker = 0;
            ...
            for (int index42 = 0; index42 <= counter9; index42 += 1)
            {
              if (simpleList2.Weight[index42] > 0)
              {
                ...
                for (int index43 = 0; index43 <= counter10; index43 += 1)
                {
                ...
                if (flag4)
                {
                  ...
                  this.AddReport(1, "Partial Retreat", str, tunr, this.CombatRound);
                  int icounter = this.ICounter;
                  for (int index44 = 0; index44 <= icounter; index44 += 1)
                  {
                    if (this.IList[index44].ISFNr == sf1 & this.IList[index44].IKilled < 1)
                    {
                      ...
                      if (Qty > 0)
                      {
                        ...
                        int num14 = -1;
                        int sfCount2 = this.game.Data.UnitObj[unr].SFCount;
                        for (int index45 = 0; index45 <= sfCount2; index45 += 1)
                        {
            ...
            {
              int sfCount3 = this.game.Data.UnitObj[unr].SFCount;
              for (int index46 = 0; index46 <= sfCount3; index46 += 1)
              {
        ...
        if (flag1)
          return;
        int sfCount = this.game.Data.UnitObj[unr].SFCount;
        for (int index47 = 0; index47 <= sfCount; index47 += 1)
        {
          ...
          {
            int qty = this.game.Data.SFObj[sf].Qty;
            for (int index48 = 1; index48 <= qty; index48 += 1)
            {
              this += 1.ICounter;
              this.IList = (Individual[]) Utils.CopyArray((Array) this.IList, (Array) new Individual[this.ICounter + 1]);
              this.IList[this.ICounter].IAttacker = 0;
          ...
          {
            int icounter = this.ICounter;
            for (int index49 = 0; index49 <= icounter; index49 += 1)
            {
    ...
    pub void AddXp(int inr, int pointstot)
    {
      ...
      {
        int num2 = pointstot;
        for (int index1 = 1; index1 <= num2; index1 += 1)
        {
          float a = 0.0f;
          if ((double) a == 0.0)
          {
    ...
    pub void AddXpUnit(int unr, int pointstot)
    {
      ...
      float Left = 0.0f;
      int sfCount2 = this.game.Data.UnitObj[unr].SFCount;
      for (int index4 = 0; index4 <= sfCount2; index4 += 1)
      {
    ...
    pub void WriteToFileLog()
    {
      ...
      for (int index = 0; index <= allDetailCounter; index += 1)
