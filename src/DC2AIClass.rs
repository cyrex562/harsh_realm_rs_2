...
namespace WindowsApplication1
{
  pub class DC2AIClass
  {
    ...
    pub int[,] VAR_SUPPLY_X;
    pub int[,] VAR_SUPPLY_Y;
    ...
    pub const int STANCE_FULLRETREAT = 4;
    pub const int STANCE_RETREAT = 1;
    pub const int STANCE_HOLD = 2;
    pub const int STANCE_ATTACK = 3;
    pub const int STANCE_RETROGRADE = 5;
    pub const int DIRECTION_NORTH = 1;
    pub const int DIRECTION_NORTHEAST = 2;
    pub const int DIRECTION_SOUTHEAST = 3;
    pub const int DIRECTION_SOUTH = 4;
    pub const int DIRECTION_SOUTHWEST = 5;
    pub const int DIRECTION_NORTHWEST = 6;
    pub const int DIRECTION_ALL = 7;
    pub const int DIRECTION_COUNT = 7;
    pub const int WEIGHT_VERYIMPORTANT = 4000;
    pub const int WEIGHT_IMPORTANT = 1000;
    pub const int WEIGHT_REGULAR = 300;
    pub const int WEIGHT_UNIMPORTANT = 50;
    pub const int WEIGHT_VERYUNIMPORTANT = 10;
    pub const int RESERVE_ASSIGN_COUNT = 4;
    pub const int RESERVE_ASSIGN_ALL = 4;
    pub const int RESERVE_ASSIGN_WEAK = 1;
    pub const int RESERVE_ASSIGN_AVERAGE = 2;
    pub const int RESERVE_ASSIGN_STRONG = 3;
    pub const int RESERVE_ASSIGN_VERYSTRONG = 4;
    pub const int RESERVE_ASSIGN_EXTREMELYSTRONG = 5;
    pub const int ACTION_GETENCIRCLED = 1;
    pub const int ACTION_MAKEENCIRCLEMENT = 2;
    pub const int ACTION_LOSETOWN = 3;
    pub const int ACTION_CONQUERTOWN = 4;
    pub const int CATEGORY_NORMAL = 1;
    pub const int CATEGORY_ARTILLERY = 2;
    pub const int CATEGORY_AIRCOVER = 3;
    pub const int CATEGORY_ENGINEER = 4;
    pub const int CATEGORY_FLAK = 5;
    pub const int CATEGORY_CARGO = 6;
    pub const int CATEGORY_NAVAL = 7;
    pub const int CATEGORY_AIRTRANSPORT = 8;
    pub const int CATEGORY_UNKNOWN = 9;
    pub const int CATEGORY_CORPS = 10;
    pub const int CATEGORY_ARMY = 11;
    pub const int CATEGORY_HIGHCOMMAND = 12;
    pub const int CATEGORY_AIRSUPPORT = 13;
    pub const int CATEGORY_VULNERABLE = 14;
    pub const int CATEGORY_TRANSPORT = 15;
    pub const int ROLESTAFF = 1;
    pub const int ROLELANDCAP = 2;
    pub const int ROLESEACAP = 3;
    pub const int ROLEAIRCAP = 4;
    pub const int ROLEENGINEER = 5;
    pub const int ROLEINFANTRY = 6;
    pub const int ROLEINFANTRYSUPPORT = 7;
    pub const int ROLEARTILLERY = 8;
    pub const int ROLEMOBILIZER = 9;
    pub const int ROLEARMOUR = 10;
    pub const int ROLEPARATROOP = 11;
    pub const int ROLEAA = 12;
    pub const int ROLEFIGHTER = 13;
    pub const int ROLETACTICALBOMBER = 14;
    pub const int ROLESTRATEGICBOMBER = 15;
    pub const int ROLETRANSPORTER = 16;
    pub const int ROLECARGOSHIP = 17;
    pub const int ROLESEASUPRIORITY = 18;
    pub const int ROLERAIDER = 19;
    pub const int FRONTLINE_WEAK = 1;
    pub const int FRONTLINE_AVERAGE = 2;
    pub const int FRONTLINE_STRONG = 3;
    pub const int FRONTLINE_VERYSTRONG = 4;
    pub const int FRONTLINE_EXTREMELYSTRONG = 5;
    pub const int FRONTTYPE_FRONTLINE = 1;
    pub const int FRONTTYPE_RESERVE = 2;
    pub const int FRONTTYPE_RESERVE_ARTILLERY = 3;
    pub const int FRONTTYPE_AIR_SUPPORT = 4;
    pub const int FRONTTYPE_AIR_COVER = 5;
    pub const int FRONTTYPE_ENGINEER = 6;
    pub const int FRONTTYPE_AIR_TRANSPORT = 7;
    pub const int FRONTTYPE_NAVY = 8;
    pub const int FRONTTYPE_CARGO = 9;
    pub const int FRONTTYPE_STRATEGIC_RESERVE = 10;
    pub const int FRONTTYPE_ENCIRCLED = 11;
    pub const int FRONTTYPE_ESCAPE = 12;
    pub const int FRONTTYPE_FLAK = 13;
    pub const int OWNER_NEUTRAL = 0;
    pub const int OWNER_FRIENDLY = 1;
    pub const int OWNER_ENEMY = 2;
    pub const int OWNER_ALLY = 3;
    pub const int THEATER_MOVETYPE_ATTACK = 1;
    pub const int THEATER_MOVETYPE_DEFEND = 2;
    pub const int THEATER_MOVETYPE_FALLBACK = 3;
    pub float[,] combatMatrix;
    pub CustomDC2AICalls CustomCalls;
    pub initExitCode: i32;
     bool TempHexNeighboursSet;

    pub DC2AIClass(GameClass tgame)
    {
    ...
    pub void DynamicOob(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
    ...
    pub void DynamicOobnewUnits(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
      ...
      while (flag & num4 < 20)
      {
        ...
        for (int index3 = 0; index3 <= historicalUnitCounter1; index3 += 1)
        {
        ...
        for (int index4 = 0; index4 <= historicalUnitCounter2; index4 += 1)
        {
          if (index4 == 747)
            index4 = index4;
          if (this.game.Data.HistoricalUnitObj[index4].Model & this.game.Data.HistoricalUnitObj[index4].Type < 5 && this.game.Data.HistoricalUnitObj[index4].TempRegime == this.game.Data.Turn | this.game.Data.HistoricalUnitObj[index4].TempRegime == -1 && simpleList1.FindNr(index4) > -1)
          {
            ...
            int num10 =  Math.Round((double) num5 / (double) Math.Max(1, val2_1));
            int num11 =  Math.Round((double) num6 / (double) Math.Max(1, val2_2));
          ...
          for (int index7 = 0; index7 <= mapWidth; index7 += 1)
          {
            ...
            for (int index8 = 0; index8 <= mapHeight; index8 += 1)
            {
              ...
              if (bmatrix3.Value[index7, index8] > 0)
              {
                ...
                int index11 = index8;
                int index12 = index11;
                int num12 = numArray1[index9, index11] +  Math.Round((double) (VBMath.Rnd() * 500f));
    ...
    pub void DynamicOobmissingUnits(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
      ...
      for (int tdata1 = 0; tdata1 <= historicalUnitCounter3; tdata1 += 1)
      {
      ...
      int counter = simpleList2.Counter;
      for (int index15 = 0; index15 <= counter; index15 += 1)
      {
        ...
        if (unitByHistorical > -1)
        {
          ...
          int num5 =  Math.Round((double) num4 / (double) Math.Max(1, val2));
          ...
          if (num5 > 70)
          {
            ...
            int mapWidth = this.map.MapWidth;
            for (int index19 = 0; index19 <= mapWidth; index19 += 1)
            {
              int mapHeight = this.map.MapHeight;
              for (int index20 = 0; index20 <= mapHeight; index20 += 1)
              {
    ...
    pub void DynamicOobremoveUnits(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
      ...
      for (int index15 = 0; index15 <= historicalUnitCounter4; index15 += 1)
      {
        if (this.game.Data.HistoricalUnitObj[index15].TempRegime == this.game.Data.Turn & this.game.Data.HistoricalUnitObj[index15].Type < 5 & this.game.Data.HistoricalUnitObj[index15].ModelMaster > -1 && numArray5[this.game.Data.HistoricalUnitObj[index15].ModelMaster] > 1)
        {
            ...
            if (this.game.Data.HistoricalUnitObj[index15].SubParts[index16] > -1)
            {
              ...
              if (unitByHistorical > -1)
              {
                if (this.game.Data.UnitObj[unitByHistorical].SOReplacementPercent > 0)
                {
                  ...
                  int num8 =  Math.Round((double) startPower * ((double) breakPercent / 100.0));
                  int num9 = startPower != 0 ? Math.Min(100,  Math.Round((double) powerPtsAbsolute / (double) startPower * 100.0)) : 100;
                  num5 += 1;
                  num4 += num9;
                }
          ...
          if (num5 > 0)
          {
            int num10 =  Math.Round((double) num4 / (double) num5);
            int num11 =  Math.Round((double) num6 / (double) num7);
    ...
    pub void DynamicOobNewCorps(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
      if (!this.VAR_USE_DYNAMIC_OOB || !this.VAR_USE_ADD_UNIT)
        return;
      ...
      int historicalUnitCounter1 = this.game.Data.HistoricalUnitCounter;
      for (int tid = 0; tid <= historicalUnitCounter1; tid += 1)
      {
      ...
      for (int index1 = 0; index1 <= counter; index1 += 1)
      {
        if (simpleList2.FindNr(simpleList1.Id[index1]) > -1)
        {
          ...
          int historicalUnitCounter2 = this.game.Data.HistoricalUnitCounter;
          for (int index3 = 0; index3 <= historicalUnitCounter2; index3 += 1)
          {
          ...
          int historicalUnitCounter3 = this.game.Data.HistoricalUnitCounter;
          for (int index4 = 0; index4 <= historicalUnitCounter3; index4 += 1)
          {
          ...
          if (this.GetOfficerFromOfficerPool(this.game.Data.HistoricalUnitObj[index2].People) > -1 | (double) this.game.Data.RuleVar[934] > 0.0)
          {
            ...
            if (requiredForAllUnits > 60 & averageHqPower < 66 | requiredForAllUnits > 120 & this.NeedCorps() | requiredForAllUnits > 60 & this.NeedCorps(2))
            {
              ...
              for (int index5 = 0; index5 <= mapWidth1; index5 += 1)
              {
                int mapHeight = this.map.MapHeight;
              ...
              for (int index7 = 0; index7 <= mapWidth2; index7 += 1)
              {
                int mapHeight = this.map.MapHeight;
                for (int index8 = 0; index8 <= mapHeight; index8 += 1)
                {
    ...
    pub NeedCorps: bool(int corpsmulti = 1)
    {
      int unitCounter1 = this.game.Data.UnitCounter;
      int num1;
    ...
    pub NeedArmy: bool(int armymulti = 1)
    {
      int unitCounter1 = this.game.Data.UnitCounter;
      int num1;
      for (int unr = 0; unr <= unitCounter1; unr += 1)
            ...
            for (int index2 = 0; index2 <= mapWidth; index2 += 1)
            {
              ...
              for (int index3 = 0; index3 <= mapHeight; index3 += 1)
              {
                if ((double) modifier >= 0.0)
                {
                  ...
                  int index6 = index3;
                  int index7 = index6;
                  int num = numArray1[index4, index6] +  Math.Round((double) ((float) aiMatrix.Value[index2, index3] * modifier));
                ...
                else
                {
                  ...
                  int index10 = index3;
                  int index11 = index10;
                  int num = numArray3[index8, index10] +  Math.Round((double) ((float) aiMatrix.Value[index2, index3] * modifier));
      ...
      float modifier)
    {
      ...
      for (int index1 = 0; index1 <= mapWidth; index1 += 1)
      {
        ...
        for (int index2 = 0; index2 <= mapHeight; index2 += 1)
        {
          int num1 = enemyDist.Value[index1, index2] <= 0 ? -9999 :  Math.Round((double) ((float) Math.Max(0, maxDist + 1 - enemyDist.Value[index1, index2]) * modifier));
          int[,] numArray1 = bmatrix.Value;
          int[,] numArray2 = numArray1;
          int index3 = index1;
          int index4 = index3;
    ...
    pub int GetOfficerFromOfficerPool(int ppl)
    {
      int historicalUnitCounter = this.game.Data.HistoricalUnitCounter;
      for (int officerFromOfficerPool = 0; officerFromOfficerPool <= historicalUnitCounter; officerFromOfficerPool += 1)
      {
    ...
    pub int GetPercentageOfModelRequiredForAllUnits(
      int aiRoleType,
      int ppl,
      int addNeedsForHis,
    ...
    pub void ExecuteChangeHQ(bool doLog, bool Early)
    {
    ...
    pub void ExecuteMoveArmy(bool doLog, bool Early)
    {
      ...
      if (simpleList1.Counter > -1)
      {
        ...
        for (int index9 = 0; index9 <= counter; index9 += 1)
        {
          ...
          if (unitByHistorical > -1)
          {
            ...
            int index10;
            for (int tdata1 = 0; tdata1 <= mapWidth3; tdata1 += 1)
            {
              int mapHeight = this.map.MapHeight;
              for (index10 = 0; index10 <= mapHeight; index10 += 1)
              {
                if (this.game.EditObj.TempValue[0].Value[tdata1, index10] <= lowestAp)
                {
                  ...
                  int num4 = 0;
                  int unitCounter2 = this.game.Data.UnitCounter;
                  for (int index11 = 0; index11 <= unitCounter2; index11 += 1)
                  {
                  ...
                  int num6 =  Math.Round((double) num4 / (double) num3);
                  int tweight = num1;
                  tweight += num2;
                  tweight += num6;
    ...
    pub void ExecuteMoveCorps(bool doLog, bool Early)
    {
      bool[] flagArray = new bool[this.game.Data.UnitCounter + 1];
      ...
      int mapWidth1 = this.map.MapWidth;
      for (int index4 = 0; index4 <= mapWidth1; index4 += 1)
      {
        int mapHeight = this.map.MapHeight;
      ...
      if (simpleList1.Counter > -1)
      {
        ...
        for (int index7 = 0; index7 <= counter; index7 += 1)
        {
          ...
          if (unr > -1)
          {
            ...
            int num6 = 0;
            int unitCounter2 = this.game.Data.UnitCounter;
            for (int index9 = 0; index9 <= unitCounter2; index9 += 1)
            {
            ...
            for (int index10 = 0; index10 <= mapWidth2; index10 += 1)
            {
              ...
              for (int index11 = 0; index11 <= mapHeight; index11 += 1)
              {
                if (this.game.EditObj.TempValue[0].Value[index10, index11] <= num1)
                {
                  ...
                  for (int index12 = 0; index12 <= unitCounter3; index12 += 1)
                  {
            ...
            {
              int num13 = num6 <= 0 ? -1 :  Math.Round((double) num5 / (double) num6);
    ...
    pub int GetAverageHQDistance(int x, int y, int forhq)
    {
      int val2 = 0;
      int num1 = 0;
      int unitCounter = this.game.Data.UnitCounter;
    ...
    pub int GetAverageSameHQFrontlineUnits(int forunr, int forhq, ref AIMatrix enemyDistance)
    {
      ...
      for (int index1 = 0; index1 <= unitCounter1; index1 += 1)
      {
        if (this.game.Data.UnitObj[index1].Historical == this.game.Data.UnitObj[forunr].Historical)
        {
          ...
          {
            int unitCounter2 = this.game.Data.UnitCounter;
            for (int index2 = 0; index2 <= unitCounter2; index2 += 1)
            {
    ...
    pub void ExecuteChangeNormalUnitHQ(bool doLog, bool Early)
    {
          ...
          else
          {
            ...
            if (historical > -1 & (this.game.Data.UnitObj[index3].DidMove | this.game.Data.UnitObj[index3].DidAttack | this.game.HandyFunctionsObj.GetLowestAp(index3) > 0) && this.game.Data.HistoricalUnitObj[historical].Type < 5)
            {
              ...
              else
              {
                ...
                for (int index4 = 0; index4 <= unitCounter4; index4 += 1)
                {
              ...
              for (int index5 = 0; index5 <= counter; index5 += 1)
              {
                ...
                for (int index7 = 0; index7 <= unitCounter5; index7 += 1)
                {
                ...
                int num9 =  Math.Round((double) num8 / (double) num7);
                ...
                int num12 = 0 + Math.Max(-20,  Math.Round((double) (this.GetAverageSameHQFrontlineUnits(index3, index6, ref enemyDistance) - hqFrontlineUnits) / 3.0));
              ...
              if (simpleList2.Counter > -1 && simpleList2.Id[0] != this.game.Data.UnitObj[index3].HQ)
              {
                ...
                for (int index9 = 0; index9 <= unitCounter6; index9 += 1)
                {
      ...
      for (int index = 0; index <= unitCounter7; index += 1)
      {
    ...
    pub void ExecuteChangeCorpsUnitHQ(bool doLog, bool Early)
    {
      bool[] flagArray = new bool[this.game.Data.UnitCounter + 1];
      this.ClearLog();
      ...
      s: String = str2 + "\r\n" + "\r\n" + "Units:";
      int unitCounter3 = this.game.Data.UnitCounter;
      for (int unr1 = 0; unr1 <= unitCounter3; unr1 += 1)
      {
        if (this.VAR_USE_CHANGE_HQ | this.VAR_USE_CHANGE_HQ_IF_NONE & (this.game.Data.UnitObj[unr1].HQ == -1 |  Math.Round((double) this.game.Data.UnitObj[unr1].SupplyInReq / 4.0) > this.game.Data.UnitObj[unr1].SupplyIn) && this.game.Data.UnitObj[unr1].Regime == this.game.Data.Turn & !flagArray[unr1] && this.game.Data.UnitObj[unr1].IsHQ & this.game.Data.UnitObj[unr1].PreDef == -1 & this.game.Data.UnitObj[unr1].X > -1 & this.game.Data.UnitObj[unr1].Historical > -1)
        {
          ...
          if (historical > -1 & (this.game.Data.UnitObj[unr1].DidMove | this.game.Data.UnitObj[unr1].DidAttack | this.game.HandyFunctionsObj.GetLowestAp(unr1) > 0) && this.game.Data.HistoricalUnitObj[historical].Type == 5)
          {
            ...
            else
            {
              ...
              num4 = 0;
              int unitCounter4 = this.game.Data.UnitCounter;
              for (int index2 = 0; index2 <= unitCounter4; index2 += 1)
              {
            ...
            for (int index3 = 0; index3 <= counter; index3 += 1)
            {
              ...
              int num7 = 0;
              int unitCounter5 = this.game.Data.UnitCounter;
              for (int index5 = 0; index5 <= unitCounter5; index5 += 1)
              {
              ...
              int num8 =  Math.Round((double) num7 / (double) num6);
            ...
            if (simpleList2.Counter > -1 && simpleList2.Id[0] != this.game.Data.UnitObj[unr1].HQ)
            {
              ...
              int unitCounter6 = this.game.Data.UnitCounter;
              for (int index7 = 0; index7 <= unitCounter6; index7 += 1)
              {
    ...
    pub void ExecuteChangeArmyUnitHQ(bool doLog, bool Early)
    {
      bool[] flagArray = new bool[this.game.Data.UnitCounter + 1];
      this.ClearLog();
      ...
      str3: String = str2 + "\r\n" + "\r\n" + "Units:";
      int unitCounter3 = this.game.Data.UnitCounter;
      for (int unr = 0; unr <= unitCounter3; unr += 1)
      {
        if (this.VAR_USE_CHANGE_HQ | this.VAR_USE_CHANGE_HQ_IF_NONE & this.game.Data.UnitObj[unr].HQ == -1 && this.game.Data.UnitObj[unr].Regime == this.game.Data.Turn & !flagArray[unr] && this.game.Data.UnitObj[unr].IsHQ & this.game.Data.UnitObj[unr].PreDef == -1 & this.game.Data.UnitObj[unr].X > -1 & this.game.Data.UnitObj[unr].Historical > -1)
        {
          ...
          if (historical > -1 & (this.game.Data.UnitObj[unr].DidMove | this.game.Data.UnitObj[unr].DidAttack | this.game.HandyFunctionsObj.GetLowestAp(unr) > 0) && this.game.Data.HistoricalUnitObj[historical].Type == 6 | this.game.Data.HistoricalUnitObj[historical].Type == 7)
          {
            ...
            else
            {
              ...
              num3 = 0;
              int unitCounter4 = this.game.Data.UnitCounter;
              for (int index = 0; index <= unitCounter4; index += 1)
              {
            ...
            for (int index1 = 0; index1 <= counter; index1 += 1)
            {
              ...
              if (this.game.Data.HistoricalUnitObj[this.game.Data.UnitObj[tid].Historical].Type > this.game.Data.HistoricalUnitObj[historical].Type)
              {
                ...
                int num6 = 0;
                int unitCounter5 = this.game.Data.UnitCounter;
                for (int index2 = 0; index2 <= unitCounter5; index2 += 1)
                {
                ...
                int num7 =  Math.Round((double) num6 / (double) num5);
            ...
            if (simpleList2.Counter > -1 && simpleList2.Id[0] != this.game.Data.UnitObj[unr].HQ)
            {
              ...
              int unitCounter6 = this.game.Data.UnitCounter;
              for (int index4 = 0; index4 <= unitCounter6; index4 += 1)
              {
      ...
      while (index5 <= 3);
      int unitCounter7 = this.game.Data.UnitCounter;
      for (int index8 = 0; index8 <= unitCounter7; index8 += 1)
      {
        if (this.game.Data.UnitObj[index8].Regime == this.game.Data.Turn && this.game.Data.UnitObj[index8].IsHQ & this.game.Data.UnitObj[index8].PreDef == -1 & this.game.Data.UnitObj[index8].X > -1)
        {
          ...
          if (historical1 > -1 && this.game.Data.HistoricalUnitObj[historical1].Type >= 8 && !(this.game.Data.RegimeObj[this.game.Data.Turn].UberRegime > -1 & this.game.Data.RegimeObj[this.game.Data.UnitObj[index8].Regime].UberRegime > -1 & this.game.Data.Turn != this.game.Data.UnitObj[index8].Regime))
          {
            ...
            for (int index9 = 0; index9 <= unitCounter8; index9 += 1)
            {
    ...
    pub void ExecuteOfficerPool(bool doLog)
    {
      ...
      for (int unr = 0; unr <= unitCounter; unr += 1)
      {
        if (this.game.Data.UnitObj[unr].X > -1 & this.game.Data.UnitObj[unr].PreDef == -1 & this.game.Data.UnitObj[unr].IsHQ & this.game.HandyFunctionsObj.GetRegime(this.game.Data.UnitObj[unr].Regime) == this.GetGameDataTurn())
        {
          ...
          int historicalUnitCounter = this.game.Data.HistoricalUnitCounter;
          int num3;
          for (int his = 0; his <= historicalUnitCounter; his += 1)
          {
    ...
    pub float GetCombatMatrixModifierVersusHex(int unr, int x, int y)
    {
      ...
      for (int index1 = 0; index1 <= sfCount1; index1 += 1)
      {
        ...
        for (int index2 = 0; index2 <= unitCounter; index2 += 1)
        {
          ...
          for (int index3 = 0; index3 <= sfCount2; index3 += 1)
          {
    ...
    pub void InitRegimeCards(bool debugOverrule, bool earlyCall = false)
    {
      bool flag = false;
      if (debugOverrule)
        flag = true;
      ...
      int mapWidth2 = this.map.MapWidth;
      for (int index47 = 0; index47 <= mapWidth2; index47 += 1)
      {
        int mapHeight = this.map.MapHeight;
        for (int index48 = 0; index48 <= mapHeight; index48 += 1)
        {
      ...
      int mapWidth3 = this.map.MapWidth;
      for (int index53 = 0; index53 <= mapWidth3; index53 += 1)
      {
        int mapHeight = this.map.MapHeight;
        for (int index54 = 0; index54 <= mapHeight; index54 += 1)
        {
      ...
      for (int x1 = 0; x1 <= mapWidth4; x1 += 1)
      {
        int mapHeight = this.map.MapHeight;
        for (int y1 = 0; y1 <= mapHeight; y1 += 1)
        {
          if (aiMatrix7.Value[x1, y1] > this.VAR_FRONTLINE_DEPTH && this.map.HexObj[x1, y1].UnitCounter > -1 && this.map.HexObj[x1, y1].Regime == this.game.Data.Turn)
          {
            ...
            int num2 = x1 - 6;
            int num3 = x1 + 6;
            for (int x2 = num2; x2 <= num3; x2 += 1)
            {
              int num4 = y1 - 6;
              int num5 = y1 + 6;
              for (int y2 = num4; y2 <= num5; y2 += 1)
              {
                if (x2 >= 0 & y2 >= 0 & x2 <= this.map.MapWidth & y2 <= this.map.MapHeight && this.map.HexObj[x2, y2].Regime == this.game.Data.Turn)
                {
                  ...
                  if (num6 <= 6)
                  {
                    ...
                    int index57 = y2;
                    int index58 = index57;
                    int num7 = numArray25[index55, index57] +  Math.Round((double) (2 * num1) / (double) (num6 + 1));
      ...
      for (int actionCardCounter = this.game.Data.RegimeObj[this.game.Data.Turn].ActionCardCounter; actionCardCounter >= 0; actionCardCounter += -1)
      {
        ...
        if (num8 > 0)
        {
          ...
          int num11 = x2_1 - 6;
          int num12 = x2_1 + 6;
          for (int x1 = num11; x1 <= num12; x1 += 1)
          {
            int num13 = y2_1 - 6;
            int num14 = y2_1 + 6;
            for (int y1 = num13; y1 <= num14; y1 += 1)
            {
              if (x1 >= 0 & y1 >= 0 & x1 <= this.map.MapWidth & y1 <= this.map.MapHeight)
              {
                ...
                if (num15 <= 6)
                {
                  ...
                  int index61 = y1;
                  int index62 = index61;
                  int num16 = numArray27[index59, index61] +  Math.Round((double) (7 - num15) * Math.Max(1.0, (double) (7 - num15) * 1.5));
      ...
      for (int actionCardCounter = this.game.Data.RegimeObj[this.game.Data.Turn].ActionCardCounter; actionCardCounter >= 0; actionCardCounter += -1)
      {
              ...
              if (this.map.HexObj[x, y].AreaCode[this.game.Data.ActionCardObj[cardnr].AreaSlot] == this.game.Data.ActionCardObj[cardnr].AreaValue)
              {
                ...
                for (int index = 0; index <= unitCounter; index += 1)
                {
                  ...
                  if (this.game.HandyFunctionsObj.IsHostileNotSelf(this.game.Data.UnitObj[unit].Regime, this.game.Data.Turn))
                  {
                    ...
                    {
                      int num22 = 100 + this.GetAIRolePercent(unit, 10) * 6 + this.GetAIRolePercent(unit, 8) * 3 +  Math.Round((double) this.GetAIRolePercent(unit, 9) / 2.0);
                      num20 += 1;
                    ...
                    else if (num21 >= 1)
                    {
                      ...
                      int num23 = 100 +  Math.Round((double) aiRolePercent1 / 2.0) +  Math.Round((double) aiRolePercent2 / 2.0);
                ...
                {
                  int num25 =  Math.Round((double) hidePts * 1.33);
                  if (num25 > 100)
                    num25 = 100;
                  num24 =  Math.Round((double) num24 * 0.15) +  Math.Round((double) num24 * 0.85 * (double) (100 - num25) / 100.0);
                }
                int num26 =  Math.Round((double) num24 * 0.25) +  Math.Round((double) num24 * 0.75 * (double) DrawMod.RandyNumber.Next(0, 100) / 100.0);
                if (num26 > num17)
                {
                  num17 = num26;
                  x2_1 = x;
        ...
        if (num17 > 0)
        {
          ...
          int num27 = x2_1 - 6;
          int num28 = x2_1 + 6;
          for (int x1 = num27; x1 <= num28; x1 += 1)
          {
            int num29 = y2_1 - 6;
            int num30 = y2_1 + 6;
            for (int y1 = num29; y1 <= num30; y1 += 1)
            {
              if (x1 >= 0 & y1 >= 0 & x1 <= this.map.MapWidth & y1 <= this.map.MapHeight)
              {
                ...
                if (num31 <= 6)
                {
                  ...
                  int index65 = y1;
                  int index66 = index65;
                  int num32 = numArray29[index63, index65] +  Math.Round((double) (7 - num31) * Math.Max(1.0, (double) (7 - num31) * 1.5));
      ...
      while (num33 > 0)
      {
        ...
        if (num34 == 0)
          num34 = 1;
        int num36 =  Math.Round((double) num35 / (double) num34);
        for (int actionCardCounter = this.game.Data.RegimeObj[this.game.Data.Turn].ActionCardCounter; actionCardCounter >= 0; actionCardCounter += -1)
        {
          ...
          if (this.game.Data.ActionCardObj[tdata1].AILabel == 2 & this.game.Data.ActionCardObj[tdata1].AILabel2 >= 0 & this.game.Data.ActionCardObj[tdata1].aILabel3 >= 0)
          {
            ...
            {
              int num37 =  Math.Round((double) (100 + this.GetPercentageOfModelRequiredForAllUnits2(this.game.Data.ActionCardObj[tdata1].AILabel2, this.game.Data.ActionCardObj[tdata1].aILabel3, 9999, 3)) * ((double) this.game.Data.ActionCardObj[tdata1].PPCost / (double) num36));
              int tweight = (double) VBMath.Rnd() <= 0.5 ?  Math.Round((double) num37 * 0.75) +  Math.Round((double) num37 * 0.25 * (double) VBMath.Rnd()) :  Math.Round((double) num37 * 0.2) +  Math.Round((double) num37 * 0.8 * (double) VBMath.Rnd());
              int sfTypeCounter = this.game.Data.SFTypeCounter;
              int index = 0;
          ...
          {
            int tweight =  Math.Round(100.0 * ((double) this.game.Data.ActionCardObj[tdata1].PPCost / (double) num36));
            simpleList.Add(actionCardCounter, tweight, tdata1);
          }
        }
        simpleList.Sort();
    ...
    pub void InitStrategicPlan(bool debugOverrule)
    {
      bool flag1 = false;
      if (debugOverrule)
        flag1 = true;
      ...
      if (true)
      {
        for (int counter1 = this.frontList.Counter; counter1 >= 0; counter1 += -1)
        {
          if (this.frontList.Front[counter1].FrontType == 1 & this.frontList.Front[counter1].FrontID < 1000000 & !this.frontList.Front[counter1].hasSupplySource && (double) this.frontList.Front[counter1].UnitCountRatio <= 0.27 & this.frontList.Front[counter1].retreatAverageScore <= 150)
          {
            ...
            for (int tid = 0; tid <= counter2; tid += 1)
            {
                ...
                for (int index1 = 0; index1 <= counter3; index1 += 1)
                {
                  if (neighbourFrontList.Id[index1] == this.frontList.Front[counter1].FrontID)
                  {
                    ...
                    if (flag2)
                    {
                      ...
                      {
                        int tweight =  Math.Round((double) ((float) (100 * this.frontList.Front[tid].FrontHexes) / this.frontList.Front[tid].UnitCountRatio));
            ...
            if (simpleList.Counter > -1)
            {
              ...
              for (int index4 = 0; index4 <= counter5; index4 += 1)
              {
      ...
      else
      {
        ...
        for (int index11 = 0; index11 <= counter6; index11 += 1)
        {
        ...
        if ((!this.VAR_USE_STRICT_HQFRONT | this.VAR_USE_STRATEGIC_OPS_WITH_STRICT_HQFRONT) & this.CustomCalls.CustomDoStrategicIterations())
        {
          ...
          while (flag3)
          {
            ...
            for (int index = 0; index <= counter7; index += 1)
            {
            ...
            for (int index16 = 0; index16 <= counter8; index16 += 1)
            {
              ...
              if (!this.frontList.Front[frontNr1].hasSupplySource | !this.VAR_DC4_STRATEGIC_DEFENSE_OF_SUPPLY_SOURCE)
              {
                ...
                if (neighbourFrontList.Counter > -1)
                {
                  ...
                  for (int index17 = 0; index17 <= counter9; index17 += 1)
                  {
            ...
            if (this.VAR_DC4_STRATEGIC_DEFENSE_OF_SUPPLY_SOURCE)
            {
              ...
              for (int index20 = 0; index20 <= counter10; index20 += 1)
              {
              ...
              for (int index23 = 0; index23 <= counter11; index23 += 1)
              {
            ...
            for (int index = 0; index <= counter12; index += 1)
            {
            ...
            if (tactionList.Counter > -1)
            {
              ...
              for (int index = 0; index <= counter13; index += 1)
              {
              ...
              if (treservelist.Counter > -1)
              {
                ...
                for (int index = 0; index <= counter14; index += 1)
                {
        ...
        if (this.CustomCalls.CustomDoStrategicIterations())
        {
          ...
          for (int index26 = 0; index26 <= mapWidth1; index26 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
          ...
          for (int index = 0; index <= counter15; index += 1)
          {
          ...
          for (int index28 = 0; index28 <= mapWidth2; index28 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
          ...
          for (int index = 0; index <= counter16; index += 1)
          {
            float num = (float) this.frontList.Front[index].enemyPower / (float) (1 + Math.Max(0, this.frontList.Front[index].OrigPower));
          ...
          for (int index34 = 0; index34 <= mapWidth3; index34 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
          ...
          for (int index40 = 0; index40 <= mapWidth4; index40 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
            for (int index41 = 0; index41 <= mapHeight; index41 += 1)
            {
          ...
          for (int index = 0; index <= counter17; index += 1)
          {
            float num = (float) this.frontList.Front[index].enemyPower / (float) (1 + Math.Max(0, this.frontList.Front[index].OrigPower));
        ...
        for (int index46 = 0; index46 <= mapWidth5; index46 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
        ...
        if ((!this.VAR_USE_STRICT_HQFRONT | this.VAR_USE_STRATEGIC_OPS_WITH_STRICT_HQFRONT) & this.CustomCalls.CustomDoStrategicIterations())
        {
          ...
          int num3;
          for (int index = 0; index <= counter18; index += 1)
            num3 += this.frontList.Front[index].GetPowerUnderFront();
          int num4 =  Math.Round((double) num3 / (double) this.frontList.Counter);
          this.frontList.ResetStats();
          tai = this;
          ...
          int val2 = 0;
          int mapWidth6 = this.map.MapWidth;
          for (int index48 = 0; index48 <= mapWidth6; index48 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index49 = 0; index49 <= mapHeight; index49 += 1)
            {
          ...
          int tweight =  Math.Round((double) num7 / (double) Math.Max(1, val2));
          this.frontList.ResetStats();
          tai = this;
          ...
          for (int index = 0; index <= counter21; index += 1)
          {
          ...
          for (int index52 = 0; index52 <= counter22; index52 += 1)
          {
          ...
          for (int index55 = 0; index55 <= counter23; index55 += 1)
          {
          ...
          for (int index58 = 0; index58 <= counter24; index58 += 1)
          {
          ...
          while (flag4)
          {
            ...
            for (int index = 0; index <= counter25; index += 1)
            {
              if ((this.frontList.Front[index].FrontType == 2 | this.frontList.Front[index].FrontType == 3) & this.frontList.Front[index].TargetFrontID == 0)
                treservelist.Add(this.frontList.Front[index].FrontID, 100);
            ...
            if (treservelist.Counter > -1)
            {
              ...
              for (int index = 0; index <= counter26; index += 1)
              {
                int initialFrontID = actionList.Id[index];
          ...
          if (num6 <= this.VAR_VP_AT_DEFEAT & this.VAR_VP_AT_DEFEAT > 0)
          {
            ...
            for (int index63 = 0; index63 <= counter27; index63 += 1)
            {
              int num15 = 0;
              int mapWidth7 = this.map.MapWidth;
              for (int index64 = 0; index64 <= mapWidth7; index64 += 1)
              {
                int mapHeight = this.map.MapHeight;
                for (int index65 = 0; index65 <= mapHeight; index65 += 1)
                {
          ...
          for (int index66 = 0; index66 <= counter28; index66 += 1)
          {
            int num16 = 0;
            int mapWidth8 = this.map.MapWidth;
            for (int index67 = 0; index67 <= mapWidth8; index67 += 1)
            {
              int mapHeight = this.map.MapHeight;
              for (int index68 = 0; index68 <= mapHeight; index68 += 1)
              {
        ...
        for (int index69 = 0; index69 <= counter29; index69 += 1)
        {
          if (this.frontList.Front[index69].Stance != 4 && this.frontList.Front[index69].FrontID < 100000 & this.frontList.Front[index69].FrontType == 1)
          {
            ...
            for (int index70 = 0; index70 <= counter30; index70 += 1)
            {
        ...
        for (int index = 0; index <= counter31; index += 1)
        {
    ...
    pub void RejoinEncircled(ref AIFrontList masterplan, ref AIWorld world, ref string strS)
    {
    ...
    pub void SetEncircledFronts(ref AIFrontList masterPlan, ref AIWorld world, ref string strS)
    {
      ...
      for (int index1 = 0; index1 <= counter1; index1 += 1)
      {
        ...
        for (int index3 = 0; index3 <= counter3; index3 += 1)
        {
        ...
        for (int index4 = 0; index4 <= counter4; index4 += 1)
        {
        ...
        if (num2 > 0 &&  Math.Round((double) (num1 * 100) / (double) num2) < 40)
        {
          ...
          for (int index5 = 0; index5 <= counter5; index5 += 1)
          {
          ...
          for (int index6 = 0; index6 <= counter6; index6 += 1)
          {
    ...
    pub void CheckIfEncircledFrontsWantToEscape(ref string strS)
    {
      ...
      for (int index1 = 0; index1 <= counter; index1 += 1)
      {
        ...
        if (aiFront.FrontType == 11 & aiFront.units.counter > -1)
        {
          ...
          int mapWidth2 = this.map.MapWidth;
          for (int index4 = 0; index4 <= mapWidth2; index4 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index5 = 0; index5 <= mapHeight; index5 += 1)
            {
    ...
    pub void ChangePanzersToTopFronts(ref AIFrontList tfrontList, ref AIMatrix fronts)
    {
      bool[] flagArray = new bool[this.game.Data.UnitCounter + 1];
      int unitCounter1 = this.game.Data.UnitCounter;
      for (int unr = 0; unr <= unitCounter1; unr += 1)
      {
        if (this.game.Data.UnitObj[unr].Regime == this.game.Data.Turn && this.game.Data.UnitObj[unr].PreDef == -1 & this.game.Data.UnitObj[unr].TempTopUnit)
        {
          ...
          if (frontNr > 0 && !tfrontList.Front[frontNr].TopOperation && flagArray[unr] | (double) tfrontList.Front[frontNr].AverageStrength > 2.0 & (double) tfrontList.Front[frontNr].UnitCountRatio > 0.66)
          {
            ...
            for (int tid = 0; tid <= counter; tid += 1)
            {
      ...
      bool allowSSHQshuffle)
    {
      ...
      if (allowSSHQshuffle && this.CustomCalls.HasCustumCalls() & this.VAR_USE_STRATEGIC_OPS_WITH_STRICT_HQFRONT & this.VAR_USE_STRICT_HQFRONT)
      {
        ...
        for (int index1 = 0; index1 <= counter2; index1 += 1)
        {
          ...
          if (averageFrontCoordinate.onmap)
          {
                ...
                for (int index3 = 0; index3 <= counter4; index3 += 1)
                {
                  ...
                  if (flag)
                  {
                    ...
                    if (averageUnitsCoordinate.onmap)
                    {
                      ...
                      if (num6 < 32)
                      {
                        int num7 =  Math.Round((double) (simpleList2.Weight[index2] * 1000) / (double) num6);
                        if (front1.units.counter > -1)
                        {
                          int tweight =  Math.Round((double) num7 / Math.Sqrt((double) (front1.units.counter + 1)));
            ...
            int num8 = num2;
            for (int index4 = 1; index4 <= num8; index4 += 1)
            {
      ...
      do
      {
        ...
        for (int index8 = 0; index8 <= counter6; index8 += 1)
        {
          ...
          int num12 =  Math.Round(1.0 + Conversion.Int((double) simpleList1.Weight[index8] / 33.0));
          SimpleList simpleList5 = treservelist.Clone();
          int num13 = 1;
          int counter7 = tfrontList.Counter;
          for (int index9 = 0; index9 <= counter7; index9 += 1)
          {
          ...
          if (num13 == 1)
          {
            for (int counter9 = simpleList5.Counter; counter9 >= 0; counter9 += -1)
            {
              ...
              if (this.VAR_USE_STRICT_HQFRONT)
              {
                ...
                for (int index10 = 0; index10 <= counter10; index10 += 1)
                {
                  int counter11 = tfrontList.Front[frontNr2].strictHQs.counter;
                  for (int index11 = 0; index11 <= counter11; index11 += 1)
                  {
            ...
            for (int index14 = 0; index14 <= counter12; index14 += 1)
            {
              num16 += 1;
              if (num16 <= num12)
              {
            ...
            if (tempFrontList.Front[index8].FrontType == 1 && tempFrontList.Front[index8].Stance != 1 & tempFrontList.Front[index8].Stance != 4 && tempFrontList.Front[index8].Strength == reserveAssign | reserveAssign == 4)
            {
              ...
              if (numArray[index8] < num1 & numArray[index8] <= maxDist)
              {
                ...
                if (this.VAR_USE_STRICT_HQFRONT)
                {
                  ...
                  for (int index10 = 0; index10 <= counter7; index10 += 1)
                  {
    ...
    pub void AssignNavyAndCargoFronts(ref AIFrontList tempFrontList)
    {
      DC2AIClass tai1 = this;
      AIMatrix aiMatrix1 = new AIMatrix(ref tai1);
      DC2AIClass tai2 = this;
          ...
          for (int index4 = 0; index4 <= counter1; index4 += 1)
          {
            ...
            if (aiFront.FrontType == 8 && aiFront.targetX == -1)
            {
              ...
              if (unitByAiid > -1 && this.game.Data.LandscapeTypeObj[this.game.Data.MapObj[0].HexObj[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y].LandscapeType].IsSea | (double) VBMath.Rnd() > 0.5 && aiMatrix4.Value[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y] == index1 && this.game.Data.UnitObj[unitByAiid].Supply > this.game.HandyFunctionsObj.UnitSupplyUse(unitByAiid) * 2 & aiMatrix5.Value[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y] < this.map.HexObj[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y].UnitCounter * 4)
              {
                ...
                for (int tdata3 = 0; tdata3 <= counter2; tdata3 += 1)
                {
                  int tweight =  Math.Round((double) simpleList1.Weight[tdata3] / (double) this.game.HandyFunctionsObj.Distance(this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y, 0, simpleList1.Data1[tdata3], simpleList1.Data2[tdata3], 0, 49));
    ...
    pub void AssignAirCoverFronts(ref AIFrontList tempFrontList)
    {
      int counter1 = tempFrontList.Counter;
      for (int index1 = 0; index1 <= counter1; index1 += 1)
      {
        ...
        if (aiFront1.FrontType == 5 && aiFront1.TargetFrontID < 1)
        {
          ...
          for (int index9 = 0; index9 <= counter3; index9 += 1)
          {
          ...
          int counter4 = tempFrontList.Counter;
          for (int index10 = 0; index10 <= counter4; index10 += 1)
          ...
          for (int index11 = 0; index11 <= mapWidth1; index11 += 1)
          {
            ...
            for (int index12 = 0; index12 <= mapHeight; index12 += 1)
            {
              ...
              if (initialFrontID > 0)
              {
                ...
                if (frontNr > -1)
                {
                  int num1 = aiMatrix3.Value[index11, index12] * (1 +  Math.Round((double) aiMatrix1.Value[index11, index12] / 10.0));
          ...
          int index15 = -1;
          int counter5 = tempFrontList.Counter;
          for (int index16 = 0; index16 <= counter5; index16 += 1)
          {
            if (tempFrontList.Front[index16].FrontType == 1 & tempFrontList.Front[index16].units.counter > -1 & numArray4[index16] > 0)
            {
              int d =  Math.Round((double) numArray3[index16] / (double) numArray4[index16]) + Math.Max(8000 - 200 * tempFrontList.Front[index16].units.counter, 0);
    ...
    pub void AssignAirTransportFronts(ref AIFrontList tempFrontList)
    {
      int counter1 = tempFrontList.Counter;
      for (int index1 = 0; index1 <= counter1; index1 += 1)
      {
          ...
          for (int index2 = 0; index2 <= counter2; index2 += 1)
          {
            ...
            if (index2 != index1 && aiFront2.FrontType == 1 | aiFront2.FrontType == 2 | aiFront2.FrontType == 3)
            {
              ...
              if (aiFront2.units.counter > -1)
              {
                ...
                int num1 =  Math.Round((double) (this.game.Data.UnitObj[unitByAiid].SupplyIn * 100) / (double) Math.Max(this.game.Data.UnitObj[unitByAiid].SupplyInReq, 1));
                if (num1 < 50)
                {
                  int num2 =  Math.Round((double) num1 * ((double) this.game.Data.UnitObj[unitByAiid].SupplyConsume / 100.0));
                  tweight += 100 - num2;
                }
              }
              if (aiFront2.artUnits.counter > -1)
              {
                ...
                x = this.game.Data.UnitObj[unitByAiid].X;
                y = this.game.Data.UnitObj[unitByAiid].Y;
                int num3 =  Math.Round((double) (this.game.Data.UnitObj[unitByAiid].SupplyIn * 100) / (double) Math.Max(this.game.Data.UnitObj[unitByAiid].SupplyInReq, 1));
                if (num3 < 50)
                {
                  int num4 =  Math.Round((double) num3 * ((double) this.game.Data.UnitObj[unitByAiid].SupplyConsume / 100.0));
                  tweight += 100 - num4;
                }
              }
              int num = 0;
    ...
    pub void AssignAirSupportFronts(ref AIFrontList tempFrontList)
    {
      int counter1 = tempFrontList.Counter;
      for (int index1 = 0; index1 <= counter1; index1 += 1)
      {
        ...
        if (aiFront1.FrontType == 4 && aiFront1.TargetFrontID < 1)
        {
          ...
          for (int index16 = 0; index16 <= counter5; index16 += 1)
          {
            ...
            {
              int num4 =  Math.Round((double) numArray3[index16] / (double) numArray4[index16]) + Math.Max(8000 - tempFrontList.Front[index16].units.counter * 200, 0);
              int num5 = tempFrontList.Front[index16].Stance != 3 ? num4 :  Math.Round((double) num4 * 0.25);
    ...
    pub void LogFronts(extraInfo: String = "")
    {
      if (!this.VAR_DEBUG_ON)
        return;
      int unitByAiid;
      ...
      for (int index3 = 0; index3 <= counter7; index3 += 1)
      {
        ...
        if (this.frontList.Front[index3].coordCount > -1)
        {
          ...
          for (int index4 = 0; index4 <= coordCount; index4 += 1)
        ...
        if (this.frontList.Front[index3].artUnits.counter > -1)
        {
          ...
          for (int index6 = 0; index6 <= counter9; index6 += 1)
          {
        ...
        if (this.frontList.Front[index3].orgUnits.counter > -1)
        {
          ...
          for (int index7 = 0; index7 <= counter10; index7 += 1)
          {
        ...
        if (this.frontList.Front[index3].strictHQs.counter > -1)
        {
          ...
          for (int index8 = 0; index8 <= counter11; index8 += 1)
          {
        ...
        for (int index9 = 0; index9 <= counter12; index9 += 1)
        {
          if (this.frontList.Front[index9].TargetFrontID > 0 & this.frontList.Front[index9].TargetFrontID == this.frontList.Front[index3].FrontID)
          {
            ...
            for (int index10 = 0; index10 <= counter13; index10 += 1)
            {
              str8: String = "";
              if (this.game.Data.UnitObj[unitByAiid].HQ > -1)
    ...
    pub void AppendLog(string filename, string texty)
    {
    ...
    pub void Screenshotgrid(ref Graphics g, int width, int height, int left, int top)
    {
      int num1 = width;
    ...
    pub void Screenshot1(ref Graphics g, ref int[,] tObj, int width, int height)
    {
      if (!this.VAR_DEBUG_ON)
        return;
          ...
          for (int y = 0; y <= mapHeight1; y += 1)
          {
            if (aiMatrix1.Value[x, y] == 0 && this.game.HandyFunctionsObj.IsHexPort(x, y, 0) | !needsPort && this.game.HandyFunctionsObj.IsHexHarbourOrSea(x, y, 0) & (this.game.HandyFunctionsObj.IsHexNextToSea(x, y, 0) | !needsPort))
            {
              ...
              while (num2 >= 0)
              {
                bool flag2 = false;
                int mapWidth2 = this.map.MapWidth;
                for (int cx = 0; cx <= mapWidth2; cx += 1)
                {
                  int mapHeight2 = this.map.MapHeight;
                  for (int cy = 0; cy <= mapHeight2; cy += 1)
                  {
        ...
        if (this.game.Data.UnitObj[unr].PreDef == -1 & this.game.Data.UnitObj[unr].X > -1)
        {
          ...
          if (index1 >= 0 & y1 >= 0 & index1 <= width & y1 <= height)
          {
            ...
            if (num2 == 1)
            {
              ...
              {
                int num4 =  Math.Round((double) this.game.Data.UnitObj[unr].TempUnitPowerAbs * ((double) this.game.Data.UnitObj[unr].SupplyConsume / 100.0));
                int num5 = num4 +  Math.Round((double) num4 * ((double) this.game.HandyFunctionsObj.GetAverageDefensiveMod(unr) / 100.0));
              ...
              int num6 =  Math.Round((double) ((float) num3 * num1)) + 10;
            ...
            do
            {
              if (this.TempHexNeighbour[index1, index2, index3].onmap)
              {
                ...
                if (coordinate1.x <= owner.Width & coordinate1.y <= owner.Height && owner.Value[coordinate1.x, coordinate1.y] == 2 | owner.Value[coordinate1.x, coordinate1.y] == 0 && this.game.Data.LandscapeTypeObj[mapClass.HexObj[this.GetRealX(coordinate1.x, owner.Left), coordinate1.y + owner.Top].LandscapeType].AIBlock < 1 && !this.game.Data.LandscapeTypeObj[mapClass.HexObj[this.GetRealX(coordinate1.x, owner.Left), coordinate1.y + owner.Top].LandscapeType].IsSea)
                {
                  ...
                  while (index4 <= 5);
                  int num3 =  Math.Round((double) troops.Value[coordinate1.x, coordinate1.y] / (double) num2);
                  if (num3 > 0)
                    num1 += 1;
            ...
            do
            {
              if (this.TempHexNeighbour[index1, index2, index3].onmap)
              {
                ...
                if (owner.Value[coordinate1.x, coordinate1.y] == 1 | owner.Value[coordinate1.x, coordinate1.y] == 3 && this.game.Data.LandscapeTypeObj[this.game.Data.MapObj[0].HexObj[this.GetRealX(coordinate1.x, owner.Left), coordinate1.y + owner.Top].LandscapeType].AIBlock < 1)
                {
                  ...
                  if (num1 < 1)
                    num1 = 1;
                  int num2 =  Math.Round((double) troops.Value[coordinate1.x, coordinate1.y] / (double) num1) + num1;
      ...
      int FuzzyHexRange)
    {
      ...
      if (this.game.Data.Product == 6)
      {
        int num4 = d <= 0 ? 6000 :  Math.Round((double) num1 / (double) d * Math.Sqrt((double) d));
        int num5 = 0;
        int width = tSupply.Width;
        for (int index8 = 0; index8 <= width; index8 += 1)
        {
          int height = tSupply.Height;
          for (int index9 = 0; index9 <= height; index9 += 1)
          {
            bool flag = false;
            if (!ownFrontUnitsOnly | frontArea.Value[index8, index9] == front.FrontID && tOwner.Value[index8, index9] == 2)
            {
              ...
              if (this.game.Data.MapObj[0].HexObj[index10, index11].Location > -1)
              {
                ...
                if (cityLevel > 0)
                {
                  ...
                  int index14 = index9;
                  int index15 = index14;
                  int num6 = numArray3[index12, index14] +  Math.Round((double) (num4 * cityLevel) / 2.0);
                ...
                do
                {
                  ...
                  if (coordinate2.onmap & coordinate2.x <= tSupply.Width & coordinate2.y <= tSupply.Height && tOwner.Value[coordinate2.x, coordinate2.y] == 1)
                  {
                    ...
                    else if (num8 <= 5)
                    {
                      ...
                      int index31 = index9;
                      int index32 = index31;
                      int num11 = numArray11[index29, index31] +  Math.Round((double) num4 * 1.5);
              ...
              if (this.game.Data.MapObj[0].HexObj[index10, index11].Location > -1)
              {
                ...
                if (num6 > 0)
                {
                  if (tOwner.Value[index8, index9] == 2)
                  {
                    ...
                    int index14 = index9;
                    int index15 = index14;
                    int num7 = numArray3[index12, index14] +  Math.Round((double) (num4 * num6) / 16.0);
                  ...
                  else
                  {
                    ...
                    int index18 = index9;
                    int index19 = index18;
                    int num8 = numArray5[index16, index18] +  Math.Round((double) (num4 * num6) / 8.0);
                ...
                if (this.game.Data.MapObj[0].HexObj[x2, y2].RoadType[index24] > -1)
                {
                  ...
                  if (coordinate2.onmap & coordinate2.x <= tSupply.Width & coordinate2.y <= tSupply.Height && tOwner.Value[coordinate2.x, coordinate2.y] == 1)
                  {
                    ...
                    else if (num10 <= 2)
                    {
                      ...
                      int index31 = index9;
                      int index32 = index31;
                      int num12 = numArray11[index29, index31] +  Math.Round((double) num4 * 0.2);
                    ...
                    else if (num10 <= 5)
                    {
                      ...
                      int index35 = index9;
                      int index36 = index35;
                      int num13 = numArray13[index33, index35] +  Math.Round((double) num4 * 0.05);
    ...
    pub AIMatrix SetAveragedVPMatrix(AIMatrix frontmatrix, int id)
    {
      DC2AIClass tai = this;
          ...
          for (int index2 = 0; index2 <= height; index2 += 1)
          {
            if (frontmatrix.Value[index1, index2] == id && this.game.Data.MapObj[0].HexObj[index1 + frontmatrix.Left, index2 + frontmatrix.Top].Location2 > -1)
            {
              ...
              if (this.game.Data.LocTypeObj[this.game.Data.LocObj[this.game.Data.MapObj[0].HexObj[index1 + frontmatrix.Left, index2 + frontmatrix.Top].Location2].Type].isSupplyBase)
              {
                ...
                int index9 = index2;
                int index10 = index9;
                int num5 = numArray3[index7, index9] + ( Math.Round((double) num3 / 2.0) + num2);
          ...
          for (int cy = 0; cy <= height; cy += 1)
          {
            if (frontmatrix.Value[cx, cy] == id && aiMatrix.Value[cx, cy] > 0)
            {
              ...
              do
              {
                ...
                {
                  int num7 =  Math.Round(Conversion.Int((double) aiMatrix.Value[cx, cy] / 2.0));
      ...
      ref AIFrontList tempList)
    {
      DC2AIClass tai = this;
      AIMatrix aiMatrix = new AIMatrix(ref tai);
      int maxdistance =  Math.Round((double) this.VAR_FRONTLINE_MAX_LENGTH / 2.0) - 1;
      if (maxdistance < 1)
        maxdistance = 1;
      int mapWidth = this.map.MapWidth;
    ...
    pub AIMatrix SetProminantCorpsAddBroadDefZonesAsPointDef(ref AIMatrix tcorps)
    {
      ...
      {
        int mapWidth = this.game.Data.MapObj[0].MapWidth;
        for (int tdata1 = 0; tdata1 <= mapWidth; tdata1 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
          for (int tdata2 = 0; tdata2 <= mapHeight; tdata2 += 1)
          {
        ...
        for (int index5 = 0; index5 <= mapWidth; index5 += 1)
        {
          ...
          for (int index6 = 0; index6 <= mapHeight; index6 += 1)
          {
            ...
            if (index7 > -1)
            {
              ...
              int num6 = 0;
              int num7 = index7;
              for (int index8 = 0; index8 <= num7; index8 += 1)
              {
    ...
    pub AIMatrix SetProminantCorpsOfHexesAndDefZones()
    {
      ...
      {
        int mapWidth1 = this.game.Data.MapObj[0].MapWidth;
        for (int tdata1 = 0; tdata1 <= mapWidth1; tdata1 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
          for (int tdata2 = 0; tdata2 <= mapHeight; tdata2 += 1)
          {
      ...
      for (int index7 = 0; index7 <= mapWidth; index7 += 1)
      {
        ...
        for (int index8 = 0; index8 <= mapHeight; index8 += 1)
        {
          if (this.game.HandyFunctionsObj.IsAlliedOrSelf(this.map.HexObj[index7, index8].Regime, this.game.Data.Turn))
          {
            ...
            for (int index10 = 0; index10 <= unitCounter1; index10 += 1)
            {
              ...
              if (this.game.Data.UnitObj[unit].TempCategory == 1)
              {
                ...
                if (hq > -1)
                {
                  ...
                  if (historical > -1 && this.game.Data.HistoricalUnitObj[historical].Type == 5)
                  {
                    int num5 = -1;
                    int num6 = index9;
                    for (int index11 = 0; index11 <= num6; index11 += 1)
                    {
            ...
            if (index9 == -1 & this.game.Data.Product >= 6)
            {
              ...
              for (int index18 = 0; index18 <= unitCounter2; index18 += 1)
              {
                ...
                if (this.game.Data.UnitObj[unit].TempCategory > 0)
                {
                  ...
                  if (hq > -1)
                  {
                    ...
                    if (historical > -1 && this.game.Data.HistoricalUnitObj[historical].Type > 5)
                    {
                      int num11 = -1;
                      int num12 = index9;
                      for (int index19 = 0; index19 <= num12; index19 += 1)
                      {
                  ...
                  else
                  {
                    ...
                    int index26 = num16;
                    int index27 = index26;
                    int num18 = numArray19[index26] +  Math.Round(1.0 + (double) (this.game.Data.UnitObj[unit].TempUnitPower + this.game.Data.UnitObj[unit].TempUnitPowerAbs) / 2.0);
            ...
            if (index9 > -1)
            {
              ...
              int num20 = 0;
              int num21 = index9;
              for (int index28 = 0; index28 <= num21; index28 += 1)
              {
      ...
      int frontID)
    {
      ...
      for (int index1 = 0; index1 <= width; index1 += 1)
      {
        ...
        for (int index2 = 0; index2 <= height; index2 += 1)
        {
          ...
          if (flag)
          {
            int num = !(enemy.Value[index1, index2] > 0 & friendly.Value[index1, index2] == 0) ? (!(friendly.Value[index1, index2] > 0 & enemy.Value[index1, index2] == 0) ? (!(friendly.Value[index1, index2] == 0 & enemy.Value[index1, index2] == 0) ? Math.Min(998, Math.Max(1,  Math.Round(100.0 * ((double) friendly.Value[index1, index2] / (double) enemy.Value[index1, index2])))) : 999) : 999) : 1;
            if (num == 450)
              num = num;
            aiMatrix.Value[index1, index2] = num;
          }
      ...
      ref AIMatrix owner)
    {
      ...
      for (int index1 = 0; index1 <= mapWidth; index1 += 1)
      {
        ...
        for (int index2 = 0; index2 <= mapHeight; index2 += 1)
        {
          ...
          {
            int num = !(friendly.Value[index1, index2] > 0 & enemy.Value[index1, index2] == 0) ? (!(enemy.Value[index1, index2] > 0 & friendly.Value[index1, index2] == 0) ? (!(enemy.Value[index1, index2] == 0 & friendly.Value[index1, index2] == 0) ? Math.Min(999, Math.Max(1,  Math.Round(100.0 * ((double) enemy.Value[index1, index2] / (double) friendly.Value[index1, index2])))) : 0) : 999) : 1;
            aiMatrix.Value[index1, index2] = num;
          }
        }
      }
    ...
    pub int GetRealX(int tx, int tleft)
    {
      if (!this.map.MapLoop)
        tx += tleft;
    ...
    pub int GetMatrixX(int tx, int tleft)
    {
      if (!this.map.MapLoop)
        tx -= tleft;
      else if (this.map.MapLoop)
    ...
    pub AIMatrix SetOwnerMatrix(int left, int top, int Width, int height)
    {
      DC2AIClass tai = this;
      AIMatrix aiMatrix = new AIMatrix(ref tai, Width, height, top, left);
      bool flag1 = false;
      ...
      ref AIMatrix ownerMatrix)
    {
          ...
          for (int index2 = 0; index2 <= height; index2 += 1)
          {
            ...
            if (ownerMatrix.Value[index1, index2] == 2)
            {
              if (this.game.Data.MapObj[0].HexObj[index1 + aiMatrix1.Left, index2 + aiMatrix1.Top].VP > 0)
              {
                ...
                int index5 = index2;
                int index6 = index5;
                int num = numArray1[index3, index5] +  Math.Round((double) aiMatrix1.Value[index1, index2] * (1.0 + Math.Sqrt((double) this.game.Data.MapObj[0].HexObj[index1 + aiMatrix1.Left, index2 + aiMatrix1.Top].VP)));
                numArray2[index4, index6] = num;
              }
              if (this.game.Data.MapObj[0].HexObj[index1 + aiMatrix1.Left, index2 + aiMatrix1.Top].UnitCounter > 0)
              {
                ...
                int index9 = index2;
                int index10 = index9;
                int num = numArray3[index7, index9] +  Math.Round((double) aiMatrix1.Value[index1, index2] * (1.0 + 0.3 * Math.Sqrt((double) this.game.Data.MapObj[0].HexObj[index1 + aiMatrix1.Left, index2 + aiMatrix1.Top].UnitCounter)));
                numArray4[index8, index10] = num;
              }
            }
          }
      ...
      if (this.game.Data.Product == 6)
      {
        ...
        int width = th.Width;
        for (int index11 = 0; index11 <= width; index11 += 1)
        {
          int height = th.Height;
    ...
    pub AIMatrix SetCenterOfValueAreaMatrix(AIMatrix useMatrix, int useNumber)
    {
      DC2AIClass tai = this;
...
label_10:
    ...
    pub void SetTempUnitPowerAndVarDefensiveMod()
    {
      this.ClearLog();
      ...
      for (int index11 = 0; index11 <= sfTypeCounter1; index11 += 1)
      {
        ...
        if (numArray1[index11, 1] > 0)
        {
          ...
          for (int index19 = 0; index19 <= sfTypeCounter3; index19 += 1)
          {
      ...
      for (int index = 0; index <= sfTypeCounter4; index += 1)
      {
      ...
      for (int index = 0; index <= sfTypeCounter5; index += 1)
      {
      ...
      for (int index = 0; index <= sfTypeCounter6; index += 1)
      {
      ...
      for (int index = 0; index <= sfTypeCounter7; index += 1)
      {
      ...
      for (int unr = 0; unr <= unitCounter2; unr += 1)
      {
        ...
        if ((double) this.game.Data.RuleVar[407] > 0.0 & this.game.Data.Product > 6 & this.game.Data.UnitObj[unr].PreDef == -1)
        {
          ...
          for (int index = 0; index <= sfCount2; index += 1)
          {
            ...
            {
              int num12 = 0;
              int tweight = this.game.Data.SFTypeObj[type].EndCombatRound <= 0 ? num12 + this.game.Data.SFTypeObj[type].SFTypeVar[48] * this.game.Data.SFObj[sf].Qty : num12 +  Math.Round((double) this.game.Data.SFTypeObj[type].SFTypeVar[48] * ((double) this.game.Data.SFTypeObj[type].EndCombatRound / 10.0) * (double) this.game.Data.SFObj[sf].Qty);
              if (tweight > 0)
            ...
            {
              int num13 = 0;
              int tweight = this.game.Data.SFTypeObj[type].EndCombatRound <= 0 ? num13 + this.game.Data.SFTypeObj[type].SFTypeVar[46] * this.game.Data.SFObj[sf].Qty : num13 +  Math.Round((double) this.game.Data.SFTypeObj[type].SFTypeVar[46] * ((double) this.game.Data.SFTypeObj[type].EndCombatRound / 10.0) * (double) this.game.Data.SFObj[sf].Qty);
              if (tweight > 0)
    ...
    pub void SetTempLandscapeDefenseBonus()
    {
      ...
      for (int index1 = 0; index1 <= landscapeTypeCounter; index1 += 1)
      {
        ...
        do
        {
          int num2 = 0;
          int sfTypeCounter = this.game.Data.SFTypeCounter;
          for (int index3 = 0; index3 <= sfTypeCounter; index3 += 1)
          {
          ...
          if (num2 == 1)
          {
            int num3 =  Math.Round((double) ( Math.Round((double) this.game.Data.LandscapeTypeObj[index1].DefBonusMax[index2]) +  Math.Round((double) this.game.Data.LandscapeTypeObj[index1].DefBonus[index2])) / 2.0);
            if (num3 > num1)
              num1 = num3;
          }
          index2 += 1;
    ...
    pub void SetTempRiverDefenseBonus()
    {
      ...
      for (int index1 = 0; index1 <= riverTypeCounter; index1 += 1)
      {
        ...
        do
        {
          ...
          if (num3 == 1)
          {
            int num4 =  Math.Round(100.0 * (1.0 / (1.0 - (double) this.game.Data.RiverTypeObj[index1].AttackPenalty[index2]))) - 100;
            if (num4 < 0)
              num4 = 0;
            num1 += num4;
            num2 += 1;
        ...
        if (num1 > 0)
        {
          int num5 =  Math.Round((double) num1 / (double) num2);
    ...
    pub void SetTempUnitCategories()
    {
      this.ClearLog();
      int unitCounter = this.game.Data.UnitCounter;
      for (int index1 = 0; index1 <= unitCounter; index1 += 1)
    ...
    pub void SetTempUnitGroupCleared()
    {
      int unitCounter = this.game.Data.UnitCounter;
      for (int index = 0; index <= unitCounter; index += 1)
    ...
    pub void MakeTempMovementTypes()
    {
      bool flag = true;
      this.ClearLog();
      if (flag)
    ...
    pub void SetTempMostUsedMovementType()
    {
      SimpleList simpleList = SimpleList::new();
      int unitCounter = this.game.Data.UnitCounter;
      for (int index1 = 0; index1 <= unitCounter; index1 += 1)
    ...
    pub void MakeCombatMatrix(bool tlog)
    {
      ...
      for (int index1 = 0; index1 <= sfTypeCounter1; index1 += 1)
      {
        ...
        int sfTypeCounter2 = this.game.Data.SFTypeCounter;
        for (int index2 = 0; index2 <= sfTypeCounter2; index2 += 1)
        {
    ...
    pub void ExecuteUberUnter()
    {
      ...
      do
      {
        ...
        if (simpleList2.Counter > -1)
        {
          ...
          {
            int unitCounter2 = this.game.Data.UnitCounter;
            for (int unr1 = 0; unr1 <= unitCounter2; unr1 += 1)
            {
              int historical = this.game.Data.UnitObj[unr1].Historical;
      ...
      if (this.game.Data.RegimeObj[this.game.Data.Turn].UberRegime == -1)
      {
        ...
        for (int index3 = 0; index3 <= counter1; index3 += 1)
        {
          ...
          if (simpleList3.Counter > 0)
          {
            ...
            {
              int counter5 = aiFront.units.counter;
              for (int index10 = 0; index10 <= counter5; index10 += 1)
              {
              ...
              for (int index12 = 0; index12 <= counter7; index12 += 1)
              {
    ...
    pub void GiveAUnit(int unr, int toreg)
    {
      if (!this.game.Data.UnitObj[unr].IsHQ)
      {
        int num = 0;
    ...
    pub void ExecuteFrontlines(bool doLog)
    {
      ...
      for (int index3 = 0; index3 <= counter3; index3 += 1)
      {
        ...
        if (num2 > 0)
        {
          int num4 =  Math.Round((double) num1 / (double) num2);
      ...
      while (flag1)
      {
        ...
        for (int index5 = 0; index5 <= counter5; index5 += 1)
        {
          if (this.masterPlan.Front[index5].FrontType == 1)
          {
            ...
            for (int index6 = num; index6 <= counter6; index6 += 1)
            {
      ...
      for (int index7 = 0; index7 <= counter9; index7 += 1)
      {
        ...
        if (aiFront1.FrontType == 8 | aiFront1.FrontType == 9 && aiFront1.units.counter > -1)
        {
          ...
          for (int index8 = 0; index8 <= counter10; index8 += 1)
          {
      ...
      AIFront front;
      for (int index = 0; index <= counter11; index += 1)
      {
      ...
      for (int index9 = 0; index9 <= counter15; index9 += 1)
      {
        ...
        if (front.FrontType == 1 && (double) front.UnitCountRatio < 0.1)
        {
          ...
          for (int index10 = 0; index10 <= counter16; index10 += 1)
          ...
          for (int index11 = 0; index11 <= counter17; index11 += 1)
      ...
      for (int index = 0; index <= counter19; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index12 = 0; index12 <= counter20; index12 += 1)
      {
        ...
        if (front.units.counter > -1 && front.FrontType == 2 & front.TargetFrontID > 0)
        {
          ...
          for (int index13 = 0; index13 <= counter21; index13 += 1)
          {
        ...
        if (front.artUnits.counter > -1 && front.FrontType == 3 & front.TargetFrontID > 0)
        {
          ...
          for (int index14 = 0; index14 <= counter22; index14 += 1)
          {
      ...
      for (int index = 0; index <= counter23; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index15 = 0; index15 <= counter24; index15 += 1)
      {
        ...
        if (front.FrontType == 1 && front.Stance == 1 | front.Stance == 4)
        {
          ...
          for (int index16 = 0; index16 <= counter25; index16 += 1)
          ...
          if (front.units.counter > -1)
          {
            ...
            for (int index17 = 0; index17 <= counter26; index17 += 1)
            {
      ...
      for (int index = 0; index <= counter27; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index = 0; index <= counter28; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index = 0; index <= counter29; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index = 0; index <= counter30; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index18 = 0; index18 <= counter31; index18 += 1)
      {
        ...
        if (front.FrontType == 13 && !(front.Stance == 1 | front.Stance == 4))
        {
          ...
          for (int index19 = 0; index19 <= counter32; index19 += 1)
          {
      ...
      for (int index = 0; index <= counter33; index += 1)
      {
        front = this.masterPlan.Front[index];
      ...
      for (int index20 = 0; index20 <= counter34; index20 += 1)
      {
        front = this.masterPlan.Front[index20];
        if (front.units.counter > -1)
        {
          int counter35 = front.units.counter;
          for (int index21 = 0; index21 <= counter35; index21 += 1)
          {
    ...
    pub void MakeEnemySupplyMatrix()
    {
      DC2AIClass tai1 = this;
    ...
    pub void MakeFriendlySupplyMatrix()
    {
      DC2AIClass tai1 = this;
      AIMatrix ownerMatrix = new AIMatrix(ref tai1);
      int mapWidth = this.map.MapWidth;
    ...
    pub void ExecuteReserveFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteAirFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteAirTransportFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteEngineerFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteOrgFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
      ...
      int attackY)
    {
      ...
      for (int index1 = 0; index1 <= counter; index1 += 1)
      {
        if (moveList.Move[index1].AttackOn.onmap)
        {
          ...
          int y = this.game.Data.UnitObj[unitByAiid].Y;
          int num = index1;
          for (int index2 = 0; index2 <= num; index2 += 1)
          {
    ...
    pub void ExecuteEscapeFront(ref AIFront front, bool doLog)
    {
    ...
    pub void ExecuteProtection(ref AIFront front, bool doLog)
    {
      ...
      do
      {
        ...
        {
          int mapHeight = this.map.MapHeight;
          for (int y2 = 0; y2 <= mapHeight; y2 += 1)
          {
            if (this.frontMatrix.Value[index1, y2] == front.FrontID & this.GetGameDataTurn() == this.GetRegime(this.map.HexObj[index1, y2].Regime) && this.map.HexObj[index1, y2].Location > -1 && front.Stance != 3 & (this.map.HexObj[index1, y2].VP >= 5 & num3 == 1 | this.map.HexObj[index1, y2].VP > 0 & num3 == 2) | front.Stance == 3 & (this.map.HexObj[index1, y2].VP >= 30 & num3 == 1 | this.map.HexObj[index1, y2].VP > 14 & num3 == 2))
            {
              ...
              while (!flag1 & Iteration < 9)
              {
                ...
                {
                  int counter = front.units.counter;
                  for (int tdata1 = 0; tdata1 <= counter; tdata1 += 1)
                  {
    ...
    pub void ExecuteNavyFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteStrategicFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
    ...
    pub void ExecuteFront2(ref AIFront front, bool doLog)
    {
      if (front.DefensiveZone > 0)
        return;
      this.map = this.game.Data.MapObj[0];
      ...
      PassHexList passHexList2 = PassHexList::new();
      PassHexList passHexList3 = PassHexList::new();
      int num1 = 5 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 30.0) +  Math.Round((double) front.units.counter * 1.5);
      int num2 = 2 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 80.0);
      int num3 = 10 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 30.0) +  Math.Round(Math.Sqrt((double) front.units.counter));
      int num4 = 0;
      if (!this.CustomCalls.CustomDoStrategicIterations())
      ...
      int num5 = num1;
      for (int Iteration = 1; Iteration <= num5; Iteration += 1)
      {
        ...
        int num8 = num3;
        for (int index2 = 1; index2 <= num8; index2 += 1)
        {
    ...
    pub void ExecuteRetreatFront(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
      ...
      PassHexList passHexList = PassHexList::new();
      int num1 = 18 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 7.0) + front.units.counter * 6;
      int num2 = 4 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 80.0);
      int num3 = 10 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) +  Math.Round(Math.Sqrt((double) front.units.counter));
      ...
      {
        int num8 = num1;
        for (int Iteration = 1; Iteration <= num8; Iteration += 1)
        {
          str2: String = str1 + "\r\n\r\nIteration #" + Iteration.ToString();
          flag1 = false;
          AITheater aiTheater1 = new AITheater(this, front, this.masterPlan);
          ...
          for (int index = 1; index <= num10; index += 1)
          {
            AITheater aiTheater3 = aiTheater1.Clone();
      ...
      {
        int num11 = num1;
        for (int Iteration = 1; Iteration <= num11; Iteration += 1)
        {
          str16: String = str1 + "\r\n\r\nIteration #" + Iteration.ToString();
          flag1 = false;
          ...
          for (int index = 1; index <= num13; index += 1)
          {
    ...
    pub void ExecuteFront(ref AIFront front, bool doLog)
    {
      SimpleList simpleList1 = SimpleList::new();
      ...
      PassHexList tempPassList = PassHexList::new();
      PassHexList passHexList = PassHexList::new();
      int num1 = 6 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) +  Math.Round((double) front.units.counter * 1.5);
      int num2 = 4 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 70.0);
      int num3 = 10 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) +  Math.Round(Math.Sqrt((double) front.units.counter));
      if (this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus >= 250)
        num3 += 5;
      int num4 = 0;
      ...
      {
        num2 = 1;
        int num5 =  Math.Round((double) num3 / 4.0) + 1;
      }
      ...
      for (int Iteration = 1; Iteration <= num6; Iteration += 1)
      {
        if (!this.VAR_DEBUG_ON)
          s = "";
        str2: String = s + "\r\n\r\nIteration #" + Iteration.ToString();
        ...
        int num8 = 5 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) +  Math.Round(Math.Sqrt((double) front.units.counter));
        if (this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus >= 250)
          num8 += 5;
        if (!this.CustomCalls.CustomDoStrategicIterations())
        ...
        int num10;
        int num11;
        for (int index3 = 1; index3 <= num9; index3 += 1)
        {
        ...
        int num13 = 10 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) + front.units.counter;
        if (this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus >= 250)
          num13 += 8;
        bool flag3 = false;
        if (!this.CustomCalls.CustomDoStrategicIterations())
        ...
        if (front.units.counter < 1 | flag3)
        {
          ...
          int num14 = num13;
          for (int index4 = 1; index4 <= num14; index4 += 1)
          {
        ...
        {
          int num16 = 1 +  Math.Round(Math.Floor(Math.Sqrt((double) (1 + front.units.counter))));
          if (num16 > 5)
            num16 = 5;
          ...
          int num17 = num13;
          int num18 = num16;
          for (int index6 = 1; index6 <= num18; index6 += 1)
          {
            tryPassList = PassHexList::new();
            passList = PassHexList::new();
            tempPassList = PassHexList::new();
            ...
            int num21 = num20 * 2;
            for (int index7 = 1; index7 <= num21; index7 += 1)
            {
            ...
            int num22 = num19 + 1;
            int num23 = index5;
            for (int index8 = num22; index8 <= num23; index8 += 1)
            {
            ...
            if (simpleList4.Counter > -1)
            {
              int num24 =  Math.Round(Math.Floor((double) (front.units.counter + 1) / (double) num16));
              if (num24 < 1)
                num24 = 1;
              ...
              int num25 = num24 - 1;
              for (int index10 = 0; index10 <= num25; index10 += 1)
              {
          ...
          if (!this.CustomCalls.CustomIsMinor())
          {
            ...
            for (int index11 = 0; index11 <= counter3; index11 += 1)
            {
              ...
              if (num26 < 1)
              {
                ...
                for (int index12 = 0; index12 <= counter4; index12 += 1)
                {
            ...
            for (int tid = 0; tid <= counter5; tid += 1)
            {
              if (simpleListArray[tid].Counter > -1)
              {
                index1 = -99999;
                int counter6 = simpleListArray[tid].Counter;
                for (int index15 = 0; index15 <= counter6; index15 += 1)
                {
            ...
            int num30 = 2 +  Math.Round(Math.Sqrt((double) (front.units.counter + 1)));
            if (num30 > simpleList5.Counter)
              num30 = simpleList5.Counter;
            int num31 = num29;
            for (int index16 = 1; index16 <= num31; index16 += 1)
            {
              int num32 = num30;
              for (int index17 = 0; index17 <= num32; index17 += 1)
              {
                int index18 = simpleList5.Id[index17];
                if (simpleListArray[index18].Counter > -1)
                {
                  int num33 = num30;
                  for (int index19 = 0; index19 <= num33; index19 += 1)
                  {
        ...
        if (flag4)
        {
          ...
          int num35 = 5 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 15.0) +  Math.Round(Math.Sqrt((double) front.units.counter));
          ...
          if (front.FrontType == 13)
            num35 =  Math.Round((double) num35 / 4.0) + 1;
          int num36 = num35;
          for (int index22 = 1; index22 <= num36; index22 += 1)
          {
        ...
        for (int index23 = 0; index23 <= counter7; index23 += 1)
        {
        ...
        for (int index24 = 0; index24 <= counter8; index24 += 1)
        {
        ...
        for (int index25 = 0; index25 <= counter9; index25 += 1)
        {
        ...
        for (int index26 = 0; index26 <= counter10; index26 += 1)
        {
        ...
        for (int index27 = 0; index27 <= counter11; index27 += 1)
        {
        ...
        for (int index28 = 0; index28 <= counter12; index28 += 1)
        {
        ...
        if (!Information.IsNothing((object) Expression4))
        {
          ...
          if (!flag1)
          {
            ...
            if (Expression4.MoveList.Counter > -1)
            {
              ...
              for (int index29 = 0; index29 <= counter13; index29 += 1)
              {
    ...
    pub void ExecuteFrontArtUnits(ref AIFront front, bool doLog)
    {
      this.map = this.game.Data.MapObj[0];
      this.ClearLog();
      ...
      int num1 = 50;
      int num2 = 3;
      int num3 = 2 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 8.0);
      if (this.game.Data.Product >= 6)
        num3 += 7;
      int num4 = 0;
      int num5 = num1;
      for (int Iteration = 1; Iteration <= num5; Iteration += 1)
      {
        ...
        for (int index = 1; index <= num8; index += 1)
        {
    ...
    pub void ResetUnrToAIid(ref AIFront front)
    {
      int counter1 = front.units.counter;
      for (int index = 0; index <= counter1; index += 1)
      {
    ...
    pub void ExecuteFrontFlakUnits(ref AIFront front, bool doLog)
    {
      ...
      int num1 = 50;
      int num2 = 3;
      int num3 = 2 +  Math.Round((double) this.game.Data.RegimeObj[this.game.Data.Turn].ProdBonus / 7.0);
      if (this.game.Data.Product >= 6)
        num3 += 6;
      int num4 = 0;
      int num5 = num1;
    ...
    pub ExecuteMoveList: bool(ref AITheater theaterUse, ref string s, int ExtraAp = 0)
    {
      int num1 = 0;
      Coordinate coordinate1;
      ...
      if (this.game.EditObj.TempUnitList.counter > -1 & coordinate2.x > -1)
      {
        ...
        else
        {
          ...
          for (int index = 0; index <= counter8; index += 1)
          ...
          for (int index = 0; index <= counter9; index += 1)
          ...
          for (int index = 0; index <= counter10; index += 1)
          {
            if (index > 0)
              s += ", ";
            s = s + "\r\n" + this.game.Data.UnitObj[this.game.EditObj.TempUnitList.unr[index]].Name;
      ...
      for (int index = 0; index <= counter11; index += 1)
      {
        ...
        if (!Information.IsNothing((object) aiMove.AttackOn) & aiMove.IsAir & aiMove.IsTransportAir && aiMove.AttackOn.onmap)
        {
          ...
          if (unitByAiid > -1 && this.game.Data.UnitObj[unitByAiid].HQ > -1)
          {
            ...
            int num4 =  Math.Round((double) ((float) this.game.HandyFunctionsObj.GetCarryCapPts(unitByAiid, 2) / this.VAR_SUPPLY_WEIGHT));
            if (num4 > supply)
              num4 = supply;
    ...
    pub string BeforeAttackPlayOfficerHandCard(ref UnitList tempUnitList)
    {
      ...
      for (int index1 = 0; index1 <= counter1; index1 += 1)
      {
        ...
        if (simpleList1.FindNr(historical) > -1)
        {
          ...
          int index2 = nr;
          int num = weight[nr] +  Math.Round((double) this.game.Data.UnitObj[unr].TempUnitPower * ((double) this.game.HandyFunctionsObj.Gethqpow(unr) / 100.0));
          numArray[index2] = num;
        }
        else
          ...
          if (!flag)
          {
            ...
            if (unr > -1)
            {
              ...
              if (hq1 > -1 && this.game.Data.HistoricalUnitObj[this.game.Data.UnitObj[hq1].Historical].Type == 5)
              {
                ...
                for (int index5 = 0; index5 <= handCardCounter; index5 += 1)
                {
              ...
              if (!flag)
              {
                ...
                if (hq2 > -1)
                {
                  ...
                  if (hq3 > -1 && this.game.Data.HistoricalUnitObj[this.game.Data.UnitObj[hq3].Historical].Type == 6)
                  {
                    ...
                    for (int index6 = 0; index6 <= handCardCounter; index6 += 1)
                    {
    ...
    pub void ExecuteStrategicTransfers(bool doLog, bool Early)
    {
          ...
          if (aiFront.FrontType == 1)
          {
            ...
            for (int index2 = 0; index2 <= counter2; index2 += 1)
            {
              ...
              if (aiMatrix1.Value[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y] != aiFront.FrontID && this.game.HandyFunctionsObj.HasHexRoad(this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y, 0))
              {
                ...
                if (tdata1 > -1)
                {
                  int tweight =  Math.Round((double) (20 + aiFront.Importance * 100) / (double) Math.Max(1,  Math.Round((double) aiMatrix3.Value[tdata1, tdata2] / 30.0)));
        ...
        else if (aiFront.FrontType == 2 && aiFront.TargetFrontID > 0)
        {
          ...
          for (int index3 = 0; index3 <= counter3; index3 += 1)
          {
            ...
            if (unitByAiid > -1 && aiMatrix1.Value[this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y] != aiFront.TargetFrontID && this.game.HandyFunctionsObj.HasHexRoad(this.game.Data.UnitObj[unitByAiid].X, this.game.Data.UnitObj[unitByAiid].Y, 0))
            {
              ...
              if (tdata1 > -1)
              {
                int tweight =  Math.Round(20.0 + (double) (aiFront.Importance * 100) / (double) Math.Max(1,  Math.Round((double) aiMatrix4.Value[tdata1, tdata2] / 30.0)));
                s = s + "\r\nunit '" + this.game.Data.UnitObj[unitByAiid].Name + "' gets score = " + tweight.ToString() + " to = " + tdata1.ToString() + "," + tdata2.ToString() + " for destination ";
                simpleList.Add(unitByAiid, tweight, tdata1, tdata2);
              }
            }
    ...
    pub void InitFrontlines(bool DebugOverrule)
    {
      bool flag1 = false;
      if (DebugOverrule)
        flag1 = true;
      ...
      if (this.VAR_ZONES_TYPE > 0)
      {
        ...
        int mapWidth = this.game.Data.MapObj[0].MapWidth;
        for (int index11 = 0; index11 <= mapWidth; index11 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
          for (int index12 = 0; index12 <= mapHeight; index12 += 1)
          {
      ...
      {
        int mapWidth2 = this.map.MapWidth;
        for (int index15 = 0; index15 <= mapWidth2; index15 += 1)
        {
          int mapHeight = this.map.MapHeight;
      ...
      if (this.CustomCalls.CustomIsMinor())
      {
        ...
        int mapWidth4 = this.game.Data.MapObj[0].MapWidth;
        for (int index18 = 0; index18 <= mapWidth4; index18 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
      ...
      if (this.game.Data.Product == 7 && this.CustomCalls.CustomDoStrategicIterations())
      {
        ...
        {
          int mapWidth5 = this.game.Data.MapObj[0].MapWidth;
          for (int index20 = 0; index20 <= mapWidth5; index20 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
            for (int index21 = 0; index21 <= mapHeight; index21 += 1)
            {
        ...
        if (flag3)
        {
          ...
          for (int index22 = 0; index22 <= mapWidth6; index22 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
        ...
        if (libVar > -1)
        {
          ...
          for (int index24 = 0; index24 <= mapWidth7; index24 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
        ...
        if (libVar > 0)
        {
          ...
          for (int index26 = 0; index26 <= mapWidth8; index26 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
            for (int index27 = 0; index27 <= mapHeight; index27 += 1)
            {
      ...
      if (!this.CustomCalls.CustomRuleInitFrontlines_MLAalreadySet())
      {
        ...
        else
        {
          ...
          for (int index28 = 0; index28 <= num3; index28 += 1)
          {
            int num4 = this.VAR_MLA_RANGE * 4;
            for (int index29 = 0; index29 <= num4; index29 += 1)
          ...
          for (int index30 = 0; index30 <= num5; index30 += 1)
          {
            int num6 = this.VAR_MLA_RANGE * 4;
            for (int index31 = 0; index31 <= num6; index31 += 1)
            {
          ...
          for (int index36 = 0; index36 <= mapWidth9; index36 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index37 = 0; index37 <= mapHeight; index37 += 1)
            {
          ...
          for (int index42 = 0; index42 <= mapWidth10; index42 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index43 = 0; index43 <= mapHeight; index43 += 1)
      ...
      int counter1 = this.frontList.Counter;
      for (int index44 = 0; index44 <= counter1; index44 += 1)
      {
        AIFront aiFront = this.frontList.Front[index44];
        int counter2 = aiFront.units.counter;
        for (int index45 = 0; index45 <= counter2; index45 += 1)
        {
      ...
      if (this.game.Data.Product < 6)
      {
        ...
        for (int index47 = 1; index47 <= num11; index47 += 1)
        {
          tai = this;
          AIMatrix aiMatrix9 = new AIMatrix(ref tai);
          int mapWidth12 = this.map.MapWidth;
          for (int x1 = 0; x1 <= mapWidth12; x1 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int y1 = 0; y1 <= mapHeight; y1 += 1)
            {
              if (this.extendedMatrix.Value[x1, y1] == 0)
              {
                ...
                for (int index52 = 0; index52 <= counter3; index52 += 1)
          ...
          for (int index53 = 0; index53 <= mapWidth13; index53 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index54 = 0; index54 <= mapHeight; index54 += 1)
            {
    ...
    pub void BlendFronts(ref AIMatrix curfronts, ref AIMatrix oldFronts)
    {
      DC2AIClass tai1 = this;
      AIMatrix aiMatrix1 = new AIMatrix(ref tai1);
      int num1 = -1;
      ...
      for (int index7 = 0; index7 <= counter1; index7 += 1)
      {
        ...
        AIMatrix aiMatrix3 = new AIMatrix(ref tai3);
        int mapWidth2 = this.map.MapWidth;
        for (int index8 = 0; index8 <= mapWidth2; index8 += 1)
        {
          int mapHeight = this.map.MapHeight;
        ...
        int num4 = 0;
        int mapWidth3 = this.map.MapWidth;
        for (int index10 = 0; index10 <= mapWidth3; index10 += 1)
        {
          int mapHeight = this.map.MapHeight;
          for (int index11 = 0; index11 <= mapHeight; index11 += 1)
          {
        ...
        int num6 =  Math.Round(Math.Ceiling((double) (num4 + 1) * 0.66));
        if (num4 <= num6)
          num6 = num4;
        int mapWidth4 = this.map.MapWidth;
        for (int index12 = 0; index12 <= mapWidth4; index12 += 1)
        {
          int mapHeight = this.map.MapHeight;
          for (int index13 = 0; index13 <= mapHeight; index13 += 1)
          {
      ...
      for (int index14 = 0; index14 <= counter2; index14 += 1)
      {
        ...
        int mapWidth5 = this.map.MapWidth;
        for (int index15 = 0; index15 <= mapWidth5; index15 += 1)
        {
          int mapHeight = this.map.MapHeight;
          for (int index16 = 0; index16 <= mapHeight; index16 += 1)
          {
        ...
        int num9 = 0;
        int mapWidth6 = this.map.MapWidth;
        for (int index17 = 0; index17 <= mapWidth6; index17 += 1)
        {
          int mapHeight = this.map.MapHeight;
        ...
        {
          int num10 = num9 - 1;
          int num11 =  Math.Round(Math.Ceiling((double) num10 * (double) num8));
          if (num11 == num10)
            num11 = num10 - 1;
          if (num10 > 0)
          {
            int mapWidth7 = this.map.MapWidth;
            for (int index19 = 0; index19 <= mapWidth7; index19 += 1)
            {
              int mapHeight = this.map.MapHeight;
              for (int index20 = 0; index20 <= mapHeight; index20 += 1)
              {
    ...
    pub void InitFrontlinesSplitLargeFronts(ref AIMatrix fronts, ref AIMatrix deepFronts)
    {
      DC2AIClass tai = this;
      AIMatrix aiMatrix = new AIMatrix(ref tai);
      int[] numArray1 = new int[1000];
      ...
      while (index2 <= 999);
      int mapWidth1 = this.map.MapWidth;
      for (int index3 = 0; index3 <= mapWidth1; index3 += 1)
      {
        int mapHeight = this.map.MapHeight;
        for (int index4 = 0; index4 <= mapHeight; index4 += 1)
        {
          ...
          if (fronts.Value[index3, index4] > 0 & fronts.Value[index3, index4] < 1000000)
          {
            int index10 = -1;
            int num5 = index1;
            for (int index11 = 0; index11 <= num5; index11 += 1)
            {
      ...
      int num12 = index1;
      for (int index25 = 0; index25 <= num12; index25 += 1)
      {
        bool flag1 = false;
        bool flag2 = false;
        ...
        if (flag1)
        {
          ...
          if (flag3 | (double) num13 > (double) this.VAR_FRONTLINE_MAX_LENGTH / 2.0 + 1.0 | flag2)
          {
            ...
            {
              int mapWidth3 = this.map.MapWidth;
              for (int index29 = 0; index29 <= mapWidth3; index29 += 1)
              {
                int mapHeight = this.map.MapHeight;
                for (int index30 = 0; index30 <= mapHeight; index30 += 1)
                {
      ...
      AIMatrix exactStrength)
    {
      ...
      for (int index2 = 0; index2 <= mapWidth1; index2 += 1)
      {
        ...
        for (int index3 = 0; index3 <= mapHeight; index3 += 1)
        {
          if (corps.Value[index2, index3] > 0)
          {
            int index4 = -1;
            int num1 = index1;
            for (int index5 = 0; index5 <= num1; index5 += 1)
            {
      ...
      int num5 = index1;
      for (int index13 = 0; index13 <= num5; index13 += 1)
      {
          ...
          if (numArray2[index14] == numArray3[index14] & numArray2[index14] < 1000000 && numArray1[index14] < this.VAR_FRONTLINE_MAX_LENGTH)
          {
            ...
            for (int index15 = 0; index15 <= num7; index15 += 1)
            {
              if (numArray2[index15] == numArray3[index15] & numArray2[index15] < 1000000 && numArray3[index14] != numArray3[index15] && numArray1[index14] + numArray1[index15] <= this.VAR_FRONTLINE_MAX_LENGTH && numArray4[index14] == numArray4[index15])
              {
                ...
                for (int index16 = 0; index16 <= num8; index16 += 1)
                {
                ...
                if (flag2)
                {
                  ...
                  for (int index19 = 0; index19 <= num10; index19 += 1)
                  {
      ...
      while (flag1);
      int mapWidth2 = this.map.MapWidth;
      for (int index22 = 0; index22 <= mapWidth2; index22 += 1)
      {
        int mapHeight = this.map.MapHeight;
        for (int index23 = 0; index23 <= mapHeight; index23 += 1)
        {
          ...
          {
            int num13 = index1;
            for (int index24 = 0; index24 <= num13; index24 += 1)
            {
      ...
      {
        int mapWidth3 = this.map.MapWidth;
        for (int index25 = 0; index25 <= mapWidth3; index25 += 1)
        {
          int mapHeight = this.map.MapHeight;
          for (int index26 = 0; index26 <= mapHeight; index26 += 1)
          {
    ...
    pub void InitFrontlinesOffensiveModifier(ref AIFrontList TempList)
    {
    ...
    pub void InitFrontlinesAddReserveFrontlines(ref AIFrontList TempList, ref AIMatrix fronts)
    {
      int num1 = 6;
      if (this.game.Data.Product >= 6)
        num1 = 9;
      ...
      {
        int mapHeight1 = this.map.MapHeight;
        for (int index2 = 0; index2 <= mapHeight1; index2 += 1)
        {
          if (this.map.HexObj[index1, index2].Regime == this.GetGameDataTurn() && this.map.HexObj[index1, index2].UnitCounter > -1)
          {
            ...
            for (int index3 = 0; index3 <= unitCounter1; index3 += 1)
            {
              int unit = this.map.HexObj[index1, index2].UnitList[index3];
              bool flag2 = false;
              ...
              if (flag2 && this.game.Data.UnitObj[unit].AIGroup < 0 && this.game.Data.UnitObj[unit].TempCategory == 1 | this.game.Data.UnitObj[unit].TempCategory == 5)
              {
                ...
                {
                  int counter1 = TempList.Counter;
                  for (int tid = 0; tid <= counter1; tid += 1)
                  {
                ...
                else
                {
                  ...
                  for (int tid = 0; tid <= counter3; tid += 1)
                  {
                    ...
                    if (aiFront3.FrontType == 1)
                    {
                      ...
                      {
                        int mapHeight2 = this.map.MapHeight;
                        for (int index6 = 0; index6 <= mapHeight2; index6 += 1)
                        {
    ...
    pub void InitFrontlinesAddAirFrontlines(ref AIFrontList TempList, ref AIMatrix fronts)
    {
      ...
      ref AIMatrix frontlines)
    {
      ...
      for (bool flag1 = true; num2 < 99 & flag1; num2 += 1)
      {
        ...
        for (int index8 = 0; index8 <= counter1; index8 += 1)
        {
          if (TempList.Front[index8].FrontType == 6 && TempList.Front[index8].coordCount >= 1)
          {
            ...
            for (int index9 = 0; index9 <= coordCount1; index9 += 1)
            {
              int num3 = 0;
              int num4 = 0;
              int coordCount2 = TempList.Front[index8].coordCount;
              for (int index10 = 0; index10 <= coordCount2; index10 += 1)
              {
                int coordCount3 = TempList.Front[index8].coordCount;
                for (int index11 = 0; index11 <= coordCount3; index11 += 1)
                {
                  if (index10 != index11)
                  {
              ...
              for (int index12 = 0; index12 <= coordCount4; index12 += 1)
              {
                int coordCount5 = TempList.Front[index8].coordCount;
                for (int index13 = 0; index13 <= coordCount5; index13 += 1)
                {
              ...
              int num10 = num6 + num7;
              int counter2 = TempList.Counter;
              for (int index15 = 0; index15 <= counter2; index15 += 1)
              {
                if (index15 != index8 & TempList.Front[index15].FrontType == 6 && TempList.Front[index15].coordCount <= 25)
                {
                  ...
                  for (int index16 = 0; index16 <= coordCount6; index16 += 1)
                  {
                    int coordCount7 = TempList.Front[index15].coordCount;
                    for (int index17 = 0; index17 <= coordCount7; index17 += 1)
                    {
                      if (index16 != index17)
                      {
                  ...
                  for (int index18 = 0; index18 <= coordCount8; index18 += 1)
                  {
                    int coordCount9 = TempList.Front[index15].coordCount;
                    for (int index19 = 0; index19 <= coordCount9; index19 += 1)
                    {
                      if (index18 != index19)
                      {
      ...
      int counter3 = TempList.Counter;
      for (int index20 = 0; index20 <= counter3; index20 += 1)
      {
    ...
    pub void InitFrontlinesAddNavyFrontlines(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
    ...
    pub void InitFrontlinesAddFlakFrontlines(ref AIFrontList TempList, ref AIMatrix frontlines)
    {
      ...
      for (int index3 = 0; index3 <= length1; index3 += 1)
      {
        int idValue =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById2].Data[index3, 0]));
        int id =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById2].Data[index3, 6]));
        if (id > 0)
        {
          ...
          if (locationById > -1)
          {
            ...
            {
              int num1 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById5].GetData2(0, idValue, 1, "city", 2)));
              if (num1 > 0)
              {
                int[,] numArray1 = aiMatrix2.Value;
                int[,] numArray2 = numArray1;
      ...
      for (int index8 = 0; index8 <= length2; index8 += 1)
      {
        int idValue =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[index8, 1]));
        int index9 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[index8, 3]));
        int index10 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[index8, 4]));
        if (this.game.Data.MapObj[0].HexObj[index9, index10].Regime == this.game.Data.Turn & index9 > -1 & index10 > -1)
        {
          int num3 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById4].GetData(0, idValue, 2)));
          if (num3 > 0)
          {
      ...
      int num5 = 0;
      int regimeCounter = this.game.Data.RegimeCounter;
      for (int index16 = 2; index16 <= regimeCounter; index16 += 1)
      {
        if ( Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById6].GetData(0, this.game.Data.RegimeObj[index16].id, 1))) == 1 & this.game.Data.Turn != index16)
        {
          ...
          for (int index17 = 0; index17 <= length3; index17 += 1)
          {
            ...
            {
              int id =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById7].Data[index17, 5]));
              if (id > 0)
              {
                ...
                {
                  int num8 =  Math.Round(Math.Floor(100.0 / (double) this.game.Data.SFTypeObj[sfTypeById].AirAPRule));
          ...
          if (num6 <= 0)
          {
            ...
            for (int index18 = 0; index18 <= length4; index18 += 1)
            {
              ...
              {
                int id =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById7].Data[index18, 5]));
                if (id > 0)
                {
                  int sfTypeById = this.game.HandyFunctionsObj.GetSFTypeByID(id);
                  if (this.game.Data.SFTypeObj[sfTypeById].Theater == 2 & this.game.Data.SFTypeObj[sfTypeById].AirAPRule > 0)
                  {
                    int num9 =  Math.Round((double)  Math.Round(Math.Floor(100.0 / (double) this.game.Data.SFTypeObj[sfTypeById].AirAPRule)) * 0.5);
                    if (this.game.Data.SFTypeObj[sfTypeById].SFTypeVar[18] > 0)
                    {
                      if (num9 > num6)
                        num6 = num9;
          ...
          int mapWidth2 = this.game.Data.MapObj[0].MapWidth;
          for (int index19 = 0; index19 <= mapWidth2; index19 += 1)
          {
            int mapHeight = this.game.Data.MapObj[0].MapHeight;
            for (index1 = 0; index1 <= mapHeight; index1 += 1)
            {
      ...
      for (int tid = 0; tid <= unitCounter1; tid += 1)
      {
        if (this.game.Data.UnitObj[tid].PreDef == -1 & this.game.Data.UnitObj[tid].Regime == this.game.Data.Turn && this.game.Data.UnitObj[tid].TempCategory == 5)
        {
          ...
          if (!Information.IsNothing((object) this.game.Data.UnitObj[tid].prevTurnAiFrontHexes))
          {
            ...
            for (int index20 = 0; index20 <= counter; index20 += 1)
            {
          ...
          if (this.game.Data.UnitObj[tid].SFCount > -1)
          {
            ...
            int num12 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById7].GetData(0, this.game.Data.SFTypeObj[type].SFTypeVar[81], 1)));
            if (num12 == 133)
            {
              tdata5 = 50;
              num10 = 1;
          ...
          int tweight = 1 +  Math.Round(Math.Ceiling((double) (num10 * num11) / 5.0));
      ...
      while (flag1)
      {
        ...
        int num17 = 0;
        int sfTypeCounter = this.game.Data.SFTypeCounter;
        for (int index23 = 0; index23 <= sfTypeCounter; index23 += 1)
        {
        ...
        int num18 = num16 <= 0 ? 0 :  Math.Round((double) (num17 * 100) / (double) num16);
        ...
        for (int index24 = 0; index24 <= counter1; index24 += 1)
        {
          ...
          if (aiFront.FrontType == 1)
          {
            ...
            if (aiFront.units.counter > -1 & powerUnderFront > 0)
            {
              ...
              int num22 = 0;
              int counter2 = aiFront.units.counter;
              for (int index25 = 0; index25 <= counter2; index25 += 1)
              {
        ...
        for (int index27 = 0; index27 <= counter3; index27 += 1)
        {
          if (simpleList6.Data5[index27] > 0 & simpleList6.Data4[index27] > 0)
          {
            ...
            int index28 = index27;
            int index29 = index28;
            int num24 = weight[index28] -  Math.Round((double) (simpleList6.Weight[index27] * simpleList6.Data4[index27]) / (double) simpleList6.Data5[index27]);
            numArray[index29] = num24;
          }
        }
        int counter4 = simpleList7.Counter;
        for (int index30 = 0; index30 <= counter4; index30 += 1)
        {
          if (simpleList7.Data5[index30] > 0 & simpleList7.Data4[index30] > 0)
          {
            ...
            int index31 = index30;
            int index32 = index31;
            int num25 = weight[index31] -  Math.Round((double) (simpleList7.Weight[index30] * simpleList7.Data4[index30]) / (double) simpleList7.Data5[index30]);
        ...
        for (int index33 = 0; index33 <= counter5; index33 += 1)
        ...
        else if (num27 > -1)
        {
          ...
          for (int index38 = 0; index38 <= counter7; index38 += 1)
          {
            if (simpleList1.Data1[index38] < 1)
            {
              ...
              for (int index40 = 0; index40 <= counter8; index40 += 1)
              {
              ...
              for (int index41 = 0; index41 <= counter9; index41 += 1)
              {
              ...
              if (num36 > 0)
              {
                int num37 =  Math.Round((double) num35 / (double) num36);
          ...
          if (index37 > -1)
          {
            ...
            for (int index42 = 0; index42 <= counter10; index42 += 1)
            {
      ...
      ref AIMatrix frontlines)
    {
      ...
      int num5 = num2;
      for (int index7 = 1; index7 <= num5; index7 += 1)
      {
        int phase = 1;
        do
        {
          bool frontline = this.CustomCalls.CustomStrategicReserveDelegateToFrontline(phase);
          int mapWidth = this.map.MapWidth;
          for (int index8 = 0; index8 <= mapWidth; index8 += 1)
          {
            int mapHeight = this.map.MapHeight;
            for (int index9 = 0; index9 <= mapHeight; index9 += 1)
            {
              if (this.map.HexObj[index8, index9].Regime == this.game.Data.Turn & this.map.HexObj[index8, index9].Location > -1 & this.map.HexObj[index8, index9].VP + this.game.Data.RegimeObj[this.game.Data.Turn].AIVP[0].Value[index8, index9] > 0)
              {
                ...
                else if (index7 == 2 & phase == 1 && this.game.Data.MapObj[0].HexObj[index8, index9].UnitCounter > -1 && this.game.HandyFunctionsObj.IsHexAirfield(index8, index9, 0))
                {
                  ...
                  for (int index10 = 0; index10 <= unitCounter3; index10 += 1)
                  {
                ...
                if (flag1)
                {
                  ...
                  SimpleList simpleList = SimpleList::new();
                  int unitCounter4 = this.game.Data.UnitCounter;
                  for (int index11 = 0; index11 <= unitCounter4; index11 += 1)
                  {
    ...
    pub void InitFrontlinesKeepCorpsTogether()
    {
      int unitCounter = this.game.Data.UnitCounter;
      for (int hq = 0; hq <= unitCounter; hq += 1)
      {
    ...
    pub void InitFrontlinesKeepDivTogether(ref AIFrontList tempList, ref AIMatrix tfronts)
    {
      ...
      for (int index3 = 0; index3 <= unitCounter3; index3 += 1)
      {
        if (this.game.Data.UnitObj[index3].PreDef == -1 & this.GetRegime(this.game.Data.UnitObj[index3].Regime) == this.GetGameDataTurn() && this.game.Data.UnitObj[index3].Historical > -1)
        {
          ...
          if (flagArray[historical])
          {
            ...
            {
              int unitCounter4 = this.game.Data.UnitCounter;
              for (int tunr = 0; tunr <= unitCounter4; tunr += 1)
              {
              ...
              int unitCounter5 = this.game.Data.UnitCounter;
              for (int tunr = 0; tunr <= unitCounter5; tunr += 1)
              {
    ...
    pub void InitFrontlinesSetOrganisingUnits(ref AIFrontList tfrontlist, AIMatrix fronts)
    {
          ...
          do
          {
            ...
            if (this.game.Data.HistoricalUnitObj[index15].SubParts[index16] > -1)
            {
              ...
              if (unitByHistorical > -1)
              {
                ...
                int powerPtsAbsolute = this.game.HandyFunctionsObj.GetPowerPtsAbsolute(unitByHistorical);
                int startPower = this.game.HandyFunctionsObj.GetStartPower(unitByHistorical);
                int num6 =  Math.Round((double) startPower * ((double) breakPercent / 100.0));
                int num7 = startPower != 0 ? Math.Min(100,  Math.Round((double) powerPtsAbsolute / (double) startPower * 100.0)) : 100;
                int val2 = num5 + 1;
                int num8 =  Math.Round((double) (num4 + num7) / (double) Math.Max(1, val2));
                if (this.game.Data.UnitObj[unitByHistorical].SOReplacementPercent == 0)
                  num8 = 0;
      ...
      ref AIMatrix owner)
    {
      ...
      else
      {
        ...
        for (int x = 0; x <= mapWidth; x += 1)
        {
          ...
          for (int y = 0; y <= mapHeight; y += 1)
          {
            ...
            if (aiMatrix4.Value[x, y] > 0)
            {
              ...
              {
                int num2 =  Math.Round((double) ((float)  Math.Round(Math.Sqrt((double) (this.game.Data.MapObj[0].HexObj[x, y].VP + this.game.Data.RegimeObj[this.game.Data.Turn].AIVP[0].Value[x, y])) * 100.0) * num1));
                if (flag2)
                  num2 *= 2;
        ...
        if (num8 == 0)
          num8 = 1;
        int num9 =  Math.Round((double) num7 / (double) num8);
        ...
        for (int index26 = 0; index26 <= counter4; index26 += 1)
        {
          int num10 = 0;
          int num11 = 0;
          int counter5 = tfrontlist.Front[index26].units.counter;
          for (int index27 = 0; index27 <= counter5; index27 += 1)
          {
        ...
        for (int tid = 0; tid <= counter6; tid += 1)
        {
        ...
        simpleList.ReverseSort();
        int num14 =  Math.Round((double) num13 / (double) this.VAR_TOP_OPERATIONS_PERCENTAGE);
        if (num14 < 1)
          num14 = 1;
        int num15 = num14;
        for (int index = 1; index <= num15; index += 1)
              ...
              if (flag)
              {
                if (owner.Value[index2, index3] == 1)
                {
                  if (this.map.HexObj[index2, index3].UnitCounter > -1)
                  {
                    ...
                    for (int index4 = 0; index4 <= unitCounter; index4 += 1)
                    {
              ...
              if (aiMatrix.Value[index7, index8] == tfrontlist.Front[index6].FrontID)
              {
                if (owner.Value[index7, index8] == 1)
                {
                  if (this.map.HexObj[index7, index8].UnitCounter > -1)
                  {
                    ...
                    for (int index9 = 0; index9 <= unitCounter; index9 += 1)
                    {
    ...
    pub SimpleList GetSSHQGroups(int hq)
    {
    ...
    pub void SSHQSettings(AIMatrix fronts, ref AIFrontList tfrontlist, ref AIMatrix ownerMatrix)
    {
      if (this.game.Data.Turn == 13)
      {
        int num1 = num1;
      ...
      else
      {
        ...
        for (int index3 = 0; index3 <= counter1; index3 += 1)
        {
          ...
          if (this.game.Data.UnitObj[index4].Historical > -1 && this.game.Data.HistoricalUnitObj[this.game.Data.UnitObj[index4].Historical].NoSplit)
            flag1 = true;
          int unitCounter3 = this.game.Data.UnitCounter;
          for (int tid = 0; tid <= unitCounter3; tid += 1)
          {
            if (this.game.Data.UnitObj[tid].Regime == this.game.Data.Turn & this.game.Data.UnitObj[tid].X > -1 & !this.game.Data.UnitObj[tid].IsHQ && this.game.Data.UnitObj[tid].TempCategory == 1 | this.game.Data.UnitObj[tid].TempCategory == 2 | this.game.Data.UnitObj[tid].TempCategory == 5 | this.game.Data.UnitObj[tid].TempCategory2 == 14 && this.game.Data.UnitObj[tid].HQ == index4 & this.game.Data.UnitObj[tid].Historical > -1 && this.game.Data.UnitObj[tid].AISubStrictGroup < 1)
            {
              ...
              int num4 = 0;
              int unitCounter4 = this.game.Data.UnitCounter;
              for (int index5 = 0; index5 <= unitCounter4; index5 += 1)
              {
        ...
        for (int index8 = 0; index8 <= counter3; index8 += 1)
        {
          ...
          while (flag4 & !flag3)
          {
            ...
            for (int index9 = 0; index9 <= counter4; index9 += 1)
            ...
            for (int index10 = 0; index10 <= counter5; index10 += 1)
            {
              ...
              int num11 =  Math.Round(Math.Floor((double) num9 / 2.0)) + 1;
              ...
              if (sshqGroups.Weight[index10] < num11 | sshqGroups.Weight[index10] < num9 && index10 > 0)
              {
                int num12 = 0;
                int num13 = index10 - 1;
                for (int index11 = 0; index11 <= num13; index11 += 1)
                {
                ...
                {
                  int num15 = index10 - 1;
                  for (int index12 = 0; index12 <= num15; index12 += 1)
                  {
                    int num16 = sshqGroups.Id[index12];
                    int unitCounter6 = this.game.Data.UnitCounter;
                    for (int index13 = 0; index13 <= unitCounter6; index13 += 1)
                    {
              ...
              int num17 =  Math.Round(Math.Floor((double) num9 / 2.0)) + 1;
              ...
              if (sshqGroups.Weight[index10] < num17)
              {
                if (index10 < sshqGroups.Counter)
                {
                  ...
                  for (int index14 = num18; index14 <= counter6; index14 += 1)
                  {
                    int num19 = sshqGroups.Id[index14];
                    int unitCounter7 = this.game.Data.UnitCounter;
                    for (int index15 = 0; index15 <= unitCounter7; index15 += 1)
                    {
                ...
                {
                  int num20 = index10 - 1;
                  for (int index16 = 0; index16 <= num20; index16 += 1)
                  {
                    int num21 = sshqGroups.Id[index16];
                    int unitCounter8 = this.game.Data.UnitCounter;
                    for (int index17 = 0; index17 <= unitCounter8; index17 += 1)
                    {
              ...
              if (this.game.Data.Product >= 6 && sshqGroups.Weight[index10] > num9 && index10 < sshqGroups.Counter)
              {
                ...
                for (int index18 = num22; index18 <= counter7; index18 += 1)
                {
                  int num23 = sshqGroups.Id[index18];
                  int num24 = sshqGroups.Weight[index10] - num9;
                  int num25 =  Math.Round(Math.Floor((double) this.VAR_SSHQ_SIZE2 / 2.0) + 1.0);
                  ...
                  if (num24 >= num25 - sshqGroups.Weight[index18])
                  {
                    ...
                    for (int index19 = 0; index19 <= unitCounter9; index19 += 1)
                    {
    ...
    pub SimpleList GetHQLandscapeTypeAPCost(int hq, int sshq)
    {
      int num1 = 9999;
      int landscapeTypeCounter1 = this.game.Data.LandscapeTypeCounter;
      for (int index = 0; index <= landscapeTypeCounter1; index += 1)
      {
      ...
      for (int tid1 = 0; tid1 <= landscapeTypeCounter2; tid1 += 1)
      {
        SimpleList simpleList2 = SimpleList::new();
        ...
        for (int index = 0; index <= counter2; index += 1)
        {
          ...
          int num8 =  Math.Round((double) simpleList2.Data1[index] * (1.0 + (double) (index + 1) / (double) (simpleList2.Counter + 1)));
          num4 += (long) (num7 * num8);
          num5 += (long) num8;
        }
      ...
      ref AIMatrix tfrontlines)
    {
      ...
      {
        int mapWidth2 = this.map.MapWidth;
        for (int index11 = 0; index11 <= mapWidth2; index11 += 1)
        {
          int mapHeight1 = this.map.MapHeight;
          for (int index12 = 0; index12 <= mapHeight1; index12 += 1)
          {
            if (fronts.Value[index11, index12] > 0 && tfrontlist.GetFrontNr(fronts.Value[index11, index12]) == -1)
            {
              ...
              if (num1 > 0)
              {
                int num9 =  Math.Round((double) num4 / (double) num1);
                if (num9 > 0)
      ...
      {
        int mapWidth4 = this.game.Data.MapObj[0].MapWidth;
        for (int index14 = 0; index14 <= mapWidth4; index14 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
          for (int index15 = 0; index15 <= mapHeight; index15 += 1)
          {
      ...
      int num10 = 0;
      int counter1 = tfrontlist.Counter;
      for (int tdata1 = 0; tdata1 <= counter1; tdata1 += 1)
      {
        ...
        if (aiFront1.FrontType == 1)
        {
          ...
          if (this.CustomCalls.CustomDoStrategicIterations())
            ...
            aiMatrix4.ExpandAndAddValueForAnyRegime(9);
          int counter2 = tfrontlist.Counter;
          for (int index16 = 0; index16 <= counter2; index16 += 1)
          {
            if (index16 > tdata1)
            {
              ...
              if (aiFront2.FrontType == 1)
              {
                int num11 = 9999;
                int mapWidth5 = this.game.Data.MapObj[0].MapWidth;
                for (int index17 = 0; index17 <= mapWidth5; index17 += 1)
                {
                  int mapHeight = this.game.Data.MapObj[0].MapHeight;
                  for (int index18 = 0; index18 <= mapHeight; index18 += 1)
                  {
          ...
          int counter3 = tfrontlist.Counter;
          for (int index19 = 0; index19 <= counter3; index19 += 1)
          {
            if (index19 > tdata1)
            {
              ...
              if (aiFront3.FrontType == 1)
              {
                int num12 = 9999;
                int mapWidth6 = this.game.Data.MapObj[0].MapWidth;
                for (int index20 = 0; index20 <= mapWidth6; index20 += 1)
                {
                  int mapHeight = this.game.Data.MapObj[0].MapHeight;
                  for (int index21 = 0; index21 <= mapHeight; index21 += 1)
                  {
          ...
          int counter4 = tfrontlist.Counter;
          for (int index22 = 0; index22 <= counter4; index22 += 1)
          {
            if (index22 > tdata1)
            {
              ...
              if (aiFront4.FrontType == 1)
              {
                int num13 = 9999;
                int mapWidth7 = this.game.Data.MapObj[0].MapWidth;
                for (int index23 = 0; index23 <= mapWidth7; index23 += 1)
                {
                  int mapHeight = this.game.Data.MapObj[0].MapHeight;
                  for (int index24 = 0; index24 <= mapHeight; index24 += 1)
                  {
          ...
          int tdata2_1;
          int tdata2_2;
          for (int index25 = 0; index25 <= counter5; index25 += 1)
          {
      ...
      if (this.VAR_ALLOW_THREAT_ENCIRCLE & this.CustomCalls.CustomDoStrategicIterations())
      {
        ...
        if (1 > index13)
          index13 = 1;
        for (int index26 = 0; index26 < index13; index26 += 1)
        {
          simpleList2.ReverseSort();
          ...
          if (num16 >= 2)
          {
            ...
            for (int index29 = 0; index29 <= counter6; index29 += 1)
            {
              ...
              for (int index30 = 0; index30 <= counter8; index30 += 1)
              {
      ...
      if (this.VAR_ALLOW_OPPORTUNITY_ENCIRCLE & this.CustomCalls.CustomDoStrategicIterations())
      {
        ...
        if (1 > index13)
          index13 = 1;
        for (int index31 = 0; index31 < index13; index31 += 1)
        {
          ...
          if ((double) num19 >= 1.5)
          {
            ...
            for (int index34 = 0; index34 <= counter10; index34 += 1)
            {
              ...
              for (int index35 = 0; index35 <= counter12; index35 += 1)
              {
      ...
      if (this.VAR_USE_STRICT_HQFRONT & this.CustomCalls.CustomDoStrategicIterations())
      {
        ...
        int unitCounter1 = this.game.Data.UnitCounter;
        for (int index36 = 0; index36 <= unitCounter1; index36 += 1)
        {
        ...
        int unitCounter2 = this.game.Data.UnitCounter;
        for (int index37 = 0; index37 <= unitCounter2; index37 += 1)
        {
          if (this.game.Data.UnitObj[index37].X > -1 & this.game.Data.UnitObj[index37].HQ > -1 & this.game.Data.UnitObj[index37].Regime == this.game.Data.Turn & !this.game.Data.UnitObj[index37].IsHQ & this.game.Data.UnitObj[index37].PreDef == -1)
          {
            ...
            if (!hqlist.CheckIfPresentUnr(hq) && this.game.Data.UnitObj[hq].Historical > -1 && this.game.Data.HistoricalUnitObj[this.game.Data.UnitObj[hq].Historical].Type <= num22)
            {
              ...
              for (index13 = 0; index13 <= counter14; index13 += 1)
              {
                int tdata2 = 0;
                int unitCounter3 = this.game.Data.UnitCounter;
                for (int index38 = 0; index38 <= unitCounter3; index38 += 1)
                {
        ...
        if (this.CustomCalls.HasCustumCalls() & this.CustomCalls.CustomRuleHQtoFrontAssign_AllowHQGroupsWithoutHQ(-1))
        {
          ...
          for (int tunr = 0; tunr <= unitCounter4; tunr += 1)
          {
            ...
            {
              int tdata2 =  Math.Round((double) this.game.Data.UnitObj[tunr].TempUnitPower * 0.8) +  Math.Round((double) this.game.Data.UnitObj[tunr].TempUnitPowerAbs * 0.2);
        ...
        SimpleList simpleList4 = SimpleList::new();
        int mapWidth8 = this.game.Data.MapObj[0].MapWidth;
        for (int index39 = 0; index39 <= mapWidth8; index39 += 1)
        {
          int mapHeight = this.game.Data.MapObj[0].MapHeight;
        ...
        do
        {
          ...
          if (this.VAR_ZONES_TYPE >= 1 & num26 == 1)
          {
            ...
            for (int tdata1 = 0; tdata1 <= mapWidth9; tdata1 += 1)
            {
              int mapHeight = this.game.Data.MapObj[0].MapHeight;
              for (int tdata2 = 0; tdata2 <= mapHeight; tdata2 += 1)
              {
            ...
            for (int index50 = 0; index50 <= counter15; index50 += 1)
            {
              bool flag2 = false;
              ...
              if (this.VAR_ZONES_TYPE == 1 | this.VAR_ZONES_TYPE == 2 & flag2 | this.VAR_ZONES_TYPE == 3 & (simpleList5.Id[index50] < 200000 | simpleList5.Id[index50] > 200000 & flag2))
              {
                ...
                for (int index51 = 0; index51 <= mapWidth10; index51 += 1)
                {
                  int mapHeight = this.game.Data.MapObj[0].MapHeight;
              ...
              if ((double) this.game.Data.RuleVar[748] < 1.0 && this.VAR_ZONES_TYPE == 1 | this.VAR_ZONES_TYPE == 3 & simpleList5.Id[index50] < 200000)
              {
                SimpleList simpleList6 = SimpleList::new();
                int unitCounter5 = this.game.Data.UnitCounter;
                for (int index53 = 0; index53 <= unitCounter5; index53 += 1)
                {
                ...
                for (int index58 = 0; index58 <= counter16; index58 += 1)
                {
                  int num34 =  Math.Round((double) simpleList6.Data2[index58] / (double) (1 + simpleList6.Data1[index58]));
                ...
                if (simpleList6.Counter > 0)
                {
                  ...
                  for (int index59 = 1; index59 <= counter17; index59 += 1)
                  {
              ...
              int unitCounter6 = this.game.Data.UnitCounter;
              for (int index61 = 0; index61 <= unitCounter6; index61 += 1)
              {
              ...
              for (int index62 = 0; index62 <= counter18; index62 += 1)
              {
                index13 = 0;
                int num36 = 0;
                int num37 = 0;
                ...
                {
                  int mapWidth11 = this.game.Data.MapObj[0].MapWidth;
                  for (int index63 = 0; index63 <= mapWidth11; index63 += 1)
                  {
                    int mapHeight = this.game.Data.MapObj[0].MapHeight;
                    for (int index64 = 0; index64 <= mapHeight; index64 += 1)
                    {
                ...
                if (num36 > 0 & num35 > 0)
                {
                  int num40 =  Math.Round((double) (index13 * 2) / (double) num36) +  Math.Round((double) (num37 * 1) / (double) num36);
                  ...
                  if (this.VAR_ZONES_TYPE == 1 | this.VAR_ZONES_TYPE == 3 & simpleList5.Id[index50] < 200000)
                  {
                    ...
                    int unitCounter7 = this.game.Data.UnitCounter;
                    int num42;
                    for (int index65 = 0; index65 <= unitCounter7; index65 += 1)
                    {
                    ...
                    int num44 = 0;
                    int mapWidth12 = this.map.MapWidth;
                    for (int index66 = 0; index66 <= mapWidth12; index66 += 1)
                    {
                      int mapHeight = this.map.MapHeight;
                      for (int index67 = 0; index67 <= mapHeight; index67 += 1)
                      {
          ...
          if (num26 == 1 & this.VAR_ZONES_TYPE >= 1 | num26 == 2)
          {
            ...
            if (this.game.Data.Product < 6)
            {
              while (flag3)
              {
                ...
                for (index68 = 0; index68 <= counter21; index68 += 1)
                {
                  ...
                  for (int index69 = num50; index69 <= counter22; index69 += 1)
                  {
            ...
            else
            {
              while (flag3)
              {
                ...
                for (index68 = 0; index68 <= counter23; index68 += 1)
                {
                  ...
                  for (int index70 = num51; index70 <= counter24; index70 += 1)
                  {
            ...
            for (int index71 = 0; index71 <= counter25; index71 += 1)
            {
              ...
              if (num26 == 1 & ((this.VAR_ZONES_TYPE == 1 | this.VAR_ZONES_TYPE == 3) & tempFront.OffensiveZone > 0 | (this.VAR_ZONES_TYPE == 2 | this.VAR_ZONES_TYPE == 3) & tempFront.DefensiveZone > 0) | num26 == 2)
              {
                ...
                if (!flag4 & this.game.Data.Product >= 6 & (tempFront.DefensiveZone < 1 | num26 == 1))
                {
                  ...
                  for (int index72 = 0; index72 <= counter26; index72 += 1)
                  {
                ...
                if (flag4)
                {
                  ...
                  for (int index73 = 0; index73 <= counter27; index73 += 1)
                  {
                    ...
                    coordinate.onmap = false;
                    int mapWidth13 = this.map.MapWidth;
                    for (int index75 = 0; index75 <= mapWidth13; index75 += 1)
                    {
                      int mapHeight = this.map.MapHeight;
                      for (int index76 = 0; index76 <= mapHeight; index76 += 1)
                      {
                    ...
                    if (flag5)
                    {
                      ...
                      int unitCounter8 = this.game.Data.UnitCounter;
                      for (int unr = 0; unr <= unitCounter8; unr += 1)
                      {
                      ...
                      if (num58 > 9999)
                        num58 = 9999;
                      int num62 =  Math.Round((double) num56 / (double) num55);
                      int num63 =  Math.Round((double) num58 / (double) num55);
                      if (this.game.Data.Product == 6)
                      {
                        num62 *= 2;
                        num63 *= 2;
                      ...
                      int num68 = 0;
                      int unitCounter9 = this.game.Data.UnitCounter;
                      for (int index77 = 0; index77 <= unitCounter9; index77 += 1)
                      {
                        if (this.game.Data.UnitObj[index77].X > -1 & (index77 == index74 | this.game.Data.UnitObj[index77].HQ == index74) & this.game.Data.UnitObj[index77].Regime == this.game.Data.Turn & !this.game.Data.UnitObj[index77].IsHQ & this.game.Data.UnitObj[index77].PreDef == -1 && this.game.Data.UnitObj[index77].AISubStrictGroup == num53 && !Information.IsNothing((object) this.game.Data.UnitObj[index77].prevTurnAiFrontHexes))
                        {
                          ...
                          for (int index78 = 0; index78 <= counter28; index78 += 1)
                          {
                      ...
                      if (tempFront.FrontHexes > 0)
                      {
                        ...
                        for (int index79 = 0; index79 <= counter29; index79 += 1)
                        {
                      ...
                      if (num61 > 0)
                      {
                        int num76 =  Math.Round((double) num60 / (double) num61);
                      ...
                      int num79 = ((this.game.Data.Product >= 6 ?  Math.Round((double) num65 * (double) num77 * 0.66) +  Math.Round((double) num65 * 0.33) :  Math.Round((double) num65 * (double) num77 * 0.5) +  Math.Round((double) num65 * 0.5)) + 2) * 2;
                      ...
                      if (tempFront.ThreatPercentage > 0 | tempFront.OpportunityPercentage > 0)
                      {
                        ...
                        int num81 = (double) num77 <= 4.0 ? ((double) num77 <= 2.5 ? ((double) num77 <= 1.5 ? ((double) num77 >= 0.66 ? ((double) num77 >= 0.33 ? num80 * 1 : num80 * 2) :  Math.Round((double) num80 * 1.5)) :  Math.Round((double) num80 / 1.5)) :  Math.Round((double) num80 / 2.0)) :  Math.Round((double) num80 / 3.0);
                        if (num81 > 100)
                          num81 = num81;
                        if (num81 > 0)
                      ...
                      if (flag5 & (double) (num79 * num75) / 2.0 < 1.0)
                      {
                        ...
                        for (int index80 = 0; index80 <= mapWidth14; index80 += 1)
                        {
                          int mapHeight = this.map.MapHeight;
                          for (int index81 = 0; index81 <= mapHeight; index81 += 1)
                          {
                      ...
                      if (flag5)
                      {
                        int tweight =  Math.Round((double) (num66 * num79 * num75) * (double) num82 / 2.0);
          ...
          for (int index82 = 0; index82 <= counter30; index82 += 1)
          {
            ...
            for (int index84 = 0; index84 <= counter31; index84 += 1)
            {
            ...
            if (!flag9)
            {
              ...
              for (int unr1 = 0; unr1 <= counter32; unr1 += 1)
              {
                ...
                for (int index85 = 0; index85 <= mapWidth15; index85 += 1)
                {
                  int mapHeight = this.map.MapHeight;
                  for (int index86 = 0; index86 <= mapHeight; index86 += 1)
                  {
                ...
                else
                {
                  ...
                  if (flag12 & flag10)
                  {
                    ...
                    if (this.game.Data.Product >= 7)
                      num87 = num23;
                    int num88 = num87;
                    for (int taid = 1; taid <= num88; taid += 1)
                    {
                ...
                if (flag10)
                {
                  ...
                  for (int unr2 = 0; unr2 <= unitCounter10; unr2 += 1)
                  {
                  ...
                  if (num95 == 0)
                    num95 = 1;
                  int num98 =  Math.Round((double) num92 / (double) num90);
                  int num99 =  Math.Round((double) num94 / (double) num90);
                  int num100 =  Math.Round((double) num98 / (double) num93 * 1.0 + (double) num99 / (double) num95) + 1;
                  int num101 =  Math.Round((double)  Math.Round((double) num100 * Math.Max(1.0, (double) num100 * 0.1)) / 4.0);
                  int num102 = 20;
                  int num103 = 0;
                  int num104 = 0;
                  int unitCounter11 = this.game.Data.UnitCounter;
                  for (int index87 = 0; index87 <= unitCounter11; index87 += 1)
                  {
                    if (this.game.Data.UnitObj[index87].X > -1 & (index87 == index83 | this.game.Data.UnitObj[index87].HQ == index83) & this.game.Data.UnitObj[index87].Regime == this.game.Data.Turn & !this.game.Data.UnitObj[index87].IsHQ & this.game.Data.UnitObj[index87].PreDef == -1 && this.game.Data.UnitObj[index87].AISubStrictGroup == num85 && !Information.IsNothing((object) this.game.Data.UnitObj[index87].prevTurnAiFrontHexes))
                    {
                      ...
                      for (int index88 = 0; index88 <= counter33; index88 += 1)
                      {
                  ...
                  int num105 = 0;
                  int curFr = !(this.CustomCalls.HasCustumCalls() & this.CustomCalls.CustomRuleHQtoFrontAssign_UnitInCorrectFront_SeeSSHQasSeperateHQ(index83)) ? num105 + hqlist.data2[index82] : num105 +  Math.Round((double) hqlist.data2[index82] / 4.0);
                  ...
                  if (tempFront.FrontHexes > 0)
                  {
                    ...
                    for (int index89 = 0; index89 <= counter34; index89 += 1)
                    {
                      bool flag13 = true;
                      if (this.game.Data.Product >= 6)
                      {
                  ...
                  if (this.game.Data.Product >= 6 && !this.CustomCalls.CustomRuleHQtoFrontAssign_UnitInCorrectFront_SeeSSHQasSeperateHQ(index83))
                  {
                    ...
                    for (int index92 = 0; index92 <= counter37; index92 += 1)
                    {
                      int taid = 1;
                      do
                      {
                        if (taid != num85 && tfrontlist.Front[index92].strictHQs.CheckIfPresentUnr(index83, taid))
                        {
                          ...
                          for (int index93 = 0; index93 <= counter38; index93 += 1)
                          {
                    ...
                    if (index13 > 0)
                    {
                      int num113 =  Math.Round((double) (100 * num112) / (double) index13);
                      if (num113 < 10)
                        score2 *= 2;
                      else if (num113 < 50)
                        score2 *= 1;
                  ...
                  if (num96 > 0)
                  {
                    int num114 =  Math.Round((double) num97 / (double) num96);
                  ...
                  if (tempFront.FrontID == 362)
                    index82 = index82;
                  int num118 = this.game.Data.Product >= 6 ?  Math.Round((double) num101 * (double) num115 * 0.8) +  Math.Round((double) num101 * 0.2) :  Math.Round((double) num101 * (double) num115 * 0.7) +  Math.Round((double) num101 * 0.3);
                  if (this.CustomCalls.HasCustumCalls())
                  {
                    if (num118 < 1)
                      num118 = 1;
                  ...
                  if (tempFront.ThreatPercentage > 0 | tempFront.OpportunityPercentage > 0)
                  {
                    ...
                    int num121 = (double) num115 <= 4.0 ? ((double) num115 <= 2.5 ? ((double) num115 <= 1.5 ? ((double) num115 >= 0.66 ? ((double) num115 >= 0.33 ? num120 * 1 : num120 * 2) :  Math.Round((double) num120 * 1.5)) :  Math.Round((double) num120 / 1.5)) :  Math.Round((double) num120 / 2.0)) :  Math.Round((double) num120 / 3.0);
                    if (num121 > 100)
                      num121 = num121;
                    if (num121 > 0)
                  ...
                  if (flag10 & (double) (score1 * score2) / 4.0 < 2999.0)
                  {
                    ...
                    for (int index94 = 0; index94 <= mapWidth16; index94 += 1)
                    {
                      int mapHeight = this.map.MapHeight;
                      for (int index95 = 0; index95 <= mapHeight; index95 += 1)
                      {
                  ...
                  if (flag10)
                  {
                    int num124 =  Math.Round((double) (num102 * score1 * score2) * (double) score3 / 4.0);
                    if (this.CustomCalls.HasCustumCalls())
      ...
      for (int unr = 0; unr <= unitCounter12; unr += 1)
      {
      ...
      if (this.game.Data.Product <= 5)
      {
        ...
        for (int unr = 0; unr <= unitCounter13; unr += 1)
        {
          if (this.game.Data.UnitObj[unr].PreDef == -1 & this.game.Data.UnitObj[unr].AIGroup == -1 & this.game.HandyFunctionsObj.GetRegime(this.game.Data.UnitObj[unr].Regime) == this.GetGameDataTurn())
          {
            int x = this.game.Data.UnitObj[unr].X;
      ...
      for (int index96 = 0; index96 <= counter39; index96 += 1)
      {
        ...
        if (tempFront.units.counter > -1)
        {
          ...
          for (int index97 = 0; index97 <= counter40; index97 += 1)
          {
