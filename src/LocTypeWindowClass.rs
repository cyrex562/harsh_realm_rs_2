...
namespace WindowsApplication1
{
  pub class LocTypeWindowClass : WindowClass
  {
     ...
     int BAddLocTypeId;
     int BAddLocTypeTextId;
     int BAddLocType2Id;
     int BAddLocTypeText2Id;
     int BNameId;
     int BNameTextId;
     int OptionsListId;
     ListClass OptionsListObj;
     int BRemoveLocTypeId;
     int BRemoveLocTypeTextId;
     int BRemoveLocTypeId2;
     int BRemoveLocTypeTextId2;
     int BDrawId;
     int BDrawTextId;
     int descid;
     int desctxtid;
    ...
    pub LocTypeWindowClass( GameClass tGame)
    ...
    pub void DoRefresh() => this.MakeLocTypeTypeItemGUI();

     void MakeLocTypeListGUI(int tLocTypenr)
    {
