...
namespace WindowsApplication1
{
  pub class LISTrafficWindowClass : WindowClass
  {
    ...
    pub void View()
    {
      ...
      int stringListById3 = this.game.HandyFunctionsObj.GetStringListByID( Math.Round((double) this.game.Data.RuleVar[405]));
      ...
      if ( Math.Round(Conversion.Val(this.game.Data.Designer)) >= 42 & !this.game.Data.RegimeObj[this.game.Data.Turn].AI & !this.game.Data.RegimeObj[this.game.Data.Turn].minimumDataUsage)
      {
        ...
        do
        {
          ...
          else
          {
            ...
            int num12 = this.AddSubPart( tsubpart8, num9, num10, 60, 40, 1);
            pullId[index6] = num12;
        ...
        if (this.game.Data.MapObj[0].HexObj[this.game.SelectX, this.game.SelectY].RoadType[index7] > -1 & x1_1 > 0)
        {
          ...
          do
          {
            ...
            else
            {
              ...
              int num16 = this.AddSubPart( tsubpart8, num14, num15, 40, 40, 1);
      ...
      else
      {
        ...
        {
          int idValue =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].GetData(9, this.game.EditObj.layerLisOnlyAssetId, 1)));
          int num22 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].GetData(9, this.game.EditObj.layerLisOnlyAssetId, 3)));
          int num23 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById1].GetData(9, this.game.EditObj.layerLisOnlyAssetId, 4)));
          str4: String = this.game.Data.StringListObj[stringListById2].GetData(0, idValue, 12);
          int nr =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById2].GetData(0, idValue, 2)));
          if (nr > 0)
        ...
        if (this.game.EditObj.layerLis_LogType == 1)
        {
          ...
          for (int index11 = 0; index11 <= length; index11 += 1)
          {
            ...
            {
              int tdata1 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[index11, 5]));
              if (tdata1 > -1)
              {
                int tdata2 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[index11, 6]));
                int tdata3 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[index11, 7]));
        ...
        for (int tdata = 0; tdata <= length1; tdata += 1)
        {
          if ( Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[tdata, 0])) == this.game.SelectX &&  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[tdata, 1])) == this.game.SelectY)
          {
            ...
            {
              int num30 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[tdata, 5]));
              int num31 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[tdata, 6]));
              int num32 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index10].Data[tdata, 7]));
...
label_160:
                    ...
                    {
                      int mapWidth = this.game.Data.MapObj[0].MapWidth;
                      for (int index29 = 0; index29 <= mapWidth; index29 += 1)
                      {
                        int mapHeight = this.game.Data.MapObj[0].MapHeight;
              ...
              {
                int mapWidth = this.game.Data.MapObj[0].MapWidth;
                for (int index32 = 0; index32 <= mapWidth; index32 += 1)
                {
                  int mapHeight = this.game.Data.MapObj[0].MapHeight;
