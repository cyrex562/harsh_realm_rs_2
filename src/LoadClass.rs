    ...
    pub void Go()
    {
      ...
      if (this.game.useModLib)
      {
        if (Strings.InStr(str1, "evlib") < 1 & this.game.EditObj.ButtonLoadMode)
        {
          ...
          for (int index1 = 0; index1 <= modlibCounter; index1 += 1)
          {
              ...
              if (simpleStringList.FindNr(this.game.modlib_Name[index1].ToLower()) == -1)
              {
                ...
                if (File.Exists(this.game.EditObj.TempFileName))
                {
                  try
                  {
                    ...
                    for (int index3 = 0; index3 <= peopleCounter; index3 += 1)
                      subPpl[index3] = -1;
                    int libraryCounter = dataClass.LibraryCounter;
                    for (int index4 = 0; index4 <= libraryCounter; index4 += 1)
                    {
                      sublib[index4] = -1;
                      numArray[index4] = -1;
                    }
        ...
        for (int index5 = 0; index5 <= stringListCounter; index5 += 1)
        {
          if (Operators.CompareString(this.game.Data.StringListObj[index5].Name, "Modify existing table", false) == 0)
          {
            ...
            {
              int num =  Math.Round(Conversion.Val(this.game.Data.StringListObj[index5].Data[index6, 1]));
      ...
      for (int index9 = 0; index9 <= unitCounter1; index9 += 1)
      {
      ...
      if (this.game.Data.Product == 7)
      {
        ...
        if (stringListById1 > -1)
        {
          ...
          try
          {
            ...
            {
              int num1 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length3, 0]));
              int num2 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length3, 1]));
              int num3 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length3, 8]));
              if (num2 >= 3241 & num2 <= 3247 & num3 < 1)
              {
                for (int length4 = this.game.Data.StringListObj[stringListById3].Length; length4 >= 0; length4 += -1)
                {
                  int num4 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length4, 0]));
                  int num5 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length4, 1]));
                  if (length3 != length4 & num4 == num1 && num5 >= 3241 & num5 <= 3247)
                  {
                    int num6 =  Math.Round(Conversion.Val(this.game.Data.StringListObj[stringListById3].Data[length4, 8]));
                    if (num2 > num5 & num6 < 1)
      ...
      else
      {
        if (Strings.Len(this.game.Data.LoadPass) > 0)
        {
          ...
          {
            int num7 =  Interaction.MsgBox((object) "You are cleared.", Title: ((object) "Shadow Empire : Planetary Conquest"));
          }
          else
          {
            int num8 =  Interaction.MsgBox((object) "Wrong Password. You cannot Load this file", Title: ((object) "Shadow Empire : Planetary Conquest"));
