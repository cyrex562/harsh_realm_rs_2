...
{
  public class CombatSelectWindowClass : WindowClass
  {
    private int okid;
    private int cancelid;
    private int mapButId;
    private int oktextid;
    private UnitList UL;
    private UnitList DL;
    private int oldUnitSelected;
    private int oldSelectx;
    private int oldSelecty;
    private int oldMode1;
    private int oldMode2;
    private CoordList oldTempCoordList;
    private CoordList oldTempCoordLastMoveList;
    ...
    public CombatSelectWindowClass(ref GameClass tGame)
    ...
    public void View()
    {
      ...
      DrawMod.DrawBlock(ref toG, 443, 220, 410, 320, 0, 0, 0, (int) byte.MaxValue);
      ...
      DrawMod.DrawRectangle(ref toG, 450, 80, 376, 50, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, 85, 2);
      DrawMod.DrawTextColouredMarc(ref toG, str1, this.game.MarcFont1, (int) Math.Round(640.0 - (double) sizeF2.Width / 2.0), 90, Color.White);
      int x1 = 136;
      int y1 = 152;
      int num2 = x1;
      int num3 = y1;
      ...
      if (landscapeType > -1 & spriteNr > -1 && this.game.Data.Product > 6 & (double) this.game.Data.RuleVar[410] > 0.0)
      {
        ...
        string str2 = "Enemy Forces";
        SizeF sizeF3 = toG.MeasureString(str2, this.game.MarcFont4);
        DrawMod.DrawTextColouredMarc(ref toG, str2, this.game.MarcFont4, (int) Math.Round((double) ((float) (num5 + 120 + 70) - sizeF3.Width / 2f)), num6 - 10, Color.White);
        int num12 = -1;
      ...
      string str3 = "Eligible Forces";
      SizeF sizeF4 = toG.MeasureString(str3, this.game.MarcFont4);
      DrawMod.DrawTextColouredMarc(ref toG, str3, this.game.MarcFont4, (int) Math.Round((double) ((float) (num15 + 120 + 70) - sizeF4.Width / 2f)), num16 - 10, Color.White);
      int num17 = -1;
      ...
      do
      {
        ...
        for (int index = 0; index <= counter2; ++index)
        {
          if (simpleStringList.Data3[index] == num20 & simpleStringList.Data2[index] != 0 & simpleStringList.Data4[index] > 0)
          {
            ...
            string str4 = Strings.Left(simpleStringList.Id[index], num23 - 1);
            string ttext = Strings.Mid(simpleStringList.Id[index], num23 + 1);
      ...
      while (num20 >= 0);
      string str5 = "odds " + num19.ToString() + " : " + num18.ToString();
      Color color;
      if (num19 > 0 & num18 < 1)
      ...
      else if (num19 >= num18)
      {
        ...
        color = (double) num25 >= 1.5 ? ((double) num25 >= 2.0 ? ((double) num25 >= 3.0 ? ((double) num25 >= 5.0 ? ((double) num25 >= 10.0 ? Color.FromArgb((int) byte.MaxValue, 0, 210, 50) : Color.FromArgb((int) byte.MaxValue, 50, 200, 50)) : Color.FromArgb((int) byte.MaxValue, 90, 200, 50)) : Color.FromArgb((int) byte.MaxValue, 130, 200, 50)) : Color.FromArgb((int) byte.MaxValue, 170, 200, 50)) : Color.FromArgb((int) byte.MaxValue, 210, 200, 50);
      ...
      else if (num18 > num19)
      {
        ...
        color = (double) num26 >= 1.5 ? ((double) num26 >= 2.0 ? ((double) num26 >= 3.0 ? ((double) num26 >= 5.0 ? ((double) num26 >= 10.0 ? Color.FromArgb((int) byte.MaxValue, 220, 10, 50) : Color.FromArgb((int) byte.MaxValue, 220, 50, 50)) : Color.FromArgb((int) byte.MaxValue, 220, 90, 50)) : Color.FromArgb((int) byte.MaxValue, 220, 130, 50)) : Color.FromArgb((int) byte.MaxValue, 220, 170, 50)) : Color.FromArgb((int) byte.MaxValue, 220, 210, 50);
        str5 = "odds  1 : " + num26.ToString();
      }
      DrawMod.DrawBlock(ref toG, 468, 559, 344, 60, 0, 0, 0, 55);
      DrawMod.DrawBlock(ref toG, 468, 559, 344, 60, (int) color.R, (int) color.G, (int) color.B, 105);
      DrawMod.DrawRectangle(ref toG, 468, 559, 344, 60, (int) byte.MaxValue, (int) byte.MaxValue, (int) byte.MaxValue, 105, 2);
      ...
      string str6 = "Attacking Forces";
      SizeF sizeF5 = toG.MeasureString(str6, this.game.MarcFont4);
      DrawMod.DrawTextColouredMarc(ref toG, str6, this.game.MarcFont4, (int) Math.Round((double) ((float) (num27 + 120 + 70) - sizeF5.Width / 2f)), num28 - 10, Color.White);
      int num29 = -1;
      ...
      int num31 = 842;
      int num32 = 30;
      ListClass tListobj = new ListClass();
      ...
      int num34;
      int num35;
      for (int index3 = 0; index3 <= counter5; ++index3)
      {
      ...
      int Number2 = num34 <= 0 ? 0 : (int) Math.Round((double) num35 / (double) num34);
          ...
          for (int i = 0; i <= sfCount; ++i)
          {
            ...
            if (reconMinusHide2.x > 1)
            {
              ...
              if (reconMinusHide2.x < 3 && this.game.Data.FOWOn & this.game.Data.UnitObj[unit2].Regime != this.game.Data.Turn && reconMinusHide2.x == 2)
              {
                ...
                num40 = (int) Math.Round((double) ((VBMath.Rnd() * num42 + num41) * (float) qty));
                if (num40 < 1)
                  num40 = 1;
      ...
      if (tListobj.ListCount > num45)
      {
        ...
        for (int index13 = num46; index13 <= listCount; ++index13)
        {
          Number4 += (int) Math.Round(Conversion.Val(tListobj.ListValue[index13]));
          Number5 += (int) Math.Round(Conversion.Val(tListobj.ListValue2[index13]));
        }
      ...
      if (num47 < 2)
        num47 = 2;
      int Number6 = (int) Math.Round((double) (this.game.Data.RuleVar[31] * (float) num47));
      int Number7 = (int) Math.Round((double) this.game.Data.RuleVar[30]);
      if (this.game.EditObj.OrderType == 11)
        Number6 = (int) Math.Round((double) this.game.Data.RuleVar[834]);
      if (this.game.EditObj.OrderType == 14)
        Number6 = (int) Math.Round((double) this.game.Data.RuleVar[833]);
      if (this.game.EditObj.OrderType == 33)
        Number6 = (int) Math.Round((double) this.game.Data.RuleVar[833]);
      ...
      string str7 = "Combat Totals";
      SizeF sizeF6 = toG.MeasureString(str7, this.game.MarcFont4);
      DrawMod.DrawTextColouredMarc(ref toG, str7, this.game.MarcFont4, (int) Math.Round((double) ((float) (num31 + 120 + 70) - sizeF6.Width / 2f)), num32 - 10, Color.White);
      int num48 = 7;
      ...
      string tDescript1 = "Click to start the attack [Space]";
      string tDescript2 = "Select some attackers in order to be able to attack [Space]";
      if (this.game.EditObj.OrderType == 11)
      {
      ...
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(buttontext, 350, tDescript1, ref this.OwnBitmap, 468, 631, tred: true, theight: 85, usefont: this.game.MarcFont1, useshadow: true, tMarcStyle: true);
        this.okid = this.AddSubPart(ref tsubpart, 468, 631, 350, 85, 1);
      }
      else
      {
        SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(buttontext, 350, tDescript2, ref this.OwnBitmap, 468, 631, true, true, 85, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
        this.okid = this.AddSubPart(ref tsubpart, 468, 631, 350, 85, 1);
      }
      SubPartClass tsubpart1 = (SubPartClass) new TextButtonPartClass("Cancel", 150, "Click to return to main screen [Esc]", ref this.OwnBitmap, 680, 142, theight: 65, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      this.cancelid = this.AddSubPart(ref tsubpart1, 680, 142, 150, 65, 1);
      SubPartClass tsubpart2 = (SubPartClass) new TextButtonPartClass("Switch", 150, "Switch between Regular Attack and Ranged Attack preperation", ref this.OwnBitmap, 450, 142, theight: 65, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
      this.switchId = this.AddSubPart(ref tsubpart2, 450, 142, 150, 65, 1);
      SubPartClass tsubpart3 = (SubPartClass) new TextButtonPartClass("Map", 70, "Select elgible Units on the Map instead.", ref this.OwnBitmap, 605, 142, theight: 65, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
