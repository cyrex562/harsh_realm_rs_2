...
{
  public class ATListSubPartClass : SubPartClass
  {
    ...
    public override void Refresh(ATListClass tListObj, int tlistselect, string theader = "")
    {
    ...
    public override int GetSelect() => this.ListSelect < 0 || this.ListSelect > this.ListObj.ListCount ? -1 : this.ListObj.ListData[this.ListSelect];
