...
{
  public class IntroWindowClass2 : WindowClass
  {
    private int BStartGameID;
    private int Bstartgame2id;
    private int BLoadGameID;
    private int BSaveGameID;
    private int BRandomID;
    private int BEditorID;
    private int BSimpleId;
    private int BEditorIDb;
    private int BSimpleIdb;
    ...
    public IntroWindowClass2(ref GameClass tGame)
      : base(ref tGame, 1024, 768, BackSprite: tGame.BACKGROUND1MARC)
    {
      ...
      if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.Inspecting | this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.PlayTurn && this.game.EditObj.PbemChallengeMiscData.Length >= 60)
      {
        ...
        while (index1 <= 11);
        int num = Math.Min(7, this.game.Data.RegimeCounter);
    ...
    public override WindowReturnClass HandleKeyPress(int nr, bool fromTimer = false)
    {
      ...
      WindowReturnClass windowReturnClass2 = this.HandleMouseClick(this.SubPartX[this.SubpartNr(this.cancelID)] + 1, this.SubPartY[this.SubpartNr(this.cancelID)] + 1, 1);
    ...
    public void DoStuff()
    {
      ...
      if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.MakingChallenge)
      {
        DrawMod.DrawTextColouredMarc(ref graphics, "SCENARIO:", this.game.MarcFont1, 175, 27, Color.White);
        SubPartClass tsubpart = (SubPartClass) new InputTextClass(this.game.EditObj.PbemTitle, this.game.MarcFont4, 200, 20, false, 50, true);
        this.title = this.AddSubPart(ref tsubpart, 320, 34, 200, 20, 0);
      }
      else
      {
        DrawMod.DrawTextColouredMarc(ref graphics, "SCENARIO:", this.game.MarcFont1, 175, 27, Color.White);
        DrawMod.DrawTextColouredMarc(ref graphics, Strings.UCase(this.game.Data.Name), this.game.MarcFont2, 315, 27, Color.White);
      }
      if (Strings.Len(this.game.Data.Designer) >= 1)
      {
        string tstring = this.game.Data.Designer;
        if (Strings.Len(this.game.Data.Designer2) > 0)
          tstring = tstring + " & " + this.game.Data.Designer2;
        SizeF sizeF2 = graphics.MeasureString("by: " + tstring, new Font("Arial Black", 19f, FontStyle.Regular, GraphicsUnit.Pixel));
        int x = (int) Math.Round((double) (950f - sizeF2.Width));
        DrawMod.DrawTextColouredMarc(ref graphics, "by:", this.game.MarcFont1, x, 27, Color.White);
        DrawMod.DrawTextColouredMarc(ref graphics, tstring, this.game.MarcFont2, x + 50, 27, Color.White);
        Rectangle trect = new Rectangle(x, 27, (int) Math.Round((double) sizeF2.Width), (int) Math.Round((double) sizeF2.Height));
        this.AddMouse(ref trect, "", "The name of the designer of this scenario");
        if (this.game.Data.scenarioVersion.Length > 0)
        {
          DrawMod.DrawTextColouredMarc(ref graphics, "SCN VERSION: ", this.game.MarcFont14, 181, 65, Color.FromArgb((int) byte.MaxValue, 240, 240, 240));
          DrawMod.DrawTextColouredMarc(ref graphics, this.game.Data.scenarioVersion.ToUpper(), this.game.MarcFont14, 260, 65, Color.FromArgb((int) byte.MaxValue, 220, 220, 220));
        }
      }
      DrawMod.DrawBlock(ref graphics, 180, 60, 775, 3, (int) this.game.MarcCol4.R, (int) this.game.MarcCol4.G, (int) this.game.MarcCol4.B, (int) this.game.MarcCol4.A);
      ref Graphics local1 = ref graphics;
      Bitmap bitmap = BitmapStore.GetBitmap(this.game.LOGOFLATTINY);
      ref Bitmap local2 = ref bitmap;
      DrawMod.DrawSimple(ref local1, ref local2, 20, 21);
      if (this.game.Data.CampaignRoom == -1)
      {
        DrawMod.DrawSimple(ref graphics, ref this.game.EditObj.MiniMap, 620, 458);
        DrawMod.DrawBlockGradient2(ref graphics, 620, 458, 299, 214, this.game.MarcCol1, this.game.MarcCol2);
        DrawMod.DrawFrame(ref this.OwnBitmap, ref this.BackBitmap, ref graphics, 620, 458, 300, 215, -1, -1);
        DrawMod.DrawTextColouredMarc(ref graphics, "MAP", this.game.MarcFont4, 630, 437, Color.White);
      }
      int num1 = 490 + this.game.EditObj.MiniMap.Width;
      if (this.game.Data.UseAI >= 1 & !this.game.Data.NoAIAdvice & this.game.Data.RegimeCounter > -1)
      {
        if (this.game.Data.UseAI == 1)
          DrawMod.DrawTextColouredMarc(ref graphics, "AI (DC1) SETTINGS", this.game.MarcFont1, 90, 120, Color.White);
        if (this.game.Data.UseAI == 2)
          DrawMod.DrawTextColouredMarc(ref graphics, "AI SETTINGS", this.game.MarcFont1, 90, 120, Color.White);
        DrawMod.DrawBlock(ref graphics, 90, 150, 250, 2, (int) this.game.MarcCol3.R, (int) this.game.MarcCol3.G, (int) this.game.MarcCol3.B, (int) this.game.MarcCol3.A);
        DrawMod.DrawBlockGradient2(ref graphics, 140, 158, 199, 79, this.game.MarcCol1, this.game.MarcCol2);
        DrawMod.DrawFrame(ref this.OwnBitmap, ref this.BackBitmap, ref graphics, 140, 158, 200, 80, -1, -1);
        if (this.game.Data.Product == 6)
        {
          if (this.game.Data.RegimeObj[0].AIHelpStrategic == 0)
            DrawMod.DrawTextColouredMarc(ref graphics, "NORMAL AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
          else if (this.game.Data.RegimeObj[0].AIHelpStrategic == 50)
            DrawMod.DrawTextColouredMarc(ref graphics, "CHALLENGING AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
          else if (this.game.Data.RegimeObj[0].AIHelpStrategic == 100)
            DrawMod.DrawTextColouredMarc(ref graphics, "HARD AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
          else if (this.game.Data.RegimeObj[0].AIHelpStrategic == 150)
            DrawMod.DrawTextColouredMarc(ref graphics, "VERY HARD AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
          else if (this.game.Data.RegimeObj[0].AIHelpStrategic == 200)
            DrawMod.DrawTextColouredMarc(ref graphics, "SUPER HARD AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
        }
          ...
          DrawMod.DrawTextColouredMarc(ref graphics, "SUPER HARD AI DIFFICULTY", this.game.MarcFont5, 150, 170, Color.White);
        SubPartClass tsubpart1 = (SubPartClass) new MarcButtonPartClass(this.game.MARCARROW, tBackbitmap: (ref this.OwnBitmap), bbx: 90, bby: 162);
        this.opt6 = this.AddSubPart(ref tsubpart1, 90, 162, 35, 35, 1);
        SubPartClass tsubpart2 = (SubPartClass) new MarcButtonPartClass(this.game.MARCARROW, tBackbitmap: (ref this.OwnBitmap), bbx: 90, bby: 202);
        this.opt4 = this.AddSubPart(ref tsubpart2, 90, 202, 35, 35, 1);
        if (this.game.Data.RegimeObj[0].ProdBonus == 0)
          DrawMod.DrawTextColouredMarc(ref graphics, "FAST AI SPEED", this.game.MarcFont5, 150, 207, Color.White);
        else if (this.game.Data.RegimeObj[0].ProdBonus <= 100)
          DrawMod.DrawTextColouredMarc(ref graphics, "NORMAL AI SPEED", this.game.MarcFont5, 150, 207, Color.White);
        else if (this.game.Data.RegimeObj[0].ProdBonus <= 250)
          DrawMod.DrawTextColouredMarc(ref graphics, "SLOW AI SPEED", this.game.MarcFont5, 150, 207, Color.White);
      }
      DrawMod.DrawTextColouredMarc(ref graphics, "SETTINGS", this.game.MarcFont1, 370, 120, Color.White);
      DrawMod.DrawBlock(ref graphics, 370, 150, 600, 2, (int) this.game.MarcCol3.R, (int) this.game.MarcCol3.G, (int) this.game.MarcCol3.B, (int) this.game.MarcCol3.A);
      DrawMod.DrawBlockGradient2(ref graphics, 420, 158, 144, 239, this.game.MarcCol1, this.game.MarcCol2);
      DrawMod.DrawFrame(ref this.OwnBitmap, ref this.BackBitmap, ref graphics, 420, 158, 145, 240, -1, -1);
      DrawMod.DrawBlockGradient2(ref graphics, 620, 158, 144, 239, this.game.MarcCol1, this.game.MarcCol2);
      DrawMod.DrawFrame(ref this.OwnBitmap, ref this.BackBitmap, ref graphics, 620, 158, 145, 240, -1, -1);
      DrawMod.DrawBlockGradient2(ref graphics, 820, 158, 144, 239, this.game.MarcCol1, this.game.MarcCol2);
      DrawMod.DrawFrame(ref this.OwnBitmap, ref this.BackBitmap, ref graphics, 820, 158, 145, 240, -1, -1);
      if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.None & !this.game.EditorBlock)
      {
        if (((this.game.Data.SimpleEditor ? 1 : 0) & 0) != 0)
        {
          SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass("EDIT", 70, tBackbitmap: (ref this.OwnBitmap), bbx: 140, bby: 718, tinactive: true, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
          this.BEditorIDb = this.AddSubPart(ref tsubpart, 140, 718, 70, 35, 1);
        }
        else
        {
          SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass("EDIT", 70, tBackbitmap: (ref this.OwnBitmap), bbx: 140, bby: 718, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
          this.BEditorID = this.AddSubPart(ref tsubpart, 140, 718, 70, 35, 1);
        }
      }
      if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.None && !this.game.EditorBlockSimple)
      {
        ...
        {
          SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass("SIMPLE EDITOR", 140, tBackbitmap: (ref this.OwnBitmap), bbx: 240, bby: 718, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
          this.BSimpleId = this.AddSubPart(ref tsubpart, 240, 718, 140, 35, 1);
        }
        else
        {
          SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass("SIMPLE EDITOR", 140, tBackbitmap: (ref this.OwnBitmap), bbx: 240, bby: 718, tinactive: true, usefont: this.game.MarcFont3, useshadow: true, tMarcStyle: true);
          this.BSimpleIdb = this.AddSubPart(ref tsubpart, 240, 718, 140, 35, 1);
        }
      }
      SubPartClass tsubpart3;
      if (this.game.Data.RegimeCounter == -1)
      {
        SubPartClass tsubpart4 = (SubPartClass) new MarcButtonPartClass(this.game.BACKBUTTON, tBackbitmap: (ref this.OwnBitmap), bbx: 20, bby: 718);
        this.cancelID = this.AddSubPart(ref tsubpart4, 20, 718, 35, 35, 1);
      }
      else if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.None)
      {
        SubPartClass tsubpart5 = (SubPartClass) new MarcButtonPartClass(this.game.BACKBUTTON, tBackbitmap: (ref this.OwnBitmap), bbx: 20, bby: 718);
        this.cancelID = this.AddSubPart(ref tsubpart5, 20, 718, 35, 35, 1);
        SubPartClass tsubpart6 = (SubPartClass) new TextButtonPartClass("START", 120, tBackbitmap: (ref this.OwnBitmap), bbx: 800, bby: 710, theight: 50, usefont: this.game.MarcFont1, useshadow: true, tMarcStyle: true);
        this.BStartGameID = this.AddSubPart(ref tsubpart6, 800, 710, 120, 50, 1);
      }
      else if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.PlayTurn)
      {
        SubPartClass tsubpart7 = (SubPartClass) new MarcButtonPartClass(this.game.BACKBUTTON, tBackbitmap: (ref this.OwnBitmap), bbx: 20, bby: 710);
        this.cancelID = this.AddSubPart(ref tsubpart7, 20, 710, 35, 35, 1);
        SubPartClass tsubpart8 = (SubPartClass) new TextButtonPartClass("START PBEM++", 240, tBackbitmap: (ref this.OwnBitmap), bbx: 680, bby: 710, theight: 50, usefont: this.game.MarcFont1, useshadow: true, tMarcStyle: true);
        this.BStartGameID = this.AddSubPart(ref tsubpart8, 680, 710, 240, 50, 1);
      }
      else if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.MakingChallenge)
      {
        DrawMod.DrawTextColouredMarc(ref graphics, "Optional", this.game.MarcFont4, 310, 714, Color.White);
        DrawMod.DrawTextColouredMarc(ref graphics, "Password:", this.game.MarcFont4, 310, 730, Color.White);
        if (Information.IsNothing((object) str))
          str = "";
        tsubpart3 = (SubPartClass) new InputTextClass(str, this.game.MarcFont4, 240, 36, false, 20, true);
        this.pass = this.AddSubPart(ref tsubpart3, 400, 714, 240, 36, 0);
        tsubpart3 = (SubPartClass) new MarcButtonPartClass(this.game.BACKBUTTON, tBackbitmap: (ref this.OwnBitmap), bbx: 20, bby: 710);
        this.cancelID = this.AddSubPart(ref tsubpart3, 20, 710, 35, 35, 1);
        ...
        if (num2 == 1 & num3 == 1)
        {
          tsubpart3 = (SubPartClass) new TextButtonPartClass("CHALLENGE", 240, tBackbitmap: (ref this.OwnBitmap), bbx: 680, bby: 710, theight: 50, usefont: this.game.MarcFont1, useshadow: true, tMarcStyle: true);
          this.BStartGameID = this.AddSubPart(ref tsubpart3, 680, 710, 240, 50, 1);
        }
        else
        {
          tsubpart3 = (SubPartClass) new TextButtonPartClass("CHALLENGE", 240, tBackbitmap: (ref this.OwnBitmap), bbx: 680, bby: 710, tinactive: true, theight: 50, usefont: this.game.MarcFont1, useshadow: true, tMarcStyle: true);
          this.Bstartgame2id = this.AddSubPart(ref tsubpart3, 680, 710, 240, 50, 1);
        }
      }
      else if (this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.Inspecting)
      {
        SubPartClass tsubpart9 = (SubPartClass) new MarcButtonPartClass(this.game.BACKBUTTON, tBackbitmap: (ref this.OwnBitmap), bbx: 20, bby: 710);
        this.cancelID = this.AddSubPart(ref tsubpart9, 20, 710, 35, 35, 1);
      }
      if (this.game.Data.CampaignRoom == -1)
      {
        tsubpart3 = (SubPartClass) new TextAreaClass2(this.game, 440, 12, this.game.MarcFont8, this.game.Data.Description, 17, ref this.OwnBitmap, 140, 440, tUseEncy: true);
        this.TempText = this.AddSubPart(ref tsubpart3, 140, 440, 440, 251, 0);
      }
      else
      {
        tsubpart3 = (SubPartClass) new TextAreaClass2(this.game, 740, 12, this.game.MarcFont8, this.game.Data.Description, 17, ref this.OwnBitmap, 140, 440, tUseEncy: true);
        this.TempText = this.AddSubPart(ref tsubpart3, 140, 440, 740, 251, 0);
      }
      if (!this.game.Data.NoPlayChoice)
      {
        DrawMod.DrawTextColouredMarc(ref graphics, "OPPONENTS", this.game.MarcFont1, 90, 245, Color.White);
        DrawMod.DrawBlock(ref graphics, 90, 275, 250, 2, (int) this.game.MarcCol3.R, (int) this.game.MarcCol3.G, (int) this.game.MarcCol3.B, (int) this.game.MarcCol3.A);
        this.doregimelist();
      }
      tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.FOWOn, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 168);
      this.opt1 = this.AddSubPart(ref tsubpart3, 380, 168, 35, 35, 1);
      DrawMod.DrawTextColouredMarc(ref graphics, "FOG OF WAR", this.game.MarcFont5, 430, 176, Color.White);
      ...
      {
        tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.PasswordsOn, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 208);
        this.opt3 = this.AddSubPart(ref tsubpart3, 380, 208, 35, 35, 1);
        DrawMod.DrawTextColouredMarc(ref graphics, "PASSWORDS", this.game.MarcFont5, 430, 216, Color.White);
      }
      tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.PBEM, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 248);
      this.opt5 = this.AddSubPart(ref tsubpart3, 380, 248, 35, 35, 1);
      DrawMod.DrawTextColouredMarc(ref graphics, "PBEM PROTECTION", this.game.MarcFont5, 430, 256, Color.White);
      if ((double) this.game.Data.RuleVar[353] == 0.0)
      {
        tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.ShrowdOn, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 328);
        this.opt2 = this.AddSubPart(ref tsubpart3, 380, 328, 35, 35, 1);
        DrawMod.DrawTextColouredMarc(ref graphics, "SHROUD", this.game.MarcFont5, 430, 336, Color.White);
        tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.ShrowdPeek, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 368);
        this.opt7 = this.AddSubPart(ref tsubpart3, 380, 368, 35, 35, 1);
        DrawMod.DrawTextColouredMarc(ref graphics, "SHROUD PEEK", this.game.MarcFont5, 430, 376, Color.White);
      }
      tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, this.game.Data.DontShowAIMove, tBackbitmap: (ref this.OwnBitmap), bbx: 380, bby: 288);
      this.opt9 = this.AddSubPart(ref tsubpart3, 380, 288, 35, 35, 1);
      DrawMod.DrawTextColouredMarc(ref graphics, "HIDE AI MOVES", this.game.MarcFont5, 430, 296, Color.White);
      int index3 = 0;
      do
      {
        if (this.game.Data.Variants[index3] > -1)
        {
          string String1 = this.game.Data.GameSlotName[this.game.Data.Variants[index3]];
          string tDescript;
          ...
          if (index3 <= 5)
          {
            if (this.game.Data.GameSlot[this.game.Data.Variants[index3]] <= 0)
            {
              int[] vari = this.vari;
              int index4 = index3;
              tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, false, tDescript, ref this.OwnBitmap, 580, 164 + index3 * 40);
              int num4 = this.AddSubPart(ref tsubpart3, 580, 164 + index3 * 40, 35, 35, 1);
              vari[index4] = num4;
            }
            else
            {
              int[] vari = this.vari;
              int index5 = index3;
              tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, true, tDescript, ref this.OwnBitmap, 580, 164 + index3 * 40);
              int num5 = this.AddSubPart(ref tsubpart3, 580, 164 + index3 * 40, 35, 35, 1);
              vari[index5] = num5;
            }
            DrawMod.DrawTextColouredMarc(ref graphics, Strings.UCase(String1), this.game.MarcFont5, 630, 176 + index3 * 40, Color.White);
          }
          else
          {
            if (this.game.Data.GameSlot[this.game.Data.Variants[index3]] <= 0)
            {
              int[] vari = this.vari;
              int index6 = index3;
              tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, false, tDescript, ref this.OwnBitmap, 780, 164 + (index3 - 6) * 40);
              int num6 = this.AddSubPart(ref tsubpart3, 780, 164 + (index3 - 6) * 40, 35, 35, 1);
              vari[index6] = num6;
            }
            else
            {
              int[] vari = this.vari;
              int index7 = index3;
              tsubpart3 = (SubPartClass) new MarcRadioPartClass(0, true, tDescript, ref this.OwnBitmap, 780, 164 + (index3 - 6) * 40);
              int num7 = this.AddSubPart(ref tsubpart3, 780, 164 + (index3 - 6) * 40, 35, 35, 1);
              vari[index7] = num7;
            }
            DrawMod.DrawTextColouredMarc(ref graphics, Strings.UCase(String1), this.game.MarcFont5, 830, 172 + (index3 - 6) * 40, Color.White);
          }
        }
        ++index3;
      }
      ...
      if (!this.game.Data.NoPlayChoice)
      {
        ...
        if (this.game.Data.RegimeCounter > -1)
        {
          ...
          for (int tdata = 0; tdata <= regimeCounter; ++tdata)
          {
            ...
            {
              ++num;
              string tname = Strings.UCase(this.game.Data.RegimeObj[tdata].Name);
        ...
        else
        {
          ...
          SubPartClass tsubpart = (SubPartClass) new ListSubPartClass(regimeListObj, 6, 250, -1, game, tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 80, tdotopandbottom: false, tbackbitmap: (ref local1), bbx: 90, bby: 285, tMarcStyle: true, overruleFont: (ref local2));
          this.RegimeListId = this.AddSubPart(ref tsubpart, 90, 285, 250, 112, 0);
        }
      }
      else
      {
      ...
      for (int index1 = 0; index1 <= subPartCounter; ++index1)
      {
        if (x > this.SubPartX[index1] & x < this.SubPartX[index1] + this.SubPartW[index1] && y > this.SubPartY[index1] & y < this.SubPartY[index1] + this.SubPartH[index1])
        {
          ...
          do
          {
            ...
            {
              string String1 = this.game.Data.GameSlotName[this.game.Data.Variants[index2]];
              string str = "Please check the scenario description for info on this variant.";
              if (Strings.InStr(String1, ",") > 0)
              {
                string[] strArray = String1.Split(',');
                String1 = strArray[0];
          ...
          else if (num == this.opt6)
          {
            ...
            if (this.game.Data.RegimeCounter > -1)
            {
              ...
              editObj1.TipText = editObj1.TipText + "Movement bonus: " + Strings.Trim(Conversion.Str((object) this.game.Data.RegimeObj[0].AIHelpMove)) + "%\r\n";
              EditClass editObj2 = this.game.EditObj;
              editObj2.TipText = editObj2.TipText + "Combat bonus: " + Strings.Trim(Conversion.Str((object) this.game.Data.RegimeObj[0].AIHelpCombat)) + "%\r\n";
              if ((double) this.game.Data.RuleVar[976] < 1.0 & this.game.Data.Product < 6)
              {
                EditClass editObj3 = this.game.EditObj;
                editObj3.TipText = editObj3.TipText + "Transfer bonus: " + Strings.Trim(Conversion.Str((object) this.game.Data.RegimeObj[0].AIHelpStrategic)) + "%\r\n";
              }
            }
          }
        ...
        for (int index1 = 0; index1 <= subPartCounter; ++index1)
        {
          if (x > this.SubPartX[index1] & x < this.SubPartX[index1] + this.SubPartW[index1] && y > this.SubPartY[index1] & y < this.SubPartY[index1] + this.SubPartH[index1])
          {
            ...
            else if (num1 == this.opt4)
            {
              if (!(this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.Inspecting | this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.PlayTurn))
              {
                int prodBonus = this.game.Data.RegimeObj[0].ProdBonus;
                int regimeCounter = this.game.Data.RegimeCounter;
                for (int index2 = 0; index2 <= regimeCounter; ++index2)
                {
                  switch (prodBonus)
            ...
            else
            {
              ...
              else if (num1 == this.BStartGameID)
              {
                if (this.game.EditObj.PbemGameSetup != PbemGameSetupPhase.None & this.game.EditObj.PbemGameSetup != PbemGameSetupPhase.PlayTurn)
                {
                  ...
                  {
                    int num8 = (int) Interaction.MsgBox((object) "Cancelled challenge because when you set password it must be min 4 and max 16 chars.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                    windowReturnClass.SetFlag(true);
                    return windowReturnClass;
                  }
                  if (this.game.EditObj.PbemTitle.Length < 4 | this.game.EditObj.PbemTitle.Length > 50)
                  {
                    int num9 = (int) Interaction.MsgBox((object) "Cancelled challenge because name of game must be min 4 and max 50 chars.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                    windowReturnClass.SetFlag(true);
                    return windowReturnClass;
                  }
                  if (this.game.Data.RegimeCounter > 7 | this.game.Data.MasterFile.Length > 1)
                  {
                    int num10 = (int) Interaction.MsgBox((object) "Cancelled challenge because more then 8 regimes in scenario or because a masterfile is still attached to scenario.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                    this.game.EditObj.PbemGameSetup = PbemGameSetupPhase.Cancel;
                    windowReturnClass.AddCommand(1, 55);
                    windowReturnClass.AddCommand(2, 91);
                    windowReturnClass.SetFlag(true);
                  ...
                  int num11 = 0;
                  int num12 = Math.Min(7, this.game.Data.RegimeCounter);
                ...
                int regimeCounter1 = this.game.Data.RegimeCounter;
                for (int index6 = 0; index6 <= regimeCounter1; ++index6)
                {
                ...
                {
                  int num14 = (int) Interaction.MsgBox((object) "There must be at least 1 human player", Title: ((object) "Shadow Empire : Planetary Conquest"));
                  if (MsgBoxResult.No == Interaction.MsgBox((object) "Do you want to proceed anyway?", MsgBoxStyle.YesNo, (object) "Shadow Empire : Planetary Conquest"))
                    goto label_208;
                }
                if ((double) this.game.Data.RuleVar[839] == 0.0)
                {
                  int num15 = (int) Interaction.MsgBox((object) "In order to play a scenario in the VR Editor rulevar(839) 'new GUI' must be set to 1.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                }
                else
                {
                  int num16 = 0;
                  int regimeCounter2 = this.game.Data.RegimeCounter;
                  for (int index7 = 0; index7 <= regimeCounter2; ++index7)
                  {
                  ...
                  {
                    int num17 = (int) Interaction.MsgBox((object) "The scenario creator has allowed no AIs in this scenario. You are not allowed to play for your own good.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                  }
                  else
                  {
                    ...
                    if (this.game.EditObj.randoallied == 1)
                    {
                      ...
                      for (int index10 = 0; index10 <= regimeCounter4; ++index10)
                      {
                        int regimeCounter5 = this.game.Data.RegimeCounter;
                        for (int index11 = 0; index11 <= regimeCounter5; ++index11)
                        {
                          if (index10 == index11)
                ...
                if (!(this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.Inspecting | this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.PlayTurn))
                {
                  ...
                  if (!this.game.Data.CreatedWithShrowd)
                  {
                    if (Strings.Len(this.game.Data.EditPass) > 0)
                    {
                      ...
                      {
                        int num18 = (int) Interaction.MsgBox((object) "You are cleared.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                      }
                      else
                      {
                        int num19 = (int) Interaction.MsgBox((object) "Wrong Password. You cannot Edit this file", Title: ((object) "Shadow Empire : Planetary Conquest"));
                        return windowReturnClass;
                      }
                    }
                  ...
                  {
                    int num20 = (int) Interaction.MsgBox((object) "Not possible. This is a random game created with a shroud.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                  }
                }
              }
              else if (num1 == this.BSimpleId && !(this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.Inspecting | this.game.EditObj.PbemGameSetup == PbemGameSetupPhase.PlayTurn))
              {
                if (!this.game.Data.CreatedWithShrowd)
                {
                  if (Strings.Len(this.game.Data.EditPass) > 0)
                  {
                    if (Operators.CompareString(Strings.LCase(Interaction.InputBox("This File is protected by an edit password. Please give it in order to edit it.", "Shadow Empire : Planetary Conquest")), Strings.LCase(this.game.Data.EditPass), false) == 0)
                    {
                      int num21 = (int) Interaction.MsgBox((object) "You are cleared.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                    }
                    else
                    {
                      int num22 = (int) Interaction.MsgBox((object) "Wrong Password. You cannot Edit this file", Title: ((object) "Shadow Empire : Planetary Conquest"));
                      return windowReturnClass;
                    }
                  }
                  this.game.EditObj.InEditor = true;
                ...
                {
                  int num23 = (int) Interaction.MsgBox((object) "Not possible. This is a random game created with a shroud.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                }
              }
            }
label_208:
