...
{
  public class ATFlexMessageWindowClass : WindowClass
  {
    private int okid;
    ...
    public ATFlexMessageWindowClass(ref GameClass tGame)
    ...
    public void View()
    {
      ...
      SubPartClass tsubpart = (SubPartClass) new TextButtonPartClass(this.game.EditObj.AnswerText[1], 100, tBackbitmap: (ref this.OwnBitmap), bbx: 350, bby: 150);
      int num3 = this.AddSubPart(ref tsubpart, 350, 150, 100, 36, 1);
      answer[1] = num3;
      Rectangle trect = new Rectangle(350, 150, 100, 35);
