...
{
  [Serializable]
  public class LandscapeTypeClass : ISerializable
  {
    public string Name;
    public int BasicSpriteCounter;
    public string[] BasicSpriteFileName;
    public int[] BasicSpriteID;
    public string[] BasicSpriteFileName2;
    public string[] BasicSpriteFileName3;
    public int[] BasicSpriteID2;
    public int[] BasicSpriteID3;
    public int[] BasicSpriteRandom;
    public string[] BasicPicFileName;
    public int[] BasicPicID;
    public bool[] PlotLast;
    public bool[] PlotBeforeRiver;
    public string SheetFileName;
    public int SheetSpriteID;
    public bool UseSheet;
    public string[] SidewaysSpriteFileName1;
    public int[] SidewaysSPriteID1;
    public string[] SidewaysSpriteFileName2;
    public int[] SidewaysSPriteID2;
    public string[] SidewaysSpriteFileName3;
    public int[] SidewaysSPriteID3;
    public bool SpecialLayer;
    public bool SpecialLayer6;
    public int[] LayerSpriteID;
    public string[] LayerSpriteFileName;
    public int OverridesCount;
    public int[] OverridesType;
    public int OverridesZ;
    public int OverridesCount2;
    public int[] OverridesType2;
    public int[] MoveCost;
    public int BuildGround;
    public bool IsSea;
    public float[] DefBonus;
    public float[] DefBonusMax;
    public bool CanBuildRoad;
    public bool CanParadrop;
    public bool CanAmph;
    public float RoadCostModifier;
    public bool[] OverIsTop;
    public int HidePts;
    public string PreHexPicFileName;
    public int PreHexPicID;
    public Bitmap TempHexBitmap;
    public string PreHexTextureFileName;
    public int PreHexTextureID;
    public bool UsePreHexTexture;
    public bool UsePreHexBorderTexture;
    public bool UsePreHexTextureAndRegularPreHex;
    public bool usePreHexBorderOwnZ;
    public int AIBlock;
    public int Red;
    public int Blue;
    public int Green;
    public bool Interior;
    public int ExtraExterior;
    public bool ExtraExteriorSame;
    public bool BlackedOut;
    public int PreHexBorder;
    public string Description;
    public bool DontShowInList;
    public int NavyOverride;
    public int AirOverride;
    public bool Transparent;
    public int TempDefenseBonus;
    public bool NoPortReq;
    public int Obstruction;
    public bool FuzzyOwnerAssured;
    public int NewGfxSkyEventPic;
    public int NewGfxSkyX;
    public int NewGfxSkyY;
    public int NewGfxBackgroundEventPic;
    public int NewGfxBackgroundX;
    public int NewGfxBackgroundY;
    public int NewGfxForegroundEventPic;
    public int NewGfxForegroundX;
    public int NewGfxForegroundY;
    public int NewGfxWeatherBackgroundEventPic;
    public int NewGfxWeatherBackgroundX;
    public int NewGfxWeatherBackgroundY;
    public int NewGfxWeatherForegroundEventPic;
    public int NewGfxWeatherForegroundX;
    public int NewGfxWeatherForegroundY;

    public LandscapeTypeClass Clone()
    {
      ...
      else
      {
        ...
        catch (Exception ex1)
        {
          ...
          try
          {
            ...
            int basicSpriteCounter = this.BasicSpriteCounter;
            for (int index = 1; index <= basicSpriteCounter; ++index)
            {
    ...
    public bool CheckOverride(int lt)
    {
      if (this.OverridesCount <= -1)
        return false;
      int num = 0;
    ...
    public bool CheckOverride2(int lt)
    {
      if (this.OverridesCount2 <= -1)
        return false;
      int num = 0;
      int overridesCount2 = this.OverridesCount2;
      for (int index = 0; index <= overridesCount2; ++index)
      {
    ...
    public void AddOverride(int lt)
    {
      if (this.OverridesCount < -1)
    ...
    public void RemoveOverride(int nr)
    {
    ...
    public void AddOverride2(int lt)
    {
      if (this.OverridesCount2 < -1)
        this.OverridesCount2 = -1;
    ...
    public void RemoveOverride2(int nr)
    {
    ...
    public LandscapeTypeClass(int hardcoded)
    {
      this.BasicSpriteFileName = new string[1];
      this.BasicSpriteID = new int[1];
      this.BasicSpriteFileName2 = new string[1];
    ...
    public void AddBasicSprite(string filename, string picfilename)
    {
      ++this.BasicSpriteCounter;
    ...
    public void ReplaceBasicSprite2(int nr, string filename)
    {
    ...
    public void ReplaceBasicSprite3(int nr, string filename)
    {
    ...
    public void ReplacePreHexTexture(string filename)
    {
    ...
    public void ReplacePicSprite(int nr, string filename)
    {
      this.BasicPicFileName[nr] = filename;
      this.BasicPicID[nr] = BitmapStore.ReloadFile(this.BasicPicID[nr], filename);
    }

    public void ReplaceSidewaysSprite1(string filename, int nr)
    {
    ...
    public void ReplaceSidewaysSprite2(string filename, int nr)
    {
    ...
    public void ReplaceSidewaysSprite3(string filename, int nr)
    {
