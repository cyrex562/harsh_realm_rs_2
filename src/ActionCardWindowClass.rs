...
// {
  ...
  impl ActionCardWindowClass {
     ...
     pub fn MakeUnitListGUI()
    {
      ...
      let mut font1: Font =  null;
       let mut local2: Font =  font1;
      ...
      self.ss = "Click to add an action card";
      ...
      let mut tsubpart4: SubPartClass = TextPartClass::new("Add Action Card", Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.BAddUnitTextId = self.AddSubPart( tsubpart4, 350, 59, 200, 20, 0);
      self.ss = "Click to import ALL actioncards from a different scenario";
      ...
      let mut tsubpart6: SubPartClass = TextPartClass::new("Import ALL cards", Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.b2bid = self.AddSubPart( tsubpart6, 650, 59, 200, 20, 0);
    }

     pub fn MakeUnitTypeItemGUI()
    {
      if (self.BNameId > 0){
      ...
      let mut tsubpart2: SubPartClass = TextPartClass::new("Title: " + self.game.Data.ActionCardObj[self.UnitNr].Title + " (#" + Strings.Trim(Conversion.Str(self.UnitNr)) + ")", Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      ...
      tsubpart2 = TextPartClass::new("PPCost: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].PPCost), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a1bid = self.AddSubPart( tsubpart2, 350, 239, 500, 20, 0);
      self.ss = "";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a2id = self.AddSubPart( tsubpart2, 320, 220, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Text: " + self.game.Data.ActionCardObj[self.UnitNr].Text, Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a2bid = self.AddSubPart( tsubpart2, 350, 219, 500, 20, 0);
      self.ss = "";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a3id = self.AddSubPart( tsubpart2, 320, 260, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("ExecuteEvent: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].ExecuteEvent), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a3bid = self.AddSubPart( tsubpart2, 350, 259, 500, 20, 0);
      self.ss = "Give event pic # to set the picture used by the actioncards";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a4id = self.AddSubPart( tsubpart2, 320, 280, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("EventPicNr: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].EventPicNr), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      ...
      self.ss = "Regimes with AlternativeActionCardPics=true use this alterantive event pic #";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.aa4id = self.AddSubPart( tsubpart2, 620, 280, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Alt. EventPicNr: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].AlternateEventPicNr), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      ...
      tsubpart2 =  TextPartClass::new("ColorScheme: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].ColorScheme), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a5bid = self.AddSubPart( tsubpart2, 350, 299, 500, 20, 0);
      self.ss = "If this card is with a historicalunit officer the AI will play the card randomly if 0. >0 it will play event to determine target unit(areax) or hex(areax,areay)";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a6id = self.AddSubPart( tsubpart2, 320, 320, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("AILabel: " + (Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].AILabel) + ", " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].AILabel2) + ", " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].aILabel3)), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a6bid = self.AddSubPart( tsubpart2, 350, 319, 500, 20, 0);
      self.ss = "tempvar0,tempvar1 will be passed to event.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a12id = self.AddSubPart( tsubpart2, 320, 340, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("TempVar0: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].TempVar0), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 100, 20, false, self.ss);
      self.a12bid = self.AddSubPart( tsubpart2, 350, 339, 100, 20, 0);
      self.ss = "tempvar0,tempvar1 will be passed to event.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a13id = self.AddSubPart( tsubpart2, 480, 340, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("TempVar1: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].TempVar1), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 100, 20, false, self.ss);
      self.a13bid = self.AddSubPart( tsubpart2, 510, 339, 100, 20, 0);
      self.ss = "do nothing special=0, 1=only show card with corps, 2=only show card with army or higher";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.aa13id = self.AddSubPart( tsubpart2, 320, 360, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("LimitedOfficerShow: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].LimitedShow), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 300, 20, false, self.ss);
      self.aa13bid = self.AddSubPart( tsubpart2, 350, 359, 300, 20, 0);
      self.ss = "Specify -1 if card has no hisvar cost of any kind";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.b3id = self.AddSubPart( tsubpart2, 620, 340, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("HisVarType: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].HisVarCostType), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.b3bid = self.AddSubPart( tsubpart2, 650, 339, 200, 20, 0);
      self.ss = "Specify the cost in points for the HisVarType specified. ";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.b4id = self.AddSubPart( tsubpart2, 620, 360, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("HisVarCost: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].HisVarCostQty), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.b4bid = self.AddSubPart( tsubpart2, 650, 359, 200, 20, 0);
      self.ss = "Defining the highlighted hexes for user pic. User selection will be passed as tempvar2,tempvar3 to event.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a14id = self.AddSubPart( tsubpart2, 320, 380, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("AreaSlot: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].AreaSlot), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a14bid = self.AddSubPart( tsubpart2, 350, 379, 500, 20, 0);
      self.ss = "Defining the highlighted hexes for user pic. User selection will be passed as tempvar2,tempvar3 to event.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a15id = self.AddSubPart( tsubpart2, 320, 400, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("AreaValue: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].AreaValue), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a15bid = self.AddSubPart( tsubpart2, 350, 399, 500, 20, 0);
      self.ss = "-1=for none. Pre Execute event is executed the moment before you select something on the popup. Use to define selectable zones. Or set Selectable Units";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a16id = self.AddSubPart( tsubpart2, 320, 420, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("PreExecuteEvent: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].PreExecuteEvent), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.a16bid = self.AddSubPart( tsubpart2, 350, 419, 200, 20, 0);
      self.ss = "Determines if this event will give you a popup to select a unit.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a17id = self.AddSubPart( tsubpart2, 320, 440, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("SelectUnit: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].UnitSelect), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a17bid = self.AddSubPart( tsubpart2, 350, 439, 500, 20, 0);
      self.ss = "The minisprite is used to draw the small officer cards. but you dont have to specify. -1=dont use.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a18id = self.AddSubPart( tsubpart2, 320, 460, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Nato Mini Sprite: " + Conversion.Str( self.game.Data.ActionCardObj[self.UnitNr].Nato), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 500, 20, false, self.ss);
      self.a18bid = self.AddSubPart( tsubpart2, 350, 459, 500, 20, 0);
      self.ss = "The mouse over text will appear if new GUI is used and card is right clicked.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a19id = self.AddSubPart( tsubpart2, 320, 480, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Mouse Over " + self.game.Data.ActionCardObj[self.UnitNr].MouseOver, Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 250, 20, false, self.ss);
      self.a19bid = self.AddSubPart( tsubpart2, 350, 479, 250, 20, 0);
      self.ss = "Card Category. Also see rulevar 905 to activate this in GUI. ";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a20id = self.AddSubPart( tsubpart2, 620, 420, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Category =" + self.game.Data.ActionCardObj[self.UnitNr].Category.ToString(), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.a20bid = self.AddSubPart( tsubpart2, 650, 419, 200, 20, 0);
      self.ss = "Change library";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a21id = self.AddSubPart( tsubpart2, 620, 440, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Set Library" + self.game.Data.ActionCardObj[self.UnitNr].LibId.libSlot.ToString(), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.a21bid = self.AddSubPart( tsubpart2, 650, 439, 200, 20, 0);
      self.ss = "Set Small Gfx.  ";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a22id = self.AddSubPart( tsubpart2, 620, 460, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Small Gfx =" + self.game.Data.ActionCardObj[self.UnitNr].SmallGfx.ToString(), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.a22bid = self.AddSubPart( tsubpart2, 650, 459, 200, 20, 0);
      self.ss = "Ignore Popup if no selection possible of either units or hexes. The actual event can read if its skipped by calling CheckPopupSkipped().  ";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONBLOCK, self.ss);
      self.a23id = self.AddSubPart( tsubpart2, 620, 480, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("IgnorePopupIfNoSel =" + self.game.Data.ActionCardObj[self.UnitNr].IgnorePopupIfNoSelect.ToString(), Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
      self.a23bid = self.AddSubPart( tsubpart2, 650, 479, 200, 20, 0);
      self.ss = "Click to remove this action card.";
      tsubpart2 =  ButtonPartClass::new(self.game.BUTTONKILL, self.ss);
      self.BRemoveUnitId = self.AddSubPart( tsubpart2, 320, 80, 32, 16, 1);
      tsubpart2 =  TextPartClass::new("Remove this Action Card", Font::new("Times New Roman", 16f, FontStyle.Regular, GraphicsUnit.Pixel), 200, 20, false, self.ss);
    ...
    pub fn HandleMouseClick(x: i32, y: i32, b: i32) -> WindowReturnClass 
    {
