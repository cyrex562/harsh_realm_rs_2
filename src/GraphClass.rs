...
namespace WindowsApplication1
{
  pub class GraphClass : SubPartClass
  {
    ...
    pub Bitmap Paint()
    {
      ...
      int num2 = 60;
      int num3 =  Math.Round((double) this.Height - (50.0 + Math.Max(2.0, (double) this.RegCount / 2.0 + 0.5) * 15.0));
      int num4 =  Math.Round(20.0 + Math.Max(2.0, (double) this.RegCount / 2.0 + 0.5) * 15.0);
      int num5 =  Math.Round(Conversion.Int((double) num1 / (double) Math.Max(10, this.game.Data.Round)));
      if (!this.tminRun)
      {
        this.tmin = 0;
        this.tminRun = true;
        int round1 = this.game.Data.Round;
        for (int index1 = 1; index1 <= round1; index1 += 1)
        {
          int regCount = this.RegCount;
          for (int index2 = 1; index2 <= regCount; index2 += 1)
          {
        ...
        for (int index3 = 1; index3 <= round2; index3 += 1)
        {
          int regCount = this.RegCount;
          for (int index4 = 1; index4 <= regCount; index4 += 1)
          {
            int[,] mat = this.Mat;
            int[,] numArray3 = mat;
            int index5 = index3;
      ...
      for (int index9 = 1; index9 <= round3; index9 += 1)
      {
        int regCount = this.RegCount;
        for (int index10 = 1; index10 <= regCount; index10 += 1)
        {
...
label_44:
      ...
      for (int index11 = 1; index11 <= round4; index11 += 1)
      {
        int regCount1 = this.RegCount;
        for (int index12 = 1; index12 <= regCount1; index12 += 1)
        {
        ...
        while (num11 == 1)
        {
          ...
          for (int index13 = 1; index13 <= regCount2; index13 += 1)
          {
            int regCount3 = this.RegCount;
            for (int index14 = 1; index14 <= regCount3; index14 += 1)
            {
        ...
        for (int index15 = 1; index15 <= regCount4; index15 += 1)
        {
      ...
      for (int index = 1; index <= num12; index += 1)
      ...
      SizeF sizeF2;
      for (int round5 = 1; round5 <= num13; round5 += 1)
      {
      ...
      do
      {
        ...
        int num18 =  Math.Round((double) ((float) (num4 + num3) - (float) num3 * (num17 / (float) num7)));
      ...
      int num19 =  Math.Round((double) Math.Max(0.0f, 220f - sizeF2.Width));
      int y1_1 = -5;
      int x1_1 =  Math.Round((double) ((float) num2 + sizeF2.Width));
      int num20 = 0;
      int regCount5 = this.RegCount;
      for (int index = 1; index <= regCount5; index += 1)
      {
      ...
      for (int index16 = 1; index16 <= num21; index16 += 1)
      {
        int regCount6 = this.RegCount;
        for (int index17 = 1; index17 <= regCount6; index17 += 1)
        {
      ...
      for (int index18 = 1; index18 <= round6; index18 += 1)
      {
        int regCount7 = this.RegCount;
        for (int index19 = 1; index19 <= regCount7; index19 += 1)
        {
          if (!this.checkForRegime | !(this.game.Data.Round == index18 & this.game.Data.Turn < index19 - 1))
          {
            ...
            if (this.showNumbers)
            {
              ...
              int index20;
              int num32 = index20;
              for (int index21 = 1; index21 <= num32; index21 += 1)
              {
              ...
              if (num31 == 0)
              {
                ...
                rectangleArray[index20] = this.game.Data.Product < 6 ? new Rectangle(num28, num29,  Math.Round((double) sizeF2.Width),  Math.Round((double) sizeF2.Height)) : new Rectangle(num28 - 8, num29 - 4,  Math.Round((double) (sizeF2.Width + 16f)),  Math.Round((double) (sizeF2.Height + 8f)));
