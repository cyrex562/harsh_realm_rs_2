...
{
  public class MapSelectWindowClass : WindowClass
  {
    private int okid;
    ...
    public MapSelectWindowClass(ref GameClass tGame)
      : base(ref tGame, 1024, 768, BackSprite: tGame.BACKGROUND2MARC)
    {
      ...
      DrawMod.DrawTextVic2(ref Expression, "Select a highlighted hex", this.game.VicFont1, 50, 43, this.game.VicColor2, this.game.VicColor2Shade);
      ...
      DrawMod.DrawRectangle(ref Expression, 49, 79, 602, 582, (int) this.game.GameCol2.R, (int) this.game.GameCol2.G, (int) this.game.GameCol2.B, (int) byte.MaxValue);
    ...
    public void ViewMessage()
    {
      ...
      SubPartClass tsubpart = (SubPartClass) new MapPartClass(600, 580, this.game, ZoomLevel: 0);
      this.mapid = this.AddSubPart(ref tsubpart, 50, 80, 600, 580, 0);
      ...
      tsubpart = (SubPartClass) new MiniMapPartClass(this.game, tMapWidth: 600, tMapHeight: 580, ZoomLevel: 0);
    ...
    public override WindowReturnClass handleTimer()
    {
      ...
      if (this.game.Data.Round > 0)
      {
        ...
        Bitmap bitmap = (Bitmap) null;
        ref Bitmap local = ref bitmap;
        subPart.PaintCoordinate((Graphics) null, selectX, selectY, counterAlpha, gBitmap: (ref local));
