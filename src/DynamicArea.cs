...
{
  public class DynamicArea : SubPartClass
  {
      ...
      for (int index1 = 0; index1 <= elementCounter; ++index1)
      {
        ...
        if (dynamicData.element[index1].type == DynamicType.TextField)
        {
          if (Strings.InStr(dynamicData.element[index1].fontName, "courier") > 0)
          {
            ...
            int trows = (int) Math.Round((double) dynamicData.element[index1].h / (double) dynamicData.element[index1].lineHeight);
            Font marcFont4b = this.game.MarcFont4b;
            string texty = dynamicData.element[index1].texty;
            int lineHeight = dynamicData.element[index1].lineHeight;
            bitmap = (Bitmap) null;
            ref Bitmap local = ref bitmap;
            int r = (int) dynamicData.element[index1].color.R;
            int g = (int) dynamicData.element[index1].color.G;
            int b = (int) dynamicData.element[index1].color.B;
            int a = (int) dynamicData.element[index1].color.A;
      ...
      for (int index3 = 0; index3 <= elementCounter3; ++index3)
      {
        if (dynamicData.element[index3].type == DynamicType.TextField)
        {
          ...
          if (Strings.InStr(dynamicData.element[index3].fontName, "courier") > 0)
          {
            ...
            int trows = (int) Math.Round((double) dynamicData.element[index3].h / (double) dynamicData.element[index3].lineHeight);
            Font marcFont4b = this.game.MarcFont4b;
            string texty = dynamicData.element[index3].texty;
            int lineHeight = dynamicData.element[index3].lineHeight;
            Bitmap bitmap = (Bitmap) null;
            ref Bitmap local = ref bitmap;
            int r = (int) dynamicData.element[index3].color.R;
            int g2 = (int) dynamicData.element[index3].color.G;
            int b = (int) dynamicData.element[index3].color.B;
            int a = (int) dynamicData.element[index3].color.A;
            ...
            for (int index5 = 0; index5 <= mouseCounter; ++index5)
            {
          ...
          else if (index4 > -1)
          {
            ...
            if (!dynamicData.element[index3].center)
            {
              ...
              ref Bitmap local = ref bitmap;
              int r = (int) dynamicData.element[index3].color.R;
              int g3 = (int) dynamicData.element[index3].color.G;
              int b = (int) dynamicData.element[index3].color.B;
              int a = (int) dynamicData.element[index3].color.A;
            ...
            else
            {
              ...
              ref Bitmap local = ref bitmap;
              int r = (int) dynamicData.element[index3].color.R;
              int g4 = (int) dynamicData.element[index3].color.G;
              int b = (int) dynamicData.element[index3].color.B;
              int a = (int) dynamicData.element[index3].color.A;
            ...
            textAreaClass2.Paint();
            int mouseCounter = textAreaClass2.MouseCounter;
            for (int index6 = 0; index6 <= mouseCounter; ++index6)
            {
