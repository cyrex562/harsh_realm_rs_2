...
{
  public class ATCombatDetailWindowClass : WindowClass
  {
    private int okid;
    private int tbacknr;
    ...
    private ATListClass OptionsList1Obj;
    ...
    public ATCombatDetailWindowClass(ref GameClass tGame, int thn)
    ...
    public ATCombatDetailWindowClass(ref GameClass tGame, int thn, bool OldGui)
      : base(ref tGame, 1024, 768, BackSprite: tGame.BACKGROUND2MARC)
    {
      this.FromMessage = tGame.EditObj.FromMessage;
      this.lasttime = DateAndTime.Now;
    ...
    public void dostuff()
    {
      ...
      if (this.game.TempCombat.CombatRound > -1)
      {
        ...
        {
          tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsListObj, 13, 280, tlistselect1, this.game, true, tHeaderCenter: false, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 10, bby: 25);
      ...
      this.OptionsList1Obj = new ATListClass();
      ...
      if (this.game.TempCombat.UCounter > -1)
      {
        ...
        {
          tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList1Obj, 14, 280, tlistselect2, this.game, true, tHeaderCenter: false, tShowPair: true, tValueWidth: 120, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 10, bby: 270);
      ...
      {
        tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList2Obj, 11, 280, tlistselect3, this.game, true, tHeaderCenter: false, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 10, bby: 535);
      ...
      {
        tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList3Obj, 36, 280, tlistselect4, this.game, true, tHeaderCenter: false, tShowPair: true, tValueWidth: 140, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 310, bby: 25);
      ...
      {
        tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList4Obj, 15, 380, tlistselect5, this.game, true, tHeaderCenter: false, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 610, bby: 25);
      ...
      if (index1 > -1)
      {
        ...
        if (this.game.TempCombat.RepType[index1] == 1)
        {
          if (flag)
          {
            tsubpart = (SubPartClass) new TextAreaClass2(this.game, 380, 6, this.game.VicFont3, str, 15, ref this.OwnBitmap, 610, 300);
            this.TAid = this.AddSubPart(ref tsubpart, 610, 300, 380, 105, 0);
          }
          else
          {
            tsubpart = (SubPartClass) new TextAreaClass(this.game, 380, 6, this.game.VicFont3, "", false, str, Color.White, tItemSize: 15, tbackbitmap: (ref this.OwnBitmap), bbx: 610, bby: 300);
            this.TAid = this.AddSubPart(ref tsubpart, 610, 300, 380, 105, 0);
          }
          ...
          while (index2 <= 30);
          tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList5Obj, 15, 170, tlistselect5, this.game, true, tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 80, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 610, bby: 465);
          ...
          while (index3 <= 30);
          tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList6Obj, 15, 170, tlistselect5, this.game, true, tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 80, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 810, bby: 465);
        ...
        else if (this.game.TempCombat.RepType[index1] == 2)
        {
          ...
          while (index4 <= 30);
          tsubpart = (SubPartClass) new ATListSubPartClass(this.OptionsList5Obj, 19, 380, tlistselect5, this.game, true, tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 200, tdotopandbottom: false, tbackbitmap: (ref this.OwnBitmap), bbx: 610, bby: 317);
          this.OptionsList5Id = this.AddSubPart(ref tsubpart, 610, 317, 380, 320, 0);
        }
        else if (flag)
        {
          tsubpart = (SubPartClass) new TextAreaClass2(this.game, 380, 26, this.game.MarcFont5, str, 15, ref this.OwnBitmap, 610, 300);
          this.TAid = this.AddSubPart(ref tsubpart, 610, 300, 380, 405, 0);
        }
        else
        {
          tsubpart = (SubPartClass) new TextAreaClass(this.game, 380, 26, this.game.gamefont1b, "", false, str, Color.White, tItemSize: 15, tbackbitmap: (ref this.OwnBitmap), bbx: 610, bby: 300);
          this.TAid = this.AddSubPart(ref tsubpart, 610, 300, 380, 405, 0);
        }
      }
      if (this.game.EditObj.CombatOneSentence.Length > 1)
      {
        if (flag)
        {
          tsubpart = (SubPartClass) new TextAreaClass2(this.game, 290, 3, this.game.VicFont3, this.game.EditObj.CombatOneSentence, 15, ref this.OwnBitmap, 310, 620);
          this.Ta2Id = this.AddSubPart(ref tsubpart, 310, 620, 290, 60, 0);
        }
        else
        {
          tsubpart = (SubPartClass) new TextAreaClass(this.game, 290, 3, this.game.VicFont3, "", false, this.game.EditObj.CombatOneSentence, Color.White, tItemSize: 15, tbackbitmap: (ref this.OwnBitmap), bbx: 310, bby: 620);
          this.Ta2Id = this.AddSubPart(ref tsubpart, 310, 620, 290, 60, 0);
        }
      }
      if (flag)
      {
        tsubpart = (SubPartClass) new TextButtonPartClass("BACK", 100, "Click to return to regular combat screen\r\nOr press any key instead.", ref this.OwnBitmap, 435, this.Hn - 40, theight: 20, usefont: this.game.VicFont2, useshadow: true, tMarcStyle: true);
        this.okid = this.AddSubPart(ref tsubpart, 460, this.Hn - 40, 100, 20, 1);
      }
      else
      {
        tsubpart = (SubPartClass) new TextButtonPartClass("Back", 100, tBackbitmap: (ref this.OwnBitmap), bbx: 460, bby: (this.Hn - 70));
