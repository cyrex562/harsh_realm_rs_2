...
{
  public class AITheater
  {
    public DC2AIClass ai;
    public MapClass map;
    public AIFront front;
    public AIFrontList frontList;
    public AIMatrix FrontArea;
    public AIMatrix origFrontArea;
    public AIMatrix Owner;
    public AIMatrix origAllTroops;
    public AIMatrix origOwner;
    public AIMatrix troopsMove;
    public AIMatrix origEnemyDistance;
    public AIMatrix enemyDistance;
    public AIMatrix FriendlySupply;
    public AIMatrix friendlySupplyIdeal;
    public AIMatrix enemyPressureFull;
    public AIMatrix enemySupply;
    public AIMatrix FriendlyBottleneckIdeal;
    public AIMatrix FriendlyBottleneck;
    public AIMatrix ForceRatio;
    public AIMatrix troopsstrength;
    public AIMatrix Advance;
    public AIMatrix EnemyPressure;
    public AIMatrix TroopsReach;
    public AIMatrix ShortenFront;
    public AIMatrix FrontAreaForAttack;
    public AIMatrix vpMatrix;
    public AIMatrix FriendlySupplyAfterEnemyMove;
    public AIMatrix EnemyBottleneck;
    public AIMatrix EnemyBottleneckOwnFrontOnly;
    public AIMatrix FriendlyBottleneckIdealOwnFrontOnly;
    public AIMatrix allTroops;
    public AIMatrix newOwner;
    public AIMatrix origAdvance;
    public AIMatrix[,] MoveCostAttack;
    public AIMatrix[] MoveTempLos;
    public AIMatrix[,] MoveCostArtAttack;
    public AICoordinateMatrix[,] MoveFromAttack;
    public AICoordinateMatrix[,] MoveFromArtAttack;
    public AIMatrix[] MoveCostMove;
    public AIMatrix[] MoveCostArtMove;
    public AIMatrix[] MoveCostOrgMove;
    public AICoordinateMatrix[] MoveFromMove;
    public AICoordinateMatrix[] MoveFromArtMove;
    public AICoordinateMatrix[] MoveFromOrgMove;
    public AIMoveList MoveList;
    public int Score;
    public float initEncRatio3;
    public float initEncRatio1;
    public float initEncRatio2;
    public float initEncRatio4;
    public float initEncRatio5;
    public float initEncRatio6;
    public float initEncRatio7;
    public float initEncRatio8;
    public int InitTotalTroops;
    public int initFrontTroops;
    public int InitHexes;
    public int initHexesTot;
    public int initOrigEnemyUnits;
    private int finalHexes;
    private int finalHexesTot;
    private float finalEncRatio1;
    private float finalEncRatio3;
    private float finalEncRatio2;
    private float finalEncRatio4;
    private float finalEncRatio5;
    private float finalEncRatio6;
    private int finalOrigEnemyUnits;
    ...
    public int Width;
    public int Height;
    public int LowestRetreatModifierAllowed;

    public AITheater(DC2AIClass tai, AIFront tfront, AIFrontList tfrontList)
    {
      this.ai = tai;
      this.map = this.ai.game.Data.MapObj[0];
      this.MoveList = new AIMoveList();
      this.front = tfront;
    ...
    public AITheater Clone()
    {
      ...
      if (this.front.units.counter > -1)
      {
        ...
        for (int index1 = 0; index1 <= upperBound2; ++index1)
        {
          int index2 = 0;
          do
          {
      ...
      if (this.front.artUnits.counter > -1)
      {
        ...
        for (int index = 0; index <= upperBound3; ++index)
        {
        ...
        for (int index3 = 0; index3 <= upperBound4; ++index3)
        {
          int index4 = 0;
          do
          {
    ...
    public void InitializeStrategic()
    {
    ...
    public void InitializeAirTransport()
    {
      this.SetMatrixDimensionsAir();
      this.Owner = this.ai.SetOwnerMatrix(this.Left, this.Top, this.Width, this.Height);
      DC2AIClass ai = this.ai;
    ...
    public void InitializeEngineer()
    {
      this.SetMatrixDimensions();
      this.Owner = this.ai.SetOwnerMatrix(this.Left, this.Top, this.Width, this.Height);
      DC2AIClass ai = this.ai;
      ...
      int tbottom = -1)
    {
      ...
      for (int tx = 0; tx <= width3; ++tx)
      {
        int height3 = this.Height;
        for (int index = 0; index <= height3; ++index)
        {
    ...
    public int GetInitialTotalTroops(ref AIMatrix tTroops, ref AIMatrix tOwner, int USEOWNER)
    {
    ...
    public int GetInitialFrontTroops(ref AIMatrix tTroops, ref AIMatrix tOwner, int USEOWNER)
    {
      int width = tTroops.Width;
    ...
    public int GetInitialFrontAreaHexes(ref AIMatrix tTroops, ref AIMatrix tOwner, int USEOWNER)
    {
      int width = tTroops.Width;
    ...
    public int GetInitialHexes(ref AIMatrix tTroops, ref AIMatrix tOwner, int USEOWNER)
    {
      int width = tTroops.Width;
      int initialHexes;
      for (int tx = 0; tx <= width; ++tx)
    ...
    public float GetTroopsRatioOutOfSupply(
    ...
    public float GetTroopsFrontRatioOutOfSupply(
      ref AIMatrix tSupply,
      ref AIMatrix tTroops,
      ref AIMatrix tOwner,
      int USEOWNER)
      ...
      bool enterEnemy = false)
    {
      ...
      int width3 = this.Width;
      for (int index7 = 0; index7 <= width3; ++index7)
      {
        int height = this.Height;
        int num2;
        for (int index8 = 0; index8 <= height; ++index8)
        {
    ...
    public void SetsupplymatrixIdeal(
      ref AIMatrix tSupply,
      ref AIMatrix tOwner,
      int USEOWNER,
      ...
      bool notAdjustedForEnemyMoveMatrix = false)
    {
      ...
      int width2 = this.Width;
      for (int index9 = 0; index9 <= width2; ++index9)
      {
        int height = this.Height;
        for (int index10 = 0; index10 <= height; ++index10)
        {
    ...
    public void BACKUP_GetEnemyMove(
      float RatioNeeded,
      bool DiminishForMultipleTarget,
      ref AIMatrix tOwner,
      ref AIMatrix tTroops,
        ...
        for (int y1 = 0; y1 <= height; ++y1)
        {
          if (tOwner.Value[x1, y1] == 1 && this.enemyDistance.Value[x1, y1] == 1)
          {
            ...
            if (num3 > 0 | !DiminishForMultipleTarget)
            {
              ...
              for (int x2 = num9; x2 <= num10; ++x2)
              {
                int num11 = y1 - (RANGE + 0);
                int num12 = y1 + (RANGE + 0);
                for (int y2 = num11; y2 <= num12; ++y2)
                {
    ...
    public void SetMoveCost(int extraAP = 0)
    {
      int num1;
      ...
      for (int index1 = 0; index1 <= counter1; ++index1)
      {
        ...
        if (unr > -1)
        {
          ...
          else
          {
            ...
            {
              int height = this.Height;
              for (int y2_1 = 0; y2_1 <= height; ++y2_1)
              {
                int index7 = 0;
                do
                {
            ...
            {
              int height = this.Height;
              for (int index14 = 0; index14 <= height; ++index14)
              {
      ...
      for (int index19 = 0; index19 <= counter2; ++index19)
      {
        ...
        {
          int width = this.Width;
          for (int index21 = 0; index21 <= width; ++index21)
          {
            int height = this.Height;
            for (int index22 = 0; index22 <= height; ++index22)
            {
              int index23 = 0;
              do
              {
        ...
        else
        {
          ...
          if (num2 == 1 | this.front.FrontType == 8 | this.front.FrontType == 9)
            ...
            this.ai.game.HandyFunctionsObj.RedimTempValue(9999);
          int width = this.Width;
          for (int index24 = 0; index24 <= width; ++index24)
          {
            int height = this.Height;
        ...
        if (unitByAiid2 > -1)
        {
          ...
          {
            int width = this.Width;
            for (int index32 = 0; index32 <= width; ++index32)
            {
              int height = this.Height;
              for (int index33 = 0; index33 <= height; ++index33)
              {
          ...
          else
          {
            ...
            {
              int height = this.Height;
              for (int index34 = 0; index34 <= height; ++index34)
              {
      ...
      for (int index39 = 0; index39 <= counter3; ++index39)
      {
        ...
        if (unitByAiid > -1)
        {
          ...
          {
            int width = this.Width;
            for (int index40 = 0; index40 <= width; ++index40)
            {
              int height = this.Height;
          ...
          else
          {
            ...
            {
              int height = this.Height;
              for (int index42 = 0; index42 <= height; ++index42)
              {
    ...
    public void SetMatrixDimensionsAir()
    {
      this.Left = 0;
      this.Top = 0;
    ...
    public void SetMatrixDimensionsWithMapLoop()
    {
    ...
    public int HexAttackOpportunity(int x, int y)
    {
    ...
    public int HexAttackImportance(int x, int y)
    {
      int num1 = 0;
    ...
    public float UnitOffensiveModifier(int unr)
    {
    ...
    public int CountUnitsWithSameHistoricalPresent(int his, UnitList UL)
    {
      int num = 0;
    ...
    public int CountUnitsWithSameHistoricalNearHex(int forunr, int forx, int fory)
    {
      int counter = this.front.units.counter;
      int num1;
      for (int index = 0; index <= counter; ++index)
    ...
    public AIMoveList SetAttackMove(
      ...
      int ignoreFirstXhexes = 0)
    {
      ...
      int index3;
      int index4;
      for (index3 = 0; index3 <= width; ++index3)
      {
        int height = this.Height;
...
label_57:
      ...
      if (num2 > -1 & index1 > -1)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            int index17;
            int num33;
            for (index14 = 0; index14 <= counter4; ++index14)
            {
              ...
              if (index4 > -1 && !UL.CheckIfPresent(index4))
              {
                ...
                do
                {
                  if (!(this.ai.game.Data.UnitObj[index4].TempCategory == 5 | this.ai.game.Data.UnitObj[index4].TempCategory == 2) & this.ai.game.HandyFunctionsObj.GetLowestAp(index4) >= this.MoveCostAttack[index14, tdata2_2].Value[index1, index2] && !(this.ai.game.Data.UnitObj[index4].TempProtector & val2 <= 1))
                  {
                    ...
                    this.ai.game.EditObj.TempUnitList = new UnitList();
                    int counter5 = UL.counter;
                    for (int index19 = 0; index19 <= counter5; ++index19)
            ...
            if (num32 < 9999)
            {
              ...
              for (int index23 = 0; index23 <= sfCount; ++index23)
              {
            ...
            for (int index30 = 0; index30 <= counter6; ++index30)
          ...
          if (val2 > 0)
          {
            ...
            for (int index31 = 0; index31 <= counter7; ++index31)
            {
              ...
              if (index4 > -1 & num60 > 0 & num60 < 15 && simpleList1.FindNr(index4) == -1)
              {
                ...
                int tdata1;
                int tdata2_3;
                for (int index32 = num62; index32 <= num63; ++index32)
                {
                  int num64 = index2 - (num60 + 1);
                  int num65 = index2 + (num60 + 1);
                  for (int y2 = num64; y2 <= num65; ++y2)
                  {
            ...
            for (index14 = 0; index14 <= counter8; ++index14)
            {
          ...
          if ((double) num26 > 0.0 & val2 > 0 & UL.counter > -1)
          {
            ...
            for (int index33 = 0; index33 <= counter10; ++index33)
            {
              ...
              if (index4 > -1 & maxArtRange < 1 && simpleList3.FindNr(index4) == -1)
              {
                ...
                int num68 = index1 - 1;
                int num69 = index1 + 1;
                for (int index34 = num68; index34 <= num69; ++index34)
                {
                  int num70 = index2 - 1;
                  int num71 = index2 + 1;
                  for (int index35 = num70; index35 <= num71; ++index35)
                  {
            ...
            for (index14 = 0; index14 <= counter11; ++index14)
            {
          ...
          if ((double) num73 > (double) currentMinimal | UL.counter == -1 & simpleList1.Counter > -1)
          {
            ...
            if (this.map.HexObj[this.GetRealX(index1), index2 + this.Top].UnitCounter > -1)
            {
              ...
              for (int index37 = 0; index37 <= counter13; ++index37)
              {
              ...
              for (int index38 = 0; index38 <= counter14; ++index38)
              {
            ...
            for (int index39 = 0; index39 <= counter15; ++index39)
            {
              if (this.map.HexObj[this.GetRealX(index1), index2 + this.Top].UnitCounter == -1)
              {
            ...
            for (int index40 = 0; index40 <= counter16; ++index40)
            {
              if (this.map.HexObj[this.GetRealX(index1), index2 + this.Top].UnitCounter == -1)
              {
          ...
          else if ((double) num74 > (double) currentMinimal & UL.counter > -1)
          {
            ...
            if (this.map.HexObj[this.GetRealX(index1), index2 + this.Top].UnitCounter > -1)
            {
              ...
              for (int index41 = 0; index41 <= counter17; ++index41)
              {
          ...
          if (flag8)
          {
            ...
            if ((double) num73 > (double) currentMinimal)
            {
              ...
              for (int index42 = 0; index42 <= counter18; ++index42)
              {
            ...
            if (flag8)
            {
              ...
              for (int index43 = 0; index43 <= counter19; ++index43)
              {
          ...
          if ((double) num73 > (double) currentMinimal | UL.counter == -1 & simpleList1.Counter > -1)
          {
            ...
            for (int index44 = 0; index44 <= counter20; ++index44)
            {
          ...
          if ((double) num73 < (double) currentMinimal | UL.counter == -1 & simpleList1.Counter == -1 & simpleList2.Counter > -1)
          {
            ...
            if (simpleList2.Counter > -1)
            {
              ...
              for (int index45 = 0; index45 <= counter21; ++index45)
              {
                ...
                for (int index47 = 0; index47 <= counter22; ++index47)
                {
      ...
      if (this.MoveList.Counter > -1)
      {
        ...
        int num84;
        int num85;
        for (int index48 = 0; index48 <= counter23; ++index48)
        {
    ...
    public bool IsLastUnit(int unr, AIFront front)
    {
    ...
    public bool EvacuateHex(int x, int y)
    {
      int num1 = 0;
      int num2 = 0;
      int num3;
    ...
    public int HexDefendImportance(int x, int y)
    {
      int num1 = 0;
    ...
    public void SetStrategicMove()
    {
      ...
      for (int index1 = 0; index1 <= counter; ++index1)
      {
        ...
        if (unitByAiid > -1 && !this.ai.game.Data.UnitObj[unitByAiid].DidMove & !this.ai.game.Data.UnitObj[unitByAiid].DidAttack && !(this.ai.game.Data.UnitObj[unitByAiid].X == this.front.targetX & this.ai.game.Data.UnitObj[unitByAiid].Y == this.front.targetY))
        {
          ...
          if (tx > -1)
            this.MoveList.AddMove(ref new AIMove()
            {
    ...
    public void SetDefensiveZoneMove(
      ref PassHexList passList,
      ref PassHexList tempPassList,
      ref PassHexList tryPassList)
    {
      ...
      for (int index2 = 0; index2 <= counter1; ++index2)
      {
        ...
        {
          int width2 = this.Width;
          for (int index3 = 0; index3 <= width2; ++index3)
          {
            int height = this.Height;
            for (int y = 0; y <= height; ++y)
            {
    ...
    public void SetAirTransportMove()
    {
      this.MoveList = new AIMoveList();
      int counter = this.front.units.counter;
      for (int index1 = 0; index1 <= counter; ++index1)
...
label_63:
          ...
          if (tx1 == -1)
          {
            ...
            aiMatrix.SetAllValuesTo(9999);
            int coordCount = this.front.coordCount;
            for (int index6 = 0; index6 <= coordCount; ++index6)
    ...
    public void SetProtectorMove(int unr, int besti, int bestx, int besty)
    {
      this.MoveList = new AIMoveList();
      int[,] numArray1 = new int[this.Width + 1, this.Height + 1];
...
label_24:
    ...
    public void SetRetreatDefendMove(
      ref PassHexList passList,
      ref PassHexList tempPassList,
      ref PassHexList tryPassList,
      int stimulateDefend,
              ...
              for (int x = 0; x <= width3; ++x)
              {
                ...
                for (int y3 = 0; y3 <= height; ++y3)
                {
                  if (this.Owner.Value[x, y3] == 1 && this.MoveCostMove[index7].Value[x, y3] <= 999)
                  {
                    ...
                    coordinate.onmap = true;
                    coordinate.map = 0;
                    for (int index9 = 0; coordinate.onmap & index9 < 99 & coordinate.x <= this.Width & coordinate.y <= this.Height; ++index9)
                    {
    ...
    public void SetDefendMoveBACKUP(ref PassHexList passList)
    {
      this.MoveList = new AIMoveList();
      int num1 = 1;
      int num2 = -9999;
    ...
    public void ImplementMoveList()
    {
      ...
      for (int index1 = 0; index1 <= counter1; ++index1)
      {
        ...
        int num1 = index1 + 1;
        int counter2 = this.MoveList.Counter;
        for (int index3 = num1; index3 <= counter2; ++index3)
        {
            ...
            if (num2 == 1)
            {
              ...
              for (int index8 = 0; index8 <= counter5; ++index8)
              {
                ...
                if (this.MoveList.Move[index8].MoveTo.onmap && unitByAiid1 != unitByAiid2 && this.MoveList.Move[index8].MoveTo.x == this.GetRealX(matrixX1) & this.MoveList.Move[index8].MoveTo.y == index5 + this.Top)
                {
                  ...
                  for (int index9 = num4; index9 <= counter6; ++index9)
                  {
      ...
      for (int index27 = 0; index27 <= counter7; ++index27)
      {
    ...
    public int GetAverageOffensiveMod2(int unr)
    {
    ...
    public int GetAverageDefensiveMod2(int unr)
    {
      if (this.ai.game.Data.UnitObj[unr].SFCount <= -1)
        return 0;
      int sfCount1 = this.ai.game.Data.UnitObj[unr].SFCount;
    ...
    public void ResetOwner()
    {
      ...
      int num20 = num8;
      for (int index9 = 0; index9 <= num20; ++index9)
      {
        int num21 = height;
        for (int index10 = 0; index10 <= num21; ++index10)
          this.Owner.Value[index9, index10] = numArray1[index9, index10];
      }
    }

    public bool isUnitThatNeedsProtection(int unr) => this.ai.game.Data.UnitObj[unr].TempCategory == 2 || this.ai.game.Data.UnitObj[unr].TempCategory == 5 || this.ai.game.Data.UnitObj[unr].TempCategory2 == 14 || this.ai.game.Data.UnitObj[unr].TempCategory == 14 || this.ai.game.Data.UnitObj[unr].TempTopUnit;

    public bool isUnitThatProtects(int protectsUnr, int unr) => this.ai.game.Data.UnitObj[protectsUnr].TempTopUnit ? this.ai.game.Data.UnitObj[unr].TempCategory == 5 || this.ai.game.Data.UnitObj[unr].TempCategory != 2 && this.ai.game.Data.UnitObj[unr].TempCategory2 != 14 && this.ai.game.Data.UnitObj[unr].TempCategory != 14 && !this.ai.game.Data.UnitObj[unr].TempTopUnit : this.ai.game.Data.UnitObj[unr].TempCategory != 2 && this.ai.game.Data.UnitObj[unr].TempCategory != 5 && this.ai.game.Data.UnitObj[unr].TempCategory2 != 14 && this.ai.game.Data.UnitObj[unr].TempCategory != 14;

    public string SetScore(bool doLog, bool IsAttack = false, int AttackX = -1, int AttackY = -1)
    {
      ...
      for (int tx = 0; tx <= width1; ++tx)
      {
        ...
        for (int index5 = 0; index5 <= height; ++index5)
        {
          ...
          for (int Index = 2; Index <= regimeCounter; ++Index)
          {
      ...
      int width2 = this.Width;
      for (int index18 = 0; index18 <= width2; ++index18)
      {
        int height = this.Height;
        for (int index19 = 0; index19 <= height; ++index19)
        {
      ...
      string str1;
      string str2 = str1 + "BefMoveOwnAllOut: " + num10.ToString() + ", BefMoveOwnFrTrOut: " + num11.ToString() + "AftMoveOwnAllOut: " + num8.ToString() + ", AftMoveOwnFrTrOut: " + num9.ToString() + ", EnmAllOut: " + num23.ToString() + ", EnmFrOut: " + num24.ToString() + ", HexTot: " + num21.ToString() + ", HexFr: " + num16.ToString() + ". ";
      float num27 = num8 + num9 + num16 + num21 + num23 + num24 + num10 + num11;
      string str3 = str2 + "*" + this.initOrigEnemyUnits.ToString() + "/" + this.finalOrigEnemyUnits.ToString();
      float num28;
      ...
      int num30 = 0;
      int width3 = this.Width;
      for (int index21 = 0; index21 <= width3; ++index21)
      {
        int height = this.Height;
        for (int index22 = 0; index22 <= height; ++index22)
        {
      ...
      if (this.front.DefensiveZone > 0)
      {
        ...
        if (simpleList.Counter > -1)
        {
          ...
          for (int tx = 0; tx <= width4; ++tx)
          {
            int height = this.Height;
            for (int index27 = 0; index27 <= height; ++index27)
            {
              if (this.ai.VAR_MATRIX_ZONES.Value[this.GetRealX(tx), index27 + this.Top] + 1000000 == this.front.FrontID)
              {
                ...
                for (int index28 = 0; index28 <= counter5; ++index28)
                {
          ...
          if (index26 < 20)
          {
            ...
            for (int index31 = 1; index31 <= num39; ++index31)
      ...
      if (this.front.Stance == 3 && this.ai.VAR_DC4_ATTACKUNIT_IS_IMPORTANT)
      {
        ...
        int counter7 = this.MoveList.Counter;
        for (int index33 = 0; index33 <= counter7; ++index33)
        {
      ...
      do
      {
        ...
        for (int index34 = 0; index34 <= counter8; ++index34)
        {
          ...
          if (unitByAiid1 > -1 && this.isUnitThatNeedsProtection(unitByAiid1))
          {
            ...
            for (int index35 = 0; index35 <= counter9; ++index35)
            {
            ...
            for (int index36 = 0; index36 <= counter10; ++index36)
            {
            ...
            for (int index37 = 0; index37 <= unitCounter; ++index37)
            {
              ...
              if (this.isUnitThatProtects(unitByAiid1, unr) && this.ai.game.Data.UnitObj[unr].X == x1 & this.ai.game.Data.UnitObj[unr].Y == y1)
              {
                ...
                for (int index38 = 0; index38 <= counter11; ++index38)
                {
      ...
      for (int index39 = 0; index39 <= counter12; ++index39)
      {
        int unr = -1;
        if (this.MoveList.Move[index39].MoveTo.onmap)
        {
          ...
          for (int index40 = num52; index40 <= counter13; ++index40)
          {
      ...
      if (this.front.FrontType == 13)
      {
        ...
        for (int index43 = 0; index43 <= counter14; ++index43)
        {
          ++val2;
          ...
          if (unitByAiid > -1)
          {
            ...
            for (int index44 = 0; index44 <= counter15; ++index44)
            {
            ...
            if (this.FrontArea.Value[matrixX, index45] == this.front.TargetFrontID)
            {
              ...
              if (this.ai.game.Data.MapObj[0].HexObj[x, y].UnitCounter > -1)
              {
                ...
                for (int index46 = 0; index46 <= unitCounter; ++index46)
                {
        ...
        for (int tx = 0; tx <= width5; ++tx)
        {
          int height = this.Height;
          for (int index47 = 0; index47 <= height; ++index47)
          {
            if (this.Owner.Value[tx, index47] == 1 & aiMatrix2.Value[tx, index47] > 0)
            {
              ...
              if (this.ai.game.Data.MapObj[0].HexObj[realX, index48].UnitCounter > -1)
              {
                ...
                for (int index49 = 0; index49 <= unitCounter; ++index49)
                {
      ...
      if (this.ai.VAR_DEBUG_ON & this.MoveList.Counter > -1)
      {
        ...
        for (int index50 = 0; index50 <= counter16; ++index50)
        {
    ...
    public string BACKUP_SetScore(bool doLog, bool IsAttack = false, int AttackX = -1, int AttackY = -1)
    {
      this.Score = 0;
      if (this.MoveList.Counter == -1 & AttackX != -2)
      {
      ...
      string str1;
      string str2 = str1 + "BefMoveOwnAllOut: " + num11.ToString() + ", BefMoveOwnFrTrOut: " + num12.ToString() + "AftMoveOwnAllOut: " + num9.ToString() + ", AftMoveOwnFrTrOut: " + num10.ToString() + ", EnmAllOut: " + num17.ToString() + ", EnmFrOut: " + num18.ToString() + ", HexTot: " + num15.ToString() + ", HexFr: " + num14.ToString() + ". ";
      ...
      if (this.front.DefensiveZone > 0)
      {
        ...
        if (simpleList.Counter > -1)
        {
          ...
          for (int tx = 0; tx <= width3; ++tx)
          {
            ...
            for (int index19 = 0; index19 <= height; ++index19)
            {
              if (this.ai.VAR_MATRIX_ZONES.Value[this.GetRealX(tx), index19 + this.Top] + 1000000 == this.front.FrontID)
              {
                int num31 = 0;
                int counter5 = simpleList.Counter;
                for (int index20 = 0; index20 <= counter5; ++index20)
                {
          ...
          if (index18 < 20)
          {
            ...
            for (int index23 = 1; index23 <= num33; ++index23)
      ...
      if (this.front.Stance == 3 && this.ai.VAR_DC4_ATTACKUNIT_IS_IMPORTANT)
      {
        ...
        int counter7 = this.MoveList.Counter;
        for (int index25 = 0; index25 <= counter7; ++index25)
        {
      ...
      int num39;
      for (int index26 = 0; index26 <= counter8; ++index26)
      {
        ...
        if (unitByAiid1 > -1 && this.ai.game.Data.UnitObj[unitByAiid1].TempCategory == 2)
        {
          ...
          int y1 = this.ai.game.Data.UnitObj[unitByAiid1].Y;
          int counter9 = this.MoveList.Counter;
          for (int index27 = 0; index27 <= counter9; ++index27)
          {
          ...
          int counter10 = this.MoveList.Counter;
          for (int index28 = 0; index28 <= counter10; ++index28)
          {
          ...
          int unitCounter = this.ai.game.Data.MapObj[0].HexObj[x1, y1].UnitCounter;
          for (int index29 = 0; index29 <= unitCounter; ++index29)
          {
      ...
      for (int index32 = 0; index32 <= counter12; ++index32)
      {
        ...
        if (unitByAiid3 > -1 && this.ai.game.Data.UnitObj[unitByAiid3].TempCategory2 == 14)
        {
          ...
          int counter13 = this.MoveList.Counter;
          for (int index33 = 0; index33 <= counter13; ++index33)
          {
          ...
          for (int index34 = 0; index34 <= counter14; ++index34)
          {
          ...
          for (int index35 = 0; index35 <= unitCounter; ++index35)
          {
            ...
            {
              int counter15 = this.MoveList.Counter;
              for (int index37 = 0; index37 <= counter15; ++index37)
              {
      ...
      int counter16 = this.MoveList.Counter;
      int num49;
      for (int index38 = 0; index38 <= counter16; ++index38)
      {
        int unr = -1;
        if (this.MoveList.Move[index38].MoveTo.onmap)
        {
          ...
          for (int index39 = num50; index39 <= counter17; ++index39)
          {
      ...
      if (this.ai.VAR_DEBUG_ON & this.MoveList.Counter > -1)
      {
        ...
        for (int index41 = 0; index41 <= counter18; ++index41)
        {
