...
namespace WindowsApplication1
{
  public class AIMatrix
  {
    ...
    public AIMatrix(ref DC2AIClass tai)
    {
      this.Value = new int[1, 1];
      this.ai = tai;
    ...
    public AIMatrix(ref DC2AIClass tai, int twidth, int theight, int ttop, int tleft)
    {
      this.Value = new int[1, 1];
      this.ai = tai;
      this.Width = twidth;
    ...
    public void RemoveValuesByMask(AIMatrix mask, int SetValXToZero, int ignoreAbove = -1)
    {
    ...
    public void AddValueByMask(AIMatrix mask, int SetValXToY, int valueY)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void RemoveValuesBySuperFrontRule()
    {
      ...
      for (int index5 = 0; index5 <= counter; ++index5)
      {
        ...
        for (int index6 = 0; index6 <= width2; ++index6)
        {
          ...
          for (int index7 = 0; index7 <= height1; ++index7)
          {
            if (this.ai.VAR_MATRIX_SUPERFRONT.Value[index6, index7] == simpleList.Id[index5])
            {
              ...
              if (num1 > 0)
              {
                ...
                for (int index8 = 0; index8 <= width3; ++index8)
                {
                  ...
                  for (int index9 = 0; index9 <= height2; ++index9)
                  {
                ...
                if (num3 >= num2)
                {
                  ...
                  for (int index10 = 0; index10 <= width4; ++index10)
                  {
                    int height3 = this.Height;
                    for (int index11 = 0; index11 <= height3; ++index11)
                    {
    ...
    public void RemoveValuesByLandscapeAIBlock(int SetToVal)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void RemoveValuesByDoubleMask(
      AIMatrix mask,
      int SetValXToZero,
      AIMatrix mask2,
      int SetValXToZero2)
    ...
    public int ReturnHighestValueInMatrix()
    {
      int num = -99999;
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void RemoveValuesByNotMask(AIMatrix mask, int SetNotValXToZero)
    {
    ...
    public void MultiplyAllValues(int number)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void DiminishAllPositiveValues(int number)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SetAllValuesTo(int number)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SetAllValuesToWithMask(int number, ref AIMatrix mask, int ifMaskValue)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SetAllValuesSubtractWith(int number)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SwitchValues(int number1, int number2)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SetValueXToValueY(int number1, int number2)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void SetAllValuesNotValueXTo(int number, int NotValueX)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void RemoveUnconnectedHex(AIMatrix frontlines)
    {
        ...
        for (int index4 = 0; index4 <= num5; ++index4)
        {
          if (this.Value[index3, index4] > 0 & frontlines.Value[index3, index4] > 0 && !this.ai.game.Data.LandscapeTypeObj[this.ai.game.Data.MapObj[0].HexObj[index3, index4].LandscapeType].IsSea)
          {
            ...
            while (flag)
            {
              ...
              ++num6;
              int num7 = width;
              for (int cx = 0; cx <= num7; ++cx)
              {
                int num8 = height;
                for (int cy = 0; cy <= num8; ++cy)
                {
    ...
    public void CopyValuesFrom(AIMatrix mat)
    {
      if (this.ai.game.Data.MapObj[0].MapLoop)
      {
        int width = this.Width;
    ...
    public void SetAllValuesHigherThenXTo(int higherthen, int number)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void RemoveValueByPercentage(AIMatrix mult, int maxPercentRemove = 100)
    {
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
      {
    ...
    public void AddValueByPercentage(AIMatrix mult, AIMatrix mult2, int divideBy = 10)
    {
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
      {
    ...
    public void AddValue(AIMatrix addvalue, int multiply)
    {
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
      {
    ...
    public void CopyToAreaSlot(ref DataClass data, int slot)
    {
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
      {
    ...
    public void RemoveSmallestEnclaves()
    {
      ...
      for (int tx = 0; tx <= width2; ++tx)
      {
        ...
        for (int index1 = 0; index1 <= height1; ++index1)
        {
          if (ownerMatrix.Value[tx, index1] == 1 & this.Value[tx, index1] > 0 & this.Value[tx, index1] < 1000000 & aiMatrix1.Value[tx, index1] == 0 && this.ai.game.Data.LandscapeTypeObj[this.ai.map.HexObj[this.ai.GetRealX(tx, this.Left), index1 + this.Top].LandscapeType].AIBlock == 0)
          {
            ...
            int width3 = this.Width;
            for (int index2 = 0; index2 <= width3; ++index2)
            {
              int height2 = this.Height;
            ...
            int width4 = this.Width;
            for (int index4 = 0; index4 <= width4; ++index4)
            {
              int height3 = this.Height;
              for (int index5 = 0; index5 <= height3; ++index5)
              {
    ...
    public void RemoveSmallestRegularFronts()
    {
      SimpleList simpleList = new SimpleList();
      int width1 = this.Width;
      for (int index1 = 0; index1 <= width1; ++index1)
      {
        ...
        for (int index2 = 0; index2 <= height1; ++index2)
        {
          if (this.Value[index1, index2] > 0 & this.Value[index1, index2] < 1000000 && simpleList.FindNr(this.Value[index1, index2]) < 0)
          {
            ...
            {
              int height2 = this.Height;
              for (int index4 = 0; index4 <= height2; ++index4)
              {
      ...
      for (int index5 = 0; index5 <= counter; ++index5)
      {
        if (simpleList.Weight[index5] < num1)
        {
          ...
          {
            int width4 = this.Width;
            for (int index6 = 0; index6 <= width4; ++index6)
            {
              int height = this.Height;
    ...
    public bool RemoveSmallestRegularFrontsAroundEncircledEnemy(
      ref AIMatrix tOwner,
      ref AIMatrix tEnemySupply)
    {
      ...
      for (int index5 = 0; index5 <= width3; ++index5)
      {
        int height1 = this.Height;
        for (int index6 = 0; index6 <= height1; ++index6)
        {
          if (this.Value[index5, index6] > 0 & this.Value[index5, index6] < 1000000 && simpleList1.FindNr(this.Value[index5, index6]) < 0)
          {
            ...
            int num3 = 0;
            int width4 = this.Width;
            for (int cx = 0; cx <= width4; ++cx)
            {
              int height2 = this.Height;
              for (int cy = 0; cy <= height2; ++cy)
              {
          ...
          if (num4 == num5)
          {
            ...
            if (simpleList4.Counter > -1)
            {
              ...
              do
              {
                ...
                int width5 = this.Width;
                for (int index11 = 0; index11 <= width5; ++index11)
                {
                  int height = this.Height;
      ...
      for (int index13 = 0; index13 <= width7; ++index13)
      {
        int height3 = this.Height;
        for (int index14 = 0; index14 <= height3; ++index14)
        {
          if (this.Value[index13, index14] > 0 & this.Value[index13, index14] < 1000000 && simpleList5.FindNr(this.Value[index13, index14]) < 0)
          {
            ...
            for (int cx = 0; cx <= width8; ++cx)
            {
              int height4 = this.Height;
              for (int cy = 0; cy <= height4; ++cy)
              {
      ...
      for (int index15 = 0; index15 <= counter4; ++index15)
      {
        if (simpleList5.Weight[index15] < num13)
        {
          ...
          if (num14 >= 1)
          {
            ...
            for (int index16 = 0; index16 <= width10; ++index16)
            {
              int height = this.Height;
              for (int index17 = 0; index17 <= height; ++index17)
              {
      ...
      do
      {
        ...
        for (int index18 = 0; index18 <= width11; ++index18)
        {
          int height = this.Height;
    ...
    public void RemoveExposedNonNeccFronts()
    {
      SimpleList simpleList1 = new SimpleList();
      int width1 = this.Width;
      for (int index1 = 0; index1 <= width1; ++index1)
      ...
      for (int index5 = 0; index5 <= counter; ++index5)
      {
        ...
        if (simpleList1.Weight[index5] < frontlineMaxLength | num7 >= 200 && num1 >= 1 & num2 <= 0 && num5 > 50)
        {
          ...
          int width4 = this.Width;
          for (int index7 = 0; index7 <= width4; ++index7)
          {
            int height = this.Height;
    ...
    public AIMatrix AverageValuesForSameRegime(
      int range,
      AIMatrix owner,
    ...
    public AIMatrix AverageAndDivideValuesForSameRegime_NotForVP(
      int range,
      AIMatrix vp,
      AIMatrix owner,
      bool OnlyHigher0Hexes = false,
    ...
    public AIMatrix AverageAndDivideValuesForSameRegime(
      int range,
      AIMatrix owner,
      bool OnlyHigher0Hexes = false,
      int OnlyOwnerX = -1,
    ...
    public AIMatrix AverageValuesForAnyRegime(int range, bool OnlyHigher0Hexes = false)
    {
      int num1 = -9999;
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
    ...
    public AIMatrix AverageValuesWithWindDirection(
      int tsteps,
    ...
    public AIMatrix AverageUniqueValuesForSameRegime(int range)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      AIMatrix aiMatrix = new AIMatrix(ref this.ai);
    ...
    public void ExpandValueForSameRegime(int maxy = 9999, int maxValueToBeMutated = -1)
    {
    ...
    public void ExpandValueForAnyRegimeWithinMask(ref AIMatrix mask, int maxy = 9999)
    {
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1 = -1;
    ...
    public void AddValueForAnyRegimeWithinMask(ref AIMatrix mask, int maxy = 9999)
    {
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1 = -1;
    ...
    public void ExpandValueForSameRegimeWithinMask(ref AIMatrix mask, int maxy = 9999)
    {
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1 = -1;
    ...
    public void ExpandValueForSameRegimeWithinDoubleMask(
      ref AIMatrix mask,
    ...
    public void ExpandValueForAnyRegime(int maxy = 9999, int maxValueToBeMutated = -1)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandValueWithoutConditions(int maxy = 9999, int maxValueToBeMutated = -1)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandValueWithoutConditionsDimishWithOne(int maxy = 9999)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandValueWithoutConditionsDimishWithOneAndOverwriteSmaller(int maxy = 9999)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public int CountHexes(int minVal, int maxVal)
    {
      int num = 0;
      int width = this.Width;
      for (int index1 = 0; index1 <= width; ++index1)
    ...
    public void ExpandValueWithoutRegimesWithMaskAndMax(
...
label_16:
    ...
    public void ExpandValueWithoutRegimesWithMaskAndMovementCost(
      int onlyNumberToCopy,
      ref AIMatrix mask,
      int maskValueNeeded,
      int maxHexesToBeTaken,
...
label_25:
    ...
    public void ExpandValueWithoutConditionsHighest(int maxy = 9999, int percenta = 100, int addVal = 0)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandValueForAnyRegimeOverRoadOnly(float moddyOfValue = 1f)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandValueForAnyRegimeOverRoadOnly_Dc4version(
      float moddyOfValue,
    ...
    public void ExpandValueForSpreadOut(
    ...
    public void ExpandValueToSpecificRegime(int UseOwner, ref AIMatrix owner)
    {
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int num1;
    ...
    public void ExpandAsSimplifiedSupplyMatrix(
      int MoveType,
    ...
    public void ExpandAsSimplifiedSupplyRouteMatrix_SuperSpeed(
      int MoveType,
      ref AIMatrix ownerMatrix,
      int OWNER,
      ...
      int maxSteps = 9999)
    {
      ...
      for (int index1 = 0; index1 <= coordList.counter; ++index1)
      {
    ...
    public void ExpandAsSimplifiedSupplyRouteMatrix(
      int MoveType,
      ref AIMatrix ownerMatrix,
      int OWNER,
      bool IgnoreOwner = false,
    ...
    public void ExpandAsSupplyIdealRouteMatrix(
      int MoveType,
      int enemyMoveType,
      ref AIMatrix ownerMatrix,
      int OWNER,
    ...
    public void ExpandAsSimplifiedSupplyRouteMatrixByID(
      int MoveType,
      ref AIMatrix ownerMatrix,
      int OWNER,
      int MustHaveID,
    ...
    public void ExpandUniquesValuesForAnyRegime(int MaxSteps = 9999, bool allowSea = false, int valueMustBeBelow = -1)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[mapClass.MapWidth + 1, mapClass.MapHeight + 1];
      int num1 = -1;
    ...
    public void ExpandUniquesValuesForSameRegime(
      int MaxSteps = 9999,
    ...
    public void ExpandAllNonZeroValuesForAnyRegime(int MaxSteps)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
    ...
    public void ExpandAllNonZeroValuesForAnyRegime(int MaxSteps, AIMatrix specialMask)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1 = -1;
    ...
    public void ExpandSpecificValueForAnyRegime(int specificVal, int MaxSteps)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1 = -1;
    ...
    public void ExpandSpecificValueForAnyRegimeMasked(
      int specificVal,
      int MaxSteps,
    ...
    public void ExpandSpecificValueForSameRegime(int specificVal, int MaxSteps)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      if (this.ai.TempHexNeighbour.GetUpperBound(0) < this.ai.game.Data.MapObj[0].MapWidth | this.ai.TempHexNeighbour.GetUpperBound(1) < this.ai.game.Data.MapObj[0].MapHeight)
    ...
    public void ExpandSpecificValueForSameRegimeWithinMask(
      int specificVal,
      int MaxSteps,
      ref AIMatrix mask)
    {
    ...
    public void ExpandAndAddValueForSameRegime(int MaxValue)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1;
    ...
    public void ExpandAndAddValueForSameOwner_FAST(int MaxValue, ref AIMatrix tOwnerMat)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      CoordList coordList = new CoordList();
      int width = this.Width;
    ...
    public void ExpandAndAddValueForSameOwner(int MaxValue, ref AIMatrix tOwnerMat)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1;
    ...
    public void SetLandscapeValues(ref SimpleList LTSL, int multiplier)
    {
      ...
      for (int tid = 0; tid <= landscapeTypeCounter; ++tid)
      {
        int index;
    ...
    public void ExpandAndAddValueForLandscapeTypeAndSameRegime(ref SimpleList LTSL, int MaxValue)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
    ...
    public void ExpandAndAddValueForAnyRegime(int MaxValue, bool blockSea = false)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1;
    ...
    public void ExpandAndRemoveValueForAnyRegime(int MaxValue, bool anyhex = false)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1;
    ...
    public void ExpandAndRemovePercentageForAnyRegime(int MaxValue, float moddy, bool anyhex = false)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      int[,] numArray = new int[this.Width + 1, this.Height + 1];
      int num1;
    ...
    public AIMatrix DetectAndMakeEdgeMatrix(bool AlsoForInaccesible)
    {
      MapClass mapClass = this.ai.game.Data.MapObj[0];
      AIMatrix aiMatrix = new AIMatrix(ref this.ai, this.Width, this.Height, this.Top, this.Left);
      int width = this.Width;
