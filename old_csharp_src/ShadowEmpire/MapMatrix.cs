...
namespace WindowsApplication1
{
  public class MapMatrix
  {
    ...
    public MapMatrix(int x, int y)
    {
      ...
      if (!ObjectFlowControl.ForLoopControl.ForLoopInitObj(Counter, (object) 0, (object) x, (object) 1, ref LoopForResult1, ref CounterResult1))
        return;
      do
      {
        object CounterResult2;
        object LoopForResult2;
        if (ObjectFlowControl.ForLoopControl.ForLoopInitObj(CounterResult2, (object) 0, (object) y, (object) 1, ref LoopForResult2, ref CounterResult2))
        {
          do
          {
