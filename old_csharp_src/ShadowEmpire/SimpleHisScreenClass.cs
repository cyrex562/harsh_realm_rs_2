...
// Type: WindowsApplication1.SimpleHisScreenClass
...
{
  public class SimpleHisScreenClass : ScreenClass
  {
    ...
    public SimpleHisScreenClass(ref GameClass tgame, Form1 tformref)
      : base(ref tgame, tgame.BACKGROUND3MARC, tformref)
    {
      ...
      this.Game.EditObj.SimpleEditWindow = 104;
      this.Wmiddle = this.AddWindow((WindowClass) new SimpleHisWindowClass(ref tgame), 0, 0, this.Game.ScreenWidth, this.Game.ScreenHeight);
    }
