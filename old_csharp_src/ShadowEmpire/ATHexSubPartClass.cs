...
{
  public class ATHexSubPartClass : SubPartClass
  {
    ...
    public ATHexSubPartClass(int tx, int ty, GameClass tgame, bool tIgnoreAttack = false)
      : base(200, 82)
    {
    ...
    public override Bitmap Paint()
    {
      ...
      if (this.game.Data.Round > 0 && this.game.Data.ShrowdOn & this.game.Data.MapObj[this.game.EditObj.MapSelected].HexObj[this.x, this.y].get_SeeNow(this.game.Data.Turn) < 1)
      {
        ...
        DrawMod.DrawText(ref graphics, tstring, new Font("Times New Roman", 12f, FontStyle.Bold, GraphicsUnit.Pixel), 10, 35);
