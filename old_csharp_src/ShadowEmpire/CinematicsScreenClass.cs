...
{
  public class CinematicsScreenClass : ScreenClass
  {
    private DateTime lasttime;
    private DateTime lastfadetime;
    private int pagespeed;
    private int fadespeed;
    private int pagenr;
    private int lastpagenr;
    private int fadenr;
    private int fadeFrameCap;
    private Bitmap bmp;
    private Bitmap lastbmp;

    public CinematicsScreenClass(ref GameClass tGame, Form1 tformref)
    ...
    public void introText(ref Graphics g, string s, int mode, int plusy)
    {
    ...
    public void loadSpecificBmp(string s)
    {
      if (!Information.IsNothing((object) this.lastbmp))
      {
        this.lastbmp.Dispose();
