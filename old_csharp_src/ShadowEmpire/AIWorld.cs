...
namespace WindowsApplication1
{
  public class AIWorld
  {
    ...
    public AIMatrix frontline;
    public AIMatrix troops;
    public AIMatrix offtroops;
    public AIMatrix move;
    public AIMatrix friendlyBottleneck;
    public AIMatrix vp;
    public AIMatrix friendlySupply;
    public AIMatrix friendlySupplyRoute;
    public AIMatrix enemySupply;
    public int startFriendlyTroops;
    public int startEnemyTroops;
    public int startFriendlyVP;
    public int startEnemyVP;
    public int[] halfScore;
    public float AbsoluteFriendlyMod;
    public float FriendlyMod;
    public int InitialPercentageInSupply;
    public AIFrontList frontList;
    public int run;

    public int UnitOffensiveModifier(int unr)
    {
    ...
    public void SetHalfScore(int tround, AIFrontList tPlan) => this.halfScore[tround] = this.GetScore("", false, tPlan, true);
    ...
    public int GetScore(string logFileName, bool DoLog, AIFrontList plan, bool halfscoreCalc)
    {
      int mapWidth = this.ai.map.MapWidth;
      int num1;
      int num2;
      ...
      if (DoLog)
      {
        ...
        for (int index3 = 0; index3 <= counter1; ++index3)
        {
          ...
          string str2 = str1 + ", AVG.STRENGTH: " + plan.Front[index3].AverageStrength.ToString();
          if (plan.Front[index3].FrontType == 2)
    ...
    public void SetOwner() => this.owner = this.ai.SetOwnerMatrix(0, 0, this.ai.map.MapWidth, this.ai.map.MapHeight);

    public void CellularAutomatonSetFriendlySupply()
    {
    ...
    public void CellularAutomatonSetFriendlySupplyRoute()
    {
    ...
    public void CellularAutomatonSetEnemySupply()
    {
    ...
    public void CellularAutomatonEnemyNextTurn() => this.CellularAutomatonSetEnemySupply();

    public void CellularAutomatonFriendlyNextTurn()
    {
      this.CellularAutomatonSetFriendlySupply();
      this.CellularAutomatonSetFriendlySupplyRoute();
    }

    public void CellularAutomatonEnemyForces()
    {
    ...
    public void CellularAutomatonStartXIterations(int iterations)
    {
      int num = iterations;
    ...
    public void CellularAutomatonSetStats()
    {
    ...
    public void CellularAutomatonFriendlyForces(AIFrontList frontList, int iteration)
    {
    ...
    public void CellularAutomatonAttack(AIFront front, int MAX_STEPS)
    {
      int num1;
      int num2;
      do
    ...
    public void CellularAutomatonEnemyAttack(float attackForceModifier)
    {
      int num1 = 3;
      int num2 = 2;
      if (this.ai.VAR_ENEMYMOVE_PROGNOSIS_MODE == 1)
    ...
    public int CellularAutomatonRetreatEnemyTroops(int x, int y, AIFront front)
    {
      int index1 = 0;
      int num1;
      do
    ...
    public int CellularAutomatonRetreatFriendlyTroops(int x, int y, AIMatrix frontlines)
    {
      int index1 = 0;
      Coordinate coordinate;
      int num1;
    ...
    public int CellularAutomatonGetTotalPowerOn(
      int x,
      int y,
      AIFront front,
      AIMatrix blocked,
    ...
    public int CellularAutomatonGetBestRiver(int x, int y, AIMatrix blocked)
    {
      int num = 0;
      int bestRiver = -1;
      int index = 0;
    ...
    public int CellularAutomatonGetTotalEnemyPowerOn(int x, int y, AIMatrix blocked)
    {
      int index = 0;
    ...
    public void CellularAutomatonMoveIn(int x, int y, AIFront front, AIMatrix blocked)
    {
      int index1 = 0;
      do
      {
    ...
    public void CellularAutomatonEnemyMoveIn(int x, int y, AIMatrix blocked)
    {
      int index1 = 0;
      do
      {
    ...
    public int CellularAutomatonGetNumberOfEnemyNeighbours(int x, int y)
    {
    ...
    public int CellularAutomatonGetNumberOfFriendlyNeighbours(int x, int y)
    {
    ...
    public void CellularAutomatonModifyTroopsOn(
      int x,
      int y,
      AIFront front,
      int attLoss,
    ...
    public void CellularAutomatonModifyEnemyTroopsOn(int x, int y, int attLoss, AIMatrix Blocked)
    {
      int index1 = 0;
      Coordinate coordinate;
      int num1;
    ...
    public float CellularAutomatonGetMinimumAttackAdvantage(int stance, int ltnr, int riv)
    {
    ...
    public int CellularAutomatonGetLossForAttacker(
      int stance,
      int attackPower,
      int defendPower,
      int ltnr,
    ...
    public int CellularAutomatonGetLossForDefender(int stance, int attackPower, int defendPower)
    {
    ...
    public void CellularAutomatonReserveDelivery(AIFront front, int iteration)
    {
      int num1 = 4;
    ...
    public void CellularAutomatonGiveEnemyReinforcements()
    {
      int mapWidth1 = this.ai.map.MapWidth;
      int num1;
      for (int index1 = 0; index1 <= mapWidth1; ++index1)
    ...
    public void CellularAutomatonGiveFriendlyReinforcements()
    {
      int mapWidth1 = this.ai.map.MapWidth;
      int num1;
      for (int index1 = 0; index1 <= mapWidth1; ++index1)
    ...
    public void CellularAutomatonRemoveFrontsWithoutFrontline(ref AIFrontList frontList)
    {
      int counter = frontList.Counter;
      for (int index1 = 0; index1 <= counter; ++index1)
      {
    ...
    public void CellularAutomatonMoveTowardsFront(int range, int mindist)
    {
    ...
    public void CellularAutomatonMoveEnemyTowardsFront(int range, int mindist)
    {
      AIMatrix aiMatrix1 = new AIMatrix(ref this.ai);
      AIMatrix aiMatrix2 = this.owner.Clone();
    ...
    public void CellularAutomatonSpreadOut(AIFront front, int range)
    {
      AIMatrix aiMatrix1 = new AIMatrix(ref this.ai);
      float num1 = 0.2f;
      int num2 = 1;
    ...
    public void CellularAutomatonFallBack(AIFront front, int MAX_NUMBER_OF_STEPS)
    {
      AIMatrix aiMatrix1 = new AIMatrix(ref this.ai);
      int num1 = 99999;
    ...
    public void CellularAutomatonEnemySpreadOut(int range)
    {
      AIMatrix aiMatrix1 = new AIMatrix(ref this.ai);
      float num1 = 0.2f;
      int num2 = 5;
