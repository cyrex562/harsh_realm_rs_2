...
// Type: WindowsApplication1.SS_ScreenClass
...
{
  public class SS_ScreenClass : ScreenClass
  {
    ...
    public SS_ScreenClass(ref GameClass tgame, Form1 tformref)
      : base(ref tgame, tgame.BACKGROUND3MARC, tformref)
    {
      ...
      this.WEditMenu = this.AddWindow((WindowClass) new SSEditOptionsWindowClass(ref tgame, this.OwnBackground, 0, 0), 0, 0, this.Game.ScreenWidth, 50);
      this.Wmiddle = this.AddWindow((WindowClass) new SSMapDashboardWindowClass(ref tgame), 0, 50, this.Game.ScreenWidth, this.Game.ScreenHeight - 50);
    }
            ...
            for (int index2 = 0; index2 <= counter; ++index2)
            {
              ...
              if (windowReturnClass.CommandType[index2] == 2)
              {
                if (windowReturnClass.CommandData[index2] == 94)
                  this.WEditMenu = this.AddWindow((WindowClass) new SSEditOptionsWindowClass(ref DrawMod.TGame, this.OwnBackground, 0, 0), 0, 0, this.Game.ScreenWidth, 50);
                if (windowReturnClass.CommandData[index2] == 95)
                  this.Wmiddle = this.AddWindow((WindowClass) new SSMapDashboardWindowClass(ref DrawMod.TGame), 0, 50, this.Game.ScreenWidth, this.Game.ScreenHeight - 50);
                if (windowReturnClass.CommandData[index2] == 122)
                  this.Wmiddle = this.AddWindow((WindowClass) new SSEventPicsClass(ref DrawMod.TGame), 0, 50, this.Game.ScreenWidth, this.Game.ScreenHeight - 50);
                if (windowReturnClass.CommandData[index2] == 123)
                  this.Wmiddle = this.AddWindow((WindowClass) new SSSmallGfxClass(ref DrawMod.TGame), 0, 50, this.Game.ScreenWidth, this.Game.ScreenHeight - 50);
