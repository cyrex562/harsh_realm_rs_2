...
{
  [Serializable]
  public class LocationTypeClass : ISerializable
  {
    public string Name;
    public int OverdrawLTNr;
    public int OverdrawSpriteNr;
    public int ExtraGraphic;
    public int SmallGraphic;
    public int SmallGraphicSpecialMode;
    public int SmallGraphicSpecialData;
    public bool[] BuildgroundType;
    ...
    public int OnDestructLT;
    public int OnDestructSpriteNr;
    public int AutoRecoverPts;
    public bool Invincible;
    public int UpgradeNr;
    public int DowngradeNr;
    public int LocTypeGroup;
    ...
    public int PictureLT;
    public int PictureSprite;
    public int AIPriority;
    public int AIEvent;
    public int AILocEvent;
    public int AIAfterBuildEvent;
    public bool AICanBuild;
    public bool HumanCanBuild;
    public int SetPeopleToSlotX;
    public bool NoHQ;
    public int AutoProd;
    public int TopAirStack;
    public bool Repairable;
    public int Logistical;
    public bool useSmallLabel;
    public bool isSupplyBase;
    public bool isSupplySource;
    public int maxSupply;
    public int maxFuel;
    public int maxEvacuate;
    public int maxDestroy;
    public int needsCityLevel;
    ...
    public LocationTypeClass(int hardcoded)
    {
      this.BuildgroundType = new bool[100];
      this.PeopleGroup = new bool[100];
      this.ItemGroup = new bool[100];
    ...
    public LocationTypeClass Clone()
    {
