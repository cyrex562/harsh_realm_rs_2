...
// Type: WindowsApplication1.SimpleTroopTypeScreenClass
...
{
  public class SimpleTroopTypeScreenClass : ScreenClass
  {
    ...
    public SimpleTroopTypeScreenClass(ref GameClass tgame, Form1 tformref)
      : base(ref tgame, tgame.BACKGROUND3MARC, tformref)
    {
      ...
      this.Game.EditObj.SimpleEditWindow = 103;
      this.Wmiddle = this.AddWindow((WindowClass) new SimpleTroopTypeWindowClass(ref tgame), 0, 0, this.Game.ScreenWidth, this.Game.ScreenHeight);
    }
