...
{
  public class GameLoopMainWindowClass : WindowClass
  {
    ...
    private bool DoingAI;

    public GameLoopMainWindowClass(ref GameClass tGame)
    ...
    public GameLoopMainWindowClass(ref GameClass tGame, bool NewGfx)
    ...
    public override WindowReturnClass handleTimer()
    {
      ...
      if (this.DoingAI)
      {
        ...
        if (DateAndTime.Now.Subtract(this.showtime).Milliseconds > 200)
        {
          ...
          if ((double) this.game.Data.RuleVar[839] == 1.0 & this.game.Data.UseAI == 1)
          {
            ...
            SubPartClass tsubpart = (SubPartClass) new TextPartClass(this.game.EditObj.TempAIString, f, 800, 30, true, tBlackBack: tBlackBack, tMarc: (!tBlackBack));
            this.TempText = this.AddSubPart(ref tsubpart, 120, 330, 800, 30, 0);
            if (this.game.EditObj.AIProgressMax > 0)
            {
              tsubpart = (SubPartClass) new TextPartClass(Strings.Trim(Conversion.Str((object) (int) Math.Round((double) this.game.EditObj.AIProgressNow / (double) this.game.EditObj.AIProgressMax * 100.0))) + "% completed", this.game.MarcFont1, 600, 40, true, tBlackBack: true, tProgress: ((int) Math.Round((double) this.game.EditObj.AIProgressNow / (double) this.game.EditObj.AIProgressMax * 100.0)), tMarc: true);
              this.TempText2 = this.AddSubPart(ref tsubpart, 220, 375, 600, 100, 0);
            }
          }
          else
          {
            SubPartClass tsubpart = (SubPartClass) new ATTextPartClass("AI step " + Strings.Trim(Conversion.Str((object) this.refrcount)), f, 800, 30, true, tBlackBack: tBlackBack, tMarc: (!tBlackBack));
      ...
      if (this.game.EditObj.Test == 1)
      {
        ...
        if (this.game.Data.Round == 0)
        {
          ...
          for (int regnr = 0; regnr <= regimeCounter; ++regnr)
          {
            ...
            for (int index = 0; index <= sfCounter; ++index)
      ...
      if ((double) this.game.Data.RuleVar[839] == 1.0)
        this.DrawDateAndRegime();
      SubPartClass tsubpart1 = (SubPartClass) new ATTextPartClass(txt, f1, 800, 30, true, tBlackBack: tBlackBack1, tMarc: (!tBlackBack1));
      this.TempText = this.AddSubPart(ref tsubpart1, 110, 360, 800, 30, 0);
      windowReturnClass1.Flag = true;
      return windowReturnClass1;
    }

    public void RemoveEnterTurnViewMessageShit()
    {
    ...
    public void DrawDateAndRegime()
    {
      ...
      if ((double) this.game.Data.RuleVar[839] == 1.0)
      {
        ...
        DrawMod.DrawBlock(ref Expression, 92, 82, 878, 3, (int) this.game.MarcCol4.R, (int) this.game.MarcCol4.G, (int) this.game.MarcCol4.B, (int) this.game.MarcCol4.A);
        DrawMod.DrawBlock(ref Expression, 92, 675, 878, 3, (int) this.game.MarcCol4.R, (int) this.game.MarcCol4.G, (int) this.game.MarcCol4.B, (int) this.game.MarcCol4.A);
      }
      else
      {
        ...
        DrawMod.DrawTextVic2(ref Expression, str2, this.game.VicFont1, (int) Math.Round((double) (900f - sizeF2.Width)), 15, this.game.VicColor2, this.game.VicColor2Shade);
      }
    ...
    public void EnterTurn()
    {
      ...
      if ((double) this.game.Data.RuleVar[839] == 1.0)
      {
        ...
        flag = false;
        SubPartClass tsubpart = (SubPartClass) new TextPartClass(txt, marcFont1, 724, 40, true, tMarc: (!flag));
      ...
      else
      {
        ...
        flag = true;
        SubPartClass tsubpart = (SubPartClass) new ATTextPartClass(txt, vicFont1, 724, 40, true, tMarc: (!flag));
        this.Heading2Text = this.AddSubPart(ref tsubpart, 150, 150, 724, 30, 0);
      }
      Font usefont = (double) this.game.Data.RuleVar[839] != 1.0 ? (Font) null : this.game.MarcFont4;
      ...
      if (!this.loggedin)
      {
        ...
        if (!this.saved)
        {
          tsubpart1 = (SubPartClass) new TextButtonPartClass(buttontext, 100, "You have to login if playing PBEM and/or using passwords.", ref this.OwnBitmap, 400, 710, usefont: usefont, useshadow: (!flag), tMarcStyle: (!flag));
          this.LoginId = this.AddSubPart(ref tsubpart1, 400, 710, 100, 35, 1);
        }
        else
        {
          tsubpart1 = (SubPartClass) new TextButtonPartClass(buttontext, 100, "You have to login if playing PBEM and/or using passwords.", ref this.OwnBitmap, 455, 710, usefont: usefont, useshadow: (!flag), tMarcStyle: (!flag));
          this.LoginId = this.AddSubPart(ref tsubpart1, 455, 710, 100, 35, 1);
        }
      }
      string buttontext1 = (double) this.game.Data.RuleVar[839] != 1.0 ? "Save & Quit" : "SAVE + QUIT";
      if (!this.loggedin & !this.saved)
      {
        tsubpart1 = (SubPartClass) new TextButtonPartClass(buttontext1, 100, "If your playing a PBEM and your not playing\r\nthis regime this is a good place to save and quit.", ref this.OwnBitmap, 530, 710, usefont: usefont, useshadow: (!flag), tMarcStyle: (!flag));
        this.SaveId = this.AddSubPart(ref tsubpart1, 530, 710, 100, 35, 1);
      }
      string buttontext2 = (double) this.game.Data.RuleVar[839] != 1.0 ? "Start Turn" : "START TURN";
      if (this.loggedin)
      {
        tsubpart1 = (SubPartClass) new TextButtonPartClass(buttontext2, 100, "Click to start the turn.", ref this.OwnBitmap, 455, 710, usefont: usefont, useshadow: (!flag), tMarcStyle: (!flag));
      ...
      if ((double) this.game.Data.RuleVar[839] == 0.0 && this.loggedin)
      {
        ...
        int tdata1;
        for (tdata1 = 0; tdata1 <= itemTypeCounter; ++tdata1)
        {
          ...
          {
            string name = this.game.Data.ItemTypeObj[tdata1].Name;
            string tvalue2 = "-";
            ...
            string tvalue = Strings.Trim(Conversion.Str((object) Number1));
        ...
        {
          tsubpart1 = (SubPartClass) new ATListSubPartClass(this.ListObj, 18, 250, -1, this.game, tHeader: "Type                                 Prod", tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 100, tbackbitmap: (ref this.OwnBitmap), bbx: 225, bby: 210);
          this.Listid1 = this.AddSubPart(ref tsubpart1, 185, 210, 250, 336, 0);
        }
        else
        {
          tsubpart1 = (SubPartClass) new ATListSubPartClass(this.ListObj, 18, 250, -1, this.game, tHeader: "Type                                 Prod    AS Loss", tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 100, tbackbitmap: (ref this.OwnBitmap), bbx: 185, bby: 210);
          this.Listid1 = this.AddSubPart(ref tsubpart1, 225, 210, 250, 336, 0);
        }
        this.ListObj2 = new ATListClass();
        if (this.game.Data.ASOn)
        {
          string tname = "Supply";
          string tvalue = "-";
        ...
        do
        {
          ...
          {
            string str = this.game.Data.TempString[400 + tdata2];
            string tvalue = "-";
            string tvalue2 = "-";
            string tvalue3 = "-";
        ...
        if (this.game.Data.ASOn)
        {
          tsubpart1 = (SubPartClass) new ATListSubPartClass(this.ListObj2, 18, 350, -1, this.game, tHeader: "Type                                                Losses Kills   AS Kill", tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 150, tbackbitmap: (ref this.OwnBitmap), bbx: 490, bby: 210);
          this.listid2 = this.AddSubPart(ref tsubpart1, 490, 210, 350, 336, 0);
        }
        else
        {
          tsubpart1 = (SubPartClass) new ATListSubPartClass(this.ListObj2, 18, 350, -1, this.game, tHeader: "Type                                                Losses Kills", tHeaderCenter: false, tHighlight: false, tShowPair: true, tValueWidth: 150, tbackbitmap: (ref this.OwnBitmap), bbx: 490, bby: 210);
          this.listid2 = this.AddSubPart(ref tsubpart1, 490, 210, 350, 336, 0);
        }
      }
      if (Information.IsNothing((object) Expression))
    ...
    public void ViewMessage()
    {
      ...
      {
        int index2 = -1;
        string str1 = this.game.Data.RegimeObj[this.game.Data.Turn].MessString[this.PhaseData];
        int num1 = 0;
        ...
        if (index2 > -1)
        {
          ...
          SubPartClass tsubpart = (SubPartClass) new TextPartClass(strArray[0], new Font("Times New Roman", 25f, FontStyle.Bold, GraphicsUnit.Pixel), 800, 30, true);
        ...
        if (this.game.Data.RegimeObj[this.game.Data.Turn].MessFrontPic[this.PhaseData] > -1)
        {
          ...
          {
            tsubpart1 = (SubPartClass) new ButtonPartClass(num3);
            this.Pic1Id = this.AddSubPart(ref tsubpart1, (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(num3) / 2.0), y, BitmapStore.GetWidth(num3), BitmapStore.Getheight(num3), 0);
            y = y + BitmapStore.Getheight(num3) + 10;
          }
          else
          {
            SubPartClass tsubpart2 = (SubPartClass) new ButtonPartClass(num3, tResizeX: BitmapStore.GetWidth(num3), tresizeY: 300);
            this.Pic1Id = this.AddSubPart(ref tsubpart2, (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(num3) / 2.0), y, BitmapStore.GetWidth(num3), 300, 0);
            y = y + 300 + 10;
          }
        }
        int num4 = 0;
        if (index2 > 0)
        {
          ...
          for (int index3 = 1; index3 <= num5; ++index3)
          {
            ...
            string str4 = Strings.Mid(strArray[index3], num6 + 1);
            int num7 = Strings.InStr(str4, "@", CompareMethod.Text);
            if (num6 > 0 & num7 > 0)
            {
              string str5 = Strings.Mid(str4, num7 + 1);
              string txt = Strings.Left(str4, Strings.Len(str4) - (1 + Strings.Len(str5)));
              int num8 = (int) Math.Round(Conversion.Val(str5));
              ...
              int[] textId = this.TextId;
              int index5 = index3;
              tsubpart1 = (SubPartClass) new TextPartClass(txt, new Font("Times New Roman", 16f, FontStyle.Bold, GraphicsUnit.Pixel), 800, 25, true);
            ...
            else
            {
              int[] textId = this.TextId;
              int index6 = index3;
              tsubpart1 = (SubPartClass) new TextPartClass(strArray[index3], new Font("Times New Roman", 16f, FontStyle.Bold, GraphicsUnit.Pixel), 800, 25, true);
        ...
        if (num4 == 0)
        {
          tsubpart1 = (SubPartClass) new TextButtonPartClass("Acknowledge", 100, tBackbitmap: (ref this.OwnBitmap), bbx: 455, bby: 690);
        ...
        if ((double) this.game.Data.RuleVar[839] == 0.0)
        {
          ...
          if (this.game.Data.RegimeObj[this.game.Data.Turn].MessFrontPic[this.PhaseData] > -1)
          {
            ...
            if (nr > -1)
            {
              ...
              {
                DrawMod.DrawOfficer(graphics, this.game.Data.RegimeObj[this.game.Data.Turn].MessFrontPic[this.PhaseData] - 10000, (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(nr) / 2.0), 70, BitmapStore.GetWidth(nr), BitmapStore.Getheight(nr));
              ...
              else if (BitmapStore.Getheight(nr) <= 200)
              {
                ...
                int x = (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(nr) / 2.0);
                int width = BitmapStore.GetWidth(nr);
                int h = BitmapStore.Getheight(nr);
                DrawMod.DrawScaled(ref local1, ref local2, x, 70, width, h);
                num13 = BitmapStore.Getheight(nr) + 20;
                DrawMod.DrawRectangle(ref graphics, (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(nr) / 2.0), 70, BitmapStore.GetWidth(nr), BitmapStore.Getheight(nr), (int) this.game.VicColor3.R, (int) this.game.VicColor3.G, (int) this.game.VicColor3.B, (int) this.game.VicColor3.A);
              }
              else
              {
                ...
                int x = (int) Math.Round(512.0 - (double) BitmapStore.GetWidth(nr) * (200.0 / (double) BitmapStore.Getheight(nr)) / 2.0);
                int w = (int) Math.Round((double) BitmapStore.GetWidth(nr) * (200.0 / (double) BitmapStore.Getheight(nr)));
                DrawMod.DrawScaled(ref local3, ref local4, x, 70, w, 200);
                num13 = 220;
                DrawMod.DrawRectangle(ref graphics, (int) Math.Round(510.0 - (double) BitmapStore.GetWidth(nr) * (200.0 / (double) BitmapStore.Getheight(nr)) / 2.0), 68, (int) Math.Round((double) BitmapStore.GetWidth(nr) * (200.0 / (double) BitmapStore.Getheight(nr)) + 4.0), 204, (int) this.game.VicColor3.R, (int) this.game.VicColor3.G, (int) this.game.VicColor3.B, (int) this.game.VicColor3.A);
              }
            }
          }
          int trows = (int) Math.Round(30.0 - (double) num13 / 16.0);
          if (7 > trows)
            trows = 7;
          int num14 = 150;
          int num15 = 110 + num13;
          ...
          SubPartClass tsubpart3 = (SubPartClass) new PaperAreaClass(this.game, num16, trows, (Font) null, "Description", false, this.game.Data.RegimeObj[this.game.Data.Turn].MessString[this.PhaseData], this.game.VicColor8, tbackbitmap: (ref this.OwnBitmap), bbx: num14, bby: num15);
          this.TAid = this.AddSubPart(ref tsubpart3, num14, num15, num16, 16 * (trows + 1), 0);
          SubPartClass tsubpart4 = (SubPartClass) new TextButtonPartClass("Acknowledge", 100, tBackbitmap: (ref this.OwnBitmap), bbx: 455, bby: 690);
          ...
          if (this.game.Data.RegimeObj[this.game.Data.Turn].MessFrontPic[phaseData] > -1)
          {
            ...
            if (nr > -1)
            {
              ...
              if (this.game.Data.RegimeObj[this.game.Data.Turn].MesStyle[phaseData] == 2)
              {
                if (width > 194)
                {
                  height = (int) Math.Round((double) height * (194.0 / (double) width));
                  width = (int) Math.Round((double) width * (194.0 / (double) width));
                }
                if (height > 200)
                {
                  width = (int) Math.Round((double) width * (200.0 / (double) height));
                  height = (int) Math.Round((double) height * (200.0 / (double) height));
                }
                rectangle = new Rectangle((int) Math.Round(500.0 - (double) width / 2.0), 20, width, height);
                num18 = height + 10;
              }
              else
              {
                if (width > 515)
                {
                  height = (int) Math.Round((double) height * (515.0 / (double) width));
                  width = (int) Math.Round((double) width * (515.0 / (double) width));
                }
                if (height > 250)
                {
                  width = (int) Math.Round((double) width * (250.0 / (double) height));
                  height = (int) Math.Round((double) height * (250.0 / (double) height));
                }
                rectangle = new Rectangle((int) Math.Round(512.0 - (double) width / 2.0), 80, width, height);
                num18 = height + 10;
              }
            }
          }
            ...
            num18 = 0;
          SubPartClass tsubpart = (SubPartClass) new TextAreaClass2(this.game, 500, 15, this.game.MarcFont3, this.game.Data.RegimeObj[this.game.Data.Turn].MessString[phaseData], 24, ref this.BackBitmap, 175, 100, true, true, tcenterit: true);
          this.TAid = this.AddSubPart(ref tsubpart, 260, 100, 500, 384, 0);
          int num19 = this.SubPartList[this.SubpartNr(this.TAid)].HeightUsed();
          int num20 = (int) Math.Round((double) (this.OwnBitmap.Height - 100 - (num18 + num19)) / 2.0);
          this.RemoveSubPart(this.TAid);
          tsubpart = (SubPartClass) new TextAreaClass2(this.game, 500, (int) Math.Round(Conversion.Int((double) num19 / 24.0)), this.game.MarcFont3, this.game.Data.RegimeObj[this.game.Data.Turn].MessString[phaseData], 24, ref this.BackBitmap, 260, num20 + num18, true, true, tcenterit: true);
          this.TAid = this.AddSubPart(ref tsubpart, 260, num20 + num18, 500, 16 * ((int) Math.Round((double) num19 / 36.0) + 1), 0);
          tsubpart = (SubPartClass) new TextButtonPartClass("PRESS ANY KEY", 160, "Click button to continue", ref this.OwnBitmap, 420, 710, theight: 20, usefont: this.game.MarcFont4, useshadow: true, tMarcStyle: true);
            ...
            if (num21 > -1)
            {
              if (this.game.Data.RegimeObj[this.game.Data.Turn].MessFrontPic[phaseData] > 10000)
              {
                ...
                if (this.game.Data.RegimeObj[this.game.Data.Turn].MesNote2[phaseData].Length > 0)
                {
                  ...
                  DrawMod.DrawTextColouredMarc(ref graphics, this.game.Data.RegimeObj[this.game.Data.Turn].MesNote2[phaseData], this.game.MarcFont7, (int) Math.Round((double) rectangle.X + (double) rectangle.Width / 2.0 - (double) sizeF2.Width / 2.0), rectangle.Y + rectangle.Height - 8, Color.White);
                }
              }
              else
              {
              ...
              if (num1 == this.LoginId)
              {
                ...
                if (this.game.Data.PBEM && this.game.Data.GameID > -1)
                {
                  ...
                  if (this.game.Data.Round == 1 | this.game.Data.RegimeObj[this.game.Data.Turn].FirstRound == this.game.Data.Round)
                  {
                    ...
                    {
                      this.game.Data.RegimeObj[this.game.Data.Turn].RandomCode = (int) Math.Round((double) Conversion.Int(VBMath.Rnd() * 9999f));
                  ...
                  else
                  {
                    ...
                    if (Operators.ConditionalCompareObjectLess(masterLogClass.ReturnQty(this.game.Data.GameID, this.game.Data.Round - 1, this.game.Data.Turn, this.game.Data.RegimeObj[this.game.Data.Turn].RandomCode), (object) 1, false))
                    {
                      ...
                      {
                        this.loggedin = false;
                        int num3 = (int) Interaction.MsgBox((object) "Wiped Logbook. Terror Mode aborts opening this turn.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                        windowReturnClass.SetFlag(true);
                        return windowReturnClass;
                      }
                      int regimeCounter = this.game.Data.RegimeCounter;
                    ...
                    else if (Operators.ConditionalCompareObjectGreater(masterLogClass.ReturnQty(this.game.Data.GameID, this.game.Data.Round, this.game.Data.Turn, -1), (object) 0, false))
                    {
                      ...
                      {
                        this.loggedin = false;
                        int num4 = (int) Interaction.MsgBox((object) "Turn has already been opened before. Terror Mode aborts opening this turn.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                        windowReturnClass.SetFlag(true);
                        return windowReturnClass;
                      }
                      int regimeCounter = this.game.Data.RegimeCounter;
                    ...
                    else if (Information.IsNothing((object) Expression))
                    {
                      ...
                      {
                        this.loggedin = false;
                        int num5 = (int) Interaction.MsgBox((object) "Unknown operations done to logfiles by user. Terror Mode aborts opening this turn.", Title: ((object) "Shadow Empire : Planetary Conquest"));
                        windowReturnClass.SetFlag(true);
                        return windowReturnClass;
                      }
                      int regimeCounter = this.game.Data.RegimeCounter;
