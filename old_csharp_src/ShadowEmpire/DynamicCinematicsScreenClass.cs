...
{
  public class DynamicCinematicsScreenClass : ScreenClass
  {
    private int pagenr;
    private int lastpagenr;
    private Bitmap fullBmp;
    private bool fullBmpCenterScale;
    private Bitmap[] bmp;
    private int[] bmpLink;
    private DateTime lastTime;
    private int textRotateNumber;
    private int textSize;
    private bool timerActive;
    private int timerMs;
    private DateTime timerStart;
    private bool udsActive;
    private bool firstRenderDone;
    private int UdsId;
    private WindowClass UdsWindow;
    private int udsX;
    private int udsY;
    private int udsW;
    private int udsH;
    private int udsNewEvent;
    private bool udsContainsButton;
    private int udsTv0;
    private Cursor tempCursor;
    private string fullBmpName;
    private SimpleStringList TabList;

    public DynamicCinematicsScreenClass(ref GameClass tGame, Form1 tformref)
      : base(ref tGame, tFormRef: tformref)
    {
      ...
      this.TabList = new SimpleStringList();
      this.pagenr = 9999999;
      this.lastpagenr = 0;
    ...
    public override Bitmap Paint(bool onlyToolTip = false)
    {
      this.textSize = 0;
      ...
      {
        this.Game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.Game.Data.RuleVar[971]));
        bool flag = false;
        ...
        int num8 = 1920;
        int num9 = 1080;
        int num10 = (int) Math.Round((double) (this.Game.ScreenWidth - 1024) / 2.0);
        int num11 = (int) Math.Round((double) (this.Game.ScreenHeight - 768) / 2.0);
        num2 = num10;
        num3 = num11;
        if ((double) num1 != 1.0)
        {
          num8 = (int) Math.Round((double) (1920f * num1));
          num9 = (int) Math.Round((double) (1080f * num1));
          int num12 = num10 + (int) Math.Round((double) (num8 - this.Game.ScreenWidth) / 2.0);
          int num13 = num11 + (int) Math.Round((double) (num9 - this.Game.ScreenHeight) / 2.0);
        }
        int x1 = (int) Math.Round((double) (this.Game.ScreenWidth - num8) / 2.0);
        int y1 = (int) Math.Round((double) (this.Game.ScreenHeight - num9) / 2.0);
        int width1 = num8;
        int height1 = num9;
        int x2;
        int y2;
        ...
        {
          x2 = (int) Math.Round((double) (1920 - num8) / 2.0);
          y2 = (int) Math.Round((double) (1080 - num9) / 2.0);
          width2 = num8;
          height2 = num9;
          if (!flag)
          {
      ...
      do
      {
        int stringListById1 = this.Game.HandyFunctionsObj.GetStringListByID((int) Math.Round((double) this.Game.Data.RuleVar[971]));
        int length = this.Game.Data.StringListObj[stringListById1].Length;
        int num15;
        for (int index1 = 0; index1 <= length; ++index1)
        {
          if ((int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 0])) == this.pagenr)
          {
            int num16 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 1]));
            Bitmap bitmap;
            if (num16 != 2 & num14 == 1 | num16 == 2 & num14 == 2)
            {
              if (Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 3]) == 2.0)
              {
                ...
                if (index2 > -1)
                {
                  ...
                  if (Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 1]) == 3.0 | Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 1]) == 1.0)
                  {
                    ...
                    int num17 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                    int num18 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                    x = num4 + (int) Math.Round((double) num1 * ((double) integer1 + 448.0));
                    y = num5 + (int) Math.Round((double) num1 * ((double) integer2 + 156.0));
                    width = (int) Math.Round((double) ((float) num17 * num1));
                    height = (int) Math.Round((double) ((float) num18 * num1));
                  }
                  else
                  {
                    x = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                    y = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 100000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 199999.0)
                      x = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 100000.0);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 299999.0)
                      x = this.Game.ScreenWidth - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 200000.0);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 300000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 399999.0)
                      x = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 300000.0);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 400000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 499999.0)
                      x = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 400000.0);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 99000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 199999.0)
                      y = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 100000.0);
                    if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 299999.0)
                      y = this.Game.ScreenHeight - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 200000.0);
                    width = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                    height = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                  }
                  if (width < 1 & height < 1)
                  {
                    ...
                    width = (int) Math.Round((double) this.bmp[index2].Width * ((double) height / (double) this.bmp[index2].Height));
                  else if (height < 1)
                    height = (int) Math.Round((double) this.bmp[index2].Height * ((double) width / (double) this.bmp[index2].Width));
              ...
              {
                int num19 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                int num20 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 100000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 199999.0)
                  num19 = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 100000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 299999.0)
                  num19 = this.Game.ScreenWidth - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 200000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 300000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 399999.0)
                  num19 = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 300000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 400000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 499999.0)
                  num19 = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 400000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 99000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 199999.0)
                  num20 = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 100000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 299999.0)
                  num20 = this.Game.ScreenHeight - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 200000.0);
                int num21 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                int num22 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                if (num21 < 1 | num22 < 1)
                {
                  num21 = 100;
                  num22 = 140;
                ...
                bitmap = this.Game.CustomBitmapObj.DrawLeaderPortrait((int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 2])), num21, num22);
              ...
              {
                int x = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                int y = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                int w = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                int h = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                if (Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 1]) == 3.0)
                {
                  w = (int) Math.Round((double) ((float) w * num1));
                  h = (int) Math.Round((double) ((float) h * num1));
                }
                int sfTypeById = this.Game.HandyFunctionsObj.GetSFTypeByID((int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 2])));
                if (sfTypeById > -1)
                {
                  ...
                  int idValue = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById2].GetData(0, id, 2)));
                  int cultureGroupId = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById3].GetData(0, idValue, 1)));
              ...
              else if (Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 3]) == 4.0)
              {
                if (!this.timerActive)
                {
                  int num23 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 8]));
                  if (num23 > 0)
                  {
              ...
              else if (Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 3]) == 7.0)
              {
                if (this.UdsId == 0 & !this.udsActive)
                {
                  ...
                  int sx = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                  int sy = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                  this.udsX = sx;
                  this.udsY = sy;
                  int num24 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                  int num25 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                  this.udsW = num24;
                  this.udsH = num25;
                  ...
                  {
                    this.Game.EventRelatedObj.DoCheckSpecificEvent(this.udsNewEvent, (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 9])));
                  ...
                  {
                    int id = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 8]));
                    if (id > 0 & Operators.CompareString(id.ToString(), this.Game.Data.StringListObj[stringListById1].Data[index1, 8], false) == 0)
                    {
                      ...
                      int tv0 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 9]));
                      this.udsTv0 = tv0;
                  ...
                  SubPartClass subPartClass = (SubPartClass) new UDSPartClass(this.Game, num24, num25, udSpopupText, ref this.UdsWindow.BackBitmap, 0, 0, true, tAlwaysShowBackground: true);
                  ref SubPartClass local7 = ref subPartClass;
                  int w = num24;
                  int h = num25;
                ...
                {
                  int num26 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                  int num27 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                  num15 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]));
                  int num28 = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 7]));
                  this.UdsWindow.FlagAll();
              ...
              {
                string str = this.Game.Data.StringListObj[stringListById1].Data[index1, 2];
                if (str.Length > 0)
              ...
              {
                int x1 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                int y1 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                int nr = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById1].Data[index1, 2]));
                if (nr > -1)
                {
                  try
                  {
              ...
              {
                int num29 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) + (double) num2);
                int num30 = (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) + (double) num3);
                ...
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 100000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 199999.0)
                  num29 = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 100000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 299999.0)
                  num29 = this.Game.ScreenWidth - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 200000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 99000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 199999.0)
                  num30 = 0 + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 100000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) >= 200000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) <= 299999.0)
                  num30 = this.Game.ScreenHeight - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 5]) - 200000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]) >= 100000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]) <= 199999.0)
                  num31 = this.Game.ScreenWidth - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 6]) - 100000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 300000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 399999.0)
                  num29 = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) + (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 300000.0);
                if (Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) >= 400000.0 & Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) <= 499999.0)
                  num29 = (int) Math.Round((double) this.Game.ScreenWidth / 2.0) - (int) Math.Round(Conversions.ToDouble(this.Game.Data.StringListObj[stringListById1].Data[index1, 4]) - 400000.0);
                string str1 = this.Game.Data.StringListObj[stringListById1].Data[index1, 8];
                string str2;
                if (this.Game.Data.Product >= 7)
                {
                  try
                  {
                    ...
                    if (num32 > -1)
                    {
                      string String1_1 = Strings.Mid(str1, num32 + 7, num33 - (num32 + 6));
                      string[] strArray;
                      ...
                      string str4 = this.Game.Data.StringListObj[stringListById1].Data[index1, 8];
                      if (strArray.GetUpperBound(0) > 0)
                      {
                        ...
                        string String1_2 = Strings.Left(str4, Length) + "[text]" + str3 + Strings.Mid(str4, num34 + 1);
        ...
        if (num14 == 2 && this.Game.Data.Product >= 7)
        {
          ...
          if (this.Game.EditObj.TipText.Length > 0 & this.Game.ModIntroType >= 1)
          {
            ...
            string str5 = this.Game.EditObj.TipTitle;
            bool flag1;
            ...
            int num35 = 100;
            int num36 = 20;
            string str6 = this.Game.EditObj.TipText;
            string str7 = "";
            int num37 = 0;
            while (str6.Length > 0)
            {
              string Left = Strings.Mid(str6, 1, 1);
            ...
            num15 = (int) Math.Round((double) (sizeF3.Width + 4f));
            ...
            if ((double) sizeF2.Width > (double) width)
              width = sizeF2.Width;
            int num39 = (int) Math.Round((double) (width + 4f));
            ...
            if (str5.Length > 0)
            {
              DrawMod.DrawBlock(ref graphics, x1 - 16, num38, num39 + 32, (int) Math.Round((double) (sizeF2.Height + 4f)), r1, g1, b1, (int) byte.MaxValue);
              DrawMod.DrawBlock(ref graphics, x1 - 16, (int) Math.Round((double) num38 + (double) sizeF2.Height + 4.0), num39 + 32, (int) Math.Round((double) h - ((double) sizeF2.Height + 4.0) + 16.0), r2, g2, b2, (int) byte.MaxValue);
              if (flag1)
              {
                DrawMod.DrawTextColouredNicely(ref graphics, str5, this.Game.MarcFont16, x1 + 2, num38 + 2, Color.FromArgb((int) byte.MaxValue, num40, num41, num42));
                DrawMod.DrawTextColouredNicely(ref graphics, str7, this.Game.MarcFont4b, x1 + 3, (int) Math.Round((double) ((float) (num38 + 6 + 8) + sizeF2.Height)), Color.FromArgb(178, 0, 0, 0));
                DrawMod.DrawTextColouredNicely(ref graphics, str7, this.Game.MarcFont4b, x1 + 2, (int) Math.Round((double) ((float) (num38 + 6 + 8) + sizeF2.Height)), Color.Black);
              }
              else
              {
                DrawMod.DrawTextColouredNicely(ref graphics, str5, this.Game.MarcFont16, x1 + 2, num38 + 2, Color.FromArgb((int) byte.MaxValue, num40, num41, num42), 12);
                DrawMod.DrawTextColouredNicely(ref graphics, str7, this.Game.MarcFont4, x1 + 2, (int) Math.Round((double) ((float) (num38 + 8 + 6) + sizeF2.Height)), Color.White);
              }
              DrawMod.DrawRectangle(ref graphics, x1 - 16, num38, num39 + 32, h + 16, r1, g1, b1, (int) byte.MaxValue);
            }
            else if (Operators.CompareString(str7, ".", false) == 0)
            {
              DrawMod.DrawBlock(ref graphics, x1, num38, 8, 4, num40, num41, num42, (int) byte.MaxValue);
              DrawMod.DrawRectangle(ref graphics, x1 + 2, num38 + 2, 1, 1, r1, g1, b1, (int) byte.MaxValue);
              DrawMod.DrawRectangle(ref graphics, x1, num38, 8, 4, r1, g1, b1, (int) byte.MaxValue);
            }
            else
            {
              DrawMod.DrawBlock(ref graphics, x1 - 16, num38, num39 + 32, h, num40, num41, num42, (int) byte.MaxValue);
              if (flag1)
              ...
              DrawMod.DrawRectangle(ref graphics, x1 - 16, num38, num39 + 32, h, r1, g1, b1, (int) byte.MaxValue);
            }
          }
        }
        if (num14 == 1)
        ...
        if (this.udsContainsButton)
        {
          if (!Information.IsNothing((object) this.UdsWindow))
          {
            ...
            if (enr > 0)
            {
              ...
              string udSpopupText = this.Game.EditObj.UDSpopupText;
              this.Game.EditObj.UDSpopupText = "";
    ...
    public void loadPageStuff(int nr)
    {
      ...
      for (int index = 0; index <= length1; ++index)
      {
        ...
        {
          string s = str + this.Game.Data.StringListObj[stringListById].Data[index, 2];
          this.fullBmpCenterScale = false;
      ...
      for (int index = 0; index <= length2; ++index)
      {
        ...
        {
          int specialRenderMode = (int) Math.Round(Conversion.Val(this.Game.Data.StringListObj[stringListById].Data[index, 1]));
    ...
    public void loadSpecificBmp(string s, int slot, int specialRenderMode = -1)
    {
      ...
      if (specialRenderMode == 1)
        DrawMod.ModifyColorOfBitmapToGrayHighSpeed(ref bmp, (int) byte.MaxValue);
      graphics.Dispose();
    ...
    public void SpecialRenderMode1(ref Graphics g, ref Bitmap b)
    {
      int num1 = 0;
      int num2 = 0;
      int num3 = b.Width - 1;
      ...
      for (int y = num5; y <= num6; ++y)
      {
        ...
        for (int x = num7; x <= num8; ++x)
        {
          ...
          int green = (int) Math.Max(pixel.B, Math.Max(pixel.R, pixel.G));
          int a = (int) pixel.A;
    ...
    public void SpecialRenderMode2(ref Graphics g, ref Bitmap b)
    {
      int num1 = 0;
      int num2 = 0;
      int num3 = b.Width - 1;
    ...
    public void loadSpecificFullBmp(string s)
    {
      if (!Information.IsNothing((object) this.fullBmp))
      {
        this.fullBmp.Dispose();
    ...
    public override void HandleTooltip(int x, int y, bool skipReset = false)
    {
      if (!Information.IsNothing((object) this.TabList))
      {
        int counter = this.TabList.Counter;
