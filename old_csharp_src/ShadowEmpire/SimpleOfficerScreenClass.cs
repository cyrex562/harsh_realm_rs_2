...
// Type: WindowsApplication1.SimpleOfficerScreenClass
...
{
  public class SimpleOfficerScreenClass : ScreenClass
  {
    ...
    public SimpleOfficerScreenClass(ref GameClass tgame, Form1 tformref)
      : base(ref tgame, tgame.BACKGROUND3MARC, tformref)
    {
      ...
      this.Game.EditObj.SimpleEditWindow = 105;
      this.Wmiddle = this.AddWindow((WindowClass) new SimpleOfficerWindowClass(ref tgame), 0, 0, this.Game.ScreenWidth, this.Game.ScreenHeight);
    }
