...
var imgPlus = Image::new ();
imgPlus.src = 'treenodeplus.gif';
var imgMinus = Image::new ();
imgMinus.src = 'treenodeminus.gif';
var imgDot = Image::new ();
...
function setSubNodeClass(el, nodeName, className) {
  // Sets the specified class name on el's first child that is a nodeName
  // element
  //
  var child;
...
function resizeTree() {
  // var treeDiv = document.getElementById('tree');
  // treeDiv.setAttribute('style', 'width: ' + document.body.offsetWidth + 'px;
  // height: ' + (document.body.offsetHeight - 27) + 'px;'); treeDiv.style.width
  // = document.documentElement.offsetWidth; treeDiv.style.height =
  // document.documentElement.offsetHeight - 27;
